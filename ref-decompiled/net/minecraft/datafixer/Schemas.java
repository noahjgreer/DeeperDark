...
public class Schemas {
   private static final BiFunction EMPTY = Schema::new;
   private static final BiFunction EMPTY_IDENTIFIER_NORMALIZE = IdentifierNormalizingSchema::new;
   ...
   public static CompletableFuture optimize(Set requiredTypes) {
   ...
   private static void build(DataFixerBuilder builder) {
      ...
      builder.addFixer(ItemNameFix.create(schema17, "cooked_fished item renamer", (id) -> {
         return Objects.equals(IdentifierNormalizingSchema.normalize(id), "minecraft:cooked_fished") ? "minecraft:cooked_fish" : id;
      }));
      ...
      builder.addFixer(new ItemRemoveBlockEntityTagFix(schema42, Set.of("minecraft:noteblock", "minecraft:flower_pot")));
      ...
      builder.addFixer(BlockNameFix.create(schema50, "Colorless shulker block fixer", (id) -> {
         return Objects.equals(IdentifierNormalizingSchema.normalize(id), "minecraft:purple_shulker_box") ? "minecraft:shulker_box" : id;
      }));
      builder.addFixer(ItemNameFix.create(schema50, "Colorless shulker item fixer", (id) -> {
         return Objects.equals(IdentifierNormalizingSchema.normalize(id), "minecraft:purple_shulker_box") ? "minecraft:shulker_box" : id;
      }));
      Schema schema51 = builder.addSchema(1475, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(BlockNameFix.create(schema51, "Flowing fixer", replacing(ImmutableMap.of("minecraft:flowing_water", "minecraft:water", "minecraft:flowing_lava", "minecraft:lava"))));
      ...
      builder.addFixer(ItemNameFix.create(schema55, "Rename seagrass items", replacing(ImmutableMap.of("minecraft:sea_grass", "minecraft:seagrass", "minecraft:tall_sea_grass", "minecraft:tall_seagrass"))));
      builder.addFixer(BlockNameFix.create(schema55, "Rename seagrass blocks", replacing(ImmutableMap.of("minecraft:sea_grass", "minecraft:seagrass", "minecraft:tall_sea_grass", "minecraft:tall_seagrass"))));
      ...
      builder.addFixer(ItemNameFix.create(schema57, "Rename prismarine_brick(s)_* blocks", replacing(ImmutableMap.of("minecraft:prismarine_bricks_slab", "minecraft:prismarine_brick_slab", "minecraft:prismarine_bricks_stairs", "minecraft:prismarine_brick_stairs"))));
      builder.addFixer(BlockNameFix.create(schema57, "Rename prismarine_brick(s)_* items", replacing(ImmutableMap.of("minecraft:prismarine_bricks_slab", "minecraft:prismarine_brick_slab", "minecraft:prismarine_bricks_stairs", "minecraft:prismarine_brick_stairs"))));
      Schema schema58 = builder.addSchema(1488, Schema1488::new);
      builder.addFixer(BlockNameFix.create(schema58, "Rename kelp/kelptop", replacing(ImmutableMap.of("minecraft:kelp_top", "minecraft:kelp", "minecraft:kelp", "minecraft:kelp_plant"))));
      builder.addFixer(ItemNameFix.create(schema58, "Rename kelptop", replacing("minecraft:kelp_top", "minecraft:kelp")));
      builder.addFixer(new ChoiceWriteReadFix(schema58, true, "Command block block entity custom name fix", TypeReferences.BLOCK_ENTITY, "minecraft:command_block") {
      ...
      builder.addFixer(new DataFix(schema58, false) {
         protected TypeRewriteRule makeRule() {
            ...
            OpticFinder opticFinder3 = DSL.typeFinder(this.getInputSchema().getType(TypeReferences.TEXT_COMPONENT));
            return this.fixTypeEverywhereTyped("Command block minecart custom name fix", type, (typed) -> {
               ...
               return !"minecraft:commandblock_minecart".equals(string) ? typed : typed.updateTyped(opticFinder2, (typedx) -> {
      ...
      builder.addFixer(ItemNameFix.create(schema59, "Rename melon_block/melon/speckled_melon", replacing(ImmutableMap.of("minecraft:melon_block", "minecraft:melon", "minecraft:melon", "minecraft:melon_slice", "minecraft:speckled_melon", "minecraft:glistering_melon_slice"))));
      ...
      builder.addFixer(new StatsRenameFix(schema67, "SwimStatsRenameFix", ImmutableMap.of("minecraft:swim_one_cm", "minecraft:walk_on_water_one_cm", "minecraft:dive_one_cm", "minecraft:walk_under_water_one_cm")));
      ...
      builder.addFixer(BlockNameFix.create(schema73, "Rename sign blocks & stone slabs", replacing(ImmutableMap.of("minecraft:stone_slab", "minecraft:smooth_stone_slab", "minecraft:sign", "minecraft:oak_sign", "minecraft:wall_sign", "minecraft:oak_wall_sign"))));
      builder.addFixer(ItemNameFix.create(schema73, "Rename sign item & stone slabs", replacing(ImmutableMap.of("minecraft:stone_slab", "minecraft:smooth_stone_slab", "minecraft:sign", "minecraft:oak_sign"))));
      ...
      builder.addFixer(new GameEventRenamesFix(schema95, "Rename sugar recipe", TypeReferences.RECIPE, replacing("minecraft:sugar", "minecraft:sugar_from_sugar_cane")));
      builder.addFixer(new AdvancementRenameFix(schema95, false, "Rename sugar recipe advancement", replacing("minecraft:recipes/misc/sugar", "minecraft:recipes/misc/sugar_from_sugar_cane")));
      ...
      UnaryOperator unaryOperator = replacing("minecraft:bee_hive", "minecraft:beehive");
      ...
      builder.addFixer(new AdvancementRenameFix(schema102, false, "Composter category change", replacing("minecraft:recipes/misc/composter", "minecraft:recipes/decorations/composter")));
      ...
      builder.addFixer(ItemNameFix.create(schema104, "Renamed fungi items to fungus", replacing(ImmutableMap.of("minecraft:warped_fungi", "minecraft:warped_fungus", "minecraft:crimson_fungi", "minecraft:crimson_fungus"))));
      builder.addFixer(BlockNameFix.create(schema104, "Renamed fungi blocks to fungus", replacing(ImmutableMap.of("minecraft:warped_fungi", "minecraft:warped_fungus", "minecraft:crimson_fungi", "minecraft:crimson_fungus"))));
      ...
      builder.addFixer(ItemNameFix.create(schema115, "Rename soul fire torch and soul fire lantern", replacing(ImmutableMap.of("minecraft:soul_fire_torch", "minecraft:soul_torch", "minecraft:soul_fire_lantern", "minecraft:soul_lantern"))));
      builder.addFixer(BlockNameFix.create(schema115, "Rename soul fire torch and soul fire lantern", replacing(ImmutableMap.of("minecraft:soul_fire_torch", "minecraft:soul_torch", "minecraft:soul_fire_wall_torch", "minecraft:soul_wall_torch", "minecraft:soul_fire_lantern", "minecraft:soul_lantern"))));
      ...
      builder.addFixer(new LegacyDimensionFix(schema120));
      ...
      builder.addFixer(new StructureSeparationDataFix(schema122));
      Schema schema123 = builder.addSchema(2551, Schema2551::new);
      builder.addFixer(new WriteAndReadFix(schema123, "add types to WorldGenData", TypeReferences.WORLD_GEN_SETTINGS));
      Schema schema124 = builder.addSchema(2552, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new GameEventRenamesFix(schema124, "Nether biome rename", TypeReferences.BIOME, replacing("minecraft:nether", "minecraft:nether_wastes")));
      Schema schema125 = builder.addSchema(2553, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new GameEventRenamesFix(schema125, "Biomes fix", TypeReferences.BIOME, replacing(FlatteningBiomeMapping.RENAMED_BIOMES)));
      Schema schema126 = builder.addSchema(2558, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new MissingDimensionFix(schema126, false));
      builder.addFixer(new OptionFix(schema126, false, "Rename swapHands setting", "key_key.swapHands", "key_key.swapOffhand"));
      Schema schema127 = builder.addSchema(2568, Schema2568::new);
      builder.addFixer(new ChoiceTypesFix(schema127, "Added Piglin Brute", TypeReferences.ENTITY));
      Schema schema128 = builder.addSchema(2571, Schema2571::new);
      builder.addFixer(new ChoiceTypesFix(schema128, "Added Goat", TypeReferences.ENTITY));
      Schema schema129 = builder.addSchema(2679, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new CauldronRenameFix(schema129, false));
      Schema schema130 = builder.addSchema(2680, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(ItemNameFix.create(schema130, "Renamed grass path item to dirt path", replacing("minecraft:grass_path", "minecraft:dirt_path")));
      builder.addFixer(BlockNameFix.create(schema130, "Renamed grass path block to dirt path", replacing("minecraft:grass_path", "minecraft:dirt_path")));
      Schema schema131 = builder.addSchema(2684, Schema2684::new);
      builder.addFixer(new ChoiceTypesFix(schema131, "Added Sculk Sensor", TypeReferences.BLOCK_ENTITY));
      Schema schema132 = builder.addSchema(2686, Schema2686::new);
      builder.addFixer(new ChoiceTypesFix(schema132, "Added Axolotl", TypeReferences.ENTITY));
      Schema schema133 = builder.addSchema(2688, Schema2688::new);
      builder.addFixer(new ChoiceTypesFix(schema133, "Added Glow Squid", TypeReferences.ENTITY));
      builder.addFixer(new ChoiceTypesFix(schema133, "Added Glow Item Frame", TypeReferences.ENTITY));
      Schema schema134 = builder.addSchema(2690, EMPTY_IDENTIFIER_NORMALIZE);
      ...
      builder.addFixer(ItemNameFix.create(schema134, "Renamed copper block items to new oxidized terms", replacing(immutableMap)));
      builder.addFixer(BlockNameFix.create(schema134, "Renamed copper blocks to new oxidized terms", replacing(immutableMap)));
      Schema schema135 = builder.addSchema(2691, EMPTY_IDENTIFIER_NORMALIZE);
      ImmutableMap immutableMap2 = ImmutableMap.builder().put("minecraft:waxed_copper", "minecraft:waxed_copper_block").put("minecraft:oxidized_copper_block", "minecraft:oxidized_copper").put("minecraft:weathered_copper_block", "minecraft:weathered_copper").put("minecraft:exposed_copper_block", "minecraft:exposed_copper").build();
      builder.addFixer(ItemNameFix.create(schema135, "Rename copper item suffixes", replacing(immutableMap2)));
      builder.addFixer(BlockNameFix.create(schema135, "Rename copper blocks suffixes", replacing(immutableMap2)));
      Schema schema136 = builder.addSchema(2693, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new AddFlagIfNotPresentFix(schema136, TypeReferences.WORLD_GEN_SETTINGS, "has_increased_height_already", false));
      Schema schema137 = builder.addSchema(2696, EMPTY_IDENTIFIER_NORMALIZE);
      ...
      builder.addFixer(ItemNameFix.create(schema137, "Renamed grimstone block items to deepslate", replacing(immutableMap3)));
      builder.addFixer(BlockNameFix.create(schema137, "Renamed grimstone blocks to deepslate", replacing(immutableMap3)));
      Schema schema138 = builder.addSchema(2700, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(BlockNameFix.create(schema138, "Renamed cave vines blocks", replacing(ImmutableMap.of("minecraft:cave_vines_head", "minecraft:cave_vines", "minecraft:cave_vines_body", "minecraft:cave_vines_plant"))));
      Schema schema139 = builder.addSchema(2701, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new StructureFeatureChildrenPoolElementFix(schema139));
      Schema schema140 = builder.addSchema(2702, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new ArrowPickupFix(schema140));
      Schema schema141 = builder.addSchema(2704, Schema2704::new);
      builder.addFixer(new ChoiceTypesFix(schema141, "Added Goat", TypeReferences.ENTITY));
      Schema schema142 = builder.addSchema(2707, Schema2707::new);
      builder.addFixer(new ChoiceTypesFix(schema142, "Added Marker", TypeReferences.ENTITY));
      builder.addFixer(new AddFlagIfNotPresentFix(schema142, TypeReferences.WORLD_GEN_SETTINGS, "has_increased_height_already", true));
      Schema schema143 = builder.addSchema(2710, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new StatsRenameFix(schema143, "Renamed play_one_minute stat to play_time", ImmutableMap.of("minecraft:play_one_minute", "minecraft:play_time")));
      Schema schema144 = builder.addSchema(2717, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(ItemNameFix.create(schema144, "Rename azalea_leaves_flowers", replacing(ImmutableMap.of("minecraft:azalea_leaves_flowers", "minecraft:flowering_azalea_leaves"))));
      builder.addFixer(BlockNameFix.create(schema144, "Rename azalea_leaves_flowers items", replacing(ImmutableMap.of("minecraft:azalea_leaves_flowers", "minecraft:flowering_azalea_leaves"))));
      Schema schema145 = builder.addSchema(2825, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new AddFlagIfNotPresentFix(schema145, TypeReferences.WORLD_GEN_SETTINGS, "has_increased_height_already", false));
      Schema schema146 = builder.addSchema(2831, Schema2831::new);
      builder.addFixer(new UntaggedSpawnerFix(schema146));
      Schema schema147 = builder.addSchema(2832, Schema2832::new);
      builder.addFixer(new WorldGenSettingsHeightAndBiomeFix(schema147));
      builder.addFixer(new ChunkHeightAndBiomeFix(schema147));
      Schema schema148 = builder.addSchema(2833, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new WorldGenSettingsDisallowOldCustomWorldsFix(schema148));
      Schema schema149 = builder.addSchema(2838, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new GameEventRenamesFix(schema149, "Caves and Cliffs biome renames", TypeReferences.BIOME, replacing(LegacyBiomeMapping.MAP)));
      Schema schema150 = builder.addSchema(2841, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new ProtoChunkTickListFix(schema150));
      Schema schema151 = builder.addSchema(2842, Schema2842::new);
      builder.addFixer(new ChunkLevelTagRenameFix(schema151));
      Schema schema152 = builder.addSchema(2843, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new TicksInWrongChunkFix(schema152));
      builder.addFixer(new GameEventRenamesFix(schema152, "Remove Deep Warm Ocean", TypeReferences.BIOME, replacing("minecraft:deep_warm_ocean", "minecraft:warm_ocean")));
      Schema schema153 = builder.addSchema(2846, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new AdvancementRenameFix(schema153, false, "Rename some C&C part 2 advancements", replacing(ImmutableMap.of("minecraft:husbandry/play_jukebox_in_meadows", "minecraft:adventure/play_jukebox_in_meadows", "minecraft:adventure/caves_and_cliff", "minecraft:adventure/fall_from_world_height", "minecraft:adventure/ride_strider_in_overworld_lava", "minecraft:nether/ride_strider_in_overworld_lava"))));
      Schema schema154 = builder.addSchema(2852, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new WorldGenSettingsDisallowOldCustomWorldsFix(schema154));
      Schema schema155 = builder.addSchema(2967, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new StructureSettingsFlattenFix(schema155));
      Schema schema156 = builder.addSchema(2970, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new StructuresToConfiguredStructuresFix(schema156));
      Schema schema157 = builder.addSchema(3076, Schema3076::new);
      builder.addFixer(new ChoiceTypesFix(schema157, "Added Sculk Catalyst", TypeReferences.BLOCK_ENTITY));
      Schema schema158 = builder.addSchema(3077, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new ChunkDeleteIgnoredLightDataFix(schema158));
      Schema schema159 = builder.addSchema(3078, Schema3078::new);
      builder.addFixer(new ChoiceTypesFix(schema159, "Added Frog", TypeReferences.ENTITY));
      builder.addFixer(new ChoiceTypesFix(schema159, "Added Tadpole", TypeReferences.ENTITY));
      builder.addFixer(new ChoiceTypesFix(schema159, "Added Sculk Shrieker", TypeReferences.BLOCK_ENTITY));
      ...
      builder.addFixer(new EntityVariantTypeFix(schema164, "Change cat variant type", var10005, "minecraft:cat", "CatType", var10008::get));
      ...
      builder.addFixer(new AdvancementCriteriaRenameFix(schema164, "Migrate cat variant advancement", "minecraft:husbandry/complete_catalogue", (string) -> {
         return (String)immutableMap4.getOrDefault(string, string);
      }));
      Schema schema165 = builder.addSchema(3087, EMPTY_IDENTIFIER_NORMALIZE);
      var10005 = TypeReferences.ENTITY;
      var10008 = (Int2ObjectOpenHashMap)Util.make(new Int2ObjectOpenHashMap(), (frogVariants) -> {
         frogVariants.put(0, "minecraft:temperate");
         frogVariants.put(1, "minecraft:warm");
         frogVariants.put(2, "minecraft:cold");
      });
      Objects.requireNonNull(var10008);
      builder.addFixer(new EntityVariantTypeFix(schema165, "Change frog variant type", var10005, "minecraft:frog", "Variant", var10008::get));
      Schema schema166 = builder.addSchema(3090, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new RenameEntityNbtKeyFix(schema166, "EntityPaintingFieldsRenameFix", "minecraft:painting", Map.of("Motive", "variant", "Facing", "facing")));
      ...
      Map map = Map.of("minecraft:british", "minecraft:british_shorthair");
      builder.addFixer(new RenameVariantsFix(schema169, "Rename british shorthair", TypeReferences.ENTITY, "minecraft:cat", map));
      builder.addFixer(new AdvancementCriteriaRenameFix(schema169, "Migrate cat variant advancement for british shorthair", "minecraft:husbandry/complete_catalogue", (string) -> {
      ...
      builder.addFixer(new PointOfInterestRemoveFix(schema169, "Remove unpopulated villager PoI types", var278::contains));
      ...
      Schema schema180 = builder.addSchema(3326, Schema3326::new);
      builder.addFixer(new ChoiceTypesFix(schema180, "Added Sniffer", TypeReferences.ENTITY));
      Schema schema181 = builder.addSchema(3327, Schema3327::new);
      builder.addFixer(new ChoiceTypesFix(schema181, "Archaeology", TypeReferences.BLOCK_ENTITY));
      Schema schema182 = builder.addSchema(3328, Schema3328::new);
      builder.addFixer(new ChoiceTypesFix(schema182, "Added interaction", TypeReferences.ENTITY));
      Schema schema183 = builder.addSchema(3438, Schema3438::new);
      builder.addFixer(RenameBlockEntityFix.create(schema183, "Rename Suspicious Sand to Brushable Block", replacing("minecraft:suspicious_sand", "minecraft:brushable_block")));
      builder.addFixer(new EntityBrushableBlockFieldsRenameFix(schema183));
      builder.addFixer(ItemNameFix.create(schema183, "Pottery shard renaming", replacing(ImmutableMap.of("minecraft:pottery_shard_archer", "minecraft:archer_pottery_shard", "minecraft:pottery_shard_prize", "minecraft:prize_pottery_shard", "minecraft:pottery_shard_arms_up", "minecraft:arms_up_pottery_shard", "minecraft:pottery_shard_skull", "minecraft:skull_pottery_shard"))));
      builder.addFixer(new ChoiceTypesFix(schema183, "Added calibrated sculk sensor", TypeReferences.BLOCK_ENTITY));
      Schema schema184 = builder.addSchema(3439, Schema3439::new);
      builder.addFixer(new UpdateSignTextFormatFix(schema184, "Updated sign text format for Signs", "minecraft:sign"));
      Schema schema185 = builder.addSchema(3439, 1, Schema3439_1::new);
      builder.addFixer(new UpdateSignTextFormatFix(schema185, "Updated sign text format for Hanging Signs", "minecraft:hanging_sign"));
      Schema schema186 = builder.addSchema(3440, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new GameEventRenamesFix(schema186, "Replace experimental 1.20 overworld", TypeReferences.MULTI_NOISE_BIOME_SOURCE_PARAMETER_LIST, replacing("minecraft:overworld_update_1_20", "minecraft:overworld")));
      builder.addFixer(new RemoveFeatureTogglesFix(schema186, "Remove 1.20 feature toggle", Set.of("minecraft:update_1_20")));
      Schema schema187 = builder.addSchema(3447, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(ItemNameFix.create(schema187, "Pottery shard item renaming to Pottery sherd", replacing((Map)Stream.of("minecraft:angler_pottery_shard", "minecraft:archer_pottery_shard", "minecraft:arms_up_pottery_shard", "minecraft:blade_pottery_shard", "minecraft:brewer_pottery_shard", "minecraft:burn_pottery_shard", "minecraft:danger_pottery_shard", "minecraft:explorer_pottery_shard", "minecraft:friend_pottery_shard", "minecraft:heart_pottery_shard", "minecraft:heartbreak_pottery_shard", "minecraft:howl_pottery_shard", "minecraft:miner_pottery_shard", "minecraft:mourner_pottery_shard", "minecraft:plenty_pottery_shard", "minecraft:prize_pottery_shard", "minecraft:sheaf_pottery_shard", "minecraft:shelter_pottery_shard", "minecraft:skull_pottery_shard", "minecraft:snort_pottery_shard").collect(Collectors.toMap(Function.identity(), (string) -> {
         return string.replace("_pottery_shard", "_pottery_sherd");
      })))));
      Schema schema188 = builder.addSchema(3448, Schema3448::new);
      builder.addFixer(new DecoratedPotFieldRenameFix(schema188));
      Schema schema189 = builder.addSchema(3450, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new RenameChunkStatusFix(schema189, "Remove liquid_carvers and heightmap chunk statuses", replacing(Map.of("minecraft:liquid_carvers", "minecraft:carvers", "minecraft:heightmaps", "minecraft:spawn"))));
      Schema schema190 = builder.addSchema(3451, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new ChunkDeleteLightFix(schema190));
      Schema schema191 = builder.addSchema(3459, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new LegacyDragonFightFix(schema191));
      Schema schema192 = builder.addSchema(3564, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new DropInvalidSignDatafixDataFix(schema192, "minecraft:sign"));
      Schema schema193 = builder.addSchema(3564, 1, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new DropInvalidSignDatafixDataFix(schema193, "minecraft:hanging_sign"));
      Schema schema194 = builder.addSchema(3565, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new RandomSequenceSettingsFix(schema194));
      Schema schema195 = builder.addSchema(3566, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new RenameScoreboardDisplaySlotFix(schema195));
      Schema schema196 = builder.addSchema(3568, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new StatusEffectFix(schema196));
      Schema schema197 = builder.addSchema(3682, Schema3682::new);
      builder.addFixer(new ChoiceTypesFix(schema197, "Added Crafter", TypeReferences.BLOCK_ENTITY));
      Schema schema198 = builder.addSchema(3683, Schema3683::new);
      builder.addFixer(new PrimedTntBlockStateFix(schema198));
      Schema schema199 = builder.addSchema(3685, Schema3685::new);
      builder.addFixer(new ProjectileItemTypeFix(schema199));
      Schema schema200 = builder.addSchema(3689, Schema3689::new);
      builder.addFixer(new ChoiceTypesFix(schema200, "Added Breeze", TypeReferences.ENTITY));
      builder.addFixer(new ChoiceTypesFix(schema200, "Added Trial Spawner", TypeReferences.BLOCK_ENTITY));
      Schema schema201 = builder.addSchema(3692, EMPTY_IDENTIFIER_NORMALIZE);
      UnaryOperator unaryOperator2 = replacing(Map.of("minecraft:grass", "minecraft:short_grass"));
      builder.addFixer(BlockNameFix.create(schema201, "Rename grass block to short_grass", unaryOperator2));
      builder.addFixer(ItemNameFix.create(schema201, "Rename grass item to short_grass", unaryOperator2));
      Schema schema202 = builder.addSchema(3799, Schema3799::new);
      builder.addFixer(new ChoiceTypesFix(schema202, "Added Armadillo", TypeReferences.ENTITY));
      Schema schema203 = builder.addSchema(3800, EMPTY_IDENTIFIER_NORMALIZE);
      UnaryOperator unaryOperator3 = replacing(Map.of("minecraft:scute", "minecraft:turtle_scute"));
      builder.addFixer(ItemNameFix.create(schema203, "Rename scute item to turtle_scute", unaryOperator3));
      Schema schema204 = builder.addSchema(3803, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new RenameEnchantmentFix(schema204, "Rename sweeping enchant to sweeping_edge", Map.of("minecraft:sweeping", "minecraft:sweeping_edge")));
      Schema schema205 = builder.addSchema(3807, Schema3807::new);
      builder.addFixer(new ChoiceTypesFix(schema205, "Added Vault", TypeReferences.BLOCK_ENTITY));
      Schema schema206 = builder.addSchema(3807, 1, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new MapBannerBlockPosFormatFix(schema206));
      Schema schema207 = builder.addSchema(3808, Schema3808::new);
      builder.addFixer(new HorseArmorFix(schema207, "minecraft:horse", "ArmorItem", true));
      Schema schema208 = builder.addSchema(3808, 1, Schema3808_1::new);
      builder.addFixer(new HorseArmorFix(schema208, "minecraft:llama", "DecorItem", false));
      Schema schema209 = builder.addSchema(3808, 2, Schema3808_2::new);
      builder.addFixer(new HorseArmorFix(schema209, "minecraft:trader_llama", "DecorItem", false));
      Schema schema210 = builder.addSchema(3809, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new HorseChestIndexingFix(schema210));
      Schema schema211 = builder.addSchema(3812, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new WolfHealthFix(schema211));
      Schema schema212 = builder.addSchema(3813, Schema3813::new);
      builder.addFixer(new BlockPosFormatFix(schema212));
      Schema schema213 = builder.addSchema(3814, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new RenameEntityAttributesFix(schema213, "Rename jump strength attribute", replacing("minecraft:horse.jump_strength", "minecraft:generic.jump_strength")));
      Schema schema214 = builder.addSchema(3816, Schema3816::new);
      builder.addFixer(new ChoiceTypesFix(schema214, "Added Bogged", TypeReferences.ENTITY));
      Schema schema215 = builder.addSchema(3818, Schema3818::new);
      builder.addFixer(new BeehiveFieldRenameFix(schema215));
      builder.addFixer(new EmptyItemInHotbarFix(schema215));
      Schema schema216 = builder.addSchema(3818, 1, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new BannerPatternFormatFix(schema216));
      Schema schema217 = builder.addSchema(3818, 2, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new TippedArrowPotionToItemFix(schema217));
      Schema schema218 = builder.addSchema(3818, 3, Schema3818_3::new);
      builder.addFixer(new WriteAndReadFix(schema218, "Inject data component types", TypeReferences.DATA_COMPONENTS));
      Schema schema219 = builder.addSchema(3818, 4, Schema3818_4::new);
      builder.addFixer(new ParticleUnflatteningFix(schema219));
      Schema schema220 = builder.addSchema(3818, 5, Schema3818_5::new);
      builder.addFixer(new ItemStackComponentizationFix(schema220));
      Schema schema221 = builder.addSchema(3818, 6, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new AreaEffectCloudPotionFix(schema221));
      Schema schema222 = builder.addSchema(3820, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new PlayerHeadBlockProfileFix(schema222));
      builder.addFixer(new LodestoneCompassComponentFix(schema222));
      Schema schema223 = builder.addSchema(3825, Schema3825::new);
      builder.addFixer(new ItemStackCustomNameToItemNameFix(schema223));
      builder.addFixer(new BannerCustomNameToItemNameFix(schema223));
      builder.addFixer(new TrialSpawnerConfigTagFix(schema223));
      builder.addFixer(new ChoiceTypesFix(schema223, "Added Ominous Item Spawner", TypeReferences.ENTITY));
      Schema schema224 = builder.addSchema(3828, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new EmptyItemInVillagerTradeFix(schema224));
      Schema schema225 = builder.addSchema(3833, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new RemoveEmptyItemInSuspiciousBlockFix(schema225));
      Schema schema226 = builder.addSchema(3938, Schema3938::new);
      builder.addFixer(new ArrowStoredWeaponFix(schema226));
      Schema schema227 = builder.addSchema(3939, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new RemoveFeatureTogglesFix(schema227, "Remove 1.21 feature toggle", Set.of("minecraft:update_1_21")));
      Schema schema228 = builder.addSchema(3943, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new OptionsMenuBlurrinessFix(schema228));
      Schema schema229 = builder.addSchema(3945, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new AttributeIdFix(schema229));
      builder.addFixer(new JukeboxTicksSinceSongStartedFix(schema229));
      Schema schema230 = builder.addSchema(4054, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new OminousBannerRarityFix(schema230));
      Schema schema231 = builder.addSchema(4055, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new AttributeIdPrefixFix(schema231));
      Schema schema232 = builder.addSchema(4057, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new CarvingStepRemoveFix(schema232));
      Schema schema233 = builder.addSchema(4059, Schema4059::new);
      builder.addFixer(new FoodToConsumableFix(schema233));
      Schema schema234 = builder.addSchema(4061, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new TrialSpawnerConfigInRegistryFix(schema234));
      Schema schema235 = builder.addSchema(4064, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new FireResistantToDamageResistantComponentFix(schema235));
      Schema schema236 = builder.addSchema(4067, Schema4067::new);
      builder.addFixer(new BoatSplitFix(schema236));
      builder.addFixer(new RemoveFeatureTogglesFix(schema236, "Remove Bundle experimental feature flag", Set.of("minecraft:bundle")));
      Schema schema237 = builder.addSchema(4068, EMPTY_IDENTIFIER_NORMALIZE);
      ...
      Schema schema238 = builder.addSchema(4070, Schema4070::new);
      builder.addFixer(new ChoiceTypesFix(schema238, "Added Pale Oak Boat and Pale Oak Chest Boat", TypeReferences.ENTITY));
      Schema schema239 = builder.addSchema(4071, Schema4071::new);
      builder.addFixer(new ChoiceTypesFix(schema239, "Added Creaking", TypeReferences.ENTITY));
      builder.addFixer(new ChoiceTypesFix(schema239, "Added Creaking Heart", TypeReferences.BLOCK_ENTITY));
      Schema schema240 = builder.addSchema(4081, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new EntitySalmonSizeFix(schema240));
      Schema schema241 = builder.addSchema(4173, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new RenameEntityNbtKeyFix(schema241, "Rename TNT Minecart fuse", "minecraft:tnt_minecart", Map.of("TNTFuse", "fuse")));
      Schema schema242 = builder.addSchema(4175, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new EquippableAssetRenameFix(schema242));
      builder.addFixer(new CustomModelDataExpansionFix(schema242));
      Schema schema243 = builder.addSchema(4176, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new BlockEntityLockToComponentFix(schema243));
      builder.addFixer(new InvalidLockComponentPredicateFix(schema243));
      Schema schema244 = builder.addSchema(4180, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new RemoveFeatureTogglesFix(schema244, "Remove Winter Drop toggle", Set.of("minecraft:winter_drop")));
      Schema schema245 = builder.addSchema(4181, EMPTY_IDENTIFIER_NORMALIZE);
      ...
      Schema schema246 = builder.addSchema(4187, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new EntityAttributeBaseFix(schema246, "Villager follow range fix undo", "minecraft:villager", "minecraft:follow_range", (followRange) -> {
         return followRange == 48.0 ? 16.0 : followRange;
      }));
      builder.addFixer(new EntityAttributeBaseFix(schema246, "Bee follow range fix", "minecraft:bee", "minecraft:follow_range", (followRange) -> {
         return followRange == 48.0 ? 16.0 : followRange;
      }));
      builder.addFixer(new EntityAttributeBaseFix(schema246, "Allay follow range fix", "minecraft:allay", "minecraft:follow_range", (followRange) -> {
         return followRange == 48.0 ? 16.0 : followRange;
      }));
      builder.addFixer(new EntityAttributeBaseFix(schema246, "Llama follow range fix", "minecraft:llama", "minecraft:follow_range", (followRange) -> {
         return followRange == 40.0 ? 16.0 : followRange;
      }));
      builder.addFixer(new EntityAttributeBaseFix(schema246, "Piglin Brute follow range fix", "minecraft:piglin_brute", "minecraft:follow_range", (followRange) -> {
         return followRange == 16.0 ? 12.0 : followRange;
      }));
      builder.addFixer(new EntityAttributeBaseFix(schema246, "Warden follow range fix", "minecraft:warden", "minecraft:follow_range", (followRange) -> {
         return followRange == 16.0 ? 24.0 : followRange;
      }));
      Schema schema247 = builder.addSchema(4290, Schema4290::new);
      builder.addFixer(new UnflattenTextComponentFix(schema247));
      Schema schema248 = builder.addSchema(4291, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new LegacyHoverEventFix(schema248));
      builder.addFixer(new TextComponentStringyFlagsFix(schema248));
      Schema schema249 = builder.addSchema(4292, Schema4292::new);
      builder.addFixer(new TextComponentHoverAndClickEventFix(schema249));
      Schema schema250 = builder.addSchema(4293, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new DropChancesFormatFix(schema250));
      Schema schema251 = builder.addSchema(4294, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new SimpleBlockPropertyRenameFix(schema251, "CreakingHeartBlockStateFix", "minecraft:creaking_heart", "active", "creaking_heart_state", (value) -> {
         return value.equals("true") ? "awake" : "uprooted";
      }));
      Schema schema252 = builder.addSchema(4295, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new BlendingDataFix(schema252));
      Schema schema253 = builder.addSchema(4296, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new AreaEffectCloudDurationScaleFix(schema253));
      Schema schema254 = builder.addSchema(4297, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new ForcedChunkToTicketFix(schema254));
      Schema schema255 = builder.addSchema(4299, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new ItemVariantComponentizationFix(schema255));
      Schema schema256 = builder.addSchema(4300, Schema4300::new);
      builder.addFixer(new SaddleEquipmentSlotFix(schema256));
      Schema schema257 = builder.addSchema(4301, Schema4301::new);
      builder.addFixer(new EquipmentFormatFix(schema257));
      Schema schema258 = builder.addSchema(4302, Schema4302::new);
      builder.addFixer(new ChoiceTypesFix(schema258, "Added Test and Test Instance Block Entities", TypeReferences.BLOCK_ENTITY));
      Schema schema259 = builder.addSchema(4303, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new EntityFallDistanceFloatToDoubleFix(schema259, TypeReferences.ENTITY));
      builder.addFixer(new EntityFallDistanceFloatToDoubleFix(schema259, TypeReferences.PLAYER));
      Schema schema260 = builder.addSchema(4305, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new SimpleBlockPropertyRenameFix(schema260, "rename test block mode", "minecraft:test_block", "test_block_mode", "mode", (value) -> {
         return value;
      }));
      Schema schema261 = builder.addSchema(4306, Schema4306::new);
      builder.addFixer(new ThrownPotionSplitFix(schema261));
      Schema schema262 = builder.addSchema(4307, Schema4307::new);
      builder.addFixer(new TooltipDisplayComponentFix(schema262));
      Schema schema263 = builder.addSchema(4309, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new RaidRenamesDataFix(schema263));
      builder.addFixer(new ChunkTicketUnpackPosFix(schema263));
      Schema schema264 = builder.addSchema(4311, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new AdvancementRenameFix(schema264, false, "Use lodestone category change", replacing("minecraft:nether/use_lodestone", "minecraft:adventure/use_lodestone")));
      Schema schema265 = builder.addSchema(4312, Schema4312::new);
      builder.addFixer(new PlayerEquipmentFix(schema265));
      Schema schema266 = builder.addSchema(4314, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new InlineBlockPosFormatFix(schema266));
      Schema schema267 = builder.addSchema(4420, Schema4420::new);
      builder.addFixer(new TypeChangeFix(schema267, "AreaEffectCloudCustomParticleFix", TypeReferences.ENTITY, "minecraft:area_effect_cloud"));
      Schema schema268 = builder.addSchema(4421, Schema4421::new);
      builder.addFixer(new ChoiceTypesFix(schema268, "Added Happy Ghast", TypeReferences.ENTITY));
      Schema schema269 = builder.addSchema(4424, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new RemoveFeatureTogglesFix(schema269, "Remove Locator Bar experimental feature flag", Set.of("minecraft:locator_bar")));
   }

   private static UnaryOperator replacingRaw(Map replacements) {
      return (string) -> {
         return (String)replacements.getOrDefault(string, string);
      };
   }

   private static UnaryOperator replacing(Map replacements) {
      return (string) -> {
         return (String)replacements.getOrDefault(IdentifierNormalizingSchema.normalize(string), string);
      };
   }

   private static UnaryOperator replacing(String old, String current) {
      return (string) -> {
         return Objects.equals(IdentifierNormalizingSchema.normalize(string), old) ? current : string;
      };
   }
}
