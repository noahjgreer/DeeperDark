...
extends IdentifierNormalizingSchema {
    ...
    protected static TypeTemplate registerFields(Schema schema) {
        return DSL.optionalFields((String)"inBlockState", (TypeTemplate)TypeReferences.BLOCK_STATE.in(schema), (String)"item", (TypeTemplate)TypeReferences.ITEM_STACK.in(schema));
    }
