...
extends Schema {
    ...
    protected static final Hook.HookFunction field_5745 = new Hook.HookFunction(){
        ...
        public <T> T apply(DynamicOps<T> ops, T value) {
            return Schema99.updateBlockEntityTags(new Dynamic(ops, value), BLOCK_RENAMES, Schema99.field_49718);
        }
    };
    ...
    public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema schema) {
        ...
        BlockEntityIdFix.RENAMED_BLOCK_ENTITIES.forEach((string, string2) -> map.put(string2, Objects.requireNonNull((Supplier)map.remove(string), () -> "Didn't find " + string + " in schema")));
        return map;
    }

    public void registerTypes(Schema schema, Map<String, Supplier<TypeTemplate>> entityTypes, Map<String, Supplier<TypeTemplate>> blockEntityTypes) {
        super.registerTypes(schema, entityTypes, blockEntityTypes);
        schema.registerType(true, TypeReferences.BLOCK_ENTITY, () -> DSL.optionalFields((String)"components", (TypeTemplate)TypeReferences.DATA_COMPONENTS.in(schema), (TypeTemplate)DSL.taggedChoiceLazy((String)"id", IdentifierNormalizingSchema.getIdentifierType(), (Map)blockEntityTypes)));
        schema.registerType(true, TypeReferences.ITEM_STACK, () -> DSL.hook((TypeTemplate)DSL.optionalFields((String)"id", (TypeTemplate)TypeReferences.ITEM_NAME.in(schema), (String)"tag", (TypeTemplate)Schema99.method_66195(schema)), (Hook.HookFunction)field_5745, (Hook.HookFunction)Hook.HookFunction.IDENTITY));
    }
}
