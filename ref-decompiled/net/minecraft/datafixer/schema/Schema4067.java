...
public class Schema4067 extends IdentifierNormalizingSchema {
   ...
   private void registerChestBoatFix(Map map, String entityId) {
      this.register(map, entityId, (string) -> {
         return DSL.optionalFields("Items", DSL.list(TypeReferences.ITEM_STACK.in(this)));
      });
   }
}
