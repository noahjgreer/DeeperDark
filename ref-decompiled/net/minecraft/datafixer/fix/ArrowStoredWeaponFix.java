...
public class ArrowStoredWeaponFix extends DataFix {
   ...
   private Function fixFor(String entityId) {
   ...
   private static Function method_59912(String name, Type type, Type type2) {
      OpticFinder opticFinder = DSL.namedChoice(name, type);
      return (typed) -> {
         return typed.updateTyped(opticFinder, type2, (typedx) -> {
            return Util.apply(typedx, type2, UnaryOperator.identity());
         });
      };
   }
}
