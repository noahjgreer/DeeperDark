...
extends DataFix {
    ...
    private TypeRewriteRule createFixRule(DSL.TypeReference typeReference, String id, Map<String, String> oldToNewKey) {
        ...
        return this.fixTypeEverywhereTyped(string, this.getInputSchema().getType(typeReference), typed2 -> typed2.updateTyped(opticFinder, typed -> this.fixOldBlockPosFormat((Typed<?>)typed, oldToNewKey)));
    }
}
