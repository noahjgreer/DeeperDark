...
public class LegacyDragonFightFix extends DataFix {
   ...
   private static Dynamic updateExitPortalLocation(Dynamic dynamic) {
      return dynamic.update("ExitPortalLocation", FixUtil::fixBlockPos);
   }

   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("LegacyDragonFightFix", this.getInputSchema().getType(TypeReferences.LEVEL), (typed) -> {
         return typed.update(DSL.remainderFinder(), (levelData) -> {
