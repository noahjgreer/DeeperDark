...
public class ChunkStructuresTemplateRenameFix extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("ChunkStructuresTemplateRenameFix", type, (structureFeatureTyped) -> {
         return structureFeatureTyped.update(DSL.remainderFinder(), this::fixChildren);
      });
   }

   private Dynamic fixChildren(Dynamic structureFeatureDynamic) {
      return structureFeatureDynamic.update("Children", (childrenDynamic) -> {
         return structureFeatureDynamic.createList(childrenDynamic.asStream().map((childDynamic) -> {
            return this.fix(structureFeatureDynamic, childDynamic);
         }));
      });
   }
