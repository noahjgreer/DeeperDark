...
public class HeightmapRenamingFix extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("HeightmapRenamingFix", type, (chunkTyped) -> {
         return chunkTyped.updateTyped(opticFinder, (levelTyped) -> {
            return levelTyped.update(DSL.remainderFinder(), this::renameHeightmapTags);
         });
      });
   }
   ...
   private Dynamic renameHeightmapTags(Dynamic levelDynamic) {
      ...
      if (optional.isEmpty()) {
         ...
         Optional optional3 = dynamic.get("SOLID").result();
