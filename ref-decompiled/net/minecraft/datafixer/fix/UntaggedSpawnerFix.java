...
public class UntaggedSpawnerFix extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("Fix mob spawner data structure", type, type2, (untaggedSpawnerTyped) -> {
         return untaggedSpawnerTyped.updateTyped(opticFinder, type3, (spawnDataTyped) -> {
            return this.fixSpawnDataTyped(type3, spawnDataTyped);
         }).updateTyped(opticFinder2, type4, (spawnPotentialsTyped) -> {
            return this.fixSpawner(type4, spawnPotentialsTyped);
         });
      });
   }

   private Typed fixSpawnDataTyped(Type spawnDataType, Typed spawnDataTyped) {
   ...
   private Typed fixSpawner(Type spawnPotentialsType, Typed spawnPotentialsTyped) {
