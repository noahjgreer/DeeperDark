...
public class ItemInstanceSpawnEggFix extends DataFix {
   ...
   private static final Map ENTITY_SPAWN_EGGS = (Map)DataFixUtils.make(Maps.newHashMap(), (map) -> {
   ...
   public TypeRewriteRule makeRule() {
      ...
      OpticFinder opticFinder2 = DSL.fieldFinder("id", IdentifierNormalizingSchema.getIdentifierType());
      ...
      return this.fixTypeEverywhereTyped("ItemInstanceSpawnEggFix" + this.getOutputSchema().getVersionKey(), type, (stack) -> {
         ...
         if (optional.isPresent() && Objects.equals(((Pair)optional.get()).getSecond(), this.spawnEggId)) {
            ...
            Optional optional2 = typed2.getOptional(opticFinder2);
            if (optional2.isPresent()) {
               return stack.set(opticFinder, Pair.of(TypeReferences.ITEM_NAME.typeName(), (String)ENTITY_SPAWN_EGGS.getOrDefault(optional2.get(), "minecraft:pig_spawn_egg")));
            }
         }
