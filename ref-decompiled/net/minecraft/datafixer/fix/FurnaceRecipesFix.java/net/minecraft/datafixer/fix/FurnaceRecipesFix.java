...
extends DataFix {
    ...
    private <R> TypeRewriteRule updateBlockEntities(Type<R> recipeType) {
        Type type = DSL.and((Type)DSL.optional((Type)DSL.field((String)"RecipesUsed", (Type)DSL.and((Type)DSL.compoundList(recipeType, (Type)DSL.intType()), (Type)DSL.remainderType()))), (Type)DSL.remainderType());
        ...
        return this.fixTypeEverywhereTyped("FurnaceRecipesFix", type5, type6, blockEntityTyped -> blockEntityTyped.updateTyped(opticFinder, type2, furnaceTyped -> this.updateBlockEntityData(recipeType, (Type)type, (Typed<?>)furnaceTyped)).updateTyped(opticFinder2, type3, blastFurnaceTyped -> this.updateBlockEntityData(recipeType, (Type)type, (Typed<?>)blastFurnaceTyped)).updateTyped(opticFinder3, type4, smokerTyped -> this.updateBlockEntityData(recipeType, (Type)type, (Typed<?>)smokerTyped)));
    }
    ...
    private <R> Typed<?> updateBlockEntityData(Type<R> recipeType, Type<Pair<Either<Pair<List<Pair<R, Integer>>, Dynamic<?>>, Unit>, Dynamic<?>>> recipesUsedType, Typed<?> smelterTyped) {
        Dynamic dynamic2 = (Dynamic)smelterTyped.getOrCreate(DSL.remainderFinder());
        ...
        return smelterTyped.set(DSL.remainderFinder(), recipesUsedType, (Object)Pair.of((Object)Either.left((Object)Pair.of((Object)list, (Object)dynamic2.emptyMap())), (Object)dynamic2));
    }
}
