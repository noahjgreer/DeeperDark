...
public class WorldGenSettingsHeightAndBiomeFix extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("WorldGenSettingsHeightAndBiomeFix", type, type2, (worldGenSettingsTyped) -> {
         OptionalDynamic optionalDynamic = ((Dynamic)worldGenSettingsTyped.get(DSL.remainderFinder())).get("has_increased_height_already");
         boolean bl = optionalDynamic.result().isEmpty();
         boolean bl2 = optionalDynamic.asBoolean(true);
         return worldGenSettingsTyped.update(DSL.remainderFinder(), (worldGenSettingsDynamic) -> {
            return worldGenSettingsDynamic.remove("has_increased_height_already");
         }).updateTyped(opticFinder, type3, (dimensionsTyped) -> {
            return Util.apply(dimensionsTyped, type3, (dimensionsDynamic) -> {
               return dimensionsDynamic.update("minecraft:overworld", (overworldDimensionDynamic) -> {
                  return overworldDimensionDynamic.update("generator", (overworldGeneratorDynamic) -> {
                     ...
                     if ("minecraft:noise".equals(string)) {
                        ...
                        return mutableBoolean.booleanValue() ? overworldGeneratorDynamic.update("settings", (overworldGeneratorSettingsDynamic) -> {
                           return "minecraft:overworld".equals(overworldGeneratorSettingsDynamic.asString("")) ? overworldGeneratorSettingsDynamic.createString("minecraft:large_biomes") : overworldGeneratorSettingsDynamic;
                        }) : overworldGeneratorDynamic;
                     } else if ("minecraft:flat".equals(string)) {
                        return bl2 ? overworldGeneratorDynamic : overworldGeneratorDynamic.update("settings", (overworldGeneratorSettingsDynamic) -> {
                           return overworldGeneratorSettingsDynamic.update("layers", WorldGenSettingsHeightAndBiomeFix::fillWithAir);
                        });
                     } else {
