...
extends DataFix {
    private static final Map<String, String> FLATTENING_MAP = (Map)DataFixUtils.make((Object)Maps.newHashMap(), map -> {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ItemInstanceTheFlatteningFix", type, itemStackTyped -> {
            ...
            String string = ItemInstanceTheFlatteningFix.getItem((String)((Pair)optional.get()).getSecond(), i);
            if (string != null) {
                typed = typed.set(opticFinder, (Object)Pair.of((Object)TypeReferences.ITEM_NAME.typeName(), (Object)string));
            }
            if (DAMAGEABLE_ITEMS.contains(((Pair)optional.get()).getSecond())) {
                ...
                typed = typed.set(opticFinder2, typed2.set(DSL.remainderFinder(), (Object)dynamic2));
            }
            typed = typed.set(DSL.remainderFinder(), (Object)dynamic.remove("Damage"));
            return typed;
        });
    }
