...
public class ItemInstanceTheFlatteningFix extends DataFix {
   private static final Map FLATTENING_MAP = (Map)DataFixUtils.make(Maps.newHashMap(), (map) -> {
   ...
   private static final Set ORIGINAL_ITEM_NAMES;
   private static final Set DAMAGEABLE_ITEMS;
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("ItemInstanceTheFlatteningFix", type, (itemStackTyped) -> {
         ...
         if (optional.isEmpty()) {
            ...
            typed = typed.set(DSL.remainderFinder(), dynamic.remove("Damage"));
            return typed;
         }
      });
   }
