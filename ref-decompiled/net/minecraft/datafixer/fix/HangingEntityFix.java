...
public class HangingEntityFix extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      TypeRewriteRule typeRewriteRule = this.fixTypeEverywhereTyped("EntityPaintingFix", type3, (entityTyped) -> {
         return entityTyped.updateTyped(opticFinder, type, (paintingTyped) -> {
            return paintingTyped.update(DSL.remainderFinder(), (paintingDynamic) -> {
               return this.fixDecorationPosition(paintingDynamic, true, false);
            });
         });
      });
      TypeRewriteRule typeRewriteRule2 = this.fixTypeEverywhereTyped("EntityItemFrameFix", type3, (entityTyped) -> {
         return entityTyped.updateTyped(opticFinder2, type2, (itemFrameTyped) -> {
            return itemFrameTyped.update(DSL.remainderFinder(), (itemFrameDynamic) -> {
               return this.fixDecorationPosition(itemFrameDynamic, false, true);
            });
         });
      });
