...
public class EntityProjectileOwnerFix extends DataFix {
   ...
   private Typed update(Typed entityTyped, String matchId, Function fixer) {
      ...
      return entityTyped.updateTyped(DSL.namedChoice(matchId, type), type2, (typed) -> {
         return typed.update(DSL.remainderFinder(), fixer);
      });
   }
}
