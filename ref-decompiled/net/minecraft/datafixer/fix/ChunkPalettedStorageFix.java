...
public class ChunkPalettedStorageFix extends DataFix {
   ...
   public static int addTo(Int2ObjectBiMap int2ObjectBiMap, Dynamic dynamic) {
   ...
   private Dynamic fixChunk(Dynamic chunkDynamic) {
      ...
      return optional.isPresent() && ((Dynamic)optional.get()).get("Sections").asStreamOpt().result().isPresent() ? chunkDynamic.set("Level", (new Level((Dynamic)optional.get())).transform()) : chunkDynamic;
   }
   ...
   private static final class Level {
      ...
      public Level(Dynamic chunkTag) {
         ...
         chunkTag.get("TileEntities").asStreamOpt().ifSuccess((stream) -> {
            stream.forEach((blockEntityTag) -> {
               int i = blockEntityTag.get("x").asInt(0) - this.x & 15;
         ...
         chunkTag.get("Sections").asStreamOpt().ifSuccess((stream) -> {
            stream.forEach((sectionTag) -> {
                     ...
                     switch (entry.getIntKey()) {
                           ...
                           while(true) {
                              do {
                                 do {
                                    ...
                                    j |= i;
                                    dynamic = this.getBlock(j);
                                 } while(!"minecraft:grass_block".equals(ChunkPalettedStorageFix.getName(dynamic)));
                           ...
                           while(true) {
                              do {
                                 do {
                                    ...
                                    j |= i;
                                    dynamic = this.getBlock(j);
                                 } while(!"minecraft:podzol".equals(ChunkPalettedStorageFix.getName(dynamic)));
                        ...
                        case 25:
                           ...
                           while(true) {
                              ...
                              j = (Integer)var10.next();
                              j |= i;
                              dynamic = this.removeBlockEntity(j);
                              if (dynamic != null) {
                                 var10000 = Boolean.toString(dynamic.get("powered").asBoolean(false));
                                 string = var10000 + (byte)Math.min(Math.max(dynamic.get("note").asInt(0), 0), 24);
                                 this.setBlock(j, (Dynamic)ChunkPalettedStorageFix.Mapping.NOTE_BLOCK_IDS_TO_STATES.getOrDefault(string, (Dynamic)ChunkPalettedStorageFix.Mapping.NOTE_BLOCK_IDS_TO_STATES.get("false0")));
                              }
                           }
                        case 26:
                           var10 = ((IntList)entry.getValue()).iterator();
                           ...
                           while(true) {
                              ...
                              j = (Integer)var10.next();
                              j |= i;
                              dynamic = this.getBlockEntity(j);
                              dynamic2 = this.getBlock(j);
                              if (dynamic != null) {
                                 k = dynamic.get("color").asInt(0);
                                 if (k != 14 && k >= 0 && k < 16) {
                                    var10000 = ChunkPalettedStorageFix.getProperty(dynamic2, "facing");
                                    string2 = var10000 + ChunkPalettedStorageFix.getProperty(dynamic2, "occupied") + ChunkPalettedStorageFix.getProperty(dynamic2, "part") + k;
                                    if (ChunkPalettedStorageFix.Mapping.BED_IDS_TO_STATES.containsKey(string2)) {
                                       this.setBlock(j, (Dynamic)ChunkPalettedStorageFix.Mapping.BED_IDS_TO_STATES.get(string2));
                                    }
                                 }
                              }
                           }
                              ...
                              if (ChunkPalettedStorageFix.getName(dynamic).endsWith("_door")) {
                                 ...
                                 if ("lower".equals(ChunkPalettedStorageFix.getProperty(dynamic2, "half"))) {
                                    ...
                                    if (string4.equals(ChunkPalettedStorageFix.getName(dynamic3))) {
                                       ...
                                       this.setBlock(j, (Dynamic)ChunkPalettedStorageFix.Mapping.DOOR_IDS_TO_STATES.get(string4 + string5 + "lower" + string7 + string6 + string8));
                           ...
                           while(true) {
                              do {
                                 do {
                                    ...
                                    j |= i;
                                    dynamic = this.getBlock(j);
                                 } while(!"minecraft:carved_pumpkin".equals(ChunkPalettedStorageFix.getName(dynamic)));
                           ...
                           while(true) {
                              do {
                                 do {
                                    ...
                                    j |= i;
                                    dynamic = this.getBlock(j);
                                 } while(!"minecraft:mycelium".equals(ChunkPalettedStorageFix.getName(dynamic)));
                        ...
                        case 140:
                           ...
                           while(true) {
                              ...
                              dynamic = this.removeBlockEntity(j);
                              if (dynamic != null) {
                                 var10000 = dynamic.get("Item").asString("");
                                 string = var10000 + dynamic.get("Data").asInt(0);
                                 this.setBlock(j, (Dynamic)ChunkPalettedStorageFix.Mapping.PLANT_TO_FLOWER_POT_STATES.getOrDefault(string, (Dynamic)ChunkPalettedStorageFix.Mapping.PLANT_TO_FLOWER_POT_STATES.get("minecraft:air0")));
                              }
                           }
                        case 144:
                           var10 = ((IntList)entry.getValue()).iterator();
                           ...
                           while(true) {
                              ...
                              if (!"up".equals(string3) && !"down".equals(string3)) {
                                 ...
                                 string2 = string + String.valueOf(dynamic.get("Rot").asInt(0));
                              }

                              dynamic.remove("SkullType");
                              dynamic.remove("facing");
                              dynamic.remove("Rot");
                              this.setBlock(j, (Dynamic)ChunkPalettedStorageFix.Mapping.SKULL_IDS_TO_STATES.getOrDefault(string2, (Dynamic)ChunkPalettedStorageFix.Mapping.SKULL_IDS_TO_STATES.get("0north")));
                           }
                        case 175:
                           var10 = ((IntList)entry.getValue()).iterator();
                           ...
                           while(true) {
                              ...
                              if ("upper".equals(ChunkPalettedStorageFix.getProperty(dynamic, "half"))) {
                                 dynamic2 = this.getBlock(adjacentTo(j, ChunkPalettedStorageFix.Facing.DOWN));
                                 switch (ChunkPalettedStorageFix.getName(dynamic2)) {
                        ...
                        case 177:
                           ...
                           while(var10.hasNext()) {
                              ...
                              dynamic2 = this.getBlock(j);
                              if (dynamic != null) {
                                 k = dynamic.get("Base").asInt(0);
                                 if (k != 15 && k >= 0 && k < 16) {
                                    var10000 = ChunkPalettedStorageFix.getProperty(dynamic2, entry.getIntKey() == 176 ? "rotation" : "facing");
                                    string2 = var10000 + "_" + k;
                                    if (ChunkPalettedStorageFix.Mapping.BANNER_IDS_TO_STATES.containsKey(string2)) {
                                       this.setBlock(j, (Dynamic)ChunkPalettedStorageFix.Mapping.BANNER_IDS_TO_STATES.get(string2));
                                    }
                                 }
                              }
                           }
      ...
      public static int adjacentTo(int packedLocalPos, Facing direction) {
         ...
         switch (direction.getAxis().ordinal()) {
            case 0:
               i = (packedLocalPos & 15) + direction.getDirection().getOffset();
               var10000 = i >= 0 && i <= 15 ? packedLocalPos & -16 | i : -1;
               break;
            case 1:
               i = (packedLocalPos >> 8) + direction.getDirection().getOffset();
               var10000 = i >= 0 && i <= 255 ? packedLocalPos & 255 | i << 8 : -1;
               break;
            case 2:
               i = (packedLocalPos >> 4 & 15) + direction.getDirection().getOffset();
   ...
   private static class Section {
      ...
      public int visit(int sidesToUpgrade) {
         if (!this.hasBlocks) {
            ...
            ChunkNibbleArray chunkNibbleArray = (ChunkNibbleArray)this.section.get("Data").asByteBufferOpt().map((byteBufferx) -> {
               return new ChunkNibbleArray(DataFixUtils.toArray(byteBufferx));
            }).result().orElseGet(ChunkNibbleArray::new);
            ChunkNibbleArray chunkNibbleArray2 = (ChunkNibbleArray)this.section.get("Add").asByteBufferOpt().map((byteBufferx) -> {
               return new ChunkNibbleArray(DataFixUtils.toArray(byteBufferx));
            }).result().orElseGet(ChunkNibbleArray::new);
   ...
   private static class Mapping {
      ...
      static final Map PLANT_TO_FLOWER_POT_STATES = (Map)DataFixUtils.make(Maps.newHashMap(), (map) -> {
      ...
      static final Map SKULL_IDS_TO_STATES = (Map)DataFixUtils.make(Maps.newHashMap(), (map) -> {
      ...
      static final Map DOOR_IDS_TO_STATES = (Map)DataFixUtils.make(Maps.newHashMap(), (map) -> {
         door(map, "oak_door");
         door(map, "iron_door");
      ...
      static final Map NOTE_BLOCK_IDS_TO_STATES = (Map)DataFixUtils.make(Maps.newHashMap(), (map) -> {
         for(int i = 0; i < 26; ++i) {
      ...
      private static final Int2ObjectMap COLORS_BY_IDS = (Int2ObjectMap)DataFixUtils.make(new Int2ObjectOpenHashMap(), (map) -> {
         map.put(0, "white");
         map.put(1, "orange");
         map.put(2, "magenta");
      ...
      static final Map BED_IDS_TO_STATES = (Map)DataFixUtils.make(Maps.newHashMap(), (map) -> {
      ...
      static final Map BANNER_IDS_TO_STATES = (Map)DataFixUtils.make(Maps.newHashMap(), (map) -> {
         ObjectIterator var1 = COLORS_BY_IDS.int2ObjectEntrySet().iterator();
      ...
      private static void skull(Map map, int id, String entity, String type) {
      ...
      private static void door(Map map, String id) {
      ...
      private static void bed(Map map, int id, String color) {
      ...
      private static void banner(Map map, int id, String color) {
         for(int i = 0; i < 16; ++i) {
