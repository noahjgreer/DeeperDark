...
public class StatsRenameFix extends DataFix {
   ...
   private TypeRewriteRule renameObjectives() {
      ...
      if (type3 == null) {
         ...
         return this.fixTypeEverywhereTyped(this.name, type2, type, (objectiveTyped) -> {
            return objectiveTyped.updateTyped(opticFinder, (criteriaTypeTyped) -> {
               return criteriaTypeTyped.updateTyped(opticFinder2, (customCriteriaTypeTyped) -> {
                  return customCriteriaTypeTyped.update(opticFinder3, (old) -> {
   ...
   private TypeRewriteRule renameStats() {
      ...
      return this.fixTypeEverywhereTyped(this.name, type2, type, (statsTyped) -> {
         return statsTyped.updateTyped(opticFinder, (statsInnerTyped) -> {
            return statsInnerTyped.updateTyped(opticFinder2, (customStatTyped) -> {
               return customStatTyped.update(opticFinder3, (old) -> {
                  return (String)this.replacements.getOrDefault(old, old);
               });
            });
         });
