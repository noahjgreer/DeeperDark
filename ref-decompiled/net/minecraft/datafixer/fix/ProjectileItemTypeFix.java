...
public class ProjectileItemTypeFix extends DataFix {
   ...
   private Function createFixApplier(String id, Fixer fixer) {
   ...
   private static Function createFixApplier(String id, Fixer fixer, Type inputType, Type outputType) {
   ...
   private static Typed fixArrow(Typed typed, Type type) {
      return Util.apply(typed, type, (data) -> {
   ...
   private static Typed fixSpectralArrow(Typed typed, Type type) {
      return Util.apply(typed, type, (data) -> {
   ...
   private static Typed fixTrident(Typed typed, Type type) {
