...
extends DataFix {
    private static final Map<String, String> RENAMED_ENTITIES = (Map)DataFixUtils.make((Object)Maps.newHashMap(), map -> {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return TypeRewriteRule.seq((TypeRewriteRule)this.convertUnchecked("item stack entity name hook converter", type, type2), (TypeRewriteRule)this.fixTypeEverywhere("EntityIdFix", (Type)taggedChoiceType, (Type)taggedChoiceType2, dynamicOps -> pair -> pair.mapFirst(string -> RENAMED_ENTITIES.getOrDefault(string, (String)string))));
    }
}
