...
public class SaddleEquipmentSlotFix extends DataFix {
   private static final Set FULL_SADDLE_STACK_ENTITY_IDS = Set.of("minecraft:horse", "minecraft:skeleton_horse", "minecraft:zombie_horse", "minecraft:donkey", "minecraft:mule", "minecraft:camel", "minecraft:llama", "minecraft:trader_llama");
   private static final Set BOOLEAN_SADDLE_ENTITY_IDS = Set.of("minecraft:pig", "minecraft:strider");
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("SaddleEquipmentSlotFix", type, type2, (typed) -> {
         ...
         if (FULL_SADDLE_STACK_ENTITY_IDS.contains(string)) {
            ...
            return BOOLEAN_SADDLE_ENTITY_IDS.contains(string) ? Util.apply(typed2, type2, SaddleEquipmentSlotFix::fixBooleanSaddleEntity) : FixUtil.withType(type2, typed);
         }
      });
   }
