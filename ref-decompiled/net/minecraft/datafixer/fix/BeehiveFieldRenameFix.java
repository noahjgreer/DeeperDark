...
public class BeehiveFieldRenameFix extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("BeehiveFieldRenameFix", type3, type4, (typed) -> {
         return FixUtil.withType(type4, typed.updateTyped(opticFinder, (typedx) -> {
            return typedx.update(DSL.remainderFinder(), this::removeBeesField).updateTyped(opticFinder2, (typed) -> {
               return typed.updateTyped(opticFinder3, (typedx) -> {
                  return typedx.update(DSL.remainderFinder(), this::renameFields);
               });
            });
         }));
      });
