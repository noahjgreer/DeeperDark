...
public class PlayerEquipmentFix extends DataFix {
   private static final Map SLOT_ID_MAP = Map.of(100, "feet", 101, "legs", 102, "chest", 103, "head", -106, "offhand");
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.writeFixAndRead("Player Equipment Fix", type, type2, (playerDynamic) -> {
         Map map = new HashMap();
         playerDynamic = playerDynamic.update("Inventory", (inventoryDynamic) -> {
            return inventoryDynamic.createList(inventoryDynamic.asStream().filter((dynamic2) -> {
         ...
         playerDynamic = playerDynamic.set("equipment", playerDynamic.createMap(map));
