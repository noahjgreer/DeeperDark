...
public class OptionsAddTextBackgroundFix extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("OptionsAddTextBackgroundFix", this.getInputSchema().getType(TypeReferences.OPTIONS), (optionsTyped) -> {
         return optionsTyped.update(DSL.remainderFinder(), (optionsDynamic) -> {
            return (Dynamic)DataFixUtils.orElse(optionsDynamic.get("chatOpacity").asString().map((string) -> {
