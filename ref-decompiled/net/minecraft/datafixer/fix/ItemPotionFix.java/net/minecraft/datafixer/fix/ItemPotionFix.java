...
extends DataFix {
    ...
    private static final @Nullable String[] ID_TO_POTIONS = (String[])DataFixUtils.make((Object)new String[128], potions -> {
        potions[0] = WATER;
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ItemPotionFix", type, itemStack -> {
            ...
            if (optional.isPresent() && Objects.equals(((Pair)optional.get()).getSecond(), "minecraft:potion")) {
                ...
                Optional optional2 = itemStack.getOptionalTyped(opticFinder2);
                ...
                if (optional2.isPresent()) {
                    ...
                    if (optional3.isEmpty()) {
                        ...
                        Typed typed2 = ((Typed)optional2.get()).set(DSL.remainderFinder(), (Object)dynamic2.set("Potion", dynamic2.createString(string == null ? WATER : string)));
                        typed = typed.set(opticFinder2, typed2);
                        if ((s & 0x4000) == 16384) {
                            typed = typed.set(opticFinder, (Object)Pair.of((Object)TypeReferences.ITEM_NAME.typeName(), (Object)"minecraft:splash_potion"));
                        }
                    }
                    if (s != 0) {
