    ...
    protected Typed<?> transform(Typed<?> inputTyped) {
        ...
        if (i > 0) {
            ...
            if (string != null) {
                ...
                return inputTyped.set(opticFinder, (Typed)((Pair)type2.readTyped(dynamic2).result().orElseThrow(() -> new IllegalStateException("Could not create record item stack."))).getFirst()).set(DSL.remainderFinder(), (Object)dynamic);
            }
        }
        return inputTyped;
    }
