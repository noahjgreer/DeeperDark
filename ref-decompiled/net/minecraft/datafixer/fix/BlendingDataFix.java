...
public class BlendingDataFix extends DataFix {
   ...
   private static final Set SKIP_BLENDING_STATUSES = Set.of("minecraft:empty", "minecraft:structure_starts", "minecraft:structure_references", "minecraft:biomes");
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped(this.name, type, (typed) -> {
         return typed.update(DSL.remainderFinder(), (chunk) -> {
            return update(chunk, chunk.get("__context"));
         });
      });
   }
