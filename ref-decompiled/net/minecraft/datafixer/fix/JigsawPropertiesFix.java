...
public class JigsawPropertiesFix extends ChoiceFix {
   ...
   private static Dynamic renameProperties(Dynamic blockEntityDynamic) {
      ...
      return blockEntityDynamic.set("name", blockEntityDynamic.createString(string)).set("target", blockEntityDynamic.createString(string)).remove("attachement_type").set("pool", blockEntityDynamic.createString(string2)).remove("target_pool");
   }
