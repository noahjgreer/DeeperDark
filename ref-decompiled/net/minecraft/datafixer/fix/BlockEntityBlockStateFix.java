...
public class BlockEntityBlockStateFix extends ChoiceFix {
   ...
   protected Typed transform(Typed inputTyped) {
      ...
      Typed typed = (Typed)type.pointTyped(inputTyped.getOps()).orElseThrow(() -> {
         return new IllegalStateException("Could not create new piston block entity.");
      });
      return typed.set(DSL.remainderFinder(), dynamic).set(opticFinder, (Typed)((Pair)type2.readTyped(dynamic2).result().orElseThrow(() -> {
