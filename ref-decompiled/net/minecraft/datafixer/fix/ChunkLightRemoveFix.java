...
public class ChunkLightRemoveFix extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("ChunkLightRemoveFix", type, this.getOutputSchema().getType(TypeReferences.CHUNK), (chunkTyped) -> {
         return chunkTyped.updateTyped(opticFinder, (levelTyped) -> {
            return levelTyped.update(DSL.remainderFinder(), (levelDynamic) -> {
               return levelDynamic.remove("isLightOn");
            });
         });
      });
   }
