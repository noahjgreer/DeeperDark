...
public class SharedConstants {
   ...
   /** @deprecated */
   @Deprecated
   public static final String VERSION_NAME = "1.21.8";
   /** @deprecated */
   @Deprecated
   public static final int RELEASE_TARGET_PROTOCOL_VERSION = 772;
   /** @deprecated */
   @Deprecated
   public static final int field_29736 = 259;
   public static final int SNBT_TOO_OLD_THRESHOLD = 4420;
   private static final int field_29708 = 30;
   public static final boolean CRASH_ON_UNCAUGHT_THREAD_EXCEPTION = false;
   /** @deprecated */
   @Deprecated
   public static final int RESOURCE_PACK_VERSION = 64;
   /** @deprecated */
   @Deprecated
   public static final int DATA_PACK_VERSION = 81;
   /** @deprecated */
   @Deprecated
   ...
   public static final boolean field_59991 = false;
   public static final boolean field_60328 = false;
   ...
   public static final boolean field_60521 = false;
   ...
   public static final boolean field_60959 = false;
