...
public class NbtSizeTracker {
    public static final int PACKET_MAX_SIZE = 0x200000;
    public static final int LEVEL_MAX_SIZE = 0x6400000;
    ...
    public static NbtSizeTracker forPacket() {
        return new NbtSizeTracker(0x200000L, 512);
    }

    public static NbtSizeTracker forLevel() {
        return new NbtSizeTracker(0x6400000L, 512);
    }
