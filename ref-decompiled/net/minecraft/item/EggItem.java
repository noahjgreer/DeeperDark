...
public class EggItem extends Item implements ProjectileItem {
   ...
   public ActionResult use(World world, PlayerEntity user, Hand hand) {
      ...
      world.playSound((Entity)null, user.getX(), user.getY(), user.getZ(), (SoundEvent)SoundEvents.ENTITY_EGG_THROW, SoundCategory.PLAYERS, 0.5F, 0.4F / (world.getRandom().nextFloat() * 0.4F + 0.8F));
