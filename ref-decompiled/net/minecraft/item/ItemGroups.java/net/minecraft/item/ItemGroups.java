...
public class ItemGroups {
    ...
    public static final RegistryKey<ItemGroup> BUILDING_BLOCKS = ItemGroups.register("building_blocks");
    public static final RegistryKey<ItemGroup> COLORED_BLOCKS = ItemGroups.register("colored_blocks");
    public static final RegistryKey<ItemGroup> NATURAL = ItemGroups.register("natural_blocks");
    public static final RegistryKey<ItemGroup> FUNCTIONAL = ItemGroups.register("functional_blocks");
    public static final RegistryKey<ItemGroup> REDSTONE = ItemGroups.register("redstone_blocks");
    public static final RegistryKey<ItemGroup> HOTBAR = ItemGroups.register("hotbar");
    public static final RegistryKey<ItemGroup> SEARCH = ItemGroups.register("search");
    public static final RegistryKey<ItemGroup> TOOLS = ItemGroups.register("tools_and_utilities");
    public static final RegistryKey<ItemGroup> COMBAT = ItemGroups.register("combat");
    public static final RegistryKey<ItemGroup> FOOD_AND_DRINK = ItemGroups.register("food_and_drinks");
    public static final RegistryKey<ItemGroup> INGREDIENTS = ItemGroups.register("ingredients");
    public static final RegistryKey<ItemGroup> SPAWN_EGGS = ItemGroups.register("spawn_eggs");
    public static final RegistryKey<ItemGroup> OPERATOR = ItemGroups.register("op_blocks");
    public static final RegistryKey<ItemGroup> INVENTORY = ItemGroups.register("inventory");
    ...
    private static @Nullable ItemGroup.DisplayContext displayContext;
    ...
    public static ItemGroup registerAndGetDefault(Registry<ItemGroup> registry) {
        Registry.register(registry, BUILDING_BLOCKS, ItemGroup.create(ItemGroup.Row.TOP, 0).displayName(Text.translatable("itemGroup.buildingBlocks")).icon(() -> new ItemStack(Blocks.BRICKS)).entries((displayContext, entries) -> {
            ...
            entries.add(Items.COPPER_BARS.weathered());
            ...
            entries.add(Items.COPPER_CHAINS.weathered());
            ...
            entries.add(Items.COPPER_BARS.waxedExposed());
            ...
            entries.add(Items.COPPER_CHAINS.waxedExposed());
            ...
            entries.add(Items.COPPER_BARS.waxedWeathered());
            ...
            entries.add(Items.COPPER_CHAINS.waxedWeathered());
            ...
            entries.add(Items.COPPER_BARS.waxedOxidized());
            ...
            entries.add(Items.COPPER_CHAINS.waxedOxidized());
        }).build());
        Registry.register(registry, COLORED_BLOCKS, ItemGroup.create(ItemGroup.Row.TOP, 1).displayName(Text.translatable("itemGroup.coloredBlocks")).icon(() -> new ItemStack(Blocks.CYAN_WOOL)).entries((displayContext, entries) -> {
        ...
        Registry.register(registry, NATURAL, ItemGroup.create(ItemGroup.Row.TOP, 2).displayName(Text.translatable("itemGroup.natural")).icon(() -> new ItemStack(Blocks.GRASS_BLOCK)).entries((displayContext, entries) -> {
        ...
        Registry.register(registry, FUNCTIONAL, ItemGroup.create(ItemGroup.Row.TOP, 3).displayName(Text.translatable("itemGroup.functional")).icon(() -> new ItemStack(Items.OAK_SIGN)).entries((displayContext, entries) -> {
            ...
            displayContext.lookup().getOptional(RegistryKeys.PAINTING_VARIANT).ifPresent(registryWrapper -> ItemGroups.addPaintings(entries, displayContext.lookup(), registryWrapper, registryEntry -> registryEntry.isIn(PaintingVariantTags.PLACEABLE), ItemGroup.StackVisibility.PARENT_AND_SEARCH_TABS));
        ...
        Registry.register(registry, REDSTONE, ItemGroup.create(ItemGroup.Row.TOP, 4).displayName(Text.translatable("itemGroup.redstone")).icon(() -> new ItemStack(Items.REDSTONE)).entries((displayContext, entries) -> {
        ...
        Registry.register(registry, TOOLS, ItemGroup.create(ItemGroup.Row.BOTTOM, 0).displayName(Text.translatable("itemGroup.tools")).icon(() -> new ItemStack(Items.DIAMOND_PICKAXE)).entries((displayContext, entries) -> {
            ...
            entries.add(Items.FURNACE_MINECART);
            entries.add(Items.TNT_MINECART);
            displayContext.lookup().getOptional(RegistryKeys.INSTRUMENT).ifPresent(wrapper -> ItemGroups.addInstruments(entries, wrapper, Items.GOAT_HORN, InstrumentTags.GOAT_HORNS, ItemGroup.StackVisibility.PARENT_AND_SEARCH_TABS));
        ...
        Registry.register(registry, COMBAT, ItemGroup.create(ItemGroup.Row.BOTTOM, 1).displayName(Text.translatable("itemGroup.combat")).icon(() -> new ItemStack(Items.NETHERITE_SWORD)).entries((displayContext, entries) -> {
            ...
            displayContext.lookup().getOptional(RegistryKeys.POTION).ifPresent(registryWrapper -> ItemGroups.addPotions(entries, registryWrapper, Items.TIPPED_ARROW, ItemGroup.StackVisibility.PARENT_AND_SEARCH_TABS, displayContext.enabledFeatures()));
        }).build());
        Registry.register(registry, FOOD_AND_DRINK, ItemGroup.create(ItemGroup.Row.BOTTOM, 2).displayName(Text.translatable("itemGroup.foodAndDrink")).icon(() -> new ItemStack(Items.GOLDEN_APPLE)).entries((displayContext, entries) -> {
            ...
            displayContext.lookup().getOptional(RegistryKeys.POTION).ifPresent(registryWrapper -> {
                ItemGroups.addPotions(entries, registryWrapper, Items.POTION, ItemGroup.StackVisibility.PARENT_AND_SEARCH_TABS, displayContext.enabledFeatures());
                ItemGroups.addPotions(entries, registryWrapper, Items.SPLASH_POTION, ItemGroup.StackVisibility.PARENT_AND_SEARCH_TABS, displayContext.enabledFeatures());
                ItemGroups.addPotions(entries, registryWrapper, Items.LINGERING_POTION, ItemGroup.StackVisibility.PARENT_AND_SEARCH_TABS, displayContext.enabledFeatures());
            });
        }).build());
        Registry.register(registry, INGREDIENTS, ItemGroup.create(ItemGroup.Row.BOTTOM, 3).displayName(Text.translatable("itemGroup.ingredients")).icon(() -> new ItemStack(Items.IRON_INGOT)).entries((displayContext, entries) -> {
            ...
            displayContext.lookup().getOptional(RegistryKeys.ENCHANTMENT).ifPresent(registryWrapper -> {
                ItemGroups.addMaxLevelEnchantedBooks(entries, registryWrapper, ItemGroup.StackVisibility.PARENT_TAB_ONLY);
                ItemGroups.addAllLevelEnchantedBooks(entries, registryWrapper, ItemGroup.StackVisibility.SEARCH_TAB_ONLY);
            });
        }).build());
        Registry.register(registry, SPAWN_EGGS, ItemGroup.create(ItemGroup.Row.BOTTOM, 4).displayName(Text.translatable("itemGroup.spawnEggs")).icon(() -> new ItemStack(Items.CREEPER_SPAWN_EGG)).entries((displayContext, entries) -> {
        ...
        Registry.register(registry, OPERATOR, ItemGroup.create(ItemGroup.Row.BOTTOM, 5).displayName(Text.translatable("itemGroup.op")).icon(() -> new ItemStack(Items.COMMAND_BLOCK)).special().entries((displayContext, entries) -> {
        ...
        return Registry.register(registry, INVENTORY, ItemGroup.create(ItemGroup.Row.BOTTOM, 6).displayName(Text.translatable("itemGroup.inventory")).icon(() -> new ItemStack(Blocks.CHEST)).texture(INVENTORY_TAB_TEXTURE_ID).noRenderedName().special().type(ItemGroup.Type.INVENTORY).noScrollbar().build());
    }
    ...
    public static void collect() {
        ...
        for (RegistryKey<ItemGroup> registryKey : Registries.ITEM_GROUP.getKeys()) {
            ...
            String string2 = map.put(Pair.of((Object)((Object)itemGroup.getRow()), (Object)itemGroup.getColumn()), string);
    ...
    private static void addPotions(ItemGroup.Entries entries, RegistryWrapper<Potion> registryWrapper, Item item, ItemGroup.StackVisibility visibility, FeatureSet enabledFeatures) {
        registryWrapper.streamEntries().filter(potionEntry -> ((Potion)potionEntry.value()).isEnabled(enabledFeatures)).map(entry -> PotionContentsComponent.createStack(item, entry)).forEach(stack -> entries.add((ItemStack)stack, visibility));
    }
    ...
    private static void addMaxLevelEnchantedBooks(ItemGroup.Entries entries, RegistryWrapper<Enchantment> registryWrapper, ItemGroup.StackVisibility stackVisibility) {
        registryWrapper.streamEntries().map(enchantmentEntry -> EnchantmentHelper.getEnchantedBookWith(new EnchantmentLevelEntry((RegistryEntry<Enchantment>)enchantmentEntry, ((Enchantment)enchantmentEntry.value()).getMaxLevel()))).forEach(stack -> entries.add((ItemStack)stack, stackVisibility));
    }
    ...
    public static List<ItemGroup> getGroupsToDisplay() {
        return ItemGroups.stream().filter(ItemGroup::shouldDisplay).toList();
    }

    public static List<ItemGroup> getGroups() {
        return ItemGroups.stream().toList();
    }
    ...
    private static void updateEntries(ItemGroup.DisplayContext displayContext) {
        ItemGroups.stream().filter(group -> group.getType() == ItemGroup.Type.CATEGORY).forEach(group -> group.updateEntries(displayContext));
        ItemGroups.stream().filter(group -> group.getType() != ItemGroup.Type.CATEGORY).forEach(group -> group.updateEntries(displayContext));
    }
