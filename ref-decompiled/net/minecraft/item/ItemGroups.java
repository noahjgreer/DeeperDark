...
public class ItemGroups {
   ...
   public static final RegistryKey BUILDING_BLOCKS = register("building_blocks");
   public static final RegistryKey COLORED_BLOCKS = register("colored_blocks");
   public static final RegistryKey NATURAL = register("natural_blocks");
   public static final RegistryKey FUNCTIONAL = register("functional_blocks");
   public static final RegistryKey REDSTONE = register("redstone_blocks");
   public static final RegistryKey HOTBAR = register("hotbar");
   public static final RegistryKey SEARCH = register("search");
   public static final RegistryKey TOOLS = register("tools_and_utilities");
   public static final RegistryKey COMBAT = register("combat");
   public static final RegistryKey FOOD_AND_DRINK = register("food_and_drinks");
   public static final RegistryKey INGREDIENTS = register("ingredients");
   public static final RegistryKey SPAWN_EGGS = register("spawn_eggs");
   public static final RegistryKey OPERATOR = register("op_blocks");
   public static final RegistryKey INVENTORY = register("inventory");
   private static final Comparator PAINTING_VARIANT_COMPARATOR = Comparator.comparing(RegistryEntry::value, Comparator.comparingInt(PaintingVariant::getArea).thenComparing(PaintingVariant::width));
   @Nullable
   ...
   public static ItemGroup registerAndGetDefault(Registry registry) {
      Registry.register(registry, (RegistryKey)BUILDING_BLOCKS, ItemGroup.create(ItemGroup.Row.TOP, 0).displayName(Text.translatable("itemGroup.buildingBlocks")).icon(() -> {
      ...
      Registry.register(registry, (RegistryKey)COLORED_BLOCKS, ItemGroup.create(ItemGroup.Row.TOP, 1).displayName(Text.translatable("itemGroup.coloredBlocks")).icon(() -> {
      ...
      Registry.register(registry, (RegistryKey)NATURAL, ItemGroup.create(ItemGroup.Row.TOP, 2).displayName(Text.translatable("itemGroup.natural")).icon(() -> {
         ...
         entries.add((ItemConvertible)Items.DRIED_GHAST);
      ...
      Registry.register(registry, (RegistryKey)FUNCTIONAL, ItemGroup.create(ItemGroup.Row.TOP, 3).displayName(Text.translatable("itemGroup.functional")).icon(() -> {
         ...
         displayContext.lookup().getOptional(RegistryKeys.PAINTING_VARIANT).ifPresent((registryWrapper) -> {
            addPaintings(entries, displayContext.lookup(), registryWrapper, (registryEntry) -> {
      ...
      Registry.register(registry, (RegistryKey)REDSTONE, ItemGroup.create(ItemGroup.Row.TOP, 4).displayName(Text.translatable("itemGroup.redstone")).icon(() -> {
      ...
      Registry.register(registry, (RegistryKey)HOTBAR, ItemGroup.create(ItemGroup.Row.TOP, 5).displayName(Text.translatable("itemGroup.hotbar")).icon(() -> {
         return new ItemStack(Blocks.BOOKSHELF);
      }).special().type(ItemGroup.Type.HOTBAR).build());
      Registry.register(registry, (RegistryKey)SEARCH, ItemGroup.create(ItemGroup.Row.TOP, 6).displayName(Text.translatable("itemGroup.search")).icon(() -> {
      ...
      Registry.register(registry, (RegistryKey)TOOLS, ItemGroup.create(ItemGroup.Row.BOTTOM, 0).displayName(Text.translatable("itemGroup.tools")).icon(() -> {
         ...
         entries.add((ItemConvertible)Items.WHITE_HARNESS);
         entries.add((ItemConvertible)Items.LIGHT_GRAY_HARNESS);
         entries.add((ItemConvertible)Items.GRAY_HARNESS);
         entries.add((ItemConvertible)Items.BLACK_HARNESS);
         entries.add((ItemConvertible)Items.BROWN_HARNESS);
         entries.add((ItemConvertible)Items.RED_HARNESS);
         entries.add((ItemConvertible)Items.ORANGE_HARNESS);
         entries.add((ItemConvertible)Items.YELLOW_HARNESS);
         entries.add((ItemConvertible)Items.LIME_HARNESS);
         entries.add((ItemConvertible)Items.GREEN_HARNESS);
         entries.add((ItemConvertible)Items.CYAN_HARNESS);
         entries.add((ItemConvertible)Items.LIGHT_BLUE_HARNESS);
         entries.add((ItemConvertible)Items.BLUE_HARNESS);
         entries.add((ItemConvertible)Items.PURPLE_HARNESS);
         entries.add((ItemConvertible)Items.MAGENTA_HARNESS);
         entries.add((ItemConvertible)Items.PINK_HARNESS);
         ...
         entries.add((ItemConvertible)Items.FURNACE_MINECART);
         entries.add((ItemConvertible)Items.TNT_MINECART);
         displayContext.lookup().getOptional(RegistryKeys.INSTRUMENT).ifPresent((wrapper) -> {
            addInstruments(entries, wrapper, Items.GOAT_HORN, InstrumentTags.GOAT_HORNS, ItemGroup.StackVisibility.PARENT_AND_SEARCH_TABS);
         });
         ...
         entries.add((ItemConvertible)Items.MUSIC_DISC_TEARS);
         entries.add((ItemConvertible)Items.MUSIC_DISC_LAVA_CHICKEN);
      }).build());
      Registry.register(registry, (RegistryKey)COMBAT, ItemGroup.create(ItemGroup.Row.BOTTOM, 1).displayName(Text.translatable("itemGroup.combat")).icon(() -> {
         ...
         displayContext.lookup().getOptional(RegistryKeys.POTION).ifPresent((registryWrapper) -> {
            addPotions(entries, registryWrapper, Items.TIPPED_ARROW, ItemGroup.StackVisibility.PARENT_AND_SEARCH_TABS, displayContext.enabledFeatures());
         });
      }).build());
      Registry.register(registry, (RegistryKey)FOOD_AND_DRINK, ItemGroup.create(ItemGroup.Row.BOTTOM, 2).displayName(Text.translatable("itemGroup.foodAndDrink")).icon(() -> {
      ...
      Registry.register(registry, (RegistryKey)INGREDIENTS, ItemGroup.create(ItemGroup.Row.BOTTOM, 3).displayName(Text.translatable("itemGroup.ingredients")).icon(() -> {
      ...
      Registry.register(registry, (RegistryKey)SPAWN_EGGS, ItemGroup.create(ItemGroup.Row.BOTTOM, 4).displayName(Text.translatable("itemGroup.spawnEggs")).icon(() -> {
         ...
         entries.add((ItemConvertible)Items.HAPPY_GHAST_SPAWN_EGG);
      ...
      Registry.register(registry, (RegistryKey)OPERATOR, ItemGroup.create(ItemGroup.Row.BOTTOM, 5).displayName(Text.translatable("itemGroup.op")).icon(() -> {
      ...
      return (ItemGroup)Registry.register(registry, (RegistryKey)INVENTORY, ItemGroup.create(ItemGroup.Row.BOTTOM, 6).displayName(Text.translatable("itemGroup.inventory")).icon(() -> {
   ...
   public static void collect() {
      Map map = new HashMap();
      Iterator var1 = Registries.ITEM_GROUP.getKeys().iterator();
      ...
      do {
         ...
         ItemGroup itemGroup = (ItemGroup)Registries.ITEM_GROUP.getValueOrThrow(registryKey);
         string = itemGroup.getDisplayName().getString();
         string2 = (String)map.put(Pair.of(itemGroup.getRow(), itemGroup.getColumn()), string);
      } while(string2 == null);
   ...
   public static ItemGroup getDefaultTab() {
      return (ItemGroup)Registries.ITEM_GROUP.getValueOrThrow(BUILDING_BLOCKS);
   }

   private static void addPotions(ItemGroup.Entries entries, RegistryWrapper registryWrapper, Item item, ItemGroup.StackVisibility visibility, FeatureSet enabledFeatures) {
   ...
   private static void addMaxLevelEnchantedBooks(ItemGroup.Entries entries, RegistryWrapper registryWrapper, ItemGroup.StackVisibility stackVisibility) {
      registryWrapper.streamEntries().map((enchantmentEntry) -> {
         return EnchantmentHelper.getEnchantedBookWith(new EnchantmentLevelEntry(enchantmentEntry, ((Enchantment)enchantmentEntry.value()).getMaxLevel()));
      }).forEach((stack) -> {
         entries.add(stack, stackVisibility);
      });
   }

   private static void addAllLevelEnchantedBooks(ItemGroup.Entries entries, RegistryWrapper registryWrapper, ItemGroup.StackVisibility stackVisibility) {
      registryWrapper.streamEntries().flatMap((enchantmentEntry) -> {
         return IntStream.rangeClosed(((Enchantment)enchantmentEntry.value()).getMinLevel(), ((Enchantment)enchantmentEntry.value()).getMaxLevel()).mapToObj((level) -> {
            return EnchantmentHelper.getEnchantedBookWith(new EnchantmentLevelEntry(enchantmentEntry, level));
         });
      }).forEach((stack) -> {
         entries.add(stack, stackVisibility);
      });
   ...
   private static void addPaintings(ItemGroup.Entries entries, RegistryWrapper.WrapperLookup registries, RegistryWrapper.Impl registryWrapper, Predicate filter, ItemGroup.StackVisibility stackVisibility) {
   ...
   public static ItemGroup getSearchGroup() {
      return (ItemGroup)Registries.ITEM_GROUP.getValueOrThrow(SEARCH);
   }
