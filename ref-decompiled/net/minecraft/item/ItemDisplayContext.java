...
public enum ItemDisplayContext implements StringIdentifiable {
   ...
   public static final Codec CODEC = StringIdentifiable.createCodec(ItemDisplayContext::values);
   public static final IntFunction FROM_INDEX = ValueLists.createIndexToValueFunction(ItemDisplayContext::getIndex, values(), (ValueLists.OutOfBoundsHandling)ValueLists.OutOfBoundsHandling.ZERO);
