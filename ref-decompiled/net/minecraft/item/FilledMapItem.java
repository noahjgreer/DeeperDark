...
public class FilledMapItem extends Item {
   ...
   public static MapState getMapState(ItemStack map, World world) {
      MapIdComponent mapIdComponent = (MapIdComponent)map.get(DataComponentTypes.MAP_ID);
      return getMapState(mapIdComponent, world);
   }

   private static MapIdComponent allocateMapId(ServerWorld world, int x, int z, int scale, boolean showIcons, boolean unlimitedTracking, RegistryKey dimension) {
   ...
   public static void fillExplorationMap(ServerWorld world, ItemStack map) {
      MapState mapState = getMapState((ItemStack)map, world);
      if (mapState != null) {
         if (world.getRegistryKey() == mapState.dimension) {
            ...
            for(n = 0; n < 128; ++n) {
               for(o = 0; o < 128; ++o) {
                  RegistryEntry registryEntry = world.getBiome(mutable.set((l + o) * i, 0, (m + n) * i));
   ...
   public void inventoryTick(ItemStack stack, ServerWorld world, Entity entity, @Nullable EquipmentSlot slot) {
      MapState mapState = getMapState((ItemStack)stack, world);
      if (mapState != null) {
   ...
   public void onCraft(ItemStack stack, World world) {
      MapPostProcessingComponent mapPostProcessingComponent = (MapPostProcessingComponent)stack.remove(DataComponentTypes.MAP_POST_PROCESSING);
