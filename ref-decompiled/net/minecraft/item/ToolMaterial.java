...
public record ToolMaterial(TagKey incorrectBlocksForDrops, int durability, float speed, float attackDamageBonus, int enchantmentValue, TagKey repairItems) {
   ...
   public ToolMaterial(TagKey tagKey, int i, float f, float g, int j, TagKey tagKey2) {
   ...
   public Item.Settings applyToolSettings(Item.Settings settings, TagKey effectiveBlocks, float attackDamage, float attackSpeed, float disableBlockingForSeconds) {
      RegistryEntryLookup registryEntryLookup = Registries.createEntryLookup(Registries.BLOCK);
   ...
   public TagKey incorrectBlocksForDrops() {
