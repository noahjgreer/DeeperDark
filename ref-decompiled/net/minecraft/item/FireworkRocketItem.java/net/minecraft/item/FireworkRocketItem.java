...
implements ProjectileItem {
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (world instanceof ServerWorld) {
            ...
            ProjectileEntity.spawn(new FireworkRocketEntity(world, context.getPlayer(), vec3d.x + (double)direction.getOffsetX() * 0.15, vec3d.y + (double)direction.getOffsetY() * 0.15, vec3d.z + (double)direction.getOffsetZ() * 0.15, itemStack), serverWorld, itemStack);
