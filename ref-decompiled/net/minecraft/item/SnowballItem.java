...
public class SnowballItem extends Item implements ProjectileItem {
   ...
   public ActionResult use(World world, PlayerEntity user, Hand hand) {
      ...
      world.playSound((Entity)null, user.getX(), user.getY(), user.getZ(), (SoundEvent)SoundEvents.ENTITY_SNOWBALL_THROW, SoundCategory.NEUTRAL, 0.5F, 0.4F / (world.getRandom().nextFloat() * 0.4F + 0.8F));
