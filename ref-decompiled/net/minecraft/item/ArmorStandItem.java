      ...
      if (direction == Direction.DOWN) {
         ...
         if (world.isSpaceEmpty((Entity)null, box) && world.getOtherEntities((Entity)null, box).isEmpty()) {
            if (world instanceof ServerWorld) {
               ...
               world.playSound((Entity)null, armorStandEntity.getX(), armorStandEntity.getY(), armorStandEntity.getZ(), (SoundEvent)SoundEvents.ENTITY_ARMOR_STAND_PLACE, SoundCategory.BLOCKS, 0.75F, 0.8F);
