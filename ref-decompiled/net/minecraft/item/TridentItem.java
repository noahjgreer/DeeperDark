      ...
      if (user instanceof PlayerEntity playerEntity) {
         ...
         if (var6 < 10) {
            ...
            if (f > 0.0F && !playerEntity.isTouchingWaterOrRain()) {
               ...
               RegistryEntry registryEntry = (RegistryEntry)EnchantmentHelper.getEffect(stack, EnchantmentEffectComponentTypes.TRIDENT_SOUND).orElse(SoundEvents.ITEM_TRIDENT_THROW);
