...
{
    public static final MapCodec<ConstantLootNumberProvider> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)Codec.FLOAT.fieldOf("value").forGetter(ConstantLootNumberProvider::value)).apply((Applicative)instance, ConstantLootNumberProvider::new));
