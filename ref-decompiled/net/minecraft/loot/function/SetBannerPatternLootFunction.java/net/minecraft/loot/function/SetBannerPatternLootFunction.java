...
extends ConditionalLootFunction {
    public static final MapCodec<SetBannerPatternLootFunction> CODEC = RecordCodecBuilder.mapCodec(instance -> SetBannerPatternLootFunction.addConditionsField(instance).and(instance.group((App)BannerPatternsComponent.CODEC.fieldOf("patterns").forGetter(function -> function.patterns), (App)Codec.BOOL.fieldOf("append").forGetter(function -> function.append))).apply((Applicative)instance, SetBannerPatternLootFunction::new));
