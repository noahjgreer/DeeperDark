...
extends ConditionalLootFunction {
    public static final MapCodec<SetContentsLootFunction> CODEC = RecordCodecBuilder.mapCodec(instance -> SetContentsLootFunction.addConditionsField(instance).and(instance.group((App)ContainerComponentModifiers.MODIFIER_CODEC.fieldOf("component").forGetter(function -> function.component), (App)LootPoolEntryTypes.CODEC.listOf().fieldOf("entries").forGetter(function -> function.entries))).apply((Applicative)instance, SetContentsLootFunction::new));
