...
import net.minecraft.loot.function.DiscardLootFunction;
...
public class LootFunctionTypes {
    ...
    public static final LootFunctionType<DiscardLootFunction> DISCARD = LootFunctionTypes.register("discard", DiscardLootFunction.CODEC);
