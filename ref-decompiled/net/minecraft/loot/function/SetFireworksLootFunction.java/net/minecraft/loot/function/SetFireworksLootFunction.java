...
extends ConditionalLootFunction {
    public static final MapCodec<SetFireworksLootFunction> CODEC = RecordCodecBuilder.mapCodec(instance -> SetFireworksLootFunction.addConditionsField(instance).and(instance.group((App)ListOperation.Values.createCodec(FireworkExplosionComponent.CODEC, 256).optionalFieldOf("explosions").forGetter(function -> function.explosions), (App)Codecs.UNSIGNED_BYTE.optionalFieldOf("flight_duration").forGetter(function -> function.flightDuration))).apply((Applicative)instance, SetFireworksLootFunction::new));
