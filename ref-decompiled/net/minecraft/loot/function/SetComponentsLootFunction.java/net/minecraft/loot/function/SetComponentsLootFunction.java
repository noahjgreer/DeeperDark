...
extends ConditionalLootFunction {
    public static final MapCodec<SetComponentsLootFunction> CODEC = RecordCodecBuilder.mapCodec(instance -> SetComponentsLootFunction.addConditionsField(instance).and((App)ComponentChanges.CODEC.fieldOf("components").forGetter(function -> function.changes)).apply((Applicative)instance, SetComponentsLootFunction::new));
