...
extends ConditionalLootFunction {
    public static final MapCodec<SetFireworkExplosionLootFunction> CODEC = RecordCodecBuilder.mapCodec(instance -> SetFireworkExplosionLootFunction.addConditionsField(instance).and(instance.group((App)FireworkExplosionComponent.Type.CODEC.optionalFieldOf("shape").forGetter(function -> function.shape), (App)FireworkExplosionComponent.COLORS_CODEC.optionalFieldOf("colors").forGetter(function -> function.colors), (App)FireworkExplosionComponent.COLORS_CODEC.optionalFieldOf("fade_colors").forGetter(function -> function.fadeColors), (App)Codec.BOOL.optionalFieldOf("trail").forGetter(function -> function.trail), (App)Codec.BOOL.optionalFieldOf("twinkle").forGetter(function -> function.twinkle))).apply((Applicative)instance, SetFireworkExplosionLootFunction::new));
