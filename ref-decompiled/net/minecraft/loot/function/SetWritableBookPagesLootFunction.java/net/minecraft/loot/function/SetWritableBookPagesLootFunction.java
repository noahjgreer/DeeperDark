...
extends ConditionalLootFunction {
    public static final MapCodec<SetWritableBookPagesLootFunction> CODEC = RecordCodecBuilder.mapCodec(instance -> SetWritableBookPagesLootFunction.addConditionsField(instance).and(instance.group((App)WritableBookContentComponent.PAGES_CODEC.fieldOf("pages").forGetter(function -> function.pages), (App)ListOperation.createCodec(100).forGetter(function -> function.operation))).apply((Applicative)instance, SetWritableBookPagesLootFunction::new));
