...
extends ConditionalLootFunction {
    public static final MapCodec<ModifyContentsLootFunction> CODEC = RecordCodecBuilder.mapCodec(instance -> ModifyContentsLootFunction.addConditionsField(instance).and(instance.group((App)ContainerComponentModifiers.MODIFIER_CODEC.fieldOf("component").forGetter(lootFunction -> lootFunction.component), (App)LootFunctionTypes.CODEC.fieldOf("modifier").forGetter(lootFunction -> lootFunction.modifier))).apply((Applicative)instance, ModifyContentsLootFunction::new));
