...
extends ConditionalLootFunction {
    ...
    public static final MapCodec<SetDamageLootFunction> CODEC = RecordCodecBuilder.mapCodec(instance -> SetDamageLootFunction.addConditionsField(instance).and(instance.group((App)LootNumberProviderTypes.CODEC.fieldOf("damage").forGetter(function -> function.durabilityRange), (App)Codec.BOOL.fieldOf("add").orElse((Object)false).forGetter(function -> function.add))).apply((Applicative)instance, SetDamageLootFunction::new));
