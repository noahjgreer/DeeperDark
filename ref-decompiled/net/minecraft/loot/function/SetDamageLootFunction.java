...
public class SetDamageLootFunction extends ConditionalLootFunction {
   ...
   public static final MapCodec CODEC = RecordCodecBuilder.mapCodec((instance) -> {
      return addConditionsField(instance).and(instance.group(LootNumberProviderTypes.CODEC.fieldOf("damage").forGetter((function) -> {
         return function.durabilityRange;
   ...
   private SetDamageLootFunction(List conditions, LootNumberProvider durabilityRange, boolean add) {
      super(conditions);
