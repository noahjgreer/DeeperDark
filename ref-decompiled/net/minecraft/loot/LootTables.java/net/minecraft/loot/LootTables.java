...
public class LootTables {
    ...
    public static final Map<DyeColor, RegistryKey<LootTable>> SHEEP_DROPS_FROM_DYE_COLOR = LootTables.registerAllDyeColors("entities/sheep");
    ...
    public static final RegistryKey<LootTable> HERO_OF_THE_VILLAGE_UNEMPLOYED_GIFT_GAMEPLAY = LootTables.register("gameplay/hero_of_the_village/unemployed_gift");
    public static final RegistryKey<LootTable> HERO_OF_THE_VILLAGE_BABY_GIFT_GAMEPLAY = LootTables.register("gameplay/hero_of_the_village/baby_gift");
    ...
    public static final RegistryKey<LootTable> CHICKEN_LAY_GAMEPLAY = LootTables.register("gameplay/chicken_lay");
    public static final RegistryKey<LootTable> ARMADILLO_SHED_GAMEPLAY = LootTables.register("gameplay/armadillo_shed");
    public static final RegistryKey<LootTable> TURTLE_GROW_GAMEPLAY = LootTables.register("gameplay/turtle_grow");
    public static final RegistryKey<LootTable> CAVE_VINE_HARVEST = LootTables.register("harvest/cave_vine");
    public static final RegistryKey<LootTable> SWEET_BERRY_BUSH_HARVEST = LootTables.register("harvest/sweet_berry_bush");
    public static final RegistryKey<LootTable> BEEHIVE_HARVEST = LootTables.register("harvest/beehive");
    public static final RegistryKey<LootTable> PUMPKIN_CARVE = LootTables.register("carve/pumpkin");
    ...
    public static final RegistryKey<LootTable> ARMADILLO_BRUSH = LootTables.register("brush/armadillo");
    public static final RegistryKey<LootTable> BOGGED_SHEARING = LootTables.register("shearing/bogged");
    public static final RegistryKey<LootTable> MOOSHROOM_SHEARING = LootTables.register("shearing/mooshroom");
    public static final RegistryKey<LootTable> MOOSHROOM_RED_SHEARING = LootTables.register("shearing/mooshroom/red");
    public static final RegistryKey<LootTable> MOOSHROOM_BROWN_SHEARING = LootTables.register("shearing/mooshroom/brown");
    public static final RegistryKey<LootTable> SNOW_GOLEM_SHEARING = LootTables.register("shearing/snow_golem");
    public static final RegistryKey<LootTable> SHEEP_SHEARING = LootTables.register("shearing/sheep");
    public static final Map<DyeColor, RegistryKey<LootTable>> SHEEP_SHEARING_FROM_DYE_COLOR = LootTables.registerAllDyeColors("shearing/sheep");
    public static final RegistryKey<LootTable> ROOT_CHARGED_CREEPER = LootTables.register("charged_creeper/root");
    public static final RegistryKey<LootTable> PIGLIN_CHARGED_CREEPER = LootTables.register("charged_creeper/piglin");
    public static final RegistryKey<LootTable> CREEPER_CHARGED_CREEPER = LootTables.register("charged_creeper/creeper");
    public static final RegistryKey<LootTable> SKELETON_CHARGED_CREEPER = LootTables.register("charged_creeper/skeleton");
    public static final RegistryKey<LootTable> WITHER_SKELETON_CHARGED_CREEPER = LootTables.register("charged_creeper/wither_skeleton");
    public static final RegistryKey<LootTable> ZOMBIE_CHARGED_CREEPER = LootTables.register("charged_creeper/zombie");
