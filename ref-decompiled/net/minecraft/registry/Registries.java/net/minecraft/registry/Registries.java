...
public class Registries {
    ...
    public static final Registry<DebugSubscriptionType<?>> DEBUG_SUBSCRIPTION = Registries.create(RegistryKeys.DEBUG_SUBSCRIPTION, DebugSubscriptionTypes::registerAndGetDefault);
    ...
    public static final DefaultedRegistry<VillagerType> VILLAGER_TYPE = Registries.create(RegistryKeys.VILLAGER_TYPE, "plains", VillagerType::registerAndGetDefault);
    public static final DefaultedRegistry<VillagerProfession> VILLAGER_PROFESSION = Registries.create(RegistryKeys.VILLAGER_PROFESSION, "none", VillagerProfession::registerAndGetDefault);
    ...
    public static final Registry<GameRule<?>> GAME_RULE = Registries.create(RegistryKeys.GAME_RULE, GameRules::registerAndGetDefault);
    ...
    public static final Registry<ComponentPredicate.Type<?>> DATA_COMPONENT_PREDICATE_TYPE = Registries.create(RegistryKeys.DATA_COMPONENT_PREDICATE_TYPE, ComponentPredicateTypes::getDefault);
    ...
    public static final Registry<MapCodec<? extends EnchantmentLevelBasedValue>> ENCHANTMENT_LEVEL_BASED_VALUE_TYPE = Registries.create(RegistryKeys.ENCHANTMENT_LEVEL_BASED_VALUE_TYPE, EnchantmentLevelBasedValue::registerAndGetDefault);
    public static final Registry<MapCodec<? extends EnchantmentEntityEffect>> ENCHANTMENT_ENTITY_EFFECT_TYPE = Registries.create(RegistryKeys.ENCHANTMENT_ENTITY_EFFECT_TYPE, EnchantmentEntityEffect::registerAndGetDefault);
    public static final Registry<MapCodec<? extends EnchantmentLocationBasedEffect>> ENCHANTMENT_LOCATION_BASED_EFFECT_TYPE = Registries.create(RegistryKeys.ENCHANTMENT_LOCATION_BASED_EFFECT_TYPE, EnchantmentLocationBasedEffect::registerAndGetDefault);
    public static final Registry<MapCodec<? extends EnchantmentValueEffect>> ENCHANTMENT_VALUE_EFFECT_TYPE = Registries.create(RegistryKeys.ENCHANTMENT_VALUE_EFFECT_TYPE, EnchantmentValueEffect::registerAndGetDefault);
    ...
    public static final Registry<ConsumeEffect.Type<?>> CONSUME_EFFECT_TYPE = Registries.create(RegistryKeys.CONSUME_EFFECT_TYPE, registry -> ConsumeEffect.Type.APPLY_EFFECTS);
    public static final Registry<RecipeDisplay.Serializer<?>> RECIPE_DISPLAY = Registries.create(RegistryKeys.RECIPE_DISPLAY, RecipeDisplayBootstrap::registerAndGetDefault);
    public static final Registry<SlotDisplay.Serializer<?>> SLOT_DISPLAY = Registries.create(RegistryKeys.SLOT_DISPLAY, SlotDisplays::registerAndGetDefault);
    public static final Registry<RecipeBookCategory> RECIPE_BOOK_CATEGORY = Registries.create(RegistryKeys.RECIPE_BOOK_CATEGORY, RecipeBookCategories::registerAndGetDefault);
    public static final Registry<ChunkTicketType> TICKET_TYPE = Registries.create(RegistryKeys.TICKET_TYPE, registry -> ChunkTicketType.UNKNOWN);
    public static final Registry<IncomingRpcMethod<?, ?>> INCOMING_RPC_METHOD = Registries.create(RegistryKeys.INCOMING_RPC_METHODS, IncomingRpcMethods::registerAndGetDefault);
    public static final Registry<OutgoingRpcMethod<?, ?>> OUTGOING_RPC_METHOD = Registries.create(RegistryKeys.OUTGOING_RPC_METHODS, registry -> OutgoingRpcMethods.SERVER_STARTED);
    public static final Registry<MapCodec<? extends TestEnvironmentDefinition>> TEST_ENVIRONMENT_DEFINITION_TYPE = Registries.create(RegistryKeys.TEST_ENVIRONMENT_DEFINITION_TYPE, TestEnvironmentDefinition::registerAndGetDefault);
    public static final Registry<MapCodec<? extends TestInstance>> TEST_INSTANCE_TYPE = Registries.create(RegistryKeys.TEST_INSTANCE_TYPE, TestInstance::registerAndGetDefault);
    public static final Registry<MapCodec<? extends SpawnCondition>> SPAWN_CONDITION_TYPE = Registries.create(RegistryKeys.SPAWN_CONDITION_TYPE, SpawnConditions::registerAndGetDefault);
    public static final Registry<MapCodec<? extends Dialog>> DIALOG_TYPE = Registries.create(RegistryKeys.DIALOG_TYPE, DialogTypes::registerAndGetDefault);
    public static final Registry<MapCodec<? extends DialogAction>> DIALOG_ACTION_TYPE = Registries.create(RegistryKeys.DIALOG_ACTION_TYPE, DialogActionTypes::registerAndGetDefault);
    public static final Registry<MapCodec<? extends InputControl>> INPUT_CONTROL_TYPE = Registries.create(RegistryKeys.INPUT_CONTROL_TYPE, InputControlTypes::registerAndGetDefault);
    public static final Registry<MapCodec<? extends DialogBody>> DIALOG_BODY_TYPE = Registries.create(RegistryKeys.DIALOG_BODY_TYPE, DialogBodyTypes::registerAndGetDefault);
    public static final Registry<MapCodec<? extends Permission>> PERMISSION_TYPE = Registries.create(RegistryKeys.PERMISSION_TYPE, Permissions::registerAndGetDefault);
    public static final Registry<MapCodec<? extends PermissionCheck>> PERMISSION_CHECK_TYPE = Registries.create(RegistryKeys.PERMISSION_CHECK_TYPE, PermissionChecks::registerAndGetDefault);
    public static final Registry<EnvironmentAttribute<?>> ENVIRONMENTAL_ATTRIBUTE = Registries.create(RegistryKeys.ENVIRONMENT_ATTRIBUTE, EnvironmentAttributes::registerAndGetDefault);
    public static final Registry<EnvironmentAttributeType<?>> ATTRIBUTE_TYPE = Registries.create(RegistryKeys.ATTRIBUTE_TYPE, EnvironmentAttributeTypes::registerAndGetDefault);
    public static final Registry<MapCodec<? extends SlotSource>> SLOT_SOURCE_TYPE = Registries.create(RegistryKeys.SLOT_SOURCE_TYPE, SlotSources::registerAndGetDefault);
    public static final Registry<Consumer<TestContext>> TEST_FUNCTION = Registries.create(RegistryKeys.TEST_FUNCTION, BuiltinTestFunctions::registerAndGetDefault);
    ...
    private static <T extends Registry<?>> void validate(Registry<T> registries) {
        registries.forEach(registry -> {
            ...
            if (registry instanceof DefaultedRegistry) {
                ...
                Objects.requireNonNull(registry.get(identifier), "Missing default of DefaultedMappedRegistry: " + String.valueOf(identifier));
            }
        });
    }
