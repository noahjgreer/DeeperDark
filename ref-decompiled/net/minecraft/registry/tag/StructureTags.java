...
public interface StructureTags {
   ...
   TagKey ON_SAVANNA_VILLAGE_MAPS = of("on_savanna_village_maps");
   TagKey ON_DESERT_VILLAGE_MAPS = of("on_desert_village_maps");
   TagKey ON_PLAINS_VILLAGE_MAPS = of("on_plains_village_maps");
   TagKey ON_TAIGA_VILLAGE_MAPS = of("on_taiga_village_maps");
   TagKey ON_SNOWY_VILLAGE_MAPS = of("on_snowy_village_maps");
   TagKey ON_JUNGLE_EXPLORER_MAPS = of("on_jungle_explorer_maps");
   TagKey ON_SWAMP_EXPLORER_MAPS = of("on_swamp_explorer_maps");
   TagKey ON_TREASURE_MAPS = of("on_treasure_maps");
   TagKey ON_TRIAL_CHAMBERS_MAPS = of("on_trial_chambers_maps");
