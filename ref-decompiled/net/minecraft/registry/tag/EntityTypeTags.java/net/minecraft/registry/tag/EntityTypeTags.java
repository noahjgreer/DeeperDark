...
public interface EntityTypeTags {
    ...
    public static final TagKey<EntityType<?>> BURN_IN_DAYLIGHT = EntityTypeTags.of("burn_in_daylight");
    ...
    public static final TagKey<EntityType<?>> BOAT = EntityTypeTags.of("boat");
    public static final TagKey<EntityType<?>> CAN_EQUIP_SADDLE = EntityTypeTags.of("can_equip_saddle");
    public static final TagKey<EntityType<?>> CAN_EQUIP_HARNESS = EntityTypeTags.of("can_equip_harness");
    public static final TagKey<EntityType<?>> CAN_WEAR_HORSE_ARMOR = EntityTypeTags.of("can_wear_horse_armor");
    public static final TagKey<EntityType<?>> CAN_WEAR_NAUTILUS_ARMOR = EntityTypeTags.of("can_wear_nautilus_armor");
    public static final TagKey<EntityType<?>> FOLLOWABLE_FRIENDLY_MOBS = EntityTypeTags.of("followable_friendly_mobs");
    public static final TagKey<EntityType<?>> CANNOT_BE_PUSHED_ONTO_BOATS = EntityTypeTags.of("cannot_be_pushed_onto_boats");
    public static final TagKey<EntityType<?>> ACCEPTS_IRON_GOLEM_GIFT = EntityTypeTags.of("accepts_iron_golem_gift");
    public static final TagKey<EntityType<?>> CANDIDATE_FOR_IRON_GOLEM_GIFT = EntityTypeTags.of("candidate_for_iron_golem_gift");
    public static final TagKey<EntityType<?>> NAUTILUS_HOSTILES = EntityTypeTags.of("nautilus_hostiles");
    public static final TagKey<EntityType<?>> CAN_FLOAT_WHILE_RIDDEN = EntityTypeTags.of("can_float_while_ridden");
