...
public class BiomeTags {
    public static final TagKey<Biome> IS_DEEP_OCEAN = BiomeTags.of("is_deep_ocean");
    public static final TagKey<Biome> IS_OCEAN = BiomeTags.of("is_ocean");
    public static final TagKey<Biome> IS_BEACH = BiomeTags.of("is_beach");
    public static final TagKey<Biome> IS_RIVER = BiomeTags.of("is_river");
    public static final TagKey<Biome> IS_MOUNTAIN = BiomeTags.of("is_mountain");
    public static final TagKey<Biome> IS_BADLANDS = BiomeTags.of("is_badlands");
    public static final TagKey<Biome> IS_HILL = BiomeTags.of("is_hill");
    ...
    public static final TagKey<Biome> JUNGLE_TEMPLE_HAS_STRUCTURE = BiomeTags.of("has_structure/jungle_temple");
    public static final TagKey<Biome> MINESHAFT_HAS_STRUCTURE = BiomeTags.of("has_structure/mineshaft");
    public static final TagKey<Biome> MINESHAFT_MESA_HAS_STRUCTURE = BiomeTags.of("has_structure/mineshaft_mesa");
    public static final TagKey<Biome> OCEAN_MONUMENT_HAS_STRUCTURE = BiomeTags.of("has_structure/ocean_monument");
    public static final TagKey<Biome> OCEAN_RUIN_COLD_HAS_STRUCTURE = BiomeTags.of("has_structure/ocean_ruin_cold");
    public static final TagKey<Biome> OCEAN_RUIN_WARM_HAS_STRUCTURE = BiomeTags.of("has_structure/ocean_ruin_warm");
    public static final TagKey<Biome> PILLAGER_OUTPOST_HAS_STRUCTURE = BiomeTags.of("has_structure/pillager_outpost");
    public static final TagKey<Biome> RUINED_PORTAL_DESERT_HAS_STRUCTURE = BiomeTags.of("has_structure/ruined_portal_desert");
    public static final TagKey<Biome> RUINED_PORTAL_JUNGLE_HAS_STRUCTURE = BiomeTags.of("has_structure/ruined_portal_jungle");
    public static final TagKey<Biome> RUINED_PORTAL_OCEAN_HAS_STRUCTURE = BiomeTags.of("has_structure/ruined_portal_ocean");
    public static final TagKey<Biome> RUINED_PORTAL_SWAMP_HAS_STRUCTURE = BiomeTags.of("has_structure/ruined_portal_swamp");
    public static final TagKey<Biome> RUINED_PORTAL_MOUNTAIN_HAS_STRUCTURE = BiomeTags.of("has_structure/ruined_portal_mountain");
    ...
    public static final TagKey<Biome> TRIAL_CHAMBERS_HAS_STRUCTURE = BiomeTags.of("has_structure/trial_chambers");
    ...
    public static final TagKey<Biome> VILLAGE_SAVANNA_HAS_STRUCTURE = BiomeTags.of("has_structure/village_savanna");
    ...
    public static final TagKey<Biome> TRAIL_RUINS_HAS_STRUCTURE = BiomeTags.of("has_structure/trail_ruins");
    ...
    public static final TagKey<Biome> ANCIENT_CITY_HAS_STRUCTURE = BiomeTags.of("has_structure/ancient_city");
    ...
    public static final TagKey<Biome> MINESHAFT_BLOCKING = BiomeTags.of("mineshaft_blocking");
    ...
    public static final TagKey<Biome> SPAWNS_COLD_VARIANT_FARM_ANIMALS = BiomeTags.of("spawns_cold_variant_farm_animals");
    public static final TagKey<Biome> SPAWNS_WARM_VARIANT_FARM_ANIMALS = BiomeTags.of("spawns_warm_variant_farm_animals");
    public static final TagKey<Biome> SPAWNS_GOLD_RABBITS = BiomeTags.of("spawns_gold_rabbits");
    public static final TagKey<Biome> SPAWNS_WHITE_RABBITS = BiomeTags.of("spawns_white_rabbits");
    ...
    public static final TagKey<Biome> SPAWNS_SNOW_FOXES = BiomeTags.of("spawns_snow_foxes");
    public static final TagKey<Biome> SPAWNS_CORAL_VARIANT_ZOMBIE_NAUTILUS = BiomeTags.of("spawns_coral_variant_zombie_nautilus");
