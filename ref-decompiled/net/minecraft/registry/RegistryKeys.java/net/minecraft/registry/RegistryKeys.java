...
public class RegistryKeys {
    ...
    public static final RegistryKey<Registry<ConsumeEffect.Type<?>>> CONSUME_EFFECT_TYPE = RegistryKeys.of("consume_effect_type");
    ...
    public static final RegistryKey<Registry<ComponentPredicate.Type<?>>> DATA_COMPONENT_PREDICATE_TYPE = RegistryKeys.of("data_component_predicate_type");
    public static final RegistryKey<Registry<ComponentType<?>>> DATA_COMPONENT_TYPE = RegistryKeys.of("data_component_type");
    public static final RegistryKey<Registry<GameRule<?>>> GAME_RULE = RegistryKeys.of("game_rule");
    public static final RegistryKey<Registry<DebugSubscriptionType<?>>> DEBUG_SUBSCRIPTION = RegistryKeys.of("debug_subscription");
    ...
    public static final RegistryKey<Registry<MapCodec<? extends DialogBody>>> DIALOG_BODY_TYPE = RegistryKeys.of("dialog_body_type");
    public static final RegistryKey<Registry<MapCodec<? extends Dialog>>> DIALOG_TYPE = RegistryKeys.of("dialog_type");
    ...
    public static final RegistryKey<Registry<MapCodec<? extends EnchantmentEntityEffect>>> ENCHANTMENT_ENTITY_EFFECT_TYPE = RegistryKeys.of("enchantment_entity_effect_type");
    public static final RegistryKey<Registry<MapCodec<? extends EnchantmentLevelBasedValue>>> ENCHANTMENT_LEVEL_BASED_VALUE_TYPE = RegistryKeys.of("enchantment_level_based_value_type");
    public static final RegistryKey<Registry<MapCodec<? extends EnchantmentLocationBasedEffect>>> ENCHANTMENT_LOCATION_BASED_EFFECT_TYPE = RegistryKeys.of("enchantment_location_based_effect_type");
    ...
    public static final RegistryKey<Registry<MapCodec<? extends EnchantmentValueEffect>>> ENCHANTMENT_VALUE_EFFECT_TYPE = RegistryKeys.of("enchantment_value_effect_type");
    ...
    public static final RegistryKey<Registry<EnvironmentAttribute<?>>> ENVIRONMENT_ATTRIBUTE = RegistryKeys.of("environment_attribute");
    public static final RegistryKey<Registry<EnvironmentAttributeType<?>>> ATTRIBUTE_TYPE = RegistryKeys.of("attribute_type");
    ...
    public static final RegistryKey<Registry<MapCodec<? extends InputControl>>> INPUT_CONTROL_TYPE = RegistryKeys.of("input_control_type");
    ...
    public static final RegistryKey<Registry<MapCodec<? extends SlotSource>>> SLOT_SOURCE_TYPE = RegistryKeys.of("slot_source_type");
    ...
    public static final RegistryKey<Registry<RecipeBookCategory>> RECIPE_BOOK_CATEGORY = RegistryKeys.of("recipe_book_category");
    public static final RegistryKey<Registry<RecipeDisplay.Serializer<?>>> RECIPE_DISPLAY = RegistryKeys.of("recipe_display");
    ...
    public static final RegistryKey<Registry<SlotDisplay.Serializer<?>>> SLOT_DISPLAY = RegistryKeys.of("slot_display");
    public static final RegistryKey<Registry<SoundEvent>> SOUND_EVENT = RegistryKeys.of("sound_event");
    public static final RegistryKey<Registry<MapCodec<? extends SpawnCondition>>> SPAWN_CONDITION_TYPE = RegistryKeys.of("spawn_condition_type");
    ...
    public static final RegistryKey<Registry<MapCodec<? extends DialogAction>>> DIALOG_ACTION_TYPE = RegistryKeys.of("dialog_action_type");
    public static final RegistryKey<Registry<MapCodec<? extends TestEnvironmentDefinition>>> TEST_ENVIRONMENT_DEFINITION_TYPE = RegistryKeys.of("test_environment_definition_type");
    public static final RegistryKey<Registry<Consumer<TestContext>>> TEST_FUNCTION = RegistryKeys.of("test_function");
    public static final RegistryKey<Registry<MapCodec<? extends TestInstance>>> TEST_INSTANCE_TYPE = RegistryKeys.of("test_instance_type");
    public static final RegistryKey<Registry<ChunkTicketType>> TICKET_TYPE = RegistryKeys.of("ticket_type");
    ...
    public static final RegistryKey<Registry<IncomingRpcMethod<?, ?>>> INCOMING_RPC_METHODS = RegistryKeys.of("incoming_rpc_methods");
    public static final RegistryKey<Registry<OutgoingRpcMethod<?, ?>>> OUTGOING_RPC_METHODS = RegistryKeys.of("outgoing_rpc_methods");
    public static final RegistryKey<Registry<MapCodec<? extends Permission>>> PERMISSION_TYPE = RegistryKeys.of("permission_type");
    public static final RegistryKey<Registry<MapCodec<? extends PermissionCheck>>> PERMISSION_CHECK_TYPE = RegistryKeys.of("permission_check_type");
    ...
    public static final RegistryKey<Registry<ChickenVariant>> CHICKEN_VARIANT = RegistryKeys.of("chicken_variant");
    public static final RegistryKey<Registry<ZombieNautilusVariant>> ZOMBIE_NAUTILUS_VARIANT = RegistryKeys.of("zombie_nautilus_variant");
    ...
    public static final RegistryKey<Registry<CowVariant>> COW_VARIANT = RegistryKeys.of("cow_variant");
    ...
    public static final RegistryKey<Registry<Dialog>> DIALOG = RegistryKeys.of("dialog");
    ...
    public static final RegistryKey<Registry<JukeboxSong>> JUKEBOX_SONG = RegistryKeys.of("jukebox_song");
    ...
    public static final RegistryKey<Registry<PigVariant>> PIG_VARIANT = RegistryKeys.of("pig_variant");
    ...
    public static final RegistryKey<Registry<TestEnvironmentDefinition>> TEST_ENVIRONMENT = RegistryKeys.of("test_environment");
    public static final RegistryKey<Registry<TestInstance>> TEST_INSTANCE = RegistryKeys.of("test_instance");
    public static final RegistryKey<Registry<Timeline>> TIMELINE = RegistryKeys.of("timeline");
    public static final RegistryKey<Registry<TrialSpawnerConfig>> TRIAL_SPAWNER = RegistryKeys.of("trial_spawner");
    ...
    public static final RegistryKey<Registry<WolfSoundVariant>> WOLF_SOUND_VARIANT = RegistryKeys.of("wolf_sound_variant");
