...
public record LoreComponent(List<Text> lines, List<Text> styledLines) implements TooltipAppender
{
    ...
    public static final PacketCodec<RegistryByteBuf, LoreComponent> PACKET_CODEC = TextCodecs.REGISTRY_PACKET_CODEC.collect(PacketCodecs.toList(256)).xmap(LoreComponent::new, LoreComponent::lines);
