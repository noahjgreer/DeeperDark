...
public record DeathProtectionComponent(List<ConsumeEffect> deathEffects) {
    public static final Codec<DeathProtectionComponent> CODEC = RecordCodecBuilder.create(instance -> instance.group((App)ConsumeEffect.CODEC.listOf().optionalFieldOf("death_effects", List.of()).forGetter(DeathProtectionComponent::deathEffects)).apply((Applicative)instance, DeathProtectionComponent::new));
