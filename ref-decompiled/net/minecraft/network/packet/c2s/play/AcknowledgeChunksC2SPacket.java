...
public record AcknowledgeChunksC2SPacket(float desiredChunksPerTick) implements Packet {
   public static final PacketCodec CODEC = Packet.createCodec(AcknowledgeChunksC2SPacket::write, AcknowledgeChunksC2SPacket::new);

   private AcknowledgeChunksC2SPacket(PacketByteBuf buf) {
      this(buf.readFloat());
   }

   public AcknowledgeChunksC2SPacket(float f) {
