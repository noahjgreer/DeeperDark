...
public abstract class PlayerMoveC2SPacket implements Packet {
   ...
   public static class OnGroundOnly extends PlayerMoveC2SPacket {
      public static final PacketCodec CODEC = Packet.createCodec(OnGroundOnly::write, OnGroundOnly::read);
   ...
   public static class LookAndOnGround extends PlayerMoveC2SPacket {
      public static final PacketCodec CODEC = Packet.createCodec(LookAndOnGround::write, LookAndOnGround::read);
   ...
   public static class PositionAndOnGround extends PlayerMoveC2SPacket {
      public static final PacketCodec CODEC = Packet.createCodec(PositionAndOnGround::write, PositionAndOnGround::read);
   ...
   public static class Full extends PlayerMoveC2SPacket {
      public static final PacketCodec CODEC = Packet.createCodec(Full::write, Full::read);
