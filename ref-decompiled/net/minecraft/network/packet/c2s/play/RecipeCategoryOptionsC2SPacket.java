...
public class RecipeCategoryOptionsC2SPacket implements Packet {
   public static final PacketCodec CODEC = Packet.createCodec(RecipeCategoryOptionsC2SPacket::write, RecipeCategoryOptionsC2SPacket::new);
   ...
   private RecipeCategoryOptionsC2SPacket(PacketByteBuf buf) {
      this.category = (RecipeBookType)buf.readEnumConstant(RecipeBookType.class);
