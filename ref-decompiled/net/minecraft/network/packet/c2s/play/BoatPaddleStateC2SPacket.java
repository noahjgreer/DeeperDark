...
public class BoatPaddleStateC2SPacket implements Packet {
   public static final PacketCodec CODEC = Packet.createCodec(BoatPaddleStateC2SPacket::write, BoatPaddleStateC2SPacket::new);
