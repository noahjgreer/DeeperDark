...
public class UpdateStructureBlockC2SPacket implements Packet {
   public static final PacketCodec CODEC = Packet.createCodec(UpdateStructureBlockC2SPacket::write, UpdateStructureBlockC2SPacket::new);
   ...
   private static final int STRICT_MASK = 8;
