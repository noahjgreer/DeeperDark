...
implements Packet<ServerPlayPacketListener> {
    public static final PacketCodec<PacketByteBuf, UpdateStructureBlockC2SPacket> CODEC = Packet.createCodec(UpdateStructureBlockC2SPacket::write, UpdateStructureBlockC2SPacket::new);
