...
implements Packet<ServerPlayPacketListener> {
    public static final PacketCodec<PacketByteBuf, UpdateCommandBlockC2SPacket> CODEC = Packet.createCodec(UpdateCommandBlockC2SPacket::write, UpdateCommandBlockC2SPacket::new);
