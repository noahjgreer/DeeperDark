...
public class UpdateJigsawC2SPacket implements Packet {
   public static final PacketCodec CODEC = Packet.createCodec(UpdateJigsawC2SPacket::write, UpdateJigsawC2SPacket::new);
   ...
   public UpdateJigsawC2SPacket(BlockPos pos, Identifier name, Identifier target, Identifier pool, String finalState, JigsawBlockEntity.Joint jointType, int selectionPriority, int placementPriority) {
      this.pos = pos;
      this.name = name;
      this.target = target;
      this.pool = pool;
   ...
   private UpdateJigsawC2SPacket(PacketByteBuf buf) {
      ...
      this.jointType = (JigsawBlockEntity.Joint)JigsawBlockEntity.Joint.CODEC.byId(buf.readString(), (Enum)JigsawBlockEntity.Joint.ALIGNED);
