...
public static class PlayerMoveC2SPacket.OnGroundOnly
extends PlayerMoveC2SPacket {
    public static final PacketCodec<PacketByteBuf, PlayerMoveC2SPacket.OnGroundOnly> CODEC = Packet.createCodec(PlayerMoveC2SPacket.OnGroundOnly::write, PlayerMoveC2SPacket.OnGroundOnly::read);

    public PlayerMoveC2SPacket.OnGroundOnly(boolean onGround, boolean horizontalCollision) {
