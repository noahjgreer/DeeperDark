...
public record ResourcePackSendS2CPacket(UUID id, String url, String hash, boolean required, Optional prompt) implements Packet {
   public static final int MAX_HASH_LENGTH = 40;
   public static final PacketCodec CODEC;

   public ResourcePackSendS2CPacket(UUID uUID, String string, String string2, boolean bl, Optional optional) {
