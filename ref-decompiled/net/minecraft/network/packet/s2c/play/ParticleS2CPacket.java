...
public class ParticleS2CPacket implements Packet {
   public static final PacketCodec CODEC = Packet.createCodec(ParticleS2CPacket::write, ParticleS2CPacket::new);
   ...
   public ParticleS2CPacket(ParticleEffect parameters, boolean forceSpawn, boolean important, double x, double y, double z, float offsetX, float offsetY, float offsetZ, float speed, int count) {
   ...
   private void write(RegistryByteBuf buf) {
      ...
      buf.writeBoolean(this.important);
