...
implements Packet<ClientPlayPacketListener> {
    public static final PacketCodec<PacketByteBuf, OpenWrittenBookS2CPacket> CODEC = Packet.createCodec(OpenWrittenBookS2CPacket::write, OpenWrittenBookS2CPacket::new);
