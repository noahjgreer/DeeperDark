...
public class EntityStatusEffectS2CPacket implements Packet {
   public static final PacketCodec CODEC = Packet.createCodec(EntityStatusEffectS2CPacket::write, EntityStatusEffectS2CPacket::new);
   ...
   private final RegistryEntry effectId;
