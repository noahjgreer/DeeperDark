...
implements Packet<ClientPlayPacketListener> {
    public static final PacketCodec<RegistryByteBuf, EntityStatusEffectS2CPacket> CODEC = Packet.createCodec(EntityStatusEffectS2CPacket::write, EntityStatusEffectS2CPacket::new);
