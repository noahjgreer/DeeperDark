...
public class EntitySpawnS2CPacket implements Packet {
   public static final PacketCodec CODEC = Packet.createCodec(EntitySpawnS2CPacket::write, EntitySpawnS2CPacket::new);
   ...
   public EntitySpawnS2CPacket(Entity entity, EntityTrackerEntry entityTrackerEntry, int entityData) {
      this(entity.getId(), entity.getUuid(), entityTrackerEntry.getPos().getX(), entityTrackerEntry.getPos().getY(), entityTrackerEntry.getPos().getZ(), entityTrackerEntry.getPitch(), entityTrackerEntry.getYaw(), entity.getType(), entityData, entityTrackerEntry.getVelocity(), (double)entityTrackerEntry.getHeadYaw());
   }

   public EntitySpawnS2CPacket(Entity entity, int entityData, BlockPos pos) {
      this(entity.getId(), entity.getUuid(), (double)pos.getX(), (double)pos.getY(), (double)pos.getZ(), entity.getPitch(), entity.getYaw(), entity.getType(), entityData, entity.getVelocity(), (double)entity.getHeadYaw());
   }
