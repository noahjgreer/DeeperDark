...
implements Packet<ClientPlayPacketListener> {
    public static final PacketCodec<PacketByteBuf, PlayerAbilitiesS2CPacket> CODEC = Packet.createCodec(PlayerAbilitiesS2CPacket::write, PlayerAbilitiesS2CPacket::new);
