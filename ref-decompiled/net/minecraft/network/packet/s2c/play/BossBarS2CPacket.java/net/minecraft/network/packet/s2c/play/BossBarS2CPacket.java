...
implements Packet<ClientPlayPacketListener> {
    ...
    extends Enum<Type> {
        public static final /* enum */ Type ADD = new Type(AddAction::new);
        public static final /* enum */ Type REMOVE = new Type(buf -> REMOVE_ACTION);
        public static final /* enum */ Type UPDATE_PROGRESS = new Type(UpdateProgressAction::new);
        public static final /* enum */ Type UPDATE_NAME = new Type(UpdateNameAction::new);
        public static final /* enum */ Type UPDATE_STYLE = new Type(UpdateStyleAction::new);
        public static final /* enum */ Type UPDATE_PROPERTIES = new Type(UpdatePropertiesAction::new);
        final PacketDecoder<RegistryByteBuf, Action> parser;
        private static final /* synthetic */ Type[] field_29114;
        ...
        private static /* synthetic */ Type[] method_36948() {
