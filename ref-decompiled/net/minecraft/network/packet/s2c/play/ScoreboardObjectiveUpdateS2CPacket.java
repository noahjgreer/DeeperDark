...
public class ScoreboardObjectiveUpdateS2CPacket implements Packet {
   public static final PacketCodec CODEC = Packet.createCodec(ScoreboardObjectiveUpdateS2CPacket::write, ScoreboardObjectiveUpdateS2CPacket::new);
   ...
   private ScoreboardObjectiveUpdateS2CPacket(RegistryByteBuf buf) {
      ...
      if (this.mode != 0 && this.mode != 2) {
         ...
         this.type = (ScoreboardCriterion.RenderType)buf.readEnumConstant(ScoreboardCriterion.RenderType.class);
