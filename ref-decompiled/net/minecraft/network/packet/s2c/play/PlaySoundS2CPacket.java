...
public class PlaySoundS2CPacket implements Packet {
   public static final PacketCodec CODEC = Packet.createCodec(PlaySoundS2CPacket::write, PlaySoundS2CPacket::new);
   ...
   public PlaySoundS2CPacket(RegistryEntry sound, SoundCategory category, double x, double y, double z, float volume, float pitch, long seed) {
      this.sound = sound;
