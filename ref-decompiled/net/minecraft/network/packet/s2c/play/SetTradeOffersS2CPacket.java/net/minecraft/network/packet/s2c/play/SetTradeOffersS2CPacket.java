...
implements Packet<ClientPlayPacketListener> {
    public static final PacketCodec<RegistryByteBuf, SetTradeOffersS2CPacket> CODEC = Packet.createCodec(SetTradeOffersS2CPacket::write, SetTradeOffersS2CPacket::new);
