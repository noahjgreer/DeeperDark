...
public class SetTradeOffersS2CPacket implements Packet {
   public static final PacketCodec CODEC = Packet.createCodec(SetTradeOffersS2CPacket::write, SetTradeOffersS2CPacket::new);
   ...
   private SetTradeOffersS2CPacket(RegistryByteBuf buf) {
      ...
      this.offers = (TradeOfferList)TradeOfferList.PACKET_CODEC.decode(buf);
