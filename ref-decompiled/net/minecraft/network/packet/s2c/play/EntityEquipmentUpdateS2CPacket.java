...
public class EntityEquipmentUpdateS2CPacket implements Packet {
   public static final PacketCodec CODEC = Packet.createCodec(EntityEquipmentUpdateS2CPacket::write, EntityEquipmentUpdateS2CPacket::new);
   private static final byte field_33342 = -128;
   private final int entityId;
   private final List equipmentList;

   public EntityEquipmentUpdateS2CPacket(int entityId, List equipmentList) {
