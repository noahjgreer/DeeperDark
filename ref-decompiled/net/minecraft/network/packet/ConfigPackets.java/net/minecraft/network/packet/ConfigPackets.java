...
public class ConfigPackets {
    public static final PacketType<CodeOfConductS2CPacket> CODE_OF_CONDUCT = ConfigPackets.s2c("code_of_conduct");
    ...
    public static final PacketType<AcceptCodeOfConductC2SPacket> ACCEPT_CODE_OF_CONDUCT = ConfigPackets.c2s("accept_code_of_conduct");
