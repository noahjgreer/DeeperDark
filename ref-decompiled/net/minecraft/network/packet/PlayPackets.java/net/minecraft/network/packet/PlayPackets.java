...
public class PlayPackets {
    ...
    public static final PacketType<BlockValueDebugS2CPacket> BLOCK_VALUE_DEBUG = PlayPackets.s2c("debug/block_value");
    public static final PacketType<ChunkValueDebugS2CPacket> CHUNK_VALUE_DEBUG = PlayPackets.s2c("debug/chunk_value");
    public static final PacketType<EntityValueDebugS2CPacket> ENTITY_VALUE_DEBUG = PlayPackets.s2c("debug/entity_value");
    public static final PacketType<EventDebugS2CPacket> EVENT_DEBUG = PlayPackets.s2c("debug/event");
    ...
    public static final PacketType<EntityPositionSyncS2CPacket> ENTITY_POSITION_SYNC = PlayPackets.s2c("entity_position_sync");
    ...
    public static final PacketType<GameTestHighlightPosS2CPacket> GAME_TEST_HIGHLIGHT_POS = PlayPackets.s2c("game_test_highlight_pos");
    public static final PacketType<OpenMountScreenS2CPacket> MOUNT_SCREEN_OPEN = PlayPackets.s2c("mount_screen_open");
    ...
    public static final PacketType<MoveMinecartAlongTrackS2CPacket> MOVE_MINECART_ALONG_TRACK = PlayPackets.s2c("move_minecart_along_track");
    ...
    public static final PacketType<PlayerRotationS2CPacket> PLAYER_ROTATION = PlayPackets.s2c("player_rotation");
    public static final PacketType<RecipeBookAddS2CPacket> RECIPE_BOOK_ADD = PlayPackets.s2c("recipe_book_add");
    public static final PacketType<RecipeBookRemoveS2CPacket> RECIPE_BOOK_REMOVE = PlayPackets.s2c("recipe_book_remove");
    public static final PacketType<RecipeBookSettingsS2CPacket> RECIPE_BOOK_SETTINGS = PlayPackets.s2c("recipe_book_settings");
    ...
    public static final PacketType<UpdateSelectedSlotS2CPacket> SET_CARRIED_ITEM_S2C = PlayPackets.s2c("set_held_slot");
    ...
    public static final PacketType<TestInstanceBlockStatusS2CPacket> TEST_INSTANCE_BLOCK_STATUS = PlayPackets.s2c("test_instance_block_status");
    ...
    public static final PacketType<WaypointS2CPacket> WAYPOINT = PlayPackets.s2c("waypoint");
    ...
    public static final PacketType<BundleItemSelectedC2SPacket> BUNDLE_ITEM_SELECTED = PlayPackets.c2s("bundle_item_selected");
    public static final PacketType<UpdateDifficultyC2SPacket> CHANGE_DIFFICULTY_C2S = PlayPackets.c2s("change_difficulty");
    public static final PacketType<ChangeGameModeC2SPacket> CHANGE_GAME_MODE = PlayPackets.c2s("change_game_mode");
    ...
    public static final PacketType<ClientTickEndC2SPacket> CLIENT_TICK_END = PlayPackets.c2s("client_tick_end");
    ...
    public static final PacketType<DebugSubscriptionRequestC2SPacket> DEBUG_SUBSCRIPTION_REQUEST = PlayPackets.c2s("debug_subscription_request");
    ...
    public static final PacketType<PickItemFromBlockC2SPacket> PICK_ITEM_FROM_BLOCK = PlayPackets.c2s("pick_item_from_block");
    public static final PacketType<PickItemFromEntityC2SPacket> PICK_ITEM_FROM_ENTITY = PlayPackets.c2s("pick_item_from_entity");
    ...
    public static final PacketType<PlayerLoadedC2SPacket> PLAYER_LOADED = PlayPackets.c2s("player_loaded");
    ...
    public static final PacketType<SetTestBlockC2SPacket> SET_TEST_BLOCK = PlayPackets.c2s("set_test_block");
    public static final PacketType<TestInstanceBlockActionC2SPacket> TEST_INSTANCE_BLOCK_ACTION = PlayPackets.c2s("test_instance_block_action");
    ...
    public static final PacketType<SetCursorItemS2CPacket> SET_CURSOR_ITEM = PlayPackets.s2c("set_cursor_item");
    public static final PacketType<SetPlayerInventoryS2CPacket> SET_PLAYER_INVENTORY = PlayPackets.s2c("set_player_inventory");
