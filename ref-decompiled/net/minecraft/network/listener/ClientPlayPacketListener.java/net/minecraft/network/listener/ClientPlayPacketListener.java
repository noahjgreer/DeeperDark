...
ClientPingResultPacketListener {
    ...
    public void onOpenMountScreen(OpenMountScreenS2CPacket var1);
    ...
    public void onMoveMinecartAlongTrack(MoveMinecartAlongTrackS2CPacket var1);
    ...
    public void onEntityPositionSync(EntityPositionSyncS2CPacket var1);
    ...
    public void onWaypoint(WaypointS2CPacket var1);

    public void onChunkValueDebug(ChunkValueDebugS2CPacket var1);

    public void onBlockValueDebug(BlockValueDebugS2CPacket var1);

    public void onEntityValueDebug(EntityValueDebugS2CPacket var1);

    public void onEventDebug(EventDebugS2CPacket var1);

    public void onGameTestHighlightPos(GameTestHighlightPosS2CPacket var1);
}
