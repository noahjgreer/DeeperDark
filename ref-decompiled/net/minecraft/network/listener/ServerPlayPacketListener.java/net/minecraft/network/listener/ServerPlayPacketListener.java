...
ServerQueryPingPacketListener {
    ...
    public void onPlayerLoaded(PlayerLoadedC2SPacket var1);

    public void onRecipeBookData(RecipeBookDataC2SPacket var1);

    public void onBundleItemSelected(BundleItemSelectedC2SPacket var1);
    ...
    public void onPickItemFromBlock(PickItemFromBlockC2SPacket var1);

    public void onPickItemFromEntity(PickItemFromEntityC2SPacket var1);
    ...
    public void onSetTestBlock(SetTestBlockC2SPacket var1);

    public void onTestInstanceBlockAction(TestInstanceBlockActionC2SPacket var1);
    ...
    public void onChangeGameMode(ChangeGameModeC2SPacket var1);
    ...
    public void onDebugSubscriptionRequest(DebugSubscriptionRequestC2SPacket var1);

    public void onClientTickEnd(ClientTickEndC2SPacket var1);
}
