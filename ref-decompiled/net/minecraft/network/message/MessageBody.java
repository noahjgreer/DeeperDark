...
public record MessageBody(String content, Instant timestamp, long salt, LastSeenMessageList lastSeenMessages) {
   ...
   public MessageBody(String string, Instant instant, long l, LastSeenMessageList lastSeenMessageList) {
      this.content = string;
   ...
   public static record Serialized(String content, Instant timestamp, long salt, LastSeenMessageList.Indexed lastSeen) {
      ...
      public Serialized(String string, Instant instant, long l, LastSeenMessageList.Indexed indexed) {
         this.content = string;
         this.timestamp = instant;
         this.salt = l;
