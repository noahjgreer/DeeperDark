...
public class FireBlock extends AbstractFireBlock {
   public static final MapCodec CODEC = createCodec(FireBlock::new);
   ...
   public static final Map DIRECTION_PROPERTIES;
   ...
   private Function createShapeFunction() {
      ...
      return this.createShapeFunction((state) -> {
         ...
         Iterator var3 = DIRECTION_PROPERTIES.entrySet().iterator();
