...
public class WallPiglinHeadBlock extends WallSkullBlock {
   public static final MapCodec CODEC = createCodec(WallPiglinHeadBlock::new);
   private static final Map SHAPES = VoxelShapes.createHorizontalFacingShapeMap(Block.createCuboidZShape(10.0, 8.0, 8.0, 16.0));
