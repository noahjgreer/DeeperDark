...
public class UntintedParticleLeavesBlock extends LeavesBlock {
   public static final MapCodec CODEC = RecordCodecBuilder.mapCodec((instance) -> {
      return instance.group(Codecs.rangedInclusiveFloat(0.0F, 1.0F).fieldOf("leaf_particle_chance").forGetter((untintedParticleLeavesBlock) -> {
         return untintedParticleLeavesBlock.leafParticleChance;
      }), ParticleTypes.TYPE_CODEC.fieldOf("leaf_particle").forGetter((untintedParticleLeavesBlock) -> {
         return untintedParticleLeavesBlock.leafParticleEffect;
      }), createSettingsCodec()).apply(instance, UntintedParticleLeavesBlock::new);
   });
