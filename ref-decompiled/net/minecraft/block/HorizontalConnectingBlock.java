...
public abstract class HorizontalConnectingBlock extends Block implements Waterloggable {
   ...
   protected Function createShapeFunction(float radius1, float radius2, float height1, float offset2, float height2) {
      VoxelShape voxelShape = Block.createColumnShape((double)radius1, 0.0, (double)radius2);
      Map map = VoxelShapes.createHorizontalFacingShapeMap(Block.createCuboidZShape((double)height1, (double)offset2, (double)height2, 0.0, 8.0));
