...
public enum Orientation implements StringIdentifiable {
   ...
   private static final Orientation[] VALUES = (Orientation[])Util.make(new Orientation[DIRECTIONS * DIRECTIONS], (values) -> {
      Orientation[] var1 = values();
      int var2 = var1.length;

      for(int var3 = 0; var3 < var2; ++var3) {
         Orientation orientation = var1[var3];
