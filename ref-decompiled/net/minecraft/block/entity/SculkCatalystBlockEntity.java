...
public class SculkCatalystBlockEntity extends BlockEntity implements GameEventListener.Holder {
   ...
   public static class Listener implements GameEventListener {
      ...
      public boolean listen(ServerWorld world, RegistryEntry event, GameEvent.Emitter emitter, Vec3d emitterPos) {
         if (event.matches((RegistryEntry)GameEvent.ENTITY_DIE)) {
            ...
            if (var6 instanceof LivingEntity) {
               ...
               if (!livingEntity.isExperienceDroppingDisabled()) {
                  ...
                  int i = livingEntity.getExperienceToDrop(world, (Entity)Nullables.map(damageSource, DamageSource::getAttacker));
      ...
      private void bloom(ServerWorld world, BlockPos pos, BlockState state, Random random) {
         ...
         world.playSound((Entity)null, pos, SoundEvents.BLOCK_SCULK_CATALYST_BLOOM, SoundCategory.BLOCKS, 2.0F, 0.6F + random.nextFloat() * 0.4F);
      }
