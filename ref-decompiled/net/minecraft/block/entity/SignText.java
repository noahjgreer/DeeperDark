...
public class SignText {
   ...
   static {
      MESSAGES_CODEC = TextCodecs.CODEC.listOf().comapFlatMap((messages) -> {
      ...
      CODEC = RecordCodecBuilder.create((instance) -> {
         ...
         }), MESSAGES_CODEC.lenientOptionalFieldOf("filtered_messages").forGetter(SignText::getFilteredMessages), DyeColor.CODEC.fieldOf("color").orElse(DyeColor.BLACK).forGetter((signText) -> {
