...
public class StructureBlockBlockEntity extends BlockEntity implements StructureBoxRendering {
   ...
   public boolean saveStructure(boolean toDisk) {
      if (this.templateName != null) {
         ...
         if (var3 instanceof ServerWorld) {
            ...
            return saveStructure(serverWorld, this.templateName, blockPos, this.size, this.ignoreEntities, this.author, toDisk, List.of());
         }
      }
   ...
   public static boolean saveStructure(ServerWorld world, Identifier templateId, BlockPos start, Vec3i size, boolean ignoreEntities, String author, boolean toDisk, List list) {
   ...
   public boolean loadAndTryPlaceStructure(ServerWorld world) {
      if (this.mode == StructureBlockMode.LOAD && this.templateName != null) {
         StructureTemplate structureTemplate = (StructureTemplate)world.getStructureTemplateManager().getTemplate(this.templateName).orElse((Object)null);
   ...
   private StructureTemplate getStructureTemplate(ServerWorld world) {
      return this.templateName == null ? null : (StructureTemplate)world.getStructureTemplateManager().getTemplate(this.templateName).orElse((Object)null);
   }
   ...
   private void loadAndPlaceStructure(ServerWorld world, StructureTemplate template) {
      ...
      BlockPos blockPos = this.getPos().add(this.offset);
      template.place(world, blockPos, blockPos, structurePlacementData, createRandom(this.seed), 2 | (this.strict ? 816 : 0));
   }
   ...
   // $FF: synthetic method
   private static void method_54876(ServerWorld serverWorld, BlockPos blockPos) {
      serverWorld.setBlockState(blockPos, Blocks.STRUCTURE_VOID.getDefaultState(), 2);
   }

   static {
      DEFAULT_SIZE = Vec3i.ZERO;
      DEFAULT_ROTATION = BlockRotation.NONE;
      DEFAULT_MIRROR = BlockMirror.NONE;
   }
