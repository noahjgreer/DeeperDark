...
public class PistonBlockEntity extends BlockEntity {
   ...
   private static final BlockState DEFAULT_PUSHED_BLOCK_STATE;
   ...
   private static final ThreadLocal ENTITY_MOVEMENT_DIRECTION;
   ...
   public PistonBlockEntity(BlockPos pos, BlockState state) {
      ...
      this.pushedBlockState = DEFAULT_PUSHED_BLOCK_STATE;
   ...
   private BlockState getHeadBlockState() {
      return !this.isExtending() && this.isSource() && this.pushedBlockState.getBlock() instanceof PistonBlock ? (BlockState)((BlockState)((BlockState)Blocks.PISTON_HEAD.getDefaultState().with(PistonHeadBlock.SHORT, this.progress > 0.25F)).with(PistonHeadBlock.TYPE, this.pushedBlockState.isOf(Blocks.STICKY_PISTON) ? PistonType.STICKY : PistonType.DEFAULT)).with(PistonHeadBlock.FACING, (Direction)this.pushedBlockState.get(PistonBlock.FACING)) : this.pushedBlockState;
   }
   ...
   private static void pushEntities(World world, BlockPos pos, float f, PistonBlockEntity blockEntity) {
      ...
      if (!voxelShape.isEmpty()) {
         ...
         List list = world.getOtherEntities((Entity)null, Boxes.stretch(box, direction, d).union(box));
         if (!list.isEmpty()) {
   ...
   private static void moveEntity(Direction direction, Entity entity, double distance, Direction movementDirection) {
      ...
      ENTITY_MOVEMENT_DIRECTION.set((Object)null);
   }
   ...
   private static void moveEntitiesInHoneyBlock(World world, BlockPos pos, float f, PistonBlockEntity blockEntity) {
      if (blockEntity.isPushingHoneyBlock()) {
         ...
         if (direction.getAxis().isHorizontal()) {
            ...
            List list = world.getOtherEntities((Entity)null, box, (entityx) -> {
               return canMoveEntity(box, entityx, pos);
            });
   ...
   public void finish() {
      if (this.world != null && (this.lastProgress < 1.0F || this.world.isClient)) {
         ...
         if (this.world.getBlockState(this.pos).isOf(Blocks.MOVING_PISTON)) {
            ...
            this.world.updateNeighbor(this.pos, blockState.getBlock(), OrientationHelper.getEmissionOrientation(this.world, this.getDirection(), (Direction)null));
         }
      }
         ...
         if (world.isClient && blockEntity.field_26705 < 5) {
            ...
            if (world.getBlockState(pos).isOf(Blocks.MOVING_PISTON)) {
               ...
               if (blockState.isAir()) {
                  ...
                  world.updateNeighbor(pos, blockState.getBlock(), OrientationHelper.getEmissionOrientation(world, blockEntity.getDirection(), (Direction)null));
               }
            }
   ...
   public VoxelShape getCollisionShape(BlockView world, BlockPos pos) {
      ...
      if (!this.extending && this.source && this.pushedBlockState.getBlock() instanceof PistonBlock) {
         voxelShape = ((BlockState)this.pushedBlockState.with(PistonBlock.EXTENDED, true)).getCollisionShape(world, pos);
      } else {
      ...
      if ((double)this.progress < 1.0 && direction == this.getMovementDirection()) {
         ...
         BlockState blockState;
         if (this.isSource()) {
            blockState = (BlockState)((BlockState)Blocks.PISTON_HEAD.getDefaultState().with(PistonHeadBlock.FACING, this.facing)).with(PistonHeadBlock.SHORT, this.extending != 1.0F - this.progress < 0.25F);
         } else {
   ...
   static {
      DEFAULT_PUSHED_BLOCK_STATE = Blocks.AIR.getDefaultState();
      ENTITY_MOVEMENT_DIRECTION = ThreadLocal.withInitial(() -> {
         return null;
      });
   }
}
