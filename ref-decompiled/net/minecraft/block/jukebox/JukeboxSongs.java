...
public interface JukeboxSongs {
   RegistryKey THIRTEEN = of("13");
   RegistryKey CAT = of("cat");
   RegistryKey BLOCKS = of("blocks");
   RegistryKey CHIRP = of("chirp");
   RegistryKey FAR = of("far");
   RegistryKey MALL = of("mall");
   RegistryKey MELLOHI = of("mellohi");
   RegistryKey STAL = of("stal");
   RegistryKey STRAD = of("strad");
   RegistryKey WARD = of("ward");
   RegistryKey ELEVEN = of("11");
   RegistryKey WAIT = of("wait");
   RegistryKey PIGSTEP = of("pigstep");
   RegistryKey OTHERSIDE = of("otherside");
   RegistryKey FIVE = of("5");
   RegistryKey RELIC = of("relic");
   RegistryKey PRECIPICE = of("precipice");
   RegistryKey CREATOR = of("creator");
   RegistryKey CREATOR_MUSIC_BOX = of("creator_music_box");
   RegistryKey TEARS = of("tears");
   RegistryKey LAVA_CHICKEN = of("lava_chicken");

   private static RegistryKey of(String id) {
      return RegistryKey.of(RegistryKeys.JUKEBOX_SONG, Identifier.ofVanilla(id));
   }

   private static void register(Registerable registry, RegistryKey key, RegistryEntry.Reference soundEvent, int lengthInSeconds, int comparatorOutput) {
   ...
   static void bootstrap(Registerable registry) {
      ...
      register(registry, TEARS, SoundEvents.MUSIC_DISC_TEARS, 175, 10);
      register(registry, LAVA_CHICKEN, SoundEvents.MUSIC_DISC_LAVA_CHICKEN, 134, 9);
   }
}
