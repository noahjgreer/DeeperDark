...
public class DeadCoralWallFanBlock extends DeadCoralFanBlock {
   public static final MapCodec CODEC = createCodec(DeadCoralWallFanBlock::new);
   ...
   static {
      ...
      SHAPES_BY_DIRECTION = VoxelShapes.createHorizontalFacingShapeMap(Block.createCuboidZShape(16.0, 8.0, 5.0, 16.0));
   }
}
