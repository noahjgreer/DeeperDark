...
OperatorBlock {
    ...
    public static boolean attachmentMatches(StructureTemplate.JigsawBlockInfo info1, StructureTemplate.JigsawBlockInfo info2) {
        Direction direction = JigsawBlock.getFacing(info1.info().state());
        Direction direction2 = JigsawBlock.getFacing(info2.info().state());
        Direction direction3 = JigsawBlock.getRotation(info1.info().state());
        Direction direction4 = JigsawBlock.getRotation(info2.info().state());
