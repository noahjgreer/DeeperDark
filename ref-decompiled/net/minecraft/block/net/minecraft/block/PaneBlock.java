...
extends HorizontalConnectingBlock {
    ...
    protected boolean isSideInvisible(BlockState state, BlockState stateFrom, Direction direction) {
        if (stateFrom.isOf(this) || stateFrom.isIn(BlockTags.BARS) && state.isIn(BlockTags.BARS) && stateFrom.contains((Property)FACING_PROPERTIES.get(direction.getOpposite()))) {
            if (!direction.getAxis().isHorizontal()) {
                return true;
            }
