...
extends AbstractPressurePlateBlock {
    public static final MapCodec<WeightedPressurePlateBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)Codec.intRange((int)1, (int)1024).fieldOf("max_weight").forGetter(block -> block.weight), (App)BlockSetType.CODEC.fieldOf("block_set_type").forGetter(block -> block.blockSetType), WeightedPressurePlateBlock.createSettingsCodec()).apply((Applicative)instance, WeightedPressurePlateBlock::new));
