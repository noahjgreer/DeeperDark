...
implements Waterloggable {
    ...
    protected ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player2, BlockHitResult hit) {
        ...
        if (world instanceof ServerWorld) {
            ...
            player2.openHandledScreen(new SimpleNamedScreenHandlerFactory((syncId, playerInventory, player) -> GenericContainerScreenHandler.createGeneric9x3(syncId, playerInventory, enderChestInventory), CONTAINER_NAME));
            player2.incrementStat(Stats.OPEN_ENDERCHEST);
            PiglinBrain.onGuardedBlockInteracted(serverWorld, player2, true);
        }
        return ActionResult.SUCCESS;
    }
