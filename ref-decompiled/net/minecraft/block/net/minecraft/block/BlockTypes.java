...
import net.minecraft.block.TestInstanceBlock;
...
public class BlockTypes {
    ...
    public static MapCodec<? extends Block> registerAndGetDefault(Registry<MapCodec<? extends Block>> registry) {
        ...
        Registry.register(registry, "weathering_copper_bar", OxidizablePaneBlock.CODEC);
        Registry.register(registry, "weathering_copper_bulb", OxidizableBulbBlock.CODEC);
        Registry.register(registry, "weathering_copper_chain", OxidizableChainBlock.CODEC);
        Registry.register(registry, "weathering_copper_chest", OxidizableCopperChestBlock.CODEC);
        ...
        Registry.register(registry, "weathering_copper_golem_statue", OxidizableCopperGolemStatueBlock.CODEC);
        ...
        Registry.register(registry, "weathering_lantern", OxidizableLanternBlock.CODEC);
        Registry.register(registry, "weathering_lightning_rod", OxidizableLightningRodBlock.CODEC);
