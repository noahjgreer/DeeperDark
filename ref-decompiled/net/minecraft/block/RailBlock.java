...
extends AbstractRailBlock {
    ...
    public RailBlock(AbstractBlock.Settings settings) {
        ...
        this.setDefaultState((BlockState)((BlockState)((BlockState)this.stateManager.getDefaultState()).with((Property)SHAPE, (Comparable)RailShape.NORTH_SOUTH)).with((Property)WATERLOGGED, (Comparable)Boolean.valueOf(false)));
    }
