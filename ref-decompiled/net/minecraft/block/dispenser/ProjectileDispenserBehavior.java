...
public class ProjectileDispenserBehavior extends ItemDispenserBehavior {
   ...
   public ItemStack dispenseSilently(BlockPointer pointer, ItemStack stack) {
      ...
      ProjectileEntity.spawnWithVelocity(this.projectile.createEntity(serverWorld, position, stack, direction), serverWorld, stack, (double)direction.getOffsetX(), (double)direction.getOffsetY(), (double)direction.getOffsetZ(), this.projectileSettings.power(), this.projectileSettings.uncertainty());
      stack.decrement(1);
      return stack;
   }
