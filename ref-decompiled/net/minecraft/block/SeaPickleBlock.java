...
public class SeaPickleBlock extends PlantBlock implements Fertilizable, Waterloggable {
   public static final MapCodec CODEC = createCodec(SeaPickleBlock::new);
   public static final int MAX_PICKLES = 4;
   public static final IntProperty PICKLES;
   public static final BooleanProperty WATERLOGGED;
   private static final VoxelShape ONE_PICKLE_SHAPE;
   private static final VoxelShape TWO_PICKLES_SHAPE;
   private static final VoxelShape THREE_PICKLES_SHAPE;
   private static final VoxelShape FOUR_PICKLES_SHAPE;
   ...
   protected VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
      ...
      switch ((Integer)state.get(PICKLES)) {
         case 2:
            var10000 = TWO_PICKLES_SHAPE;
            break;
         case 3:
            var10000 = THREE_PICKLES_SHAPE;
            break;
         case 4:
            var10000 = FOUR_PICKLES_SHAPE;
            break;
         default:
            var10000 = ONE_PICKLE_SHAPE;
      }
   ...
   static {
      ...
      ONE_PICKLE_SHAPE = Block.createColumnShape(4.0, 0.0, 6.0);
      TWO_PICKLES_SHAPE = Block.createColumnShape(10.0, 0.0, 6.0);
      THREE_PICKLES_SHAPE = Block.createColumnShape(12.0, 0.0, 6.0);
      FOUR_PICKLES_SHAPE = Block.createColumnShape(12.0, 0.0, 7.0);
   }
}
