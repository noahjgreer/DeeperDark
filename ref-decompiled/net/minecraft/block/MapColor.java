...
public class MapColor {
    private static final @Nullable MapColor[] COLORS = new MapColor[64];
    ...
    public int getRenderColor(Brightness brightness) {
        ...
        return ColorHelper.scaleRgb((int)ColorHelper.fullAlpha((int)this.color), (int)brightness.brightness);
    }

    public static MapColor get(int id) {
        Preconditions.checkPositionIndex((int)id, (int)COLORS.length, (String)"material id");
        return MapColor.getUnchecked((int)id);
    }
    ...
    public static int getRenderColor(int colorByte) {
        ...
        return MapColor.getUnchecked((int)(i >> 2)).getRenderColor(Brightness.get((int)(i & 3)));
    }
