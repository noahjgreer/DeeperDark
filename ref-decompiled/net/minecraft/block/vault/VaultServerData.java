...
public class VaultServerData {
    ...
    static Codec<VaultServerData> codec = RecordCodecBuilder.create(instance -> instance.group((App)Uuids.LINKED_SET_CODEC.lenientOptionalFieldOf("rewarded_players", Set.of()).forGetter(data -> data.rewardedPlayers), (App)Codec.LONG.lenientOptionalFieldOf("state_updating_resumes_at", (Object)0L).forGetter(data -> data.stateUpdatingResumesAt), (App)ItemStack.CODEC.listOf().lenientOptionalFieldOf("items_to_eject", List.of()).forGetter(data -> data.itemsToEject), (App)Codec.INT.lenientOptionalFieldOf("total_ejections_needed", (Object)0).forGetter(data -> data.totalEjectionsNeeded)).apply((Applicative)instance, VaultServerData::new));
    ...
    ItemStack getItemToDisplay() {
        ...
        return Objects.requireNonNullElse((ItemStack)this.itemsToEject.get(this.itemsToEject.size() - 1), ItemStack.EMPTY);
    }
    ...
    ItemStack getItemToEject() {
        ...
        this.markDirty();
        return Objects.requireNonNullElse((ItemStack)this.itemsToEject.remove(this.itemsToEject.size() - 1), ItemStack.EMPTY);
    }
    ...
    public float getEjectSoundPitchModifier() {
        ...
        return 1.0f - MathHelper.getLerpProgress((float)this.getItemsToEject().size(), (float)1.0f, (float)this.totalEjectionsNeeded);
    }
}
