...
public class OxidizableBulbBlock extends BulbBlock implements Oxidizable {
   public static final MapCodec CODEC = RecordCodecBuilder.mapCodec((instance) -> {
      return instance.group(Oxidizable.OxidationLevel.CODEC.fieldOf("weathering_state").forGetter(OxidizableBulbBlock::getDegradationLevel), createSettingsCodec()).apply(instance, OxidizableBulbBlock::new);
   });
