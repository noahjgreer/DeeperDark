...
extends Block {
    ...
    private Function<BlockState, VoxelShape> createShapeFunction(float radius) {
        ...
        Map map = VoxelShapes.createFacingShapeMap((VoxelShape)Block.createCuboidZShape((double)radius, (double)0.0, (double)8.0));
        return this.createShapeFunction(state -> {
            ...
            for (Map.Entry entry : FACING_PROPERTIES.entrySet()) {
                ...
                voxelShape2 = VoxelShapes.union((VoxelShape)((VoxelShape)map.get(entry.getKey())), (VoxelShape)voxelShape2);
            }
            return voxelShape2;
        });
    }
