...
public class WeightedPressurePlateBlock extends AbstractPressurePlateBlock {
   public static final MapCodec CODEC = RecordCodecBuilder.mapCodec((instance) -> {
      return instance.group(Codec.intRange(1, 1024).fieldOf("max_weight").forGetter((block) -> {
         return block.weight;
      }), BlockSetType.CODEC.fieldOf("block_set_type").forGetter((block) -> {
         return block.blockSetType;
      }), createSettingsCodec()).apply(instance, WeightedPressurePlateBlock::new);
   });
