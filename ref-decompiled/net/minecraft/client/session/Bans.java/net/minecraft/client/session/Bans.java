...
public class Bans {
    ...
    private static Text getReasonText(BanDetails banDetails) {
        ...
        if (StringUtils.isNumeric((CharSequence)string)) {
            ...
            Text text = banReason != null ? Texts.withStyle(banReason.getDescription(), Style.EMPTY.withBold(true)) : (string2 != null ? Text.translatable("gui.banned.description.reason_id_message", i, string2).formatted(Formatting.BOLD) : Text.translatable("gui.banned.description.reason_id", i).formatted(Formatting.BOLD));
