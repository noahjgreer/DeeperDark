...
public class WorldUnloadedEvent {
    ...
    public void send(TelemetrySender sender) {
        this.startTime.ifPresent(startTime -> sender.send(TelemetryEventType.WORLD_UNLOADED, builder -> {
            builder.put(TelemetryEventProperty.SECONDS_SINCE_LOAD, (Object)this.getSecondsSinceLoad(startTime));
            builder.put(TelemetryEventProperty.TICKS_SINCE_LOAD, (Object)((int)this.ticksSinceLoad));
        }));
    }
}
