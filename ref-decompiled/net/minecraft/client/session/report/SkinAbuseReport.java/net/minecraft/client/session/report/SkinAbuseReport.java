...
extends AbuseReport {
    ...
    extends AbuseReport.Builder<SkinAbuseReport> {
        ...
        public Either<AbuseReport.ReportWithId, AbuseReport.ValidationError> build(AbuseReportContext context) {
            ...
            com.mojang.authlib.minecraft.report.AbuseReport abuseReport = com.mojang.authlib.minecraft.report.AbuseReport.skin((String)((SkinAbuseReport)this.report).opinionComments, (String)string2, (String)string22, (ReportedEntity)reportedEntity, (Instant)((SkinAbuseReport)this.report).currentTime);
