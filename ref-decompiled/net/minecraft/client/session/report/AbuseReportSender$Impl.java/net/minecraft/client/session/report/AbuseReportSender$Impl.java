...
public record AbuseReportSender.Impl(ReporterEnvironment environment, UserApiService userApiService) implements AbuseReportSender
{
    ...
    public CompletableFuture<Unit> send(UUID id, AbuseReportType type, AbuseReport report) {
        return CompletableFuture.supplyAsync(() -> {
            ...
            try {
                ...
                throw new CompletionException(new AbuseReportSender.AbuseReportException(text, (Throwable)minecraftClientHttpException));
            }
            catch (MinecraftClientException minecraftClientException) {
                Text text = this.getErrorText(minecraftClientException);
                throw new CompletionException(new AbuseReportSender.AbuseReportException(text, (Throwable)minecraftClientException));
            }
