...
extends Enum<AbuseReportReason> {
    public static final /* enum */ AbuseReportReason I_WANT_TO_REPORT_THEM = new AbuseReportReason("i_want_to_report_them");
    ...
    public static final /* enum */ AbuseReportReason SEXUALLY_INAPPROPRIATE = new AbuseReportReason("sexually_inappropriate");
