...
extends RealmsScreen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float deltaTicks) {
        ...
        context.drawTextWithShadow(this.textRenderer, SENTENCE_ONE_TEXT, this.width / 2 - 120, RealmsTermsScreen.row(5), -1);
        ...
        context.drawTextWithShadow(this.textRenderer, SENTENCE_TWO_TEXT, this.width / 2 - 120 + i, RealmsTermsScreen.row(5), this.onLink ? -9670204 : -13408581);
    }
}
