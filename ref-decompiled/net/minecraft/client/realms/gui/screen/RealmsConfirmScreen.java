...
public class RealmsConfirmScreen extends RealmsScreen {
   ...
   public void render(DrawContext context, int mouseX, int mouseY, float deltaTicks) {
      ...
      context.drawCenteredTextWithShadow(this.textRenderer, (Text)this.title1, this.width / 2, row(3), -1);
      context.drawCenteredTextWithShadow(this.textRenderer, (Text)this.title2, this.width / 2, row(5), -1);
   }
}
