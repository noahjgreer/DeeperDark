...
extends RealmsScreen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float deltaTicks) {
        ...
        context.drawCenteredTextWithShadow(this.textRenderer, this.title1, this.width / 2, RealmsConfirmScreen.row(3), -1);
        context.drawCenteredTextWithShadow(this.textRenderer, this.title2, this.width / 2, RealmsConfirmScreen.row(5), -1);
    }
}
