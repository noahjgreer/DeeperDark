...
extends RealmsScreen {
    ...
    public void init() {
        ...
        MutableText text = Text.translatable("mco.account.privacy.info.button");
        directionalLayoutWidget.add(ButtonWidget.builder(text, ConfirmLinkScreen.opening((Screen)this, Urls.GDPR)).build());
