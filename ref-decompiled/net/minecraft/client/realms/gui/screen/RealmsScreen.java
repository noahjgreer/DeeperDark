...
extends Screen {
    ...
    protected static final Identifier REALMS_LOGO_TEXTURE = Identifier.ofVanilla((String)"textures/gui/title/realms.png");
    ...
    protected RealmsLabel addLabel(RealmsLabel label) {
        ...
        return (RealmsLabel)this.addDrawable((Drawable)label);
    }

    public Text narrateLabels() {
        return ScreenTexts.joinLines((Collection)this.labels.stream().map(RealmsLabel::getText).collect(Collectors.toList()));
    }

    protected static IconWidget createRealmsLogoIconWidget() {
        return IconWidget.create((int)128, (int)34, (Identifier)REALMS_LOGO_TEXTURE, (int)128, (int)64);
    }
}
