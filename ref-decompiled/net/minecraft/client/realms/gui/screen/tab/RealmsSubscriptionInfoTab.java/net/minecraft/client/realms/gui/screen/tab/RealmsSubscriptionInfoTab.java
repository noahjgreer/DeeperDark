...
implements RealmsUpdatableTab {
    ...
    RealmsSubscriptionInfoTab(RealmsConfigureWorldScreen screen, MinecraftClient client, RealmsServer server) {
        ...
        adder.add(new TextWidget(200, textRenderer.fontHeight, SUBSCRIPTION_START_LABEL_TEXT, textRenderer));
        this.startDateTextWidget = adder.add(new TextWidget(200, textRenderer.fontHeight, this.startDate, textRenderer));
        adder.add(EmptyWidget.ofHeight(2));
        this.timeLeftLabelTextWidget = adder.add(new TextWidget(200, textRenderer.fontHeight, TIME_LEFT_LABEL_TEXT, textRenderer));
        this.daysLeftTextWidget = adder.add(new TextWidget(200, textRenderer.fontHeight, this.daysLeft, textRenderer));
        adder.add(EmptyWidget.ofHeight(2));
        ...
        adder.add(EmptyWidget.ofHeight(2));
        this.subscriptionInfoTextWidget = adder.add(NarratedMultilineTextWidget.builder(Text.empty(), textRenderer).width(200).build(), Positioner.create().alignHorizontalCenter());
