...
public class RealmsInviteScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.inviteButton = (ButtonWidget)directionalLayoutWidget.add(ButtonWidget.builder(INVITE_TEXT, (button) -> {
         this.onInvite();
      }).width(200).build());
      ...
      if (this.inviteButton != null && this.nameWidget != null) {
         if (StringHelper.isBlank(this.nameWidget.getText())) {
            ...
            CompletableFuture.supplyAsync(() -> {
               return this.configureScreen.invite(l, string);
            }, Util.getIoWorkerExecutor()).thenAcceptAsync((success) -> {
               if (success) {
   ...
   public void render(DrawContext context, int mouseX, int mouseY, float deltaTicks) {
      ...
      if (this.errorMessage != null && this.inviteButton != null) {
         context.drawCenteredTextWithShadow(this.textRenderer, (Text)this.errorMessage, this.width / 2, this.inviteButton.getY() + this.inviteButton.getHeight() + 8, -1);
      }
