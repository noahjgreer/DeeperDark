...
public class RealmsDownloadLatestWorldScreen extends RealmsScreen {
   ...
   public void render(DrawContext context, int mouseX, int mouseY, float deltaTicks) {
      ...
      context.drawCenteredTextWithShadow(this.textRenderer, (Text)this.downloadTitle, this.width / 2, 20, -1);
      ...
      if (this.downloadError != null) {
         context.drawCenteredTextWithShadow(this.textRenderer, (Text)this.downloadError, this.width / 2, 110, -65536);
      }
   ...
   private void drawDots(DrawContext context) {
      ...
      context.drawTextWithShadow(this.textRenderer, (String)DOTS[this.dotIndex % DOTS.length], this.width / 2 + i / 2 + 5, 50, -1);
   }
   ...
   private void drawProgressBar(DrawContext context) {
      ...
      context.drawCenteredTextWithShadow(this.textRenderer, (Text)Text.translatable("mco.download.percent", this.progress), this.width / 2, 84, -1);
   }
   ...
   private void drawDownloadSpeed0(DrawContext context, long bytesPerSecond) {
      if (bytesPerSecond > 0L) {
         ...
         context.drawTextWithShadow(this.textRenderer, (Text)Text.translatable("mco.download.speed", SizeUnit.getUserFriendlyString(bytesPerSecond)), this.width / 2 + i / 2 + 15, 84, -1);
      }
