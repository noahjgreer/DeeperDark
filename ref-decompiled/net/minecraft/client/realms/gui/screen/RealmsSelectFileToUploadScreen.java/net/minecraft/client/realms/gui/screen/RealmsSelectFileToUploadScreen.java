...
extends RealmsScreen {
    ...
    public void init() {
        ...
        this.field_62100 = directionalLayoutWidget.add(new TextFieldWidget(this.textRenderer, this.width / 2 - 100, 22, 200, 20, this.field_62100, Text.translatable("selectWorld.search")));
        ...
        this.uploadButton = directionalLayoutWidget2.add(ButtonWidget.builder(Text.translatable("mco.upload.button.name"), buttonWidget -> this.worldSelectionList.getSelectedAsOptional().ifPresent(this::upload)).build());
