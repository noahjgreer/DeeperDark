...
public class RealmsConnectingScreen extends RealmsLongRunningMcoTaskScreen {
   ...
   public void init() {
      ...
      if (this.serverAddress.regionData() != null && this.serverAddress.regionData().region() != null) {
         ...
         TextWidget textWidget = new TextWidget(Text.translatable("mco.connect.region", Text.translatable(this.serverAddress.regionData().region().translationKey)), this.textRenderer);
         ...
         directionalLayoutWidget.add(IconWidget.create(10, 8, identifier), (Consumer)(Positioner::alignTop));
         this.footerLayout.add(directionalLayoutWidget, (Consumer)((positioner) -> {
            positioner.marginTop(40);
         }));
