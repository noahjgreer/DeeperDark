...
public class RealmsPopups {
    ...
    private static final Text INFO_TEXT = Text.translatable((String)"mco.info").withColor(8226750);
    private static final Text WARNING_TEXT = Text.translatable((String)"mco.warning").withColor(-65536);
