...
public class WorldTemplate extends ValueObject {
   ...
   public static WorldTemplate parse(JsonObject node) {
      ...
      try {
         ...
         worldTemplate.image = JsonUtils.getNullableStringOr("image", node, (String)null);
         ...
         worldTemplate.type = WorldTemplate.WorldTemplateType.valueOf(JsonUtils.getNullableStringOr("type", node, WorldTemplate.WorldTemplateType.WORLD_TEMPLATE.name()));
