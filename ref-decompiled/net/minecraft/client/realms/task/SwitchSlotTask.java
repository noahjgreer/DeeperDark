...
extends LongRunningTask {
    ...
    private static final Text TITLE = Text.translatable((String)"mco.minigame.world.slot.screen.title");
    ...
    public void run() {
        ...
        for (int i = 0; i < 25; ++i) {
            try {
                ...
                SwitchSlotTask.pause((long)retryCallException.delaySeconds);
                continue;
            }
