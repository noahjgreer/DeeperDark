...
extends LongRunningTask {
    ...
    private static final Text TITLE = Text.translatable((String)"mco.minigame.world.starting.screen.title");
    ...
    public void run() {
        ...
        for (int i = 0; i < 25; ++i) {
            try {
                ...
                SwitchMinigameTask.setScreen((Screen)this.field_60863);
                break;
            }
                ...
                SwitchMinigameTask.pause((long)retryCallException.delaySeconds);
                continue;
            }
