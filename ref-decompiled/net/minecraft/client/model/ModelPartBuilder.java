...
public class ModelPartBuilder {
    ...
    public ModelPartBuilder cuboid(String name, float offsetX, float offsetY, float offsetZ, int sizeX, int sizeY, int sizeZ, Dilation extra, int textureX, int textureY) {
        ...
        this.cuboidData.add(new ModelCuboidData(name, (float)this.textureX, (float)this.textureY, offsetX, offsetY, offsetZ, (float)sizeX, (float)sizeY, (float)sizeZ, extra, this.mirror, 1.0f, 1.0f, ALL_DIRECTIONS));
        return this;
    }
    ...
    public ModelPartBuilder cuboid(String name, float offsetX, float offsetY, float offsetZ, int sizeX, int sizeY, int sizeZ, int textureX, int textureY) {
        this.uv(textureX, textureY);
        this.cuboidData.add(new ModelCuboidData(name, (float)this.textureX, (float)this.textureY, offsetX, offsetY, offsetZ, (float)sizeX, (float)sizeY, (float)sizeZ, Dilation.NONE, this.mirror, 1.0f, 1.0f, ALL_DIRECTIONS));
        return this;
    }

    public ModelPartBuilder cuboid(float offsetX, float offsetY, float offsetZ, float sizeX, float sizeY, float sizeZ) {
        this.cuboidData.add(new ModelCuboidData(null, (float)this.textureX, (float)this.textureY, offsetX, offsetY, offsetZ, sizeX, sizeY, sizeZ, Dilation.NONE, this.mirror, 1.0f, 1.0f, ALL_DIRECTIONS));
        return this;
    }
    ...
    public ModelPartBuilder cuboid(float offsetX, float offsetY, float offsetZ, float sizeX, float sizeY, float sizeZ, Set<Direction> directions) {
        this.cuboidData.add(new ModelCuboidData(null, (float)this.textureX, (float)this.textureY, offsetX, offsetY, offsetZ, sizeX, sizeY, sizeZ, Dilation.NONE, this.mirror, 1.0f, 1.0f, directions));
        return this;
    }

    public ModelPartBuilder cuboid(String name, float offsetX, float offsetY, float offsetZ, float sizeX, float sizeY, float sizeZ) {
        this.cuboidData.add(new ModelCuboidData(name, (float)this.textureX, (float)this.textureY, offsetX, offsetY, offsetZ, sizeX, sizeY, sizeZ, Dilation.NONE, this.mirror, 1.0f, 1.0f, ALL_DIRECTIONS));
        return this;
    }
    ...
    public ModelPartBuilder cuboid(String name, float offsetX, float offsetY, float offsetZ, float sizeX, float sizeY, float sizeZ, Dilation extra) {
        this.cuboidData.add(new ModelCuboidData(name, (float)this.textureX, (float)this.textureY, offsetX, offsetY, offsetZ, sizeX, sizeY, sizeZ, extra, this.mirror, 1.0f, 1.0f, ALL_DIRECTIONS));
        return this;
    }
    ...
    public ModelPartBuilder cuboid(float offsetX, float offsetY, float offsetZ, float sizeX, float sizeY, float sizeZ, boolean mirror) {
        this.cuboidData.add(new ModelCuboidData(null, (float)this.textureX, (float)this.textureY, offsetX, offsetY, offsetZ, sizeX, sizeY, sizeZ, Dilation.NONE, mirror, 1.0f, 1.0f, ALL_DIRECTIONS));
        return this;
    }
    ...
    public ModelPartBuilder cuboid(float offsetX, float offsetY, float offsetZ, float sizeX, float sizeY, float sizeZ, Dilation extra, float textureScaleX, float textureScaleY) {
        this.cuboidData.add(new ModelCuboidData(null, (float)this.textureX, (float)this.textureY, offsetX, offsetY, offsetZ, sizeX, sizeY, sizeZ, extra, this.mirror, textureScaleX, textureScaleY, ALL_DIRECTIONS));
        return this;
    }
    ...
    public ModelPartBuilder cuboid(float offsetX, float offsetY, float offsetZ, float sizeX, float sizeY, float sizeZ, Dilation extra) {
        this.cuboidData.add(new ModelCuboidData(null, (float)this.textureX, (float)this.textureY, offsetX, offsetY, offsetZ, sizeX, sizeY, sizeZ, extra, this.mirror, 1.0f, 1.0f, ALL_DIRECTIONS));
        return this;
    }

    public List<ModelCuboidData> build() {
        return ImmutableList.copyOf((Collection)this.cuboidData);
    }
