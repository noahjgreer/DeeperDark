...
public class TextureTransform {
    ...
    public static final TextureTransform GLINT_TEXTURING = new TextureTransform("glint_texturing", () -> TextureTransform.getGlintTransformation(8.0f));
    public static final TextureTransform ENTITY_GLINT_TEXTURING = new TextureTransform("entity_glint_texturing", () -> TextureTransform.getGlintTransformation(0.5f));
    public static final TextureTransform ARMOR_ENTITY_GLINT_TEXTURING = new TextureTransform("armor_entity_glint_texturing", () -> TextureTransform.getGlintTransformation(0.16f));
    ...
    public Matrix4f getTransformSupplier() {
        return this.transformSupplier.get();
    }
