 ...
 *  net.minecraft.client.render.item.model.special.SignModelRenderer
...
implements SimpleSpecialModelRenderer {
    ...
    public void render(ItemDisplayContext displayContext, MatrixStack matrices, OrderedRenderCommandQueue queue, int light, int overlay, boolean glint, int i) {
        SignBlockEntityRenderer.renderAsItem((SpriteHolder)this.spriteHolder, (MatrixStack)matrices, (OrderedRenderCommandQueue)queue, (int)light, (int)overlay, (Model.SinglePartModel)this.model, (SpriteIdentifier)this.texture);
    }

    public void collectVertices(Consumer<Vector3fc> consumer) {
        MatrixStack matrixStack = new MatrixStack();
        SignBlockEntityRenderer.setTransformsForItem((MatrixStack)matrixStack);
