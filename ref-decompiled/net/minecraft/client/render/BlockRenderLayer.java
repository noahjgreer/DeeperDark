...
extends Enum<BlockRenderLayer> {
    public static final /* enum */ BlockRenderLayer SOLID = new BlockRenderLayer("SOLID", 0, RenderPipelines.SOLID_TERRAIN, 0x400000, false);
    public static final /* enum */ BlockRenderLayer CUTOUT = new BlockRenderLayer("CUTOUT", 1, RenderPipelines.CUTOUT_TERRAIN, 0x400000, false);
    public static final /* enum */ BlockRenderLayer TRANSLUCENT = new BlockRenderLayer("TRANSLUCENT", 2, RenderPipelines.TRANSLUCENT, 786432, true);
    public static final /* enum */ BlockRenderLayer TRIPWIRE = new BlockRenderLayer("TRIPWIRE", 3, RenderPipelines.TRIPWIRE_TERRAIN, 1536, true);
