...
public class WorldBorderRendering {
    ...
    public void render(WorldBorderRenderState state, Vec3d cameraPos, double viewDistanceBlocks, double farPlaneDistance) {
        ...
        float g = (float)ColorHelper.getRed(state.tint) / 255.0f;
        float h = (float)ColorHelper.getGreen(state.tint) / 255.0f;
        float i = (float)ColorHelper.getBlue(state.tint) / 255.0f;
