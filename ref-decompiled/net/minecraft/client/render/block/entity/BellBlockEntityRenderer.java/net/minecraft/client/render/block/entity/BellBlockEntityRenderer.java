...
implements BlockEntityRenderer<BellBlockEntity, BellBlockEntityRenderState> {
    ...
    @Override
    public void updateRenderState(BellBlockEntity bellBlockEntity, BellBlockEntityRenderState bellBlockEntityRenderState, float f, Vec3d vec3d,  @Nullable ModelCommandRenderer.CrumblingOverlayCommand crumblingOverlayCommand) {
    ...
    public void render(BellBlockEntityRenderState bellBlockEntityRenderState, MatrixStack matrixStack, OrderedRenderCommandQueue orderedRenderCommandQueue, CameraRenderState cameraRenderState) {
        ...
        orderedRenderCommandQueue.submitModel(this.bellBody, bellModelState, matrixStack, renderLayer, bellBlockEntityRenderState.lightmapCoordinates, OverlayTexture.DEFAULT_UV, -1, this.materials.getSprite(BELL_BODY_TEXTURE), 0, bellBlockEntityRenderState.crumblingOverlay);
    }
