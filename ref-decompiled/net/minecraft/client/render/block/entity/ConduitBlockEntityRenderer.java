...
public class ConduitBlockEntityRenderer implements BlockEntityRenderer {
   public static final SpriteMapper SPRITE_MAPPER;
   ...
   public void render(ConduitBlockEntity conduitBlockEntity, float f, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i, int j, Vec3d vec3d) {
      ...
      if (!conduitBlockEntity.isActive()) {
         h = conduitBlockEntity.getRotation(0.0F);
         ...
         h = conduitBlockEntity.getRotation(f) * 57.295776F;
   ...
   static {
      SPRITE_MAPPER = new SpriteMapper(SpriteAtlasTexture.BLOCK_ATLAS_TEXTURE, "entity/conduit");
      BASE_TEXTURE = SPRITE_MAPPER.mapVanilla("base");
      CAGE_TEXTURE = SPRITE_MAPPER.mapVanilla("cage");
      WIND_TEXTURE = SPRITE_MAPPER.mapVanilla("wind");
      WIND_VERTICAL_TEXTURE = SPRITE_MAPPER.mapVanilla("wind_vertical");
      OPEN_EYE_TEXTURE = SPRITE_MAPPER.mapVanilla("open_eye");
      CLOSED_EYE_TEXTURE = SPRITE_MAPPER.mapVanilla("closed_eye");
   }
}
