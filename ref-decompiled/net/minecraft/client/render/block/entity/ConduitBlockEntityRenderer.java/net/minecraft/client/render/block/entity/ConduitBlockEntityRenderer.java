...
implements BlockEntityRenderer<ConduitBlockEntity, ConduitBlockEntityRenderState> {
    ...
    @Override
    public void updateRenderState(ConduitBlockEntity conduitBlockEntity, ConduitBlockEntityRenderState conduitBlockEntityRenderState, float f, Vec3d vec3d,  @Nullable ModelCommandRenderer.CrumblingOverlayCommand crumblingOverlayCommand) {
