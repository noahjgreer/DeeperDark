...
implements BlockEntityRenderer<TestInstanceBlockEntity, TestInstanceBlockEntityRenderState> {
    ...
    @Override
    public void updateRenderState(TestInstanceBlockEntity testInstanceBlockEntity, TestInstanceBlockEntityRenderState testInstanceBlockEntityRenderState, float f, Vec3d vec3d,  @Nullable ModelCommandRenderer.CrumblingOverlayCommand crumblingOverlayCommand) {
