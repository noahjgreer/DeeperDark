...
public class PathfindingDebugRenderer implements DebugRenderer.Renderer {
   ...
   public static void drawPath(MatrixStack matrices, VertexConsumerProvider vertexConsumers, Path path, float nodeSize, boolean drawDebugNodes, boolean drawLabels, double cameraX, double cameraY, double cameraZ) {
      ...
      if (getManhattanDistance(blockPos, cameraX, cameraY, cameraZ) <= 80.0F) {
         DebugRenderer.drawBox(matrices, vertexConsumers, (new Box((double)((float)blockPos.getX() + 0.25F), (double)((float)blockPos.getY() + 0.25F), (double)blockPos.getZ() + 0.25, (double)((float)blockPos.getX() + 0.75F), (double)((float)blockPos.getY() + 0.75F), (double)((float)blockPos.getZ() + 0.75F))).offset(-cameraX, -cameraY, -cameraZ), 0.0F, 1.0F, 0.0F, 0.5F);
         ...
         for(int i = 0; i < path.getLength(); ++i) {
            ...
            if (getManhattanDistance(pathNode.getBlockPos(), cameraX, cameraY, cameraZ) <= 80.0F) {
               ...
               DebugRenderer.drawBox(matrices, vertexConsumers, (new Box((double)((float)pathNode.x + 0.5F - nodeSize), (double)((float)pathNode.y + 0.01F * (float)i), (double)((float)pathNode.z + 0.5F - nodeSize), (double)((float)pathNode.x + 0.5F + nodeSize), (double)((float)pathNode.y + 0.25F + 0.01F * (float)i), (double)((float)pathNode.z + 0.5F + nodeSize))).offset(-cameraX, -cameraY, -cameraZ), f, 0.0F, g, 0.5F);
            }
         }
      }
      ...
      if (drawDebugNodes && debugNodeInfo != null) {
         PathNode[] var19 = debugNodeInfo.closedSet();
         int var21 = var19.length;

         PathNode pathNode2;
         int var23;
         for(var23 = 0; var23 < var21; ++var23) {
            pathNode2 = var19[var23];
            if (getManhattanDistance(pathNode2.getBlockPos(), cameraX, cameraY, cameraZ) <= 80.0F) {
               DebugRenderer.drawBox(matrices, vertexConsumers, (new Box((double)((float)pathNode2.x + 0.5F - nodeSize / 2.0F), (double)((float)pathNode2.y + 0.01F), (double)((float)pathNode2.z + 0.5F - nodeSize / 2.0F), (double)((float)pathNode2.x + 0.5F + nodeSize / 2.0F), (double)pathNode2.y + 0.1, (double)((float)pathNode2.z + 0.5F + nodeSize / 2.0F))).offset(-cameraX, -cameraY, -cameraZ), 1.0F, 0.8F, 0.8F, 0.5F);
            }
         }

         var19 = debugNodeInfo.openSet();
         var21 = var19.length;

         for(var23 = 0; var23 < var21; ++var23) {
            pathNode2 = var19[var23];
            if (getManhattanDistance(pathNode2.getBlockPos(), cameraX, cameraY, cameraZ) <= 80.0F) {
               DebugRenderer.drawBox(matrices, vertexConsumers, (new Box((double)((float)pathNode2.x + 0.5F - nodeSize / 2.0F), (double)((float)pathNode2.y + 0.01F), (double)((float)pathNode2.z + 0.5F - nodeSize / 2.0F), (double)((float)pathNode2.x + 0.5F + nodeSize / 2.0F), (double)pathNode2.y + 0.1, (double)((float)pathNode2.z + 0.5F + nodeSize / 2.0F))).offset(-cameraX, -cameraY, -cameraZ), 0.8F, 1.0F, 1.0F, 0.5F);
            }
         }
      }
      ...
      if (drawLabels) {
         for(int j = 0; j < path.getLength(); ++j) {
            ...
            if (getManhattanDistance(pathNode3.getBlockPos(), cameraX, cameraY, cameraZ) <= 80.0F) {
               DebugRenderer.drawString(matrices, vertexConsumers, String.valueOf(pathNode3.type), (double)pathNode3.x + 0.5, (double)pathNode3.y + 0.75, (double)pathNode3.z + 0.5, -1, 0.02F, true, 0.0F, true);
               DebugRenderer.drawString(matrices, vertexConsumers, String.format(Locale.ROOT, "%.2f", pathNode3.penalty), (double)pathNode3.x + 0.5, (double)pathNode3.y + 0.25, (double)pathNode3.z + 0.5, -1, 0.02F, true, 0.0F, true);
            }
         }
      }
