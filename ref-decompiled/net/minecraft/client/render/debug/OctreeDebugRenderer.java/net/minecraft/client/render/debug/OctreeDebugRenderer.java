...
implements DebugRenderer.Renderer {
    ...
    private void renderNode(Octree.Node node, int i, boolean bl, MutableInt mutableInt, boolean bl2) {
        ...
        long m = l + 5L;
        GizmoDrawing.box(box.contract(0.1 * (double)i), DrawStyle.stroked(ColorHelper.fromFloats(bl ? 0.4f : 1.0f, OctreeDebugRenderer.getColorComponent(m, 0.3f), OctreeDebugRenderer.getColorComponent(m, 0.8f), OctreeDebugRenderer.getColorComponent(m, 0.5f))));
    }
