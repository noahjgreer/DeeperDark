            ...
            for (ChunkBuilder.BuiltChunk builtChunk : worldRenderer.getBuiltChunks()) {
                ...
                if (bl) {
                    ...
                    for (int j = 0; j < DIRECTIONS.length; ++j) {
                        ...
                        GizmoDrawing.line(Vec3d.add(blockPos, 8.0, 8.0, 8.0), Vec3d.add(blockPos, 8 - 16 * direction.getOffsetX(), 8 - 16 * direction.getOffsetY(), 8 - 16 * direction.getOffsetZ()), ColorHelper.fullAlpha(i));
                    }
                }
                ...
                for (Direction direction2 : DIRECTIONS) {
                    for (Direction direction3 : DIRECTIONS) {
                        ...
                        if (bl3) continue;
                        ++i;
                        GizmoDrawing.line(Vec3d.add(blockPos, 8 + 8 * direction2.getOffsetX(), 8 + 8 * direction2.getOffsetY(), 8 + 8 * direction2.getOffsetZ()), Vec3d.add(blockPos, 8 + 8 * direction3.getOffsetX(), 8 + 8 * direction3.getOffsetY(), 8 + 8 * direction3.getOffsetZ()), ColorHelper.getArgb(255, 255, 0, 0));
                    }
                }
                if (i <= 0) continue;
                float f = 0.5f;
