...
public class Frustum {
   ...
   public Frustum coverBoxAroundSetPosition(int boxSize) {
      ...
      for(double i = Math.ceil(this.z / (double)boxSize) * (double)boxSize; this.frustumIntersection.intersectAab((float)(d - this.x), (float)(e - this.y), (float)(f - this.z), (float)(g - this.x), (float)(h - this.y), (float)(i - this.z)) != -2; this.z -= (double)(this.recession.z() * 4.0F)) {
