...
public class MissingModel {
   ...
   public static UnbakedModel create() {
      ...
      Map map = Util.mapEnum(Direction.class, (direction) -> {
         return new ModelElementFace(direction, -1, "missingno", uV, AxisRotation.R0);
      });
      ModelElement modelElement = new ModelElement(new Vector3f(0.0F, 0.0F, 0.0F), new Vector3f(16.0F, 16.0F, 16.0F), map);
      return new JsonUnbakedModel(new UnbakedGeometry(List.of(modelElement)), (UnbakedModel.GuiLight)null, (Boolean)null, ModelTransformation.NONE, (new ModelTextures.Textures.Builder()).addTextureReference("particle", "missingno").addSprite("missingno", new SpriteIdentifier(SpriteAtlasTexture.BLOCK_ATLAS_TEXTURE, MissingSprite.getMissingSpriteId())).build(), (Identifier)null);
   }
}
