...
public record ModelElement(Vector3fc from, Vector3fc to, Map<Direction, ModelElementFace> faces, @Nullable ModelElementRotation rotation, boolean shade, int lightEmission) {
    ...
    implements JsonDeserializer<ModelElement> {
        ...
        public ModelElement deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext jsonDeserializationContext) throws JsonParseException {
            ...
            Vector3f vector3f = Deserializer.deserializeFromTo(jsonObject, FROM_KEY);
            Vector3f vector3f2 = Deserializer.deserializeFromTo(jsonObject, TO_KEY);
        ...
        private @Nullable ModelElementRotation deserializeRotation(JsonObject object) {
            if (object.has(ROTATION_KEY)) {
                ...
                Vector3f vector3f = Deserializer.deserializeVec3f(jsonObject, ORIGIN_KEY);
        ...
        private static Vector3f deserializeFromTo(JsonObject json, String key) {
            Vector3f vector3f = Deserializer.deserializeVec3f(json, key);
