...
public enum ChunkBuilderMode implements TranslatableOption {
   ...
   private static final IntFunction BY_ID = ValueLists.createIndexToValueFunction(ChunkBuilderMode::getId, values(), (ValueLists.OutOfBoundsHandling)ValueLists.OutOfBoundsHandling.WRAP);
