...
extends Enum<ChunkBuilderMode> {
    public static final /* enum */ ChunkBuilderMode NONE = new ChunkBuilderMode("NONE", 0, 0, "options.prioritizeChunkUpdates.none");
    public static final /* enum */ ChunkBuilderMode PLAYER_AFFECTED = new ChunkBuilderMode("PLAYER_AFFECTED", 1, 1, "options.prioritizeChunkUpdates.byPlayer");
    public static final /* enum */ ChunkBuilderMode NEARBY = new ChunkBuilderMode("NEARBY", 2, 2, "options.prioritizeChunkUpdates.nearby");
    ...
    private ChunkBuilderMode(int id, String name) {
        this.id = id;
        this.text = Text.translatable((String)name);
    }
    ...
    static {
        ...
        BY_ID = ValueLists.createIndexToValueFunction(chunkBuilderMode -> chunkBuilderMode.id, (Object[])ChunkBuilderMode.values(), (ValueLists.OutOfBoundsHandling)ValueLists.OutOfBoundsHandling.WRAP);
