...
public class BuiltChunkStorage {
        ...
        for (int j = 0; j < this.sizeX; ++j) {
            for (int k = 0; k < this.sizeY; ++k) {
                for (int l = 0; l < this.sizeZ; ++l) {
                    ...
                    this.chunks[m] = new ChunkBuilder.BuiltChunk(chunkBuilder2, m, ChunkSectionPos.asLong(j, k + this.world.getBottomSectionCoord(), l));
                }
            }
        }
    }
    ...
    protected @Nullable ChunkBuilder.BuiltChunk getRenderedChunk(BlockPos blockPos) {
        return this.getRenderedChunk(ChunkSectionPos.toLong(blockPos));
    }

    protected @Nullable ChunkBuilder.BuiltChunk getRenderedChunk(long sectionPos) {
    ...
    private @Nullable ChunkBuilder.BuiltChunk getRenderedChunk(int sectionX, int sectionY, int sectionZ) {
