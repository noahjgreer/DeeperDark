...
extends AbstractHorseEntityRenderer<HorseEntity, HorseEntityRenderState, HorseEntityModel> {
    ...
    public HorseEntityRenderer(EntityRendererFactory.Context context) {
        ...
        this.addFeature(new SaddleFeatureRenderer<HorseEntityRenderState, HorseEntityModel, HorseEntityModel>(this, context.getEquipmentRenderer(), EquipmentModel.LayerType.HORSE_BODY, state -> state.armorStack, new HorseEntityModel(context.getPart(EntityModelLayers.HORSE_ARMOR)), new HorseEntityModel(context.getPart(EntityModelLayers.HORSE_ARMOR_BABY)), 2));
        this.addFeature(new SaddleFeatureRenderer<HorseEntityRenderState, HorseEntityModel, HorseSaddleEntityModel>(this, context.getEquipmentRenderer(), EquipmentModel.LayerType.HORSE_SADDLE, state -> state.saddleStack, new HorseSaddleEntityModel(context.getPart(EntityModelLayers.HORSE_SADDLE)), new HorseSaddleEntityModel(context.getPart(EntityModelLayers.HORSE_BABY_SADDLE)), 2));
    }
