...
public final class HorseEntityRenderer extends AbstractHorseEntityRenderer {
   ...
   public HorseEntityRenderer(EntityRendererFactory.Context context) {
      ...
      this.addFeature(new SaddleFeatureRenderer(this, context.getEquipmentRenderer(), EquipmentModel.LayerType.HORSE_BODY, (horseEntityRenderState) -> {
         return horseEntityRenderState.armor;
      }, new HorseEntityModel(context.getPart(EntityModelLayers.HORSE_ARMOR)), new HorseEntityModel(context.getPart(EntityModelLayers.HORSE_ARMOR_BABY))));
      this.addFeature(new SaddleFeatureRenderer(this, context.getEquipmentRenderer(), EquipmentModel.LayerType.HORSE_SADDLE, (horseEntityRenderState) -> {
         return horseEntityRenderState.saddleStack;
      }, new HorseSaddleEntityModel(context.getPart(EntityModelLayers.HORSE_SADDLE)), new HorseSaddleEntityModel(context.getPart(EntityModelLayers.HORSE_BABY_SADDLE))));
   }
