...
public class DrownedEntityRenderer extends ZombieBaseEntityRenderer {
   ...
   protected BipedEntityModel.ArmPose getArmPose(DrownedEntity drownedEntity, Arm arm) {
      ...
      return drownedEntity.getMainArm() == arm && drownedEntity.isAttacking() && itemStack.isOf(Items.TRIDENT) ? BipedEntityModel.ArmPose.THROW_SPEAR : BipedEntityModel.ArmPose.EMPTY;
   }
