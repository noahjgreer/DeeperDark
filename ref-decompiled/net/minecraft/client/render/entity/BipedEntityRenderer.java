...
public abstract class BipedEntityRenderer extends AgeableMobEntityRenderer {
   public BipedEntityRenderer(EntityRendererFactory.Context context, BipedEntityModel model, float shadowRadius) {
      this(context, model, model, shadowRadius);
   }

   public BipedEntityRenderer(EntityRendererFactory.Context context, BipedEntityModel model, BipedEntityModel babyModel, float scale) {
      this(context, model, babyModel, scale, HeadFeatureRenderer.HeadTransformation.DEFAULT);
   }

   public BipedEntityRenderer(EntityRendererFactory.Context context, BipedEntityModel model, BipedEntityModel babyModel, float scale, HeadFeatureRenderer.HeadTransformation headTransformation) {
   ...
   protected BipedEntityModel.ArmPose getArmPose(MobEntity entity, Arm arm) {
      return BipedEntityModel.ArmPose.EMPTY;
   }

   public void updateRenderState(MobEntity mobEntity, BipedEntityRenderState bipedEntityRenderState, float f) {
