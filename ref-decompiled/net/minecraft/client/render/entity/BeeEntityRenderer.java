...
extends AgeableMobEntityRenderer<BeeEntity, BeeEntityRenderState, BeeEntityModel> {
    private static final Identifier ANGRY_TEXTURE = Identifier.ofVanilla((String)"textures/entity/bee/bee_angry.png");
    private static final Identifier ANGRY_NECTAR_TEXTURE = Identifier.ofVanilla((String)"textures/entity/bee/bee_angry_nectar.png");
    private static final Identifier PASSIVE_TEXTURE = Identifier.ofVanilla((String)"textures/entity/bee/bee.png");
    private static final Identifier NECTAR_TEXTURE = Identifier.ofVanilla((String)"textures/entity/bee/bee_nectar.png");

    public BeeEntityRenderer(EntityRendererFactory.Context context) {
        super(context, (EntityModel)new BeeEntityModel(context.getPart(EntityModelLayers.BEE)), (EntityModel)new BeeEntityModel(context.getPart(EntityModelLayers.BEE_BABY)), 0.4f);
    }
    ...
    public void updateRenderState(BeeEntity beeEntity, BeeEntityRenderState beeEntityRenderState, float f) {
        super.updateRenderState((LivingEntity)beeEntity, (LivingEntityRenderState)beeEntityRenderState, f);
