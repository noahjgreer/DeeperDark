...
public class TridentRiptideEntityModel extends EntityModel {
   ...
   public static TexturedModelData getTexturedModelData() {
      ...
      for(int i = 0; i < 2; ++i) {
         ...
         modelPartData.addChild(getPartName(i), ModelPartBuilder.create().uv(0, 0).cuboid(-8.0F, -16.0F + f, -8.0F, 16.0F, 32.0F, 16.0F), ModelTransform.NONE.withScale(g));
      }
   ...
   public void setAngles(PlayerEntityRenderState playerEntityRenderState) {
      ...
      for(int i = 0; i < this.parts.length; ++i) {
         ...
         this.parts[i].yaw = MathHelper.wrapDegrees(f) * 0.017453292F;
      }
