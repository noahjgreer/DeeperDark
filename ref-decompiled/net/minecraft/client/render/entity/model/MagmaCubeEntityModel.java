...
extends EntityModel<SlimeEntityRenderState> {
    ...
    public MagmaCubeEntityModel(ModelPart modelPart) {
        super(modelPart);
        Arrays.setAll(this.slices, i -> modelPart.getChild(MagmaCubeEntityModel.getSliceName((int)i)));
    }
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        for (int i = 0; i < 8; ++i) {
            ...
            modelPartData.addChild(MagmaCubeEntityModel.getSliceName((int)i), ModelPartBuilder.create().uv(j, k).cuboid(-4.0f, (float)(16 + i), -4.0f, 8.0f, 1.0f, 8.0f), ModelTransform.NONE);
        }
    ...
    public void setAngles(SlimeEntityRenderState slimeEntityRenderState) {
        super.setAngles((Object)slimeEntityRenderState);
