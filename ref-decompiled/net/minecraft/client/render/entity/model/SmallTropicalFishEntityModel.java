...
public class SmallTropicalFishEntityModel extends EntityModel {
   ...
   public static TexturedModelData getTexturedModelData(Dilation dilation) {
      ...
      int i = true;
      modelPartData.addChild("body", ModelPartBuilder.create().uv(0, 0).cuboid(-1.0F, -1.5F, -3.0F, 2.0F, 3.0F, 6.0F, dilation), ModelTransform.origin(0.0F, 22.0F, 0.0F));
      modelPartData.addChild("tail", ModelPartBuilder.create().uv(22, -6).cuboid(0.0F, -1.5F, 0.0F, 0.0F, 3.0F, 6.0F, dilation), ModelTransform.origin(0.0F, 22.0F, 3.0F));
      ...
      modelPartData.addChild("top_fin", ModelPartBuilder.create().uv(10, -5).cuboid(0.0F, -3.0F, 0.0F, 0.0F, 3.0F, 6.0F, dilation), ModelTransform.origin(0.0F, 20.5F, -3.0F));
