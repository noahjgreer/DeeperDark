...
extends EntityModel<T> {
    ...
    public static ModelData getModelData(Dilation dilation) {
        ...
        modelPartData.addChild("head", ModelPartBuilder.create().cuboid("main", -2.5f, -2.0f, -3.0f, 5.0f, 4.0f, 5.0f, dilation).cuboid("nose", -1.5f, -0.001f, -4.0f, 3, 2, 2, dilation, 0, 24).cuboid("ear1", -2.0f, -3.0f, 0.0f, 1, 1, 2, dilation, 0, 10).cuboid("ear2", 1.0f, -3.0f, 0.0f, 1, 1, 2, dilation, 6, 10), ModelTransform.origin((float)0.0f, (float)15.0f, (float)-9.0f));
        modelPartData.addChild("body", ModelPartBuilder.create().uv(20, 0).cuboid(-2.0f, 3.0f, -8.0f, 4.0f, 16.0f, 6.0f, dilation), ModelTransform.of((float)0.0f, (float)12.0f, (float)-10.0f, (float)1.5707964f, (float)0.0f, (float)0.0f));
        modelPartData.addChild(TAIL1, ModelPartBuilder.create().uv(0, 15).cuboid(-0.5f, 0.0f, 0.0f, 1.0f, 8.0f, 1.0f, dilation), ModelTransform.of((float)0.0f, (float)15.0f, (float)8.0f, (float)0.9f, (float)0.0f, (float)0.0f));
        modelPartData.addChild(TAIL2, ModelPartBuilder.create().uv(4, 15).cuboid(-0.5f, 0.0f, 0.0f, 1.0f, 8.0f, 1.0f, dilation2), ModelTransform.origin((float)0.0f, (float)20.0f, (float)14.0f));
        ModelPartBuilder modelPartBuilder = ModelPartBuilder.create().uv(8, 13).cuboid(-1.0f, 0.0f, 1.0f, 2.0f, 6.0f, 2.0f, dilation);
        modelPartData.addChild("left_hind_leg", modelPartBuilder, ModelTransform.origin((float)1.1f, (float)18.0f, (float)5.0f));
        modelPartData.addChild("right_hind_leg", modelPartBuilder, ModelTransform.origin((float)-1.1f, (float)18.0f, (float)5.0f));
        ModelPartBuilder modelPartBuilder2 = ModelPartBuilder.create().uv(40, 0).cuboid(-1.0f, 0.0f, 0.0f, 2.0f, 10.0f, 2.0f, dilation);
        modelPartData.addChild("left_front_leg", modelPartBuilder2, ModelTransform.origin((float)1.2f, (float)14.1f, (float)-5.0f));
        modelPartData.addChild("right_front_leg", modelPartBuilder2, ModelTransform.origin((float)-1.2f, (float)14.1f, (float)-5.0f));
        return modelData;
    }
    ...
    public void setAngles(T felineEntityRenderState) {
        ...
        if (!((FelineEntityRenderState)felineEntityRenderState).inSittingPose) {
            ...
            if (((FelineEntityRenderState)felineEntityRenderState).sprinting) {
                this.leftHindLeg.pitch = MathHelper.cos((double)(h * 0.6662f)) * g;
                this.rightHindLeg.pitch = MathHelper.cos((double)(h * 0.6662f + 0.3f)) * g;
                this.leftFrontLeg.pitch = MathHelper.cos((double)(h * 0.6662f + (float)Math.PI + 0.3f)) * g;
                this.rightFrontLeg.pitch = MathHelper.cos((double)(h * 0.6662f + (float)Math.PI)) * g;
                this.lowerTail.pitch = 1.7278761f + 0.31415927f * MathHelper.cos((double)h) * g;
            } else {
                this.leftHindLeg.pitch = MathHelper.cos((double)(h * 0.6662f)) * g;
                this.rightHindLeg.pitch = MathHelper.cos((double)(h * 0.6662f + (float)Math.PI)) * g;
                this.leftFrontLeg.pitch = MathHelper.cos((double)(h * 0.6662f + (float)Math.PI)) * g;
                this.rightFrontLeg.pitch = MathHelper.cos((double)(h * 0.6662f)) * g;
                this.lowerTail.pitch = !((FelineEntityRenderState)felineEntityRenderState).inSneakingPose ? 1.7278761f + 0.7853982f * MathHelper.cos((double)h) * g : 1.7278761f + 0.47123894f * MathHelper.cos((double)h) * g;
            }
        }
        if (((FelineEntityRenderState)felineEntityRenderState).inSittingPose) {
        ...
        if (((FelineEntityRenderState)felineEntityRenderState).sleepAnimationProgress > 0.0f) {
            this.head.roll = MathHelper.lerpAngleDegrees((float)((FelineEntityRenderState)felineEntityRenderState).sleepAnimationProgress, (float)this.head.roll, (float)-1.2707963f);
            this.head.yaw = MathHelper.lerpAngleDegrees((float)((FelineEntityRenderState)felineEntityRenderState).sleepAnimationProgress, (float)this.head.yaw, (float)1.2707963f);
            ...
            this.upperTail.pitch = MathHelper.lerpAngleDegrees((float)((FelineEntityRenderState)felineEntityRenderState).tailCurlAnimationProgress, (float)this.upperTail.pitch, (float)0.8f);
            this.lowerTail.pitch = MathHelper.lerpAngleDegrees((float)((FelineEntityRenderState)felineEntityRenderState).tailCurlAnimationProgress, (float)this.lowerTail.pitch, (float)-0.4f);
        }
        if (((FelineEntityRenderState)felineEntityRenderState).headDownAnimationProgress > 0.0f) {
            this.head.pitch = MathHelper.lerpAngleDegrees((float)((FelineEntityRenderState)felineEntityRenderState).headDownAnimationProgress, (float)this.head.pitch, (float)-0.58177644f);
        }
    }
}
