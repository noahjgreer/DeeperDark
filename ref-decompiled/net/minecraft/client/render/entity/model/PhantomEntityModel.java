...
public class PhantomEntityModel extends EntityModel {
   ...
   public void setAngles(PhantomEntityRenderState phantomEntityRenderState) {
      ...
      float f = phantomEntityRenderState.wingFlapProgress * 7.448451F * 0.017453292F;
      float g = 16.0F;
      this.leftWingBase.roll = MathHelper.cos(f) * 16.0F * 0.017453292F;
      this.leftWingTip.roll = MathHelper.cos(f) * 16.0F * 0.017453292F;
      this.rightWingBase.roll = -this.leftWingBase.roll;
      this.rightWingTip.roll = -this.leftWingTip.roll;
      this.tailBase.pitch = -(5.0F + MathHelper.cos(f * 2.0F) * 5.0F) * 0.017453292F;
      this.tailTip.pitch = -(5.0F + MathHelper.cos(f * 2.0F) * 5.0F) * 0.017453292F;
   }
}
