...
extends BipedEntityModel<S> {
    ...
    public static TexturedModelData getParchedTexturedModelData() {
        ...
        ModelPartData modelPartData = modelData.getRoot();
        modelPartData.addChild("body", ModelPartBuilder.create().uv(16, 16).cuboid(-4.0f, 0.0f, -2.0f, 8.0f, 12.0f, 4.0f).uv(28, 0).cuboid(-4.0f, 10.0f, -2.0f, 8.0f, 1.0f, 4.0f).uv(16, 48).cuboid(-4.0f, 0.0f, -2.0f, 8.0f, 12.0f, 4.0f, new Dilation(0.025f)), ModelTransform.origin(0.0f, 0.0f, 0.0f));
        modelPartData.addChild("head", ModelPartBuilder.create().uv(0, 0).cuboid(-4.0f, -8.0f, -4.0f, 8.0f, 8.0f, 8.0f).uv(0, 32).cuboid(-4.0f, -8.0f, -4.0f, 8.0f, 8.0f, 8.0f, new Dilation(0.2f)), ModelTransform.origin(0.0f, 0.0f, 0.0f)).addChild("hat", ModelPartBuilder.create(), ModelTransform.NONE);
        modelPartData.addChild("right_arm", ModelPartBuilder.create().uv(40, 16).cuboid(-1.0f, -2.0f, -1.0f, 2.0f, 12.0f, 2.0f).uv(42, 33).cuboid(-1.55f, -2.025f, -1.5f, 3.0f, 12.0f, 3.0f), ModelTransform.origin(-5.5f, 2.0f, 0.0f));
        modelPartData.addChild("left_arm", ModelPartBuilder.create().uv(56, 16).cuboid(-1.0f, -2.0f, -1.0f, 2.0f, 12.0f, 2.0f).uv(40, 48).cuboid(-1.45f, -2.025f, -1.5f, 3.0f, 12.0f, 3.0f), ModelTransform.origin(5.5f, 2.0f, 0.0f));
        modelPartData.addChild("right_leg", ModelPartBuilder.create().uv(0, 16).cuboid(-1.0f, 0.0f, -1.0f, 2.0f, 12.0f, 2.0f).uv(0, 49).cuboid(-1.5f, -0.0f, -1.5f, 3.0f, 12.0f, 3.0f), ModelTransform.origin(-2.0f, 12.0f, 0.0f));
        modelPartData.addChild("left_leg", ModelPartBuilder.create().uv(0, 16).cuboid(-1.0f, 0.0f, -1.0f, 2.0f, 12.0f, 2.0f).uv(4, 49).cuboid(-1.5f, 0.0f, -1.5f, 3.0f, 12.0f, 3.0f), ModelTransform.origin(2.0f, 12.0f, 0.0f));
