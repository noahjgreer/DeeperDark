...
public class SnifferEntityModel extends EntityModel {
   ...
   public static TexturedModelData getTexturedModelData() {
      ...
      ModelPartData modelPartData2 = modelPartData.addChild("bone", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 5.0F, 0.0F));
      ...
      modelPartData2.addChild("right_front_leg", ModelPartBuilder.create().uv(32, 87).cuboid(-3.5F, -1.0F, -4.0F, 7.0F, 10.0F, 8.0F, new Dilation(0.0F)), ModelTransform.origin(-7.5F, 10.0F, -15.0F));
      modelPartData2.addChild("right_mid_leg", ModelPartBuilder.create().uv(32, 105).cuboid(-3.5F, -1.0F, -4.0F, 7.0F, 10.0F, 8.0F, new Dilation(0.0F)), ModelTransform.origin(-7.5F, 10.0F, 0.0F));
      modelPartData2.addChild("right_hind_leg", ModelPartBuilder.create().uv(32, 123).cuboid(-3.5F, -1.0F, -4.0F, 7.0F, 10.0F, 8.0F, new Dilation(0.0F)), ModelTransform.origin(-7.5F, 10.0F, 15.0F));
      modelPartData2.addChild("left_front_leg", ModelPartBuilder.create().uv(0, 87).cuboid(-3.5F, -1.0F, -4.0F, 7.0F, 10.0F, 8.0F, new Dilation(0.0F)), ModelTransform.origin(7.5F, 10.0F, -15.0F));
      modelPartData2.addChild("left_mid_leg", ModelPartBuilder.create().uv(0, 105).cuboid(-3.5F, -1.0F, -4.0F, 7.0F, 10.0F, 8.0F, new Dilation(0.0F)), ModelTransform.origin(7.5F, 10.0F, 0.0F));
      modelPartData2.addChild("left_hind_leg", ModelPartBuilder.create().uv(0, 123).cuboid(-3.5F, -1.0F, -4.0F, 7.0F, 10.0F, 8.0F, new Dilation(0.0F)), ModelTransform.origin(7.5F, 10.0F, 15.0F));
      ModelPartData modelPartData4 = modelPartData3.addChild("head", ModelPartBuilder.create().uv(8, 15).cuboid(-6.5F, -7.5F, -11.5F, 13.0F, 18.0F, 11.0F, new Dilation(0.0F)).uv(8, 4).cuboid(-6.5F, 7.5F, -11.5F, 13.0F, 0.0F, 11.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 6.5F, -19.48F));
      modelPartData4.addChild("left_ear", ModelPartBuilder.create().uv(2, 0).cuboid(0.0F, 0.0F, -3.0F, 1.0F, 19.0F, 7.0F, new Dilation(0.0F)), ModelTransform.origin(6.51F, -7.5F, -4.51F));
      modelPartData4.addChild("right_ear", ModelPartBuilder.create().uv(48, 0).cuboid(-1.0F, 0.0F, -3.0F, 1.0F, 19.0F, 7.0F, new Dilation(0.0F)), ModelTransform.origin(-6.51F, -7.5F, -4.51F));
      modelPartData4.addChild("nose", ModelPartBuilder.create().uv(10, 45).cuboid(-6.5F, -2.0F, -9.0F, 13.0F, 2.0F, 9.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, -4.5F, -11.5F));
   ...
   public void setAngles(SnifferEntityRenderState snifferEntityRenderState) {
      ...
      this.head.yaw = snifferEntityRenderState.relativeHeadYaw * 0.017453292F;
