...
public class WitherEntityModel extends EntityModel {
   ...
   public void setAngles(WitherEntityRenderState witherEntityRenderState) {
      ...
      this.ribcage.pitch = (0.065F + 0.05F * f) * 3.1415927F;
      this.tail.setOrigin(-2.0F, 6.9F + MathHelper.cos(this.ribcage.pitch) * 10.0F, -0.5F + MathHelper.sin(this.ribcage.pitch) * 10.0F);
      this.tail.pitch = (0.265F + 0.1F * f) * 3.1415927F;
      this.centerHead.yaw = witherEntityRenderState.relativeHeadYaw * 0.017453292F;
   ...
   private static void rotateHead(WitherEntityRenderState witherEntityRenderState, ModelPart head, int sigma) {
      head.yaw = (witherEntityRenderState.sideHeadYaws[sigma] - witherEntityRenderState.bodyYaw) * 0.017453292F;
      head.pitch = witherEntityRenderState.sideHeadPitches[sigma] * 0.017453292F;
   }
}
