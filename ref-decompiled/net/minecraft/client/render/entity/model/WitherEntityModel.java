...
extends EntityModel<WitherEntityRenderState> {
    ...
    public static TexturedModelData getTexturedModelData(Dilation dilation) {
        ...
        float f = 0.20420352f;
        modelPartData.addChild("ribcage", ModelPartBuilder.create().uv(0, 22).cuboid(0.0f, 0.0f, 0.0f, 3.0f, 10.0f, 3.0f, dilation).uv(24, 22).cuboid(-4.0f, 1.5f, 0.5f, 11.0f, 2.0f, 2.0f, dilation).uv(24, 22).cuboid(-4.0f, 4.0f, 0.5f, 11.0f, 2.0f, 2.0f, dilation).uv(24, 22).cuboid(-4.0f, 6.5f, 0.5f, 11.0f, 2.0f, 2.0f, dilation), ModelTransform.of((float)-2.0f, (float)6.9f, (float)-0.5f, (float)0.20420352f, (float)0.0f, (float)0.0f));
        modelPartData.addChild("tail", ModelPartBuilder.create().uv(12, 22).cuboid(0.0f, 0.0f, 0.0f, 3.0f, 6.0f, 3.0f, dilation), ModelTransform.of((float)-2.0f, (float)(6.9f + MathHelper.cos((double)0.2042035162448883) * 10.0f), (float)(-0.5f + MathHelper.sin((double)0.2042035162448883) * 10.0f), (float)0.83252203f, (float)0.0f, (float)0.0f));
        ...
        modelPartData.addChild("right_head", modelPartBuilder, ModelTransform.origin((float)-8.0f, (float)4.0f, (float)0.0f));
        modelPartData.addChild("left_head", modelPartBuilder, ModelTransform.origin((float)10.0f, (float)4.0f, (float)0.0f));
    ...
    public void setAngles(WitherEntityRenderState witherEntityRenderState) {
        super.setAngles((Object)witherEntityRenderState);
        WitherEntityModel.rotateHead((WitherEntityRenderState)witherEntityRenderState, (ModelPart)this.rightHead, (int)0);
        WitherEntityModel.rotateHead((WitherEntityRenderState)witherEntityRenderState, (ModelPart)this.leftHead, (int)1);
        float f = MathHelper.cos((double)(witherEntityRenderState.age * 0.1f));
        this.ribcage.pitch = (0.065f + 0.05f * f) * (float)Math.PI;
        this.tail.setOrigin(-2.0f, 6.9f + MathHelper.cos((double)this.ribcage.pitch) * 10.0f, -0.5f + MathHelper.sin((double)this.ribcage.pitch) * 10.0f);
