...
extends EntityModel<EndCrystalEntityRenderState> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData modelPartData2 = modelPartData.addChild(OUTER_GLASS, modelPartBuilder, ModelTransform.origin((float)0.0f, (float)24.0f, (float)0.0f));
    ...
    public void setAngles(EndCrystalEntityRenderState endCrystalEntityRenderState) {
        super.setAngles((Object)endCrystalEntityRenderState);
        this.base.visible = endCrystalEntityRenderState.baseVisible;
        float f = endCrystalEntityRenderState.age * 3.0f;
        float g = EndCrystalEntityRenderer.getYOffset((float)endCrystalEntityRenderState.age) * 16.0f;
