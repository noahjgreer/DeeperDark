...
public class EndCrystalEntityModel extends EntityModel {
   ...
   public void setAngles(EndCrystalEntityRenderState endCrystalEntityRenderState) {
      ...
      var10000.originY += g / 2.0F;
      this.outerGlass.rotate(RotationAxis.POSITIVE_Y.rotationDegrees(f).rotateAxis(1.0471976F, field_52906, 0.0F, field_52906));
      this.innerGlass.rotate((new Quaternionf()).setAngleAxis(1.0471976F, field_52906, 0.0F, field_52906).rotateY(f * 0.017453292F));
      this.cube.rotate((new Quaternionf()).setAngleAxis(1.0471976F, field_52906, 0.0F, field_52906).rotateY(f * 0.017453292F));
   }
}
