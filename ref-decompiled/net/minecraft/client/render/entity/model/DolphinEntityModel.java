...
public class DolphinEntityModel extends EntityModel {
   ...
   public void setAngles(DolphinEntityRenderState dolphinEntityRenderState) {
      ...
      this.body.pitch = dolphinEntityRenderState.pitch * 0.017453292F;
      this.body.yaw = dolphinEntityRenderState.relativeHeadYaw * 0.017453292F;
      if (dolphinEntityRenderState.moving) {
         ModelPart var10000 = this.body;
         var10000.pitch += -0.05F - 0.05F * MathHelper.cos(dolphinEntityRenderState.age * 0.3F);
