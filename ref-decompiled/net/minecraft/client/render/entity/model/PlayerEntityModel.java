...
extends BipedEntityModel<PlayerEntityRenderState> {
    ...
    public static ModelData getTexturedModelData(Dilation dilation, boolean slim) {
        ...
        float f = 0.25f;
        if (slim) {
            modelPartData2 = modelPartData.addChild("left_arm", ModelPartBuilder.create().uv(32, 48).cuboid(-1.0f, -2.0f, -2.0f, 3.0f, 12.0f, 4.0f, dilation), ModelTransform.origin((float)5.0f, (float)2.0f, (float)0.0f));
            modelPartData3 = modelPartData.addChild("right_arm", ModelPartBuilder.create().uv(40, 16).cuboid(-2.0f, -2.0f, -2.0f, 3.0f, 12.0f, 4.0f, dilation), ModelTransform.origin((float)-5.0f, (float)2.0f, (float)0.0f));
            ...
            modelPartData2 = modelPartData.addChild("left_arm", ModelPartBuilder.create().uv(32, 48).cuboid(-1.0f, -2.0f, -2.0f, 4.0f, 12.0f, 4.0f, dilation), ModelTransform.origin((float)5.0f, (float)2.0f, (float)0.0f));
        ...
        modelPartData2 = modelPartData.addChild("left_leg", ModelPartBuilder.create().uv(16, 48).cuboid(-2.0f, 0.0f, -2.0f, 4.0f, 12.0f, 4.0f, dilation), ModelTransform.origin((float)1.9f, (float)12.0f, (float)0.0f));
    ...
    public static EquipmentModelData<ModelData> createEquipmentModelData(Dilation hatDilation, Dilation armorDilation) {
        return BipedEntityModel.createEquipmentModelData((Dilation)hatDilation, (Dilation)armorDilation).map(modelData -> {
            ModelPartData modelPartData = modelData.getRoot();
    ...
    public ModelPart getRandomPart(Random random) {
        return (ModelPart)Util.getRandom((List)this.parts, (Random)random);
    }
}
