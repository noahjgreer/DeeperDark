...
public abstract class AbstractBoatEntityRenderer extends EntityRenderer {
   ...
   public void render(BoatEntityRenderState boatEntityRenderState, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
      ...
      if (f > 0.0F) {
         matrixStack.multiply(RotationAxis.POSITIVE_X.rotationDegrees(MathHelper.sin(f) * f * boatEntityRenderState.damageWobbleStrength / 10.0F * (float)boatEntityRenderState.damageWobbleSide));
      }
