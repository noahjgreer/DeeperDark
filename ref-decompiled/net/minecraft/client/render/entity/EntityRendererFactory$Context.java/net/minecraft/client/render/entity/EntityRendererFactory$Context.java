...
public static class EntityRendererFactory.Context {
    ...
    public EntityRendererFactory.Context(EntityRenderManager renderDispatcher, ItemModelManager itemRenderer, MapRenderer mapRenderer, BlockRenderManager blockRenderManager, ResourceManager resourceManager, LoadedEntityModels entityModels, EquipmentModelLoader equipmentModelLoader, AtlasManager atlasManager, TextRenderer textRenderer, PlayerSkinCache playerSkinCache) {
