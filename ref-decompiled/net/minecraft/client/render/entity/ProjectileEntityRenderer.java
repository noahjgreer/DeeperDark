...
public abstract class ProjectileEntityRenderer extends EntityRenderer {
   ...
   protected abstract Identifier getTexture(ProjectileEntityRenderState state);

   public void updateRenderState(PersistentProjectileEntity persistentProjectileEntity, ProjectileEntityRenderState projectileEntityRenderState, float f) {
