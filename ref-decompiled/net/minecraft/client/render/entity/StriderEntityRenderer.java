...
public class StriderEntityRenderer extends AgeableMobEntityRenderer {
   ...
   public StriderEntityRenderer(EntityRendererFactory.Context context) {
      ...
      this.addFeature(new SaddleFeatureRenderer(this, context.getEquipmentRenderer(), EquipmentModel.LayerType.STRIDER_SADDLE, (striderEntityRenderState) -> {
         return striderEntityRenderState.saddleStack;
      }, new StriderEntityModel(context.getPart(EntityModelLayers.STRIDER_SADDLE)), new StriderEntityModel(context.getPart(EntityModelLayers.STRIDER_BABY_SADDLE))));
   }
