...
extends CamelEntityRenderer {
    ...
    protected SaddleFeatureRenderer<CamelEntityRenderState, CamelEntityModel, CamelSaddleEntityModel> createSaddleFeatureRenderer(EntityRendererFactory.Context context) {
        return new SaddleFeatureRenderer<CamelEntityRenderState, CamelEntityModel, CamelSaddleEntityModel>(this, context.getEquipmentRenderer(), EquipmentModel.LayerType.CAMEL_HUSK_SADDLE, state -> state.saddleStack, new CamelSaddleEntityModel(context.getPart(EntityModelLayers.CAMEL_HUSK)), new CamelSaddleEntityModel(context.getPart(EntityModelLayers.CAMEL_HUSK_BABY)));
    }
