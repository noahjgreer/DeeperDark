...
extends EntityRenderer<WitherSkullEntity, WitherSkullEntityRenderState> {
    ...
    public void render(WitherSkullEntityRenderState witherSkullEntityRenderState, MatrixStack matrixStack, OrderedRenderCommandQueue orderedRenderCommandQueue, CameraRenderState cameraRenderState) {
        ...
        orderedRenderCommandQueue.submitModel(this.model, witherSkullEntityRenderState.skullState, matrixStack, this.model.getLayer(this.getTexture(witherSkullEntityRenderState)), witherSkullEntityRenderState.light, OverlayTexture.DEFAULT_UV, witherSkullEntityRenderState.outlineColor, null);
        matrixStack.pop();
        super.render(witherSkullEntityRenderState, matrixStack, orderedRenderCommandQueue, cameraRenderState);
    }
