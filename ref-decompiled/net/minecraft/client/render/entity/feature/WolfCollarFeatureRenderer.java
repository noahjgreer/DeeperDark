...
public class WolfCollarFeatureRenderer extends FeatureRenderer {
   ...
   public WolfCollarFeatureRenderer(FeatureRendererContext featureRendererContext) {
   ...
   public void render(MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i, WolfEntityRenderState wolfEntityRenderState, float f, float g) {
      ...
      if (dyeColor != null && !wolfEntityRenderState.invisible) {
         ...
         ((WolfEntityModel)this.getContextModel()).render(matrixStack, vertexConsumer, i, OverlayTexture.DEFAULT_UV, j);
      }
   }
}
