...
public class WolfArmorFeatureRenderer extends FeatureRenderer {
   ...
   public WolfArmorFeatureRenderer(FeatureRendererContext context, LoadedEntityModels loader, EquipmentRenderer equipmentRenderer) {
      super(context);
   ...
   public void render(MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i, WolfEntityRenderState wolfEntityRenderState, float f, float g) {
      ...
      if (equippableComponent != null && !equippableComponent.assetId().isEmpty()) {
         ...
         this.equipmentRenderer.render(EquipmentModel.LayerType.WOLF_BODY, (RegistryKey)equippableComponent.assetId().get(), wolfEntityModel, itemStack, matrixStack, vertexConsumerProvider, i);
