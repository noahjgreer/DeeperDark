...
public class BreezeWindFeatureRenderer extends FeatureRenderer {
   ...
   public BreezeWindFeatureRenderer(EntityRendererFactory.Context entityRendererContext, FeatureRendererContext featureContext) {
