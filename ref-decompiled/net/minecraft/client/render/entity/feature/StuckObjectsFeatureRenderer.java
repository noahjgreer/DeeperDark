...
public abstract class StuckObjectsFeatureRenderer extends FeatureRenderer {
   ...
   public StuckObjectsFeatureRenderer(LivingEntityRenderer entityRenderer, Model model, Identifier texture, RenderPosition renderPosition) {
   ...
   private void renderObject(MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, float f, float directionX, float directionY) {
      ...
      float h = (float)(Math.atan2((double)f, (double)directionY) * 57.2957763671875);
      float i = (float)(Math.atan2((double)directionX, (double)g) * 57.2957763671875);
