...
public class FireCommandRenderer {
    ...
    private void render(MatrixStack.Entry matricesEntry, VertexConsumerProvider vertexConsumers, EntityRenderState renderState, Quaternionf rotation, AtlasManager atlasManager) {
        ...
        while (i > 0.0f) {
            ...
            FireCommandRenderer.vertex(matricesEntry, vertexConsumer, -g - 0.0f, 0.0f - j, k, o, p);
            FireCommandRenderer.vertex(matricesEntry, vertexConsumer, g - 0.0f, 0.0f - j, k, m, p);
            FireCommandRenderer.vertex(matricesEntry, vertexConsumer, g - 0.0f, 1.4f - j, k, m, n);
            FireCommandRenderer.vertex(matricesEntry, vertexConsumer, -g - 0.0f, 1.4f - j, k, o, n);
            i -= 0.45f;
            j -= 0.45f;
            g *= 0.9f;
            k -= 0.03f;
