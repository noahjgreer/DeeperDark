...
extends SinglePreparationResourceReloader<List<Text>> {
    ...
    public static final Text MERRY_X_MAS_ = SplashTextResourceSupplier.create("Merry X-mas!");
    public static final Text HAPPY_NEW_YEAR_ = SplashTextResourceSupplier.create("Happy new year!");
    public static final Text OOOOO_O_O_OOOOO__SPOOKY_ = SplashTextResourceSupplier.create("OOoooOOOoooo! Spooky!");
    ...
    public @Nullable SplashTextRenderer get() {
        ...
        if (this.session != null && RANDOM.nextInt(this.splashTexts.size()) == 42) {
            return new SplashTextRenderer(SplashTextResourceSupplier.create(this.session.getUsername().toUpperCase(Locale.ROOT) + " IS YOU"));
        }
