...
extends Screen {
    ...
    private @Nullable SelectionListWidget selectionList;
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float deltaTicks) {
        ...
        this.contextMessage.draw(Alignment.CENTER, this.width / 2, k, this.textRenderer.fontHeight, drawnTextConsumer);
    }
