...
extends ReportScreen<SkinAbuseReport.Builder> {
    ...
    protected void addContent() {
        ...
        directionalLayoutWidget2.add(LayoutWidgets.createLabeledWidget(this.textRenderer, this.commentsBox, MORE_COMMENTS_TEXT, positioner -> positioner.marginBottom(12)));
    }
