...
public class ChatReportScreen extends ReportScreen {
   ...
   protected void addContent() {
      this.selectChatButton = (ButtonWidget)this.layout.add(ButtonWidget.builder(SELECT_CHAT_TEXT, (button) -> {
         this.client.setScreen(new ChatSelectionScreen(this, this.context, (ChatAbuseReport.Builder)this.reportBuilder, (updatedReportBuilder) -> {
            this.reportBuilder = updatedReportBuilder;
            this.onChange();
         }));
      }).width(280).build());
      this.selectReasonButton = ButtonWidget.builder(SELECT_REASON_TEXT, (button) -> {
         this.client.setScreen(new AbuseReportReasonScreen(this, ((ChatAbuseReport.Builder)this.reportBuilder).getReason(), AbuseReportType.CHAT, (reason) -> {
