...
public class OutOfMemoryScreen extends Screen {
   ...
   protected void init() {
      ...
      directionalLayoutWidget.add(ButtonWidget.builder(ScreenTexts.TO_TITLE, (button) -> {
         this.client.setScreen(new TitleScreen());
      }).build());
      directionalLayoutWidget.add(ButtonWidget.builder(Text.translatable("menu.quit"), (button) -> {
