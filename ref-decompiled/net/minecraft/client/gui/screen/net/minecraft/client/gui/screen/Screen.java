...
implements Drawable {
    ...
    public static @Nullable SelectedElementNarrationData findSelectedElementData(List<? extends Selectable> selectables, @Nullable Selectable selectable) {
    ...
    @Environment(value=EnvType.CLIENT)
    public static final class SelectedElementNarrationData
    extends Record {
        ...
        public final String toString() {
            return ObjectMethods.bootstrap("toString", new MethodHandle[]{SelectedElementNarrationData.class, "entry;index;priority", "selectable", "index", "selectType"}, this);
        }

        @Override
        public final int hashCode() {
            return (int)ObjectMethods.bootstrap("hashCode", new MethodHandle[]{SelectedElementNarrationData.class, "entry;index;priority", "selectable", "index", "selectType"}, this);
        }

        @Override
        public final boolean equals(Object object) {
            return (boolean)ObjectMethods.bootstrap("equals", new MethodHandle[]{SelectedElementNarrationData.class, "entry;index;priority", "selectable", "index", "selectType"}, this, object);
        }
