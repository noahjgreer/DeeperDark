...
extends Screen {
    ...
    protected void init() {
        ...
        this.textWidget = directionalLayoutWidget.add(new ScrollableTextWidget(0, 0, this.width - 100, this.height - 100, this.messageText, this.textRenderer), positioner -> positioner.margin(12));
