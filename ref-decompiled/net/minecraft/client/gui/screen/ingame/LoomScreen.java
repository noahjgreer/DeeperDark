...
extends HandledScreen<LoomScreenHandler> {
    private static final Identifier BANNER_SLOT_TEXTURE = Identifier.ofVanilla((String)"container/slot/banner");
    private static final Identifier DYE_SLOT_TEXTURE = Identifier.ofVanilla((String)"container/slot/dye");
    private static final Identifier PATTERN_SLOT_TEXTURE = Identifier.ofVanilla((String)"container/slot/banner_pattern");
    private static final Identifier SCROLLER_TEXTURE = Identifier.ofVanilla((String)"container/loom/scroller");
    private static final Identifier SCROLLER_DISABLED_TEXTURE = Identifier.ofVanilla((String)"container/loom/scroller_disabled");
    private static final Identifier PATTERN_SELECTED_TEXTURE = Identifier.ofVanilla((String)"container/loom/pattern_selected");
    private static final Identifier PATTERN_HIGHLIGHTED_TEXTURE = Identifier.ofVanilla((String)"container/loom/pattern_highlighted");
    private static final Identifier PATTERN_TEXTURE = Identifier.ofVanilla((String)"container/loom/pattern");
    private static final Identifier ERROR_TEXTURE = Identifier.ofVanilla((String)"container/loom/error");
    private static final Identifier TEXTURE = Identifier.ofVanilla((String)"textures/gui/container/loom.png");
    ...
    public LoomScreen(LoomScreenHandler screenHandler, PlayerInventory inventory, Text title) {
        super((ScreenHandler)screenHandler, inventory, title);
    ...
    private int getRows() {
        return MathHelper.ceilDiv((int)((LoomScreenHandler)this.handler).getBannerPatterns().size(), (int)4);
    }
        ...
        if (this.canApplyDyePattern) {
            ...
            block0: for (int q = 0; q < 4; ++q) {
                for (int r = 0; r < 4; ++r) {
                    ...
                    int u = p + r * 14;
                    int v = n + q * 14;
                    RegistryEntry registryEntry = (RegistryEntry)list.get(t);
                    ...
                    if (t == ((LoomScreenHandler)this.handler).getSelectedPattern()) {
                        ...
                        context.drawTooltip((Text)Text.translatable((String)(((BannerPattern)registryEntry.value()).translationKey() + "." + dyeColor2.getId())), mouseX, mouseY);
                        context.setCursor(StandardCursors.POINTING_HAND);
                    } else {
                        identifier2 = PATTERN_TEXTURE;
                    }
                    context.drawGuiTexture(RenderPipelines.GUI_TEXTURED, identifier2, u, v, 14, 14);
                    Sprite sprite = context.getSprite(TexturedRenderLayers.getBannerPatternTextureId((RegistryEntry)registryEntry));
        ...
        if (this.canApplyDyePattern) {
            ...
            for (int k = 0; k < 4; ++k) {
                for (int l = 0; l < 4; ++l) {
                    ...
                    int n = m * 4 + l;
                    if (!(d >= 0.0) || !(e >= 0.0) || !(d < 14.0) || !(e < 14.0) || !((LoomScreenHandler)this.handler).onButtonClick((PlayerEntity)this.client.player, n)) continue;
                    MinecraftClient.getInstance().getSoundManager().play((SoundInstance)PositionedSoundInstance.ui((SoundEvent)SoundEvents.UI_LOOM_SELECT_PATTERN, (float)1.0f));
    ...
    public boolean mouseScrolled(double mouseX, double mouseY, double horizontalAmount, double verticalAmount) {
        ...
        if (this.canApplyDyePattern && i > 0) {
            ...
            this.scrollPosition = MathHelper.clamp((float)(this.scrollPosition - f), (float)0.0f, (float)1.0f);
    ...
    private void onInventoryChanged() {
        ...
        this.bannerPatterns = itemStack.isEmpty() ? null : (BannerPatternsComponent)itemStack.getOrDefault(DataComponentTypes.BANNER_PATTERNS, (Object)BannerPatternsComponent.DEFAULT);
        ...
        BannerPatternsComponent bannerPatternsComponent = (BannerPatternsComponent)itemStack2.getOrDefault(DataComponentTypes.BANNER_PATTERNS, (Object)BannerPatternsComponent.DEFAULT);
        boolean bl = this.hasTooManyPatterns = bannerPatternsComponent.layers().size() >= 6;
        if (this.hasTooManyPatterns) {
            this.bannerPatterns = null;
        }
        if (!(ItemStack.areEqual((ItemStack)itemStack2, (ItemStack)this.banner) && ItemStack.areEqual((ItemStack)itemStack3, (ItemStack)this.dye) && ItemStack.areEqual((ItemStack)itemStack4, (ItemStack)this.pattern))) {
