...
extends Screen {
    ...
    protected void init() {
        ...
        this.jointRotationButton = this.addDrawableChild(CyclingButtonWidget.builder(JigsawBlockEntity.Joint::asText, this.joint).values((JigsawBlockEntity.Joint[])JigsawBlockEntity.Joint.values()).omitKeyText().build(this.width / 2 + 54, 160, 100, 20, JOINT_LABEL_TEXT, (button, joint) -> {
            this.joint = joint;
        }));
    ...
    private void updateDoneButtonState() {
        boolean bl;
        this.doneButton.active = bl = JigsawBlockScreen.isValidId(this.nameField.getText()) && JigsawBlockScreen.isValidId(this.targetField.getText()) && JigsawBlockScreen.isValidId(this.poolField.getText());
