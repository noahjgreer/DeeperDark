...
extends Screen {
    ...
    protected void init() {
        ...
        this.addDrawableChild(ButtonWidget.builder(SIGN_BUTTON_TEXT, button -> this.client.setScreen(this.signingScreen)).position(this.width / 2 - 98 - 2, this.getDoneButtonY()).width(98).build());
    ...
    private Text getPageIndicatorText() {
        return Text.translatable("book.pageIndicator", this.currentPage + 1, this.countPages()).withColor(-16777216).withoutShadow();
    }
