...
extends HandledScreen<CartographyTableScreenHandler> {
    private static final Identifier ERROR_TEXTURE = Identifier.ofVanilla((String)"container/cartography_table/error");
    private static final Identifier SCALED_MAP_TEXTURE = Identifier.ofVanilla((String)"container/cartography_table/scaled_map");
    private static final Identifier DUPLICATED_MAP_TEXTURE = Identifier.ofVanilla((String)"container/cartography_table/duplicated_map");
    private static final Identifier MAP_TEXTURE = Identifier.ofVanilla((String)"container/cartography_table/map");
    private static final Identifier LOCKED_TEXTURE = Identifier.ofVanilla((String)"container/cartography_table/locked");
    private static final Identifier TEXTURE = Identifier.ofVanilla((String)"textures/gui/container/cartography_table.png");
    ...
    protected void drawBackground(DrawContext context, float deltaTicks, int mouseX, int mouseY) {
        ...
        if (mapIdComponent != null) {
            mapState = FilledMapItem.getMapState((MapIdComponent)mapIdComponent, (World)this.client.world);
            if (mapState != null) {
                if (mapState.locked) {
                    bl4 = true;
                    if (bl2 || bl3) {
