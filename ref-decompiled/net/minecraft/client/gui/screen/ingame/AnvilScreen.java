...
extends ForgingScreen<AnvilScreenHandler> {
    private static final Identifier TEXT_FIELD_TEXTURE = Identifier.ofVanilla((String)"container/anvil/text_field");
    private static final Identifier TEXT_FIELD_DISABLED_TEXTURE = Identifier.ofVanilla((String)"container/anvil/text_field_disabled");
    private static final Identifier ERROR_TEXTURE = Identifier.ofVanilla((String)"container/anvil/error");
    private static final Identifier TEXTURE = Identifier.ofVanilla((String)"textures/gui/container/anvil.png");
    private static final Text TOO_EXPENSIVE_TEXT = Text.translatable((String)"container.repair.expensive");
    private TextFieldWidget nameField;
    private final PlayerEntity player;

    public AnvilScreen(AnvilScreenHandler handler, PlayerInventory inventory, Text title) {
        super((ForgingScreenHandler)handler, inventory, title, TEXTURE);
    ...
    protected void setup() {
        ...
        this.nameField = new TextFieldWidget(this.textRenderer, i + 62, j + 24, 103, 12, (Text)Text.translatable((String)"container.repair"));
        ...
        this.nameField.setChangedListener(arg_0 -> this.onRenamed(arg_0));
        this.nameField.setText("");
        this.addDrawableChild((Element)this.nameField);
    ...
    protected void setInitialFocus() {
        this.setInitialFocus((Element)this.nameField);
    }
    ...
    private void onRenamed(String name) {
        ...
        if (((AnvilScreenHandler)this.handler).setNewItemName(string)) {
            this.client.player.networkHandler.sendPacket((Packet)new RenameItemC2SPacket(string));
        }
    }
    ...
    protected void drawForeground(DrawContext context, int mouseX, int mouseY) {
        ...
        if (i > 0) {
            ...
            if (i >= 40 && !this.client.player.isInCreativeMode()) {
                ...
                text = Text.translatable((String)"container.repair.cost", (Object[])new Object[]{i});
    ...
    public void onSlotUpdate(ScreenHandler handler, int slotId, ItemStack stack) {
        if (slotId == 0) {
            ...
            this.setFocused((Element)this.nameField);
        }
    }
}
