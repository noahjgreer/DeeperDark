...
public class StructureBlockScreen extends Screen {
   ...
   private static final ImmutableList MODES = ImmutableList.copyOf(StructureBlockMode.values());
   private static final ImmutableList MODES_EXCEPT_DATA;
   ...
   private CyclingButtonWidget ignoreEntitiesButton;
   private CyclingButtonWidget strictButton;
   private CyclingButtonWidget mirrorButton;
   private CyclingButtonWidget showAirButton;
   private CyclingButtonWidget showBoundingBoxButton;
   ...
   protected void init() {
      ...
      this.buttonSave = (ButtonWidget)this.addDrawableChild(ButtonWidget.builder(Text.translatable("structure_block.button.save"), (button) -> {
      ...
      this.buttonLoad = (ButtonWidget)this.addDrawableChild(ButtonWidget.builder(Text.translatable("structure_block.button.load"), (button) -> {
      ...
      this.addDrawableChild(CyclingButtonWidget.builder((value) -> {
         return Text.translatable("structure_block.mode." + value.asString());
      }).values(MODES_EXCEPT_DATA, MODES).omitKeyText().initially(this.mode).build(this.width / 2 - 4 - 150, 185, 50, 20, Text.literal("MODE"), (button, mode) -> {
         this.structureBlock.setMode(mode);
         this.updateWidgets(mode);
      }));
      this.buttonDetect = (ButtonWidget)this.addDrawableChild(ButtonWidget.builder(Text.translatable("structure_block.button.detect_size"), (button) -> {
         if (this.structureBlock.getMode() == StructureBlockMode.SAVE) {
      ...
      this.ignoreEntitiesButton = (CyclingButtonWidget)this.addDrawableChild(CyclingButtonWidget.onOffBuilder(!this.structureBlock.shouldIgnoreEntities()).omitKeyText().build(this.width / 2 + 4 + 100, 160, 50, 20, INCLUDE_ENTITIES_TEXT, (button, includeEntities) -> {
         this.structureBlock.setIgnoreEntities(!includeEntities);
      }));
      this.strictButton = (CyclingButtonWidget)this.addDrawableChild(CyclingButtonWidget.onOffBuilder(this.structureBlock.isStrict()).omitKeyText().build(this.width / 2 + 4 + 100, 120, 50, 20, STRICT_TEXT, (button, strict) -> {
         this.structureBlock.setStrict(strict);
      }));
      this.mirrorButton = (CyclingButtonWidget)this.addDrawableChild(CyclingButtonWidget.builder(BlockMirror::getName).values((Object[])BlockMirror.values()).omitKeyText().initially(this.mirror).build(this.width / 2 - 20, 185, 40, 20, Text.literal("MIRROR"), (button, mirror) -> {
         this.structureBlock.setMirror(mirror);
      }));
      this.showAirButton = (CyclingButtonWidget)this.addDrawableChild(CyclingButtonWidget.onOffBuilder(this.structureBlock.shouldShowAir()).omitKeyText().build(this.width / 2 + 4 + 100, 80, 50, 20, SHOW_AIR_TEXT, (button, showAir) -> {
         this.structureBlock.setShowAir(showAir);
      }));
      this.showBoundingBoxButton = (CyclingButtonWidget)this.addDrawableChild(CyclingButtonWidget.onOffBuilder(this.structureBlock.shouldShowBoundingBox()).omitKeyText().build(this.width / 2 + 4 + 100, 80, 50, 20, SHOW_BOUNDING_BOX_TEXT, (button, showBoundingBox) -> {
         this.structureBlock.setShowBoundingBox(showBoundingBox);
      }));
      this.buttonRotate0 = (ButtonWidget)this.addDrawableChild(ButtonWidget.builder(Text.literal("0"), (button) -> {
      ...
      this.buttonRotate90 = (ButtonWidget)this.addDrawableChild(ButtonWidget.builder(Text.literal("90"), (button) -> {
         this.structureBlock.setRotation(BlockRotation.CLOCKWISE_90);
         this.updateRotationButton();
      }).dimensions(this.width / 2 - 1 - 40 - 20, 185, 40, 20).build());
      this.buttonRotate180 = (ButtonWidget)this.addDrawableChild(ButtonWidget.builder(Text.literal("180"), (button) -> {
         this.structureBlock.setRotation(BlockRotation.CLOCKWISE_180);
         this.updateRotationButton();
      }).dimensions(this.width / 2 + 1 + 20, 185, 40, 20).build());
      this.buttonRotate270 = (ButtonWidget)this.addDrawableChild(ButtonWidget.builder(Text.literal("270"), (button) -> {
   ...
   public void render(DrawContext context, int mouseX, int mouseY, float deltaTicks) {
      ...
      if (structureBlockMode != StructureBlockMode.DATA) {
         context.drawTextWithShadow(this.textRenderer, (Text)STRUCTURE_NAME_TEXT, this.width / 2 - 153, 30, -6250336);
      ...
      if (structureBlockMode == StructureBlockMode.LOAD || structureBlockMode == StructureBlockMode.SAVE) {
         context.drawTextWithShadow(this.textRenderer, (Text)POSITION_TEXT, this.width / 2 - 153, 70, -6250336);
         ...
         context.drawTextWithShadow(this.textRenderer, (Text)INCLUDE_ENTITIES_TEXT, this.width / 2 + 154 - this.textRenderer.getWidth((StringVisitable)INCLUDE_ENTITIES_TEXT), 150, -6250336);
      }

      if (structureBlockMode == StructureBlockMode.SAVE) {
         context.drawTextWithShadow(this.textRenderer, (Text)SIZE_TEXT, this.width / 2 - 153, 110, -6250336);
         ...
         context.drawTextWithShadow(this.textRenderer, (Text)DETECT_SIZE_TEXT, this.width / 2 + 154 - this.textRenderer.getWidth((StringVisitable)DETECT_SIZE_TEXT), 110, -6250336);
         context.drawTextWithShadow(this.textRenderer, (Text)SHOW_AIR_TEXT, this.width / 2 + 154 - this.textRenderer.getWidth((StringVisitable)SHOW_AIR_TEXT), 70, -6250336);
      }

      if (structureBlockMode == StructureBlockMode.LOAD) {
         context.drawTextWithShadow(this.textRenderer, (Text)INTEGRITY_TEXT, this.width / 2 - 153, 110, -6250336);
         this.inputIntegrity.render(context, mouseX, mouseY, deltaTicks);
         this.inputSeed.render(context, mouseX, mouseY, deltaTicks);
         context.drawTextWithShadow(this.textRenderer, (Text)STRICT_TEXT, this.width / 2 + 154 - this.textRenderer.getWidth((StringVisitable)STRICT_TEXT), 110, -6250336);
         context.drawTextWithShadow(this.textRenderer, (Text)SHOW_BOUNDING_BOX_TEXT, this.width / 2 + 154 - this.textRenderer.getWidth((StringVisitable)SHOW_BOUNDING_BOX_TEXT), 70, -6250336);
      }

      if (structureBlockMode == StructureBlockMode.DATA) {
         context.drawTextWithShadow(this.textRenderer, (Text)CUSTOM_DATA_TEXT, this.width / 2 - 153, 110, -6250336);
         this.inputMetadata.render(context, mouseX, mouseY, deltaTicks);
      }

      context.drawTextWithShadow(this.textRenderer, (Text)structureBlockMode.asText(), this.width / 2 - 153, 174, -6250336);
   }
   ...
   static {
      MODES_EXCEPT_DATA = (ImmutableList)MODES.stream().filter((mode) -> {
         return mode != StructureBlockMode.DATA;
