...
extends RecipeBookScreen<CraftingScreenHandler> {
    private static final Identifier TEXTURE = Identifier.ofVanilla((String)"textures/gui/container/crafting_table.png");

    public CraftingScreen(CraftingScreenHandler handler, PlayerInventory inventory, Text title) {
        super((AbstractRecipeScreenHandler)handler, (RecipeBookWidget)new CraftingRecipeBookWidget((AbstractCraftingScreenHandler)handler), inventory, title);
    }
