...
public class GameMenuScreen extends Screen {
   ...
   private Optional getCustomOptionsDialog() {
      ...
      if (optional.isPresent()) {
         RegistryEntryList registryEntryList = (RegistryEntryList)optional.get();
   ...
   private void addFeedbackAndCustomOptionsButtons(MinecraftClient client, RegistryEntry dialog, GridWidget.Adder gridAdder) {
      gridAdder.add(this.createButton(FEEDBACK_TEXT, () -> {
         return new FeedbackScreen(this);
      }));
      gridAdder.add(ButtonWidget.builder(((Dialog)dialog.value()).common().getExternalTitle(), (button) -> {
         client.player.networkHandler.showDialog(dialog, this);
   ...
   @Environment(EnvType.CLIENT)
   private static class FeedbackScreen extends Screen {
