...
public class DirectConnectScreen extends Screen {
   ...
   protected void init() {
      ...
      this.selectServerButton = (ButtonWidget)this.addDrawableChild(ButtonWidget.builder(Text.translatable("selectServer.select"), (button) -> {
         this.saveAndClose();
   ...
   public void render(DrawContext context, int mouseX, int mouseY, float deltaTicks) {
      ...
      context.drawTextWithShadow(this.textRenderer, (Text)ENTER_IP_TEXT, this.width / 2 - 100 + 1, 100, -6250336);
