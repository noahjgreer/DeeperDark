...
extends GameOptionsScreen {
    ...
    protected void addOptions() {
        SimpleOption<?>[] simpleOptions = AccessibilityOptionsScreen.getOptions(this.gameOptions);
        ButtonWidget buttonWidget2 = ButtonWidget.builder(OptionsScreen.CONTROL_TEXT, buttonWidget -> this.client.setScreen(new ControlsOptionsScreen(this, this.gameOptions))).build();
        SimpleOption<?> simpleOption = simpleOptions[0];
        this.body.addWidgetEntry(simpleOption.createWidget(this.gameOptions), this.gameOptions.getNarrator(), buttonWidget2);
    ...
    protected void initFooter() {
        ...
        directionalLayoutWidget.add(ButtonWidget.builder(Text.translatable("options.accessibility.link"), ConfirmLinkScreen.opening((Screen)this, Urls.JAVA_ACCESSIBILITY)).build());
