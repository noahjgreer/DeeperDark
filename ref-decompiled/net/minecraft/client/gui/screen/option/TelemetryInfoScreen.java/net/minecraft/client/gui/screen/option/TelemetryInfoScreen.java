...
extends Screen {
    ...
    private static final Text OPT_IN_DESCRIPTION_TEXT = Text.translatable("telemetry_info.opt_in.description").withColor(-2039584);
    ...
    protected void init() {
        ...
        if (OPTIONAL_TELEMETRY_ENABLED_BY_API) {
            this.optInCheckbox = directionalLayoutWidget3.add(CheckboxWidget.builder(OPT_IN_DESCRIPTION_TEXT, this.textRenderer).maxWidth(this.width - 40).option(this.options.getTelemetryOptInExtra()).callback(this::updateOptIn).build());
        }
