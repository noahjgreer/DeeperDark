...
public class CreditsAndAttributionScreen extends Screen {
   ...
   protected void init() {
      ...
      directionalLayoutWidget.add(ButtonWidget.builder(CREDITS_TEXT, (button) -> {
         this.openCredits();
      }).width(210).build());
      directionalLayoutWidget.add(ButtonWidget.builder(ATTRIBUTION_TEXT, ConfirmLinkScreen.opening(this, (URI)Urls.JAVA_ATTRIBUTION)).width(210).build());
      directionalLayoutWidget.add(ButtonWidget.builder(LICENSE_TEXT, ConfirmLinkScreen.opening(this, (URI)Urls.JAVA_LICENSES)).width(210).build());
