...
public class ControlsOptionsScreen extends GameOptionsScreen {
   ...
   protected void addOptions() {
      this.body.addWidgetEntry(ButtonWidget.builder(Text.translatable("options.mouse_settings"), (button) -> {
         this.client.setScreen(new MouseOptionsScreen(this, this.gameOptions));
      }).build(), ButtonWidget.builder(Text.translatable("controls.keybinds"), (button) -> {
