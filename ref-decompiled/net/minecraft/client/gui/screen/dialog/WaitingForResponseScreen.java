...
public class WaitingForResponseScreen extends Screen {
   ...
   private static final Text[] BUTTON_TEXTS;
   ...
   static {
      BUTTON_TEXTS = new Text[]{Text.empty(), Text.translatable("gui.waitingForResponse.button.inactive", 4), Text.translatable("gui.waitingForResponse.button.inactive", 3), Text.translatable("gui.waitingForResponse.button.inactive", 2), Text.translatable("gui.waitingForResponse.button.inactive", 1), ScreenTexts.BACK};
   }
}
