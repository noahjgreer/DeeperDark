...
public class DialogControls {
   public static final Supplier EMPTY_ACTION_CLICK_EVENT = Optional::empty;
   ...
   public void addInput(DialogInput input, Consumer widgetConsumer) {
   ...
   public Supplier createClickEvent(Optional action) {
      if (action.isPresent()) {
   ...
   public ButtonWidget.Builder createButton(DialogActionButtonData actionButtonData) {
      ...
      return createButton(actionButtonData.data(), (button) -> {
