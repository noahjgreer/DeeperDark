...
extends Screen {
    ...
    protected void init() {
        ...
        this.movementText = MultilineText.create(this.textRenderer, this.styleHelp(Text.translatable("demo.help.movementShort", gameOptions.forwardKey.getBoundKeyLocalizedText(), gameOptions.leftKey.getBoundKeyLocalizedText(), gameOptions.backKey.getBoundKeyLocalizedText(), gameOptions.rightKey.getBoundKeyLocalizedText())), this.styleHelp(Text.translatable("demo.help.movementMouse")), this.styleHelp(Text.translatable("demo.help.jump", gameOptions.jumpKey.getBoundKeyLocalizedText())), this.styleHelp(Text.translatable("demo.help.inventory", gameOptions.inventoryKey.getBoundKeyLocalizedText())));
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float deltaTicks) {
        ...
        this.fullWrappedText.draw(Alignment.LEFT, i, j + 20, this.textRenderer.fontHeight, drawnTextConsumer);
    }
}
