...
extends Screen {
    ...
    private Text toText(LevelStorage.Session session, boolean old, @Nullable Exception exception) {
        ...
        MutableText mutableText2 = instant != null ? Text.literal(WorldListWidget.DATE_FORMAT.format(ZonedDateTime.ofInstant(instant, ZoneId.systemDefault()))) : Text.translatable("recover_world.state_entry.unknown");
