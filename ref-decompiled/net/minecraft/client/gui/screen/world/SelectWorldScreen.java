...
public class SelectWorldScreen extends Screen {
   ...
   protected void init() {
      ...
      this.levelList = (WorldListWidget)this.addDrawableChild(new WorldListWidget(this, this.client, this.width, this.height - 112, 48, 36, this.searchBox.getText(), this.levelList));
      this.selectButton = (ButtonWidget)this.addDrawableChild(ButtonWidget.builder(LevelSummary.SELECT_WORLD_TEXT, (button) -> {
