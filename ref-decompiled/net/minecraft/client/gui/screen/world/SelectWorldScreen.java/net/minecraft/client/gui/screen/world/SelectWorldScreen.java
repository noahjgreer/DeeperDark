...
extends Screen {
    ...
    protected void init() {
        ...
        this.searchBox = directionalLayoutWidget2.add(new TextFieldWidget(this.textRenderer, this.width / 2 - 100, 22, 200, 20, this.searchBox, Text.translatable("selectWorld.search")));
    ...
    private void addButtons(Consumer<WorldListWidget.WorldEntry> playAction, WorldListWidget levelList) {
        ...
        this.selectButton = adder.add(ButtonWidget.builder(LevelSummary.SELECT_WORLD_TEXT, button -> levelList.getSelectedAsOptional().ifPresent(playAction)).build(), 2);
        ...
        this.editButton = adder.add(ButtonWidget.builder(Text.translatable("selectWorld.edit"), button -> levelList.getSelectedAsOptional().ifPresent(WorldListWidget.WorldEntry::edit)).width(71).build());
        this.deleteButton = adder.add(ButtonWidget.builder(Text.translatable("selectWorld.delete"), button -> levelList.getSelectedAsOptional().ifPresent(WorldListWidget.WorldEntry::deleteIfConfirmed)).width(71).build());
        this.recreateButton = adder.add(ButtonWidget.builder(Text.translatable("selectWorld.recreate"), button -> levelList.getSelectedAsOptional().ifPresent(WorldListWidget.WorldEntry::recreate)).width(71).build());
