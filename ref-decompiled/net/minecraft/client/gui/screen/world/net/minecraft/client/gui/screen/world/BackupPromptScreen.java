...
extends Screen {
    ...
    protected void init() {
        ...
        this.eraseCacheCheckbox = CheckboxWidget.builder(Text.translatable("selectWorld.backupEraseCache").withColor(-2039584), this.textRenderer).pos(this.width / 2 - 155 + 80, 76 + i).build();
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float deltaTicks) {
        ...
        this.wrappedText.draw(Alignment.CENTER, this.width / 2, 70, this.textRenderer.fontHeight, drawnTextConsumer);
    }
