...
public class ConfirmLinkScreen extends ConfirmScreen {
   ...
   public ConfirmLinkScreen(BooleanConsumer callback, String link, boolean linkTrusted) {
      this(callback, getConfirmText(linkTrusted), Text.literal(link), (String)link, linkTrusted ? ScreenTexts.CANCEL : ScreenTexts.NO, linkTrusted);
   }

   public ConfirmLinkScreen(BooleanConsumer callback, Text title, String link, boolean linkTrusted) {
      this(callback, title, getConfirmText(linkTrusted, link), (String)link, linkTrusted ? ScreenTexts.CANCEL : ScreenTexts.NO, linkTrusted);
   }
