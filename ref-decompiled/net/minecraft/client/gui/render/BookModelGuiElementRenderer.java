...
extends SpecialGuiElementRenderer<BookModelGuiElementRenderState> {
    ...
    protected void render(BookModelGuiElementRenderState bookModelGuiElementRenderState, MatrixStack matrixStack) {
        ...
        float h = MathHelper.clamp((float)(MathHelper.fractionalPart((float)(g + 0.25f)) * 1.6f - 0.3f), (float)0.0f, (float)1.0f);
        float i = MathHelper.clamp((float)(MathHelper.fractionalPart((float)(g + 0.75f)) * 1.6f - 0.3f), (float)0.0f, (float)1.0f);
