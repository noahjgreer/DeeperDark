...
implements AutoCloseable {
    ...
    protected void renderElement(T element, GuiRenderState state) {
        state.addSimpleElementToCurrentLayer(new TexturedQuadGuiElementRenderState(RenderPipelines.GUI_TEXTURED_PREMULTIPLIED_ALPHA, TextureSetup.of(this.textureView, RenderSystem.getSamplerCache().getRepeated(FilterMode.NEAREST)), element.pose(), element.x1(), element.y1(), element.x2(), element.y2(), 0.0f, 1.0f, 1.0f, 0.0f, -1, element.scissorArea(), null));
    }
