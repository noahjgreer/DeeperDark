...
public class PlayerSkinGuiElementRenderer extends SpecialGuiElementRenderer {
   ...
   protected void render(PlayerSkinGuiElementRenderState playerSkinGuiElementRenderState, MatrixStack matrixStack) {
      ...
      matrix4fStack.rotateAround(RotationAxis.POSITIVE_X.rotationDegrees(playerSkinGuiElementRenderState.xRotation()), 0.0F, f * -playerSkinGuiElementRenderState.yPivot(), 0.0F);
      ...
      playerSkinGuiElementRenderState.playerModel().render(matrixStack, this.vertexConsumers.getBuffer(renderLayer), 15728880, OverlayTexture.DEFAULT_UV);
