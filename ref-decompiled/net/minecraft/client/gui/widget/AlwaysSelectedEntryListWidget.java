...
public abstract class AlwaysSelectedEntryListWidget extends EntryListWidget {
   ...
   public GuiNavigationPath getNavigationPath(GuiNavigation navigation) {
      if (this.getEntryCount() == 0) {
         ...
         if (entry != null) {
            return GuiNavigationPath.of((ParentElement)this, (GuiNavigationPath)GuiNavigationPath.of(entry));
         } else {
         ...
         return entry2 == null ? null : GuiNavigationPath.of((ParentElement)this, (GuiNavigationPath)GuiNavigationPath.of(entry2));
      } else {
         return null;
      }
   }
