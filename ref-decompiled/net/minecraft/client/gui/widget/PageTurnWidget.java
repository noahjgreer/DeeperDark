...
extends ButtonWidget {
    private static final Identifier PAGE_FORWARD_HIGHLIGHTED_TEXTURE = Identifier.ofVanilla((String)"widget/page_forward_highlighted");
    private static final Identifier PAGE_FORWARD_TEXTURE = Identifier.ofVanilla((String)"widget/page_forward");
    private static final Identifier PAGE_BACKWARD_HIGHLIGHTED_TEXTURE = Identifier.ofVanilla((String)"widget/page_backward_highlighted");
    private static final Identifier PAGE_BACKWARD_TEXTURE = Identifier.ofVanilla((String)"widget/page_backward");
    private static final Text NEXT_TEXT = Text.translatable((String)"book.page_button.next");
    private static final Text PREVIOUS_TEXT = Text.translatable((String)"book.page_button.previous");
    ...
    public void playDownSound(SoundManager soundManager) {
        if (this.playPageTurnSound) {
            soundManager.play((SoundInstance)PositionedSoundInstance.ui((SoundEvent)SoundEvents.ITEM_BOOK_PAGE_TURN, (float)1.0f));
        }
    }
