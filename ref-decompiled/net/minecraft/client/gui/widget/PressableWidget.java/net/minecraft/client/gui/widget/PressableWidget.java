...
extends ClickableWidget.InactivityIndicatingWidget {
    ...
    protected final void drawButton(DrawContext context) {
        context.drawGuiTexture(RenderPipelines.GUI_TEXTURED, TEXTURES.get(this.active, this.focusOverride != null ? this.focusOverride.get().booleanValue() : this.isSelected()), this.getX(), this.getY(), this.getWidth(), this.getHeight(), ColorHelper.getWhite(this.alpha));
    }
