...
public abstract class TextIconButtonWidget extends ButtonWidget {
   ...
   public static class Builder {
      ...
      public TextIconButtonWidget build() {
         if (this.texture == null) {
            ...
            return (TextIconButtonWidget)(this.hideText ? new IconOnly(this.width, this.height, this.text, this.textureWidth, this.textureHeight, this.texture, this.onPress, this.narrationSupplier) : new WithText(this.width, this.height, this.text, this.textureWidth, this.textureHeight, this.texture, this.onPress, this.narrationSupplier));
         }
      }
   }
   ...
   public static class WithText extends TextIconButtonWidget {
      protected WithText(int i, int j, Text text, int k, int l, Identifier identifier, ButtonWidget.PressAction pressAction, @Nullable ButtonWidget.NarrationSupplier narrationSupplier) {
