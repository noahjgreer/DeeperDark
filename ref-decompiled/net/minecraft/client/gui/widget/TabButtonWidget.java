...
extends ClickableWidget.InactivityIndicatingWidget {
    private static final ButtonTextures TAB_BUTTON_TEXTURES = new ButtonTextures(Identifier.ofVanilla((String)"widget/tab_selected"), Identifier.ofVanilla((String)"widget/tab"), Identifier.ofVanilla((String)"widget/tab_selected_highlighted"), Identifier.ofVanilla((String)"widget/tab_highlighted"));
    ...
    public void renderWidget(DrawContext context, int mouseX, int mouseY, float deltaTicks) {
        ...
        this.drawMessage(context.getHoverListener((ClickableWidget)this, DrawContext.HoverType.NONE));
        this.setCursor(context);
    }

    protected void renderBackgroundTexture(DrawContext context, int left, int top, int right, int bottom) {
        Screen.renderBackgroundTexture((DrawContext)context, (Identifier)Screen.MENU_BACKGROUND_TEXTURE, (int)left, (int)top, (float)0.0f, (float)0.0f, (int)(right - left), (int)(bottom - top));
    }
    ...
    private void drawCurrentTabLine(DrawContext context, TextRenderer textRenderer, int color) {
        int i = Math.min(textRenderer.getWidth((StringVisitable)this.getMessage()), this.getWidth() - 4);
    ...
    protected void appendClickableNarrations(NarrationMessageBuilder builder) {
        builder.put(NarrationPart.TITLE, (Text)Text.translatable((String)"gui.narrate.tab", (Object[])new Object[]{this.tab.getTitle()}));
