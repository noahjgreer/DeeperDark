...
extends PressableWidget {
    ...
    public static Builder builder(net.minecraft.text.Text message, PressAction onPress) {
        return new Builder(message, onPress);
    }

    protected ButtonWidget(int x, int y, int width, int height, net.minecraft.text.Text message, PressAction onPress, NarrationSupplier narrationSupplier) {
    ...
    public static class Builder {
        ...
        public ButtonWidget build() {
            Text buttonWidget = new Text(this.x, this.y, this.width, this.height, this.message, this.onPress, this.narrationSupplier);
    ...
    extends ButtonWidget {
        protected Text(int i, int j, int k, int l, net.minecraft.text.Text text, PressAction pressAction, NarrationSupplier narrationSupplier) {
