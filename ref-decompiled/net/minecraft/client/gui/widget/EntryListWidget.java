...
extends ContainerWidget {
    private static final Identifier MENU_LIST_BACKGROUND_TEXTURE = Identifier.ofVanilla((String)"textures/gui/menu_list_background.png");
    private static final Identifier INWORLD_MENU_LIST_BACKGROUND_TEXTURE = Identifier.ofVanilla((String)"textures/gui/inworld_menu_list_background.png");
    private static final int SPACER_HEIGHT = 2;
    protected final MinecraftClient client;
    protected final int itemHeight;
    private final List<E> children = new Entries(this);
    ...
    public void setSelected(@Nullable E entry) {
        ...
        if (entry != null) {
            ...
            boolean bl3 = bl2 = entry.getContentBottomEnd() > this.getBottom();
    ...
    protected void scrollTo(E entry) {
        ...
        if ((j = this.getBottom() - entry.getY() - entry.getHeight() - 2) < 0) {
            this.scroll(-j);
        }
    }
    ...
    protected @Nullable E getNeighboringEntry(NavigationDirection direction, Predicate<E> predicate) {
        return (E)this.getNeighboringEntry(direction, predicate, this.getSelectedOrNull());
    }

    protected @Nullable E getNeighboringEntry(NavigationDirection direction, Predicate<E> predicate, @Nullable E selected) {
        int i;
        switch (1.field_41786[direction.ordinal()]) {
            default: {
    ...
    protected void removeEntries(List<E> entries) {
        entries.forEach(arg_0 -> this.removeEntry(arg_0));
    }
    ...
    protected void appendNarrations(NarrationMessageBuilder builder, E entry) {
        ...
        if (list.size() > 1 && (i = list.indexOf(entry)) != -1) {
            builder.put(NarrationPart.POSITION, (Text)Text.translatable((String)"narrator.position.list", (Object[])new Object[]{i + 1, list.size()}));
        }
    }
