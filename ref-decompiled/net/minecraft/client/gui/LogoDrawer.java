...
public class LogoDrawer {
    public static final Identifier LOGO_TEXTURE = Identifier.ofVanilla((String)"textures/gui/title/minecraft.png");
    public static final Identifier MINCERAFT_TEXTURE = Identifier.ofVanilla((String)"textures/gui/title/minceraft.png");
    public static final Identifier EDITION_TEXTURE = Identifier.ofVanilla((String)"textures/gui/title/edition.png");
    ...
    public void draw(DrawContext context, int screenWidth, float alpha, int y) {
        ...
        int j = ColorHelper.getWhite((float)f);
        context.drawTexture(RenderPipelines.GUI_TEXTURED, this.minceraft ? MINCERAFT_TEXTURE : LOGO_TEXTURE, i, y, 0.0f, 0.0f, 256, 44, 256, 64, j);
