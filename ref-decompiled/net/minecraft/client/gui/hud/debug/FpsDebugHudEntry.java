...
implements DebugHudEntry {
    public void render(DebugHudLines lines, @Nullable World world, @Nullable WorldChunk clientChunk, @Nullable WorldChunk chunk) {
        ...
        lines.addPriorityLine(String.format(Locale.ROOT, "%d fps T: %s%s", minecraftClient.getCurrentFps(), i == 260 ? "inf" : Integer.valueOf(i), (Boolean)gameOptions.getEnableVsync().getValue() != false ? " vsync" : ""));
    }
