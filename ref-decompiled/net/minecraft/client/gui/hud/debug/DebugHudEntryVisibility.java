...
implements StringIdentifiable {
    public static final /* enum */ DebugHudEntryVisibility ALWAYS_ON = new DebugHudEntryVisibility("ALWAYS_ON", 0, "alwaysOn");
    public static final /* enum */ DebugHudEntryVisibility IN_OVERLAY = new DebugHudEntryVisibility("IN_OVERLAY", 1, "inOverlay");
    public static final /* enum */ DebugHudEntryVisibility NEVER = new DebugHudEntryVisibility("NEVER", 2, "never");
