...
public class TickChart extends DebugChart {
   ...
   private final Supplier millisPerTickSupplier;

   public TickChart(TextRenderer textRenderer, MultiValueDebugSampleLog log, Supplier millisPerTickSupplier) {
   ...
   protected int getHeight(double value) {
      return (int)Math.round(toMillisecondsPerTick(value) * 60.0 / (double)(Float)this.millisPerTickSupplier.get());
   }
