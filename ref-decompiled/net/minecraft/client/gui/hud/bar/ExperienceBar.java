...
implements Bar {
    private static final Identifier BACKGROUND = Identifier.ofVanilla((String)"hud/experience_bar_background");
    private static final Identifier PROGRESS = Identifier.ofVanilla((String)"hud/experience_bar_progress");
