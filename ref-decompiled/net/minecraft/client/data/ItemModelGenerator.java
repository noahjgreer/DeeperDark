 ...
 *  net.minecraft.item.equipment.trim.ArmorTrimMaterials
...
public class ItemModelGenerator {
    private static final TintSource UNTINTED = ItemModels.constantTintSource((int)-1);
    public static final Identifier HELMET_TRIM_ID_PREFIX = ItemModelGenerator.getTrimAssetIdPrefix((String)"helmet");
    public static final Identifier CHESTPLATE_TRIM_ID_PREFIX = ItemModelGenerator.getTrimAssetIdPrefix((String)"chestplate");
    public static final Identifier LEGGINGS_TRIM_ID_PREFIX = ItemModelGenerator.getTrimAssetIdPrefix((String)"leggings");
    public static final Identifier BOOTS_TRIM_ID_PREFIX = ItemModelGenerator.getTrimAssetIdPrefix((String)"boots");
    ...
    public static Identifier getTrimAssetIdPrefix(String prefix) {
        return Identifier.ofVanilla((String)("trims/items/" + prefix + "_trim"));
    }
    ...
    public final void register(Item item) {
        this.output.accept(item, ItemModels.basic((Identifier)ModelIds.getItemModelId((Item)item)));
    }

    public final Identifier upload(Item item, Model model) {
        return model.upload(ModelIds.getItemModelId((Item)item), TextureMap.layer0((Item)item), this.modelCollector);
    }

    public final void register(Item item, Model model) {
        this.output.accept(item, ItemModels.basic((Identifier)this.upload(item, model)));
    }

    public final Identifier registerSubModel(Item item, String suffix, Model model) {
        return model.upload(ModelIds.getItemSubModelId((Item)item, (String)suffix), TextureMap.layer0((Identifier)TextureMap.getSubId((Item)item, (String)suffix)), this.modelCollector);
    }

    public final Identifier uploadWithTextureSource(Item item, Item textureSourceItem, Model model) {
        return model.upload(ModelIds.getItemModelId((Item)item), TextureMap.layer0((Item)textureSourceItem), this.modelCollector);
    }

    public final void registerWithTextureSource(Item item, Item textureSourceItem, Model model) {
        this.output.accept(item, ItemModels.basic((Identifier)this.uploadWithTextureSource(item, textureSourceItem, model)));
    }
    ...
    public final void registerWithTintedLayer(Item item, String layer1Suffix, TintSource tint) {
        Identifier identifier = this.uploadTwoLayers(item, TextureMap.getId((Item)item), TextureMap.getSubId((Item)item, (String)layer1Suffix));
        this.output.accept(item, ItemModels.tinted((Identifier)identifier, (TintSource[])new TintSource[]{UNTINTED, tint}));
    }

    public final void registerWithTintedOverlay(Item item, int tint) {
        Identifier identifier = TextureMap.getId((Item)item);
        Identifier identifier2 = TextureMap.getSubId((Item)item, (String)"_overlay");
        Identifier identifier3 = ModelIds.getItemModelId((Item)item);
        Models.GENERATED_TWO_LAYERS.upload(identifier3, TextureMap.layered((Identifier)identifier, (Identifier)identifier2), this.modelCollector);
        this.output.accept(item, ItemModels.tinted((Identifier)identifier3, (TintSource[])new TintSource[]{new DyeTintSource(tint)}));
    }
    ...
    public final List<RangeDispatchItemModel.Entry> createCompassRangeDispatchEntries(Item item) {
        ...
        ItemModel.Unbaked unbaked = ItemModels.basic((Identifier)this.registerSubModel(item, "_16", Models.GENERATED));
        list.add(ItemModels.rangeDispatchEntry((ItemModel.Unbaked)unbaked, (float)0.0f));
        for (int i = 1; i < 32; ++i) {
            int j = MathHelper.floorMod((int)(i - 16), (int)32);
            ItemModel.Unbaked unbaked2 = ItemModels.basic((Identifier)this.registerSubModel(item, String.format(Locale.ROOT, "_%02d", j), Models.GENERATED));
            list.add(ItemModels.rangeDispatchEntry((ItemModel.Unbaked)unbaked2, (float)((float)i - 0.5f)));
        }
        list.add(ItemModels.rangeDispatchEntry((ItemModel.Unbaked)unbaked, (float)31.5f));
        return list;
    }

    public final void registerCompass(Item item) {
        List list = this.createCompassRangeDispatchEntries(item);
        this.output.accept(item, ItemModels.condition((BooleanProperty)ItemModels.hasComponentProperty((ComponentType)DataComponentTypes.LODESTONE_TRACKER), (ItemModel.Unbaked)ItemModels.rangeDispatch((NumericProperty)new CompassProperty(true, CompassState.Target.LODESTONE), (float)32.0f, (List)list), (ItemModel.Unbaked)ItemModels.rangeDispatch((NumericProperty)new CompassProperty(true, CompassState.Target.SPAWN), (float)32.0f, (List)list)));
    }

    public final void registerRecoveryCompass(Item item) {
        this.output.accept(item, ItemModels.rangeDispatch((NumericProperty)new CompassProperty(true, CompassState.Target.RECOVERY), (float)32.0f, (List)this.createCompassRangeDispatchEntries(item)));
    }

    public final void registerClock(Item clock) {
        ArrayList<RangeDispatchItemModel.Entry> list = new ArrayList<RangeDispatchItemModel.Entry>();
        ItemModel.Unbaked unbaked = ItemModels.basic((Identifier)this.registerSubModel(clock, "_00", Models.GENERATED));
        list.add(ItemModels.rangeDispatchEntry((ItemModel.Unbaked)unbaked, (float)0.0f));
        for (int i = 1; i < 64; ++i) {
            ItemModel.Unbaked unbaked2 = ItemModels.basic((Identifier)this.registerSubModel(clock, String.format(Locale.ROOT, "_%02d", i), Models.GENERATED));
            list.add(ItemModels.rangeDispatchEntry((ItemModel.Unbaked)unbaked2, (float)((float)i - 0.5f)));
        }
        list.add(ItemModels.rangeDispatchEntry((ItemModel.Unbaked)unbaked, (float)63.5f));
        this.output.accept(clock, ItemModels.overworldSelect((ItemModel.Unbaked)ItemModels.rangeDispatch((NumericProperty)new TimeProperty(true, TimeProperty.Source.DAYTIME), (float)64.0f, list), (ItemModel.Unbaked)ItemModels.rangeDispatch((NumericProperty)new TimeProperty(true, TimeProperty.Source.RANDOM), (float)64.0f, list)));
    }

    public final Identifier uploadTwoLayers(Item item, Identifier layer0, Identifier layer1) {
        return Models.GENERATED_TWO_LAYERS.upload(item, TextureMap.layered((Identifier)layer0, (Identifier)layer1), this.modelCollector);
    }

    public final Identifier uploadArmor(Identifier id, Identifier layer0, Identifier layer1) {
        return Models.GENERATED_TWO_LAYERS.upload(id, TextureMap.layered((Identifier)layer0, (Identifier)layer1), this.modelCollector);
    }

    public final void uploadArmor(Identifier id, Identifier layer0, Identifier layer1, Identifier layer2) {
        Models.GENERATED_THREE_LAYERS.upload(id, TextureMap.layered((Identifier)layer0, (Identifier)layer1, (Identifier)layer2), this.modelCollector);
    }
    ...
    public final void registerArmor(Item item, RegistryKey<EquipmentAsset> equipmentKey, Identifier trimIdPrefix, boolean dyeable) {
        ...
        Identifier identifier2 = TextureMap.getId((Item)item);
        Identifier identifier3 = TextureMap.getSubId((Item)item, (String)"_overlay");
        ArrayList<SelectItemModel.SwitchCase> list = new ArrayList<SelectItemModel.SwitchCase>(TRIM_MATERIALS.size());
        for (TrimMaterial trimMaterial : TRIM_MATERIALS) {
            ...
            if (dyeable) {
                ...
                unbaked = ItemModels.tinted((Identifier)identifier4, (TintSource[])new TintSource[]{new DyeTintSource(-6265536)});
            } else {
                this.uploadArmor(identifier4, identifier2, identifier5);
                unbaked = ItemModels.basic((Identifier)identifier4);
            }
            list.add(ItemModels.switchCase((Object)trimMaterial.materialKey, (ItemModel.Unbaked)unbaked));
        }
        if (dyeable) {
            Models.GENERATED_TWO_LAYERS.upload(identifier, TextureMap.layered((Identifier)identifier2, (Identifier)identifier3), this.modelCollector);
            unbaked2 = ItemModels.tinted((Identifier)identifier, (TintSource[])new TintSource[]{new DyeTintSource(-6265536)});
        } else {
            Models.GENERATED.upload(identifier, TextureMap.layer0((Identifier)identifier2), this.modelCollector);
            unbaked2 = ItemModels.basic((Identifier)identifier);
        }
        this.output.accept(item, ItemModels.select((SelectProperty)new TrimMaterialProperty(), (ItemModel.Unbaked)unbaked2, list));
    }

    public final void registerBundle(Item item) {
        ItemModel.Unbaked unbaked = ItemModels.basic((Identifier)this.upload(item, Models.GENERATED));
        ...
        ItemModel.Unbaked unbaked2 = ItemModels.composite((ItemModel.Unbaked[])new ItemModel.Unbaked[]{ItemModels.basic((Identifier)identifier), new BundleSelectedItemModel.Unbaked(), ItemModels.basic((Identifier)identifier2)});
        ItemModel.Unbaked unbaked3 = ItemModels.condition((BooleanProperty)new BundleHasSelectedItemProperty(), (ItemModel.Unbaked)unbaked2, (ItemModel.Unbaked)unbaked);
        this.output.accept(item, ItemModels.select((SelectProperty)new DisplayContextProperty(), (ItemModel.Unbaked)unbaked, (SelectItemModel.SwitchCase[])new SelectItemModel.SwitchCase[]{ItemModels.switchCase((Object)ItemDisplayContext.GUI, (ItemModel.Unbaked)unbaked3)}));
    }

    public final Identifier uploadOpenBundleModel(Item item, Model model, String textureSuffix) {
        Identifier identifier = TextureMap.getSubId((Item)item, (String)textureSuffix);
        return model.upload(item, TextureMap.layer0((Identifier)identifier), this.modelCollector);
    }

    public final void registerBow(Item item) {
        ItemModel.Unbaked unbaked = ItemModels.basic((Identifier)ModelIds.getItemModelId((Item)item));
        ItemModel.Unbaked unbaked2 = ItemModels.basic((Identifier)this.registerSubModel(item, "_pulling_0", Models.BOW));
        ItemModel.Unbaked unbaked3 = ItemModels.basic((Identifier)this.registerSubModel(item, "_pulling_1", Models.BOW));
        ItemModel.Unbaked unbaked4 = ItemModels.basic((Identifier)this.registerSubModel(item, "_pulling_2", Models.BOW));
        this.output.accept(item, ItemModels.condition((BooleanProperty)ItemModels.usingItemProperty(), (ItemModel.Unbaked)ItemModels.rangeDispatch((NumericProperty)new UseDurationProperty(false), (float)0.05f, (ItemModel.Unbaked)unbaked2, (RangeDispatchItemModel.Entry[])new RangeDispatchItemModel.Entry[]{ItemModels.rangeDispatchEntry((ItemModel.Unbaked)unbaked3, (float)0.65f), ItemModels.rangeDispatchEntry((ItemModel.Unbaked)unbaked4, (float)0.9f)}), (ItemModel.Unbaked)unbaked));
    }

    public final void registerCrossbow(Item item) {
        ItemModel.Unbaked unbaked = ItemModels.basic((Identifier)ModelIds.getItemModelId((Item)item));
        ItemModel.Unbaked unbaked2 = ItemModels.basic((Identifier)this.registerSubModel(item, "_pulling_0", Models.CROSSBOW));
        ItemModel.Unbaked unbaked3 = ItemModels.basic((Identifier)this.registerSubModel(item, "_pulling_1", Models.CROSSBOW));
        ItemModel.Unbaked unbaked4 = ItemModels.basic((Identifier)this.registerSubModel(item, "_pulling_2", Models.CROSSBOW));
        ItemModel.Unbaked unbaked5 = ItemModels.basic((Identifier)this.registerSubModel(item, "_arrow", Models.CROSSBOW));
        ItemModel.Unbaked unbaked6 = ItemModels.basic((Identifier)this.registerSubModel(item, "_firework", Models.CROSSBOW));
        this.output.accept(item, ItemModels.select((SelectProperty)new ChargeTypeProperty(), (ItemModel.Unbaked)ItemModels.condition((BooleanProperty)ItemModels.usingItemProperty(), (ItemModel.Unbaked)ItemModels.rangeDispatch((NumericProperty)new CrossbowPullProperty(), (ItemModel.Unbaked)unbaked2, (RangeDispatchItemModel.Entry[])new RangeDispatchItemModel.Entry[]{ItemModels.rangeDispatchEntry((ItemModel.Unbaked)unbaked3, (float)0.58f), ItemModels.rangeDispatchEntry((ItemModel.Unbaked)unbaked4, (float)1.0f)}), (ItemModel.Unbaked)unbaked), (SelectItemModel.SwitchCase[])new SelectItemModel.SwitchCase[]{ItemModels.switchCase((Object)CrossbowItem.ChargeType.ARROW, (ItemModel.Unbaked)unbaked5), ItemModels.switchCase((Object)CrossbowItem.ChargeType.ROCKET, (ItemModel.Unbaked)unbaked6)}));
    }
    ...
    public final void registerCondition(Item item, BooleanProperty property, ItemModel.Unbaked onTrue, ItemModel.Unbaked onFalse) {
        this.output.accept(item, ItemModels.condition((BooleanProperty)property, (ItemModel.Unbaked)onTrue, (ItemModel.Unbaked)onFalse));
    }

    public final void registerWithBrokenCondition(Item item) {
        ItemModel.Unbaked unbaked = ItemModels.basic((Identifier)this.upload(item, Models.GENERATED));
        ItemModel.Unbaked unbaked2 = ItemModels.basic((Identifier)this.registerSubModel(item, "_broken", Models.GENERATED));
        this.registerCondition(item, (BooleanProperty)new BrokenProperty(), unbaked2, unbaked);
    }

    public final void registerBrush(Item item) {
        ItemModel.Unbaked unbaked = ItemModels.basic((Identifier)ModelIds.getItemModelId((Item)item));
        ItemModel.Unbaked unbaked2 = ItemModels.basic((Identifier)ModelIds.getItemSubModelId((Item)item, (String)"_brushing_0"));
        ItemModel.Unbaked unbaked3 = ItemModels.basic((Identifier)ModelIds.getItemSubModelId((Item)item, (String)"_brushing_1"));
        ItemModel.Unbaked unbaked4 = ItemModels.basic((Identifier)ModelIds.getItemSubModelId((Item)item, (String)"_brushing_2"));
        this.output.accept(item, ItemModels.rangeDispatch((NumericProperty)new UseCycleProperty(10.0f), (float)0.1f, (ItemModel.Unbaked)unbaked, (RangeDispatchItemModel.Entry[])new RangeDispatchItemModel.Entry[]{ItemModels.rangeDispatchEntry((ItemModel.Unbaked)unbaked2, (float)0.25f), ItemModels.rangeDispatchEntry((ItemModel.Unbaked)unbaked3, (float)0.5f), ItemModels.rangeDispatchEntry((ItemModel.Unbaked)unbaked4, (float)0.75f)}));
    }

    public final void registerFishingRod(Item item) {
        ItemModel.Unbaked unbaked = ItemModels.basic((Identifier)this.upload(item, Models.HANDHELD_ROD));
        ItemModel.Unbaked unbaked2 = ItemModels.basic((Identifier)this.registerSubModel(item, "_cast", Models.HANDHELD_ROD));
        this.registerCondition(item, (BooleanProperty)new FishingRodCastProperty(), unbaked2, unbaked);
    }

    public final void registerGoatHorn(Item item) {
        ItemModel.Unbaked unbaked = ItemModels.basic((Identifier)ModelIds.getItemModelId((Item)item));
        ItemModel.Unbaked unbaked2 = ItemModels.basic((Identifier)ModelIds.getMinecraftNamespacedItem((String)"tooting_goat_horn"));
        this.registerCondition(item, ItemModels.usingItemProperty(), unbaked2, unbaked);
    }

    public final void registerShield(Item item) {
        ItemModel.Unbaked unbaked = ItemModels.special((Identifier)ModelIds.getItemModelId((Item)item), (SpecialModelRenderer.Unbaked)new ShieldModelRenderer.Unbaked());
        ItemModel.Unbaked unbaked2 = ItemModels.special((Identifier)ModelIds.getItemSubModelId((Item)item, (String)"_blocking"), (SpecialModelRenderer.Unbaked)new ShieldModelRenderer.Unbaked());
        this.registerCondition(item, ItemModels.usingItemProperty(), unbaked2, unbaked);
    }

    public static ItemModel.Unbaked createModelWithInHandVariant(ItemModel.Unbaked model, ItemModel.Unbaked inHandModel) {
        return ItemModels.select((SelectProperty)new DisplayContextProperty(), (ItemModel.Unbaked)inHandModel, (SelectItemModel.SwitchCase[])new SelectItemModel.SwitchCase[]{ItemModels.switchCase(List.of(ItemDisplayContext.GUI, ItemDisplayContext.GROUND, ItemDisplayContext.FIXED, ItemDisplayContext.ON_SHELF), (ItemModel.Unbaked)model)});
    }

    public final void registerWithInHandModel(Item item) {
        ItemModel.Unbaked unbaked = ItemModels.basic((Identifier)this.upload(item, Models.GENERATED));
        ItemModel.Unbaked unbaked2 = ItemModels.basic((Identifier)ModelIds.getItemSubModelId((Item)item, (String)"_in_hand"));
        this.output.accept(item, ItemModelGenerator.createModelWithInHandVariant((ItemModel.Unbaked)unbaked, (ItemModel.Unbaked)unbaked2));
    }

    public final void registerTrident(Item item) {
        ItemModel.Unbaked unbaked = ItemModels.basic((Identifier)this.upload(item, Models.GENERATED));
        ItemModel.Unbaked unbaked2 = ItemModels.special((Identifier)ModelIds.getItemSubModelId((Item)item, (String)"_in_hand"), (SpecialModelRenderer.Unbaked)new TridentModelRenderer.Unbaked());
        ItemModel.Unbaked unbaked3 = ItemModels.special((Identifier)ModelIds.getItemSubModelId((Item)item, (String)"_throwing"), (SpecialModelRenderer.Unbaked)new TridentModelRenderer.Unbaked());
        ItemModel.Unbaked unbaked4 = ItemModels.condition((BooleanProperty)ItemModels.usingItemProperty(), (ItemModel.Unbaked)unbaked3, (ItemModel.Unbaked)unbaked2);
        this.output.accept(item, ItemModelGenerator.createModelWithInHandVariant((ItemModel.Unbaked)unbaked, (ItemModel.Unbaked)unbaked4));
    }

    public final void registerSpear(Item item) {
        ItemModel.Unbaked unbaked = ItemModels.basic((Identifier)this.upload(item, Models.GENERATED));
        ItemModel.Unbaked unbaked2 = ItemModels.basic((Identifier)Models.SPEAR_IN_HAND.upload(item, TextureMap.layer0((Identifier)TextureMap.getSubId((Item)item, (String)"_in_hand")), this.modelCollector));
        this.output.accept(item, ItemModelGenerator.createModelWithInHandVariant((ItemModel.Unbaked)unbaked, (ItemModel.Unbaked)unbaked2), new ItemAsset.Properties(true, false, 1.95f));
    }

    public final void registerPotionTinted(Item item, Identifier model) {
        this.output.accept(item, ItemModels.tinted((Identifier)model, (TintSource[])new TintSource[]{new PotionTintSource()}));
    }

    public final void registerPotion(Item item) {
        Identifier identifier = this.uploadTwoLayers(item, ModelIds.getMinecraftNamespacedItem((String)"potion_overlay"), ModelIds.getItemModelId((Item)item));
        this.registerPotionTinted(item, identifier);
    }

    public final void registerTippedArrow(Item item) {
        Identifier identifier = this.uploadTwoLayers(item, ModelIds.getItemSubModelId((Item)item, (String)"_head"), ModelIds.getItemSubModelId((Item)item, (String)"_base"));
        this.registerPotionTinted(item, identifier);
    }

    public final void registerDyeable(Item item, int defaultColor) {
        Identifier identifier = this.upload(item, Models.GENERATED);
        this.output.accept(item, ItemModels.tinted((Identifier)identifier, (TintSource[])new TintSource[]{new DyeTintSource(defaultColor)}));
    }

    public final void registerWithDyeableOverlay(Item item) {
        Identifier identifier = TextureMap.getId((Item)item);
        Identifier identifier2 = TextureMap.getSubId((Item)item, (String)"_overlay");
        Identifier identifier3 = Models.GENERATED.upload(item, TextureMap.layer0((Identifier)identifier), this.modelCollector);
        Identifier identifier4 = ModelIds.getItemSubModelId((Item)item, (String)"_dyed");
        Models.GENERATED_TWO_LAYERS.upload(identifier4, TextureMap.layered((Identifier)identifier, (Identifier)identifier2), this.modelCollector);
        this.output.accept(item, ItemModels.condition((BooleanProperty)ItemModels.hasComponentProperty((ComponentType)DataComponentTypes.DYED_COLOR), (ItemModel.Unbaked)ItemModels.tinted((Identifier)identifier4, (TintSource[])new TintSource[]{UNTINTED, new DyeTintSource(0)}), (ItemModel.Unbaked)ItemModels.basic((Identifier)identifier3)));
    }
    ...
    public void register() {
        ...
        this.registerWithTintedOverlay(Items.FIREWORK_STAR, (TintSource)new FireworkTintSource());
        this.registerWithTintedLayer(Items.FILLED_MAP, "_markings", (TintSource)new MapColorTintSource());
