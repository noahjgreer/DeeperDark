...
public class ItemModelGenerator {
   ...
   public static final List TRIM_MATERIALS;
   ...
   public ItemModelGenerator(ItemModelOutput output, BiConsumer modelCollector) {
      this.output = output;
   ...
   public final List createCompassRangeDispatchEntries(Item item) {
      ...
      for(int i = 1; i < 32; ++i) {
         ...
         list.add(ItemModels.rangeDispatchEntry(unbaked2, (float)i - 0.5F));
      }
   ...
   public final void registerCompass(Item item) {
      ...
      this.output.accept(item, ItemModels.condition(ItemModels.hasComponentProperty(DataComponentTypes.LODESTONE_TRACKER), ItemModels.rangeDispatch(new CompassProperty(true, CompassState.Target.LODESTONE), 32.0F, list), ItemModels.overworldSelect(ItemModels.rangeDispatch(new CompassProperty(true, CompassState.Target.SPAWN), 32.0F, list), ItemModels.rangeDispatch(new CompassProperty(true, CompassState.Target.NONE), 32.0F, list))));
   }

   public final void registerRecoveryCompass(Item item) {
      this.output.accept(item, ItemModels.rangeDispatch(new CompassProperty(true, CompassState.Target.RECOVERY), 32.0F, this.createCompassRangeDispatchEntries(item)));
   }
   ...
   public final void registerClock(Item clock) {
      ...
      this.output.accept(clock, ItemModels.overworldSelect(ItemModels.rangeDispatch(new TimeProperty(true, TimeProperty.Source.DAYTIME), 64.0F, list), ItemModels.rangeDispatch(new TimeProperty(true, TimeProperty.Source.RANDOM), 64.0F, list)));
   }
   ...
   public final void registerArmor(Item item, RegistryKey equipmentKey, Identifier trimIdPrefix, boolean dyeable) {
      ...
      List list = new ArrayList(TRIM_MATERIALS.size());

      TrimMaterial trimMaterial;
      ItemModel.Unbaked unbaked;
      for(Iterator var9 = TRIM_MATERIALS.iterator(); var9.hasNext(); list.add(ItemModels.switchCase((Object)trimMaterial.materialKey, unbaked))) {
         trimMaterial = (TrimMaterial)var9.next();
      ...
      this.output.accept(item, ItemModels.select((SelectProperty)(new TrimMaterialProperty()), unbaked2, (List)list));
   }
   ...
   public final void registerBundle(Item item) {
      ...
      this.output.accept(item, ItemModels.select((SelectProperty)(new DisplayContextProperty()), unbaked, (SelectItemModel.SwitchCase[])(ItemModels.switchCase((Object)ItemDisplayContext.GUI, unbaked3))));
   }
   ...
   public final void registerBow(Item item) {
      ...
      this.output.accept(item, ItemModels.condition(ItemModels.usingItemProperty(), ItemModels.rangeDispatch(new UseDurationProperty(false), 0.05F, unbaked2, ItemModels.rangeDispatchEntry(unbaked3, 0.65F), ItemModels.rangeDispatchEntry(unbaked4, 0.9F)), unbaked));
   }
   ...
   public final void registerCrossbow(Item item) {
      ...
      this.output.accept(item, ItemModels.select((SelectProperty)(new ChargeTypeProperty()), ItemModels.condition(ItemModels.usingItemProperty(), ItemModels.rangeDispatch(new CrossbowPullProperty(), unbaked2, (RangeDispatchItemModel.Entry[])(ItemModels.rangeDispatchEntry(unbaked3, 0.58F), ItemModels.rangeDispatchEntry(unbaked4, 1.0F))), unbaked), (SelectItemModel.SwitchCase[])(ItemModels.switchCase((Object)CrossbowItem.ChargeType.ARROW, unbaked5), ItemModels.switchCase((Object)CrossbowItem.ChargeType.ROCKET, unbaked6))));
   }
   ...
   public final void registerBrush(Item item) {
      ...
      this.output.accept(item, ItemModels.rangeDispatch(new UseCycleProperty(10.0F), 0.1F, unbaked, ItemModels.rangeDispatchEntry(unbaked2, 0.25F), ItemModels.rangeDispatchEntry(unbaked3, 0.5F), ItemModels.rangeDispatchEntry(unbaked4, 0.75F)));
   }
   ...
   public static ItemModel.Unbaked createModelWithInHandVariant(ItemModel.Unbaked model, ItemModel.Unbaked inHandModel) {
      return ItemModels.select((SelectProperty)(new DisplayContextProperty()), inHandModel, (SelectItemModel.SwitchCase[])(ItemModels.switchCase(List.of(ItemDisplayContext.GUI, ItemDisplayContext.GROUND, ItemDisplayContext.FIXED), model)));
   }
   ...
   public final void registerWithDyeableOverlay(Item item) {
      ...
      this.output.accept(item, ItemModels.condition(ItemModels.hasComponentProperty(DataComponentTypes.DYED_COLOR), ItemModels.tinted(identifier4, UNTINTED, new DyeTintSource(0)), ItemModels.basic(identifier3)));
   }
   ...
   public static record TrimMaterial(ArmorTrimAssets assets, RegistryKey materialKey) {
      ...
      public RegistryKey materialKey() {
