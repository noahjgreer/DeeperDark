...
public class TexturedModel {
    ...
    public static final Factory CUBE_ALL_INNER_FACES = TexturedModel.makeFactory(TextureMap::all, Models.CUBE_ALL_INNER_FACES);
    ...
    public static final Factory MOSSY_CARPET_SIDE = TexturedModel.makeFactory(TextureMap::side, Models.MOSSY_CARPET_SIDE);
    public static final Factory FLOWERBED_1 = TexturedModel.makeFactory(TextureMap::flowerbed, Models.FLOWERBED_1);
    public static final Factory FLOWERBED_2 = TexturedModel.makeFactory(TextureMap::flowerbed, Models.FLOWERBED_2);
    public static final Factory FLOWERBED_3 = TexturedModel.makeFactory(TextureMap::flowerbed, Models.FLOWERBED_3);
    public static final Factory FLOWERBED_4 = TexturedModel.makeFactory(TextureMap::flowerbed, Models.FLOWERBED_4);
    public static final Factory TEMPLATE_LEAF_LITTER_1 = TexturedModel.makeFactory(TextureMap::texture, Models.TEMPLATE_LEAF_LITTER_1);
    public static final Factory TEMPLATE_LEAF_LITTER_2 = TexturedModel.makeFactory(TextureMap::texture, Models.TEMPLATE_LEAF_LITTER_2);
    public static final Factory TEMPLATE_LEAF_LITTER_3 = TexturedModel.makeFactory(TextureMap::texture, Models.TEMPLATE_LEAF_LITTER_3);
    public static final Factory TEMPLATE_LEAF_LITTER_4 = TexturedModel.makeFactory(TextureMap::texture, Models.TEMPLATE_LEAF_LITTER_4);
    ...
    public static final Factory TEMPLATE_CHAIN = TexturedModel.makeFactory(TextureMap::texture, Models.TEMPLATE_CHAIN);
