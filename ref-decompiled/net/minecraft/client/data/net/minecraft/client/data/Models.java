...
public class Models {
    ...
    public static final Model CUBE_ALL_INNER_FACES = Models.block("cube_all_inner_faces", TextureKey.ALL);
    ...
    public static final Model CUBE_BOTTOM_TOP_INNER_FACES = Models.block("cube_bottom_top_inner_faces", TextureKey.TOP, TextureKey.BOTTOM, TextureKey.SIDE);
    ...
    public static final Model CROSS_EMISSIVE = Models.block("cross_emissive", TextureKey.CROSS, TextureKey.CROSS_EMISSIVE);
    ...
    public static final Model FLOWER_POT_CROSS_EMISSIVE = Models.block("flower_pot_cross_emissive", TextureKey.PLANT, TextureKey.CROSS_EMISSIVE);
    ...
    public static final Model MOSSY_CARPET_SIDE = Models.block("mossy_carpet_side", TextureKey.SIDE);
    ...
    public static final Model TEMPLATE_LEAF_LITTER_1 = Models.block("template_leaf_litter_1", "_1", TextureKey.TEXTURE);
    public static final Model TEMPLATE_LEAF_LITTER_2 = Models.block("template_leaf_litter_2", "_2", TextureKey.TEXTURE);
    public static final Model TEMPLATE_LEAF_LITTER_3 = Models.block("template_leaf_litter_3", "_3", TextureKey.TEXTURE);
    public static final Model TEMPLATE_LEAF_LITTER_4 = Models.block("template_leaf_litter_4", "_4", TextureKey.TEXTURE);
    ...
    public static final Model TEMPLATE_SHELF_BODY = Models.block("template_shelf_body", TextureKey.ALL, TextureKey.PARTICLE);
    public static final Model TEMPLATE_SHELF_INVENTORY = Models.block("template_shelf_inventory", "_inventory", TextureKey.ALL, TextureKey.PARTICLE);
    public static final Model TEMPLATE_SHELF_UNPOWERED = Models.block("template_shelf_unpowered", "_unpowered", TextureKey.ALL, TextureKey.PARTICLE);
    public static final Model TEMPLATE_SHELF_UNCONNECTED = Models.block("template_shelf_unconnected", "_unconnected", TextureKey.ALL, TextureKey.PARTICLE);
    public static final Model TEMPLATE_SHELF_LEFT = Models.block("template_shelf_left", "_left", TextureKey.ALL, TextureKey.PARTICLE);
    public static final Model TEMPLATE_SHELF_CENTER = Models.block("template_shelf_center", "_center", TextureKey.ALL, TextureKey.PARTICLE);
    public static final Model TEMPLATE_SHELF_RIGHT = Models.block("template_shelf_right", "_right", TextureKey.ALL, TextureKey.PARTICLE);
    ...
    public static final Model TEMPLATE_CHAIN = Models.block("template_chain", TextureKey.TEXTURE);
    public static final Model TEMPLATE_BARS_CAP = Models.block("template_bars_cap", "_cap", TextureKey.BARS, TextureKey.EDGE);
    public static final Model TEMPLATE_BARS_CAP_ALT = Models.block("template_bars_cap_alt", "_cap_alt", TextureKey.BARS, TextureKey.EDGE);
    public static final Model TEMPLATE_BARS_POST = Models.block("template_bars_post", "_post", TextureKey.BARS, TextureKey.EDGE);
    public static final Model TEMPLATE_BARS_POST_ENDS = Models.block("template_bars_post_ends", "_post_ends", TextureKey.BARS, TextureKey.EDGE);
    public static final Model TEMPLATE_BARS_SIDE = Models.block("template_bars_side", "_side", TextureKey.BARS, TextureKey.EDGE);
    public static final Model TEMPLATE_BARS_SIDE_ALT = Models.block("template_bars_side_alt", "_side_alt", TextureKey.BARS, TextureKey.EDGE);
    public static final Model TEMPLATE_TORCH = Models.block("template_torch", TextureKey.TORCH);
    public static final Model TEMPLATE_TORCH_UNLIT = Models.block("template_torch_unlit", TextureKey.TORCH);
    public static final Model TEMPLATE_TORCH_WALL = Models.block("template_torch_wall", TextureKey.TORCH);
    public static final Model TEMPLATE_TORCH_WALL_UNLIT = Models.block("template_torch_wall_unlit", TextureKey.TORCH);
    public static final Model TEMPLATE_REDSTONE_TORCH = Models.block("template_redstone_torch", TextureKey.TORCH);
    public static final Model TEMPLATE_REDSTONE_TORCH_WALL = Models.block("template_redstone_torch_wall", TextureKey.TORCH);
    ...
    public static final Model DRIED_GHAST = Models.block("dried_ghast", TextureKey.PARTICLE, TextureKey.TOP, TextureKey.BOTTOM, TextureKey.NORTH, TextureKey.SOUTH, TextureKey.EAST, TextureKey.WEST, TextureKey.TENTACLES);
    ...
    public static final Model TEMPLATE_CHEST = Models.item("template_chest", TextureKey.PARTICLE);
    public static final Model TEMPLATE_BUNDLE_OPEN_FRONT = Models.openBundle("template_bundle_open_front", "_open_front", TextureKey.LAYER0);
    public static final Model TEMPLATE_BUNDLE_OPEN_BACK = Models.openBundle("template_bundle_open_back", "_open_back", TextureKey.LAYER0);
    public static final Model BOW = Models.item("bow", TextureKey.LAYER0);
    public static final Model CROSSBOW = Models.item("crossbow", TextureKey.LAYER0);
    public static final Model SPEAR_IN_HAND = Models.openBundle("spear_in_hand", "_in_hand", TextureKey.LAYER0);
    ...
    public static final Model TEMPLATE_VAULT = Models.block("template_vault", TextureKey.TOP, TextureKey.BOTTOM, TextureKey.SIDE, TextureKey.FRONT);
    public static final Model HANDHELD_MACE = Models.item("handheld_mace", TextureKey.LAYER0);
    public static final Model TEMPLATE_LIGHTNING_ROD = Models.block("template_lightning_rod", TextureKey.TEXTURE);
