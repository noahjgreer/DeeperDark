...
public class TextureMap {
    ...
    public static TextureMap crossAndCrossEmissive(Block block) {
        return new TextureMap().put(TextureKey.CROSS, TextureMap.getId(block)).put(TextureKey.CROSS_EMISSIVE, TextureMap.getSubId(block, "_emissive"));
    }
    ...
    public static TextureMap plantAndCrossEmissive(Block block) {
        return new TextureMap().put(TextureKey.PLANT, TextureMap.getId(block)).put(TextureKey.CROSS_EMISSIVE, TextureMap.getSubId(block, "_emissive"));
    }
    ...
    public static TextureMap driedGhast(String hydration) {
        return new TextureMap().put(TextureKey.PARTICLE, TextureMap.getSubId(Blocks.DRIED_GHAST, hydration + "_north")).put(TextureKey.BOTTOM, TextureMap.getSubId(Blocks.DRIED_GHAST, hydration + "_bottom")).put(TextureKey.TOP, TextureMap.getSubId(Blocks.DRIED_GHAST, hydration + "_top")).put(TextureKey.NORTH, TextureMap.getSubId(Blocks.DRIED_GHAST, hydration + "_north")).put(TextureKey.SOUTH, TextureMap.getSubId(Blocks.DRIED_GHAST, hydration + "_south")).put(TextureKey.EAST, TextureMap.getSubId(Blocks.DRIED_GHAST, hydration + "_east")).put(TextureKey.WEST, TextureMap.getSubId(Blocks.DRIED_GHAST, hydration + "_west")).put(TextureKey.TENTACLES, TextureMap.getSubId(Blocks.DRIED_GHAST, hydration + "_tentacles"));
    }
    ...
    public static TextureMap bars(Block block) {
        return new TextureMap().put(TextureKey.BARS, TextureMap.getId(block)).put(TextureKey.EDGE, TextureMap.getId(block));
    }
