...
public class TextureMap {
   ...
   private final Set inherited = Sets.newHashSet();
   ...
   public static TextureMap wallSideTopBottom(Block block) {
      Identifier identifier = getId(block);
      return (new TextureMap()).put(TextureKey.WALL, identifier).put(TextureKey.SIDE, identifier).put(TextureKey.TOP, getSubId(block, "_top")).put(TextureKey.BOTTOM, getSubId(block, "_bottom"));
   }

   public static TextureMap wallSideEnd(Block block) {
      Identifier identifier = getId(block);
      return (new TextureMap()).put(TextureKey.TEXTURE, identifier).put(TextureKey.WALL, identifier).put(TextureKey.SIDE, identifier).put(TextureKey.END, getSubId(block, "_top"));
   }
   ...
   public static TextureMap trialSpawner(Block block, String side, String top) {
      return (new TextureMap()).put(TextureKey.SIDE, getSubId(block, side)).put(TextureKey.TOP, getSubId(block, top)).put(TextureKey.BOTTOM, getSubId(block, "_bottom"));
   }

   public static TextureMap vault(Block block, String front, String side, String top, String bottom) {
      return (new TextureMap()).put(TextureKey.FRONT, getSubId(block, front)).put(TextureKey.SIDE, getSubId(block, side)).put(TextureKey.TOP, getSubId(block, top)).put(TextureKey.BOTTOM, getSubId(block, bottom));
   }
   ...
   public static TextureMap frontSideWithCustomBottom(Block block, Block bottom) {
      return (new TextureMap()).put(TextureKey.PARTICLE, getSubId(block, "_front")).put(TextureKey.DOWN, getId(bottom)).put(TextureKey.UP, getSubId(block, "_top")).put(TextureKey.NORTH, getSubId(block, "_front")).put(TextureKey.EAST, getSubId(block, "_side")).put(TextureKey.SOUTH, getSubId(block, "_side")).put(TextureKey.WEST, getSubId(block, "_front"));
   }

   public static TextureMap frontTopSide(Block frontTopSideBlock, Block downBlock) {
      return (new TextureMap()).put(TextureKey.PARTICLE, getSubId(frontTopSideBlock, "_front")).put(TextureKey.DOWN, getId(downBlock)).put(TextureKey.UP, getSubId(frontTopSideBlock, "_top")).put(TextureKey.NORTH, getSubId(frontTopSideBlock, "_front")).put(TextureKey.SOUTH, getSubId(frontTopSideBlock, "_front")).put(TextureKey.EAST, getSubId(frontTopSideBlock, "_side")).put(TextureKey.WEST, getSubId(frontTopSideBlock, "_side"));
   }

   public static TextureMap snifferEgg(String age) {
      return (new TextureMap()).put(TextureKey.PARTICLE, getSubId(Blocks.SNIFFER_EGG, age + "_north")).put(TextureKey.BOTTOM, getSubId(Blocks.SNIFFER_EGG, age + "_bottom")).put(TextureKey.TOP, getSubId(Blocks.SNIFFER_EGG, age + "_top")).put(TextureKey.NORTH, getSubId(Blocks.SNIFFER_EGG, age + "_north")).put(TextureKey.SOUTH, getSubId(Blocks.SNIFFER_EGG, age + "_south")).put(TextureKey.EAST, getSubId(Blocks.SNIFFER_EGG, age + "_east")).put(TextureKey.WEST, getSubId(Blocks.SNIFFER_EGG, age + "_west"));
   }

   public static TextureMap driedGhast(String hydration) {
      return (new TextureMap()).put(TextureKey.PARTICLE, getSubId(Blocks.DRIED_GHAST, hydration + "_north")).put(TextureKey.BOTTOM, getSubId(Blocks.DRIED_GHAST, hydration + "_bottom")).put(TextureKey.TOP, getSubId(Blocks.DRIED_GHAST, hydration + "_top")).put(TextureKey.NORTH, getSubId(Blocks.DRIED_GHAST, hydration + "_north")).put(TextureKey.SOUTH, getSubId(Blocks.DRIED_GHAST, hydration + "_south")).put(TextureKey.EAST, getSubId(Blocks.DRIED_GHAST, hydration + "_east")).put(TextureKey.WEST, getSubId(Blocks.DRIED_GHAST, hydration + "_west")).put(TextureKey.TENTACLES, getSubId(Blocks.DRIED_GHAST, hydration + "_tentacles"));
   }
   ...
   public static TextureMap candleCake(Block block, boolean lit) {
      return (new TextureMap()).put(TextureKey.PARTICLE, getSubId(Blocks.CAKE, "_side")).put(TextureKey.BOTTOM, getSubId(Blocks.CAKE, "_bottom")).put(TextureKey.TOP, getSubId(Blocks.CAKE, "_top")).put(TextureKey.SIDE, getSubId(Blocks.CAKE, "_side")).put(TextureKey.CANDLE, getSubId(block, lit ? "_lit" : ""));
   }
