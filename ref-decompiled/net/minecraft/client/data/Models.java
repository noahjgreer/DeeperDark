...
public class Models {
   ...
   public static final Model CUBE_ALL_INNER_FACES;
   public static final Model CUBE_MIRRORED_ALL;
   public static final Model CUBE_NORTH_WEST_MIRRORED_ALL;
   public static final Model CUBE_COLUMN_UV_LOCKED_X;
   public static final Model CUBE_COLUMN_UV_LOCKED_Y;
   public static final Model CUBE_COLUMN_UV_LOCKED_Z;
   public static final Model CUBE_COLUMN;
   public static final Model CUBE_COLUMN_HORIZONTAL;
   public static final Model CUBE_COLUMN_MIRRORED;
   public static final Model CUBE_TOP;
   public static final Model CUBE_BOTTOM_TOP;
   public static final Model CUBE_BOTTOM_TOP_INNER_FACES;
   ...
   public static final Model DOOR_BOTTOM_LEFT;
   public static final Model DOOR_BOTTOM_LEFT_OPEN;
   public static final Model DOOR_BOTTOM_RIGHT;
   public static final Model DOOR_BOTTOM_RIGHT_OPEN;
   public static final Model DOOR_TOP_LEFT;
   public static final Model DOOR_TOP_LEFT_OPEN;
   public static final Model DOOR_TOP_RIGHT;
   public static final Model DOOR_TOP_RIGHT_OPEN;
   public static final Model CUSTOM_FENCE_POST;
   public static final Model CUSTOM_FENCE_SIDE_NORTH;
   public static final Model CUSTOM_FENCE_SIDE_EAST;
   public static final Model CUSTOM_FENCE_SIDE_SOUTH;
   public static final Model CUSTOM_FENCE_SIDE_WEST;
   public static final Model CUSTOM_FENCE_INVENTORY;
   ...
   public static final Model TEMPLATE_CUSTOM_FENCE_GATE;
   public static final Model TEMPLATE_CUSTOM_FENCE_GATE_OPEN;
   public static final Model TEMPLATE_CUSTOM_FENCE_GATE_WALL;
   public static final Model TEMPLATE_CUSTOM_FENCE_GATE_WALL_OPEN;
   ...
   public static final Model MOSSY_CARPET_SIDE;
   public static final Model FLOWERBED_1;
   public static final Model FLOWERBED_2;
   public static final Model FLOWERBED_3;
   public static final Model FLOWERBED_4;
   public static final Model TEMPLATE_LEAF_LITTER_1;
   public static final Model TEMPLATE_LEAF_LITTER_2;
   public static final Model TEMPLATE_LEAF_LITTER_3;
   public static final Model TEMPLATE_LEAF_LITTER_4;
   ...
   public static final Model TEMPLATE_CHISELED_BOOKSHELF_SLOT_TOP_LEFT;
   public static final Model TEMPLATE_CHISELED_BOOKSHELF_SLOT_TOP_MID;
   public static final Model TEMPLATE_CHISELED_BOOKSHELF_SLOT_TOP_RIGHT;
   public static final Model TEMPLATE_CHISELED_BOOKSHELF_SLOT_BOTTOM_LEFT;
   public static final Model TEMPLATE_CHISELED_BOOKSHELF_SLOT_BOTTOM_MID;
   public static final Model TEMPLATE_CHISELED_BOOKSHELF_SLOT_BOTTOM_RIGHT;
   ...
   public static final Model TEMPLATE_TORCH_UNLIT;
   public static final Model TEMPLATE_TORCH_WALL;
   public static final Model TEMPLATE_TORCH_WALL_UNLIT;
   public static final Model TEMPLATE_REDSTONE_TORCH;
   public static final Model TEMPLATE_REDSTONE_TORCH_WALL;
   ...
   public static final Model DRIED_GHAST;
   ...
   public static final Model TEMPLATE_CAULDRON_LEVEL1;
   public static final Model TEMPLATE_CAULDRON_LEVEL2;
   public static final Model TEMPLATE_CAULDRON_FULL;
   public static final Model TEMPLATE_AZALEA;
   public static final Model TEMPLATE_POTTED_AZALEA_BUSH;
   public static final Model TEMPLATE_POTTED_FLOWERING_AZALEA_BUSH;
   public static final Model SNIFFER_EGG;
   public static final Model GENERATED;
   public static final Model TEMPLATE_MUSIC_DISC;
   public static final Model HANDHELD;
   public static final Model HANDHELD_ROD;
   public static final Model GENERATED_TWO_LAYERS;
   public static final Model GENERATED_THREE_LAYERS;
   public static final Model TEMPLATE_SHULKER_BOX;
   public static final Model TEMPLATE_BED;
   public static final Model TEMPLATE_CHEST;
   public static final Model TEMPLATE_BUNDLE_OPEN_FRONT;
   public static final Model TEMPLATE_BUNDLE_OPEN_BACK;
   public static final Model BOW;
   public static final Model CROSSBOW;
   public static final Model TEMPLATE_CANDLE;
   public static final Model TEMPLATE_TWO_CANDLES;
   public static final Model TEMPLATE_THREE_CANDLES;
   public static final Model TEMPLATE_FOUR_CANDLES;
   public static final Model TEMPLATE_CAKE_WITH_CANDLE;
   public static final Model TEMPLATE_SCULK_SHRIEKER;
   public static final Model TEMPLATE_VAULT;
   ...
   static {
      ...
      CUBE_ALL_INNER_FACES = block("cube_all_inner_faces", TextureKey.ALL);
      CUBE_MIRRORED_ALL = block("cube_mirrored_all", "_mirrored", TextureKey.ALL);
      CUBE_NORTH_WEST_MIRRORED_ALL = block("cube_north_west_mirrored_all", "_north_west_mirrored", TextureKey.ALL);
      CUBE_COLUMN_UV_LOCKED_X = block("cube_column_uv_locked_x", "_x", TextureKey.END, TextureKey.SIDE);
      CUBE_COLUMN_UV_LOCKED_Y = block("cube_column_uv_locked_y", "_y", TextureKey.END, TextureKey.SIDE);
      CUBE_COLUMN_UV_LOCKED_Z = block("cube_column_uv_locked_z", "_z", TextureKey.END, TextureKey.SIDE);
      ...
      CUBE_COLUMN_MIRRORED = block("cube_column_mirrored", "_mirrored", TextureKey.END, TextureKey.SIDE);
      ...
      CUBE_BOTTOM_TOP_INNER_FACES = block("cube_bottom_top_inner_faces", TextureKey.TOP, TextureKey.BOTTOM, TextureKey.SIDE);
      ...
      DOOR_BOTTOM_LEFT = block("door_bottom_left", "_bottom_left", TextureKey.TOP, TextureKey.BOTTOM);
      DOOR_BOTTOM_LEFT_OPEN = block("door_bottom_left_open", "_bottom_left_open", TextureKey.TOP, TextureKey.BOTTOM);
      DOOR_BOTTOM_RIGHT = block("door_bottom_right", "_bottom_right", TextureKey.TOP, TextureKey.BOTTOM);
      DOOR_BOTTOM_RIGHT_OPEN = block("door_bottom_right_open", "_bottom_right_open", TextureKey.TOP, TextureKey.BOTTOM);
      DOOR_TOP_LEFT = block("door_top_left", "_top_left", TextureKey.TOP, TextureKey.BOTTOM);
      DOOR_TOP_LEFT_OPEN = block("door_top_left_open", "_top_left_open", TextureKey.TOP, TextureKey.BOTTOM);
      DOOR_TOP_RIGHT = block("door_top_right", "_top_right", TextureKey.TOP, TextureKey.BOTTOM);
      DOOR_TOP_RIGHT_OPEN = block("door_top_right_open", "_top_right_open", TextureKey.TOP, TextureKey.BOTTOM);
      CUSTOM_FENCE_POST = block("custom_fence_post", "_post", TextureKey.TEXTURE, TextureKey.PARTICLE);
      CUSTOM_FENCE_SIDE_NORTH = block("custom_fence_side_north", "_side_north", TextureKey.TEXTURE);
      CUSTOM_FENCE_SIDE_EAST = block("custom_fence_side_east", "_side_east", TextureKey.TEXTURE);
      CUSTOM_FENCE_SIDE_SOUTH = block("custom_fence_side_south", "_side_south", TextureKey.TEXTURE);
      CUSTOM_FENCE_SIDE_WEST = block("custom_fence_side_west", "_side_west", TextureKey.TEXTURE);
      CUSTOM_FENCE_INVENTORY = block("custom_fence_inventory", "_inventory", TextureKey.TEXTURE);
      ...
      TEMPLATE_CUSTOM_FENCE_GATE = block("template_custom_fence_gate", TextureKey.TEXTURE, TextureKey.PARTICLE);
      TEMPLATE_CUSTOM_FENCE_GATE_OPEN = block("template_custom_fence_gate_open", "_open", TextureKey.TEXTURE, TextureKey.PARTICLE);
      TEMPLATE_CUSTOM_FENCE_GATE_WALL = block("template_custom_fence_gate_wall", "_wall", TextureKey.TEXTURE, TextureKey.PARTICLE);
      TEMPLATE_CUSTOM_FENCE_GATE_WALL_OPEN = block("template_custom_fence_gate_wall_open", "_wall_open", TextureKey.TEXTURE, TextureKey.PARTICLE);
      ...
      POINTED_DRIPSTONE = block("pointed_dripstone", TextureKey.CROSS);
      CROSS = block("cross", TextureKey.CROSS);
      TINTED_CROSS = block("tinted_cross", TextureKey.CROSS);
      CROSS_EMISSIVE = block("cross_emissive", TextureKey.CROSS, TextureKey.CROSS_EMISSIVE);
      ...
      FLOWER_POT_CROSS_EMISSIVE = block("flower_pot_cross_emissive", TextureKey.PLANT, TextureKey.CROSS_EMISSIVE);
      ...
      MOSSY_CARPET_SIDE = block("mossy_carpet_side", TextureKey.SIDE);
      FLOWERBED_1 = block("flowerbed_1", "_1", TextureKey.FLOWERBED, TextureKey.STEM);
      FLOWERBED_2 = block("flowerbed_2", "_2", TextureKey.FLOWERBED, TextureKey.STEM);
      FLOWERBED_3 = block("flowerbed_3", "_3", TextureKey.FLOWERBED, TextureKey.STEM);
      FLOWERBED_4 = block("flowerbed_4", "_4", TextureKey.FLOWERBED, TextureKey.STEM);
      TEMPLATE_LEAF_LITTER_1 = block("template_leaf_litter_1", "_1", TextureKey.TEXTURE);
      TEMPLATE_LEAF_LITTER_2 = block("template_leaf_litter_2", "_2", TextureKey.TEXTURE);
      TEMPLATE_LEAF_LITTER_3 = block("template_leaf_litter_3", "_3", TextureKey.TEXTURE);
      TEMPLATE_LEAF_LITTER_4 = block("template_leaf_litter_4", "_4", TextureKey.TEXTURE);
      ...
      TEMPLATE_CHISELED_BOOKSHELF_SLOT_TOP_LEFT = block("template_chiseled_bookshelf_slot_top_left", "_slot_top_left", TextureKey.TEXTURE);
      TEMPLATE_CHISELED_BOOKSHELF_SLOT_TOP_MID = block("template_chiseled_bookshelf_slot_top_mid", "_slot_top_mid", TextureKey.TEXTURE);
      TEMPLATE_CHISELED_BOOKSHELF_SLOT_TOP_RIGHT = block("template_chiseled_bookshelf_slot_top_right", "_slot_top_right", TextureKey.TEXTURE);
      TEMPLATE_CHISELED_BOOKSHELF_SLOT_BOTTOM_LEFT = block("template_chiseled_bookshelf_slot_bottom_left", "_slot_bottom_left", TextureKey.TEXTURE);
      TEMPLATE_CHISELED_BOOKSHELF_SLOT_BOTTOM_MID = block("template_chiseled_bookshelf_slot_bottom_mid", "_slot_bottom_mid", TextureKey.TEXTURE);
      TEMPLATE_CHISELED_BOOKSHELF_SLOT_BOTTOM_RIGHT = block("template_chiseled_bookshelf_slot_bottom_right", "_slot_bottom_right", TextureKey.TEXTURE);
      TEMPLATE_ANVIL = block("template_anvil", TextureKey.TOP);
      STEM_GROWTH_STAGES = (Model[])IntStream.range(0, 8).mapToObj((stage) -> {
         return block("stem_growth" + stage, "_stage" + stage, TextureKey.STEM);
      }).toArray((i) -> {
         return new Model[i];
      });
      ...
      TEMPLATE_TORCH_UNLIT = block("template_torch_unlit", TextureKey.TORCH);
      TEMPLATE_TORCH_WALL = block("template_torch_wall", TextureKey.TORCH);
      TEMPLATE_TORCH_WALL_UNLIT = block("template_torch_wall_unlit", TextureKey.TORCH);
      TEMPLATE_REDSTONE_TORCH = block("template_redstone_torch", TextureKey.TORCH);
      TEMPLATE_REDSTONE_TORCH_WALL = block("template_redstone_torch_wall", TextureKey.TORCH);
      ...
      DRIED_GHAST = block("dried_ghast", TextureKey.PARTICLE, TextureKey.TOP, TextureKey.BOTTOM, TextureKey.NORTH, TextureKey.SOUTH, TextureKey.EAST, TextureKey.WEST, TextureKey.TENTACLES);
      ...
      TEMPLATE_CAULDRON_LEVEL1 = block("template_cauldron_level1", TextureKey.CONTENT, TextureKey.INSIDE, TextureKey.PARTICLE, TextureKey.TOP, TextureKey.BOTTOM, TextureKey.SIDE);
      TEMPLATE_CAULDRON_LEVEL2 = block("template_cauldron_level2", TextureKey.CONTENT, TextureKey.INSIDE, TextureKey.PARTICLE, TextureKey.TOP, TextureKey.BOTTOM, TextureKey.SIDE);
      TEMPLATE_CAULDRON_FULL = block("template_cauldron_full", TextureKey.CONTENT, TextureKey.INSIDE, TextureKey.PARTICLE, TextureKey.TOP, TextureKey.BOTTOM, TextureKey.SIDE);
      TEMPLATE_AZALEA = block("template_azalea", TextureKey.TOP, TextureKey.SIDE);
      TEMPLATE_POTTED_AZALEA_BUSH = block("template_potted_azalea_bush", TextureKey.PLANT, TextureKey.TOP, TextureKey.SIDE);
      TEMPLATE_POTTED_FLOWERING_AZALEA_BUSH = block("template_potted_azalea_bush", TextureKey.PLANT, TextureKey.TOP, TextureKey.SIDE);
      SNIFFER_EGG = block("sniffer_egg", TextureKey.TOP, TextureKey.BOTTOM, TextureKey.NORTH, TextureKey.SOUTH, TextureKey.EAST, TextureKey.WEST);
      GENERATED = item("generated", TextureKey.LAYER0);
      TEMPLATE_MUSIC_DISC = item("template_music_disc", TextureKey.LAYER0);
      HANDHELD = item("handheld", TextureKey.LAYER0);
      HANDHELD_ROD = item("handheld_rod", TextureKey.LAYER0);
      GENERATED_TWO_LAYERS = item("generated", TextureKey.LAYER0, TextureKey.LAYER1);
      GENERATED_THREE_LAYERS = item("generated", TextureKey.LAYER0, TextureKey.LAYER1, TextureKey.LAYER2);
      TEMPLATE_SHULKER_BOX = item("template_shulker_box", TextureKey.PARTICLE);
      TEMPLATE_BED = item("template_bed", TextureKey.PARTICLE);
      TEMPLATE_CHEST = item("template_chest", TextureKey.PARTICLE);
      TEMPLATE_BUNDLE_OPEN_FRONT = openBundle("template_bundle_open_front", "_open_front", TextureKey.LAYER0);
      TEMPLATE_BUNDLE_OPEN_BACK = openBundle("template_bundle_open_back", "_open_back", TextureKey.LAYER0);
      BOW = item("bow", TextureKey.LAYER0);
      CROSSBOW = item("crossbow", TextureKey.LAYER0);
      TEMPLATE_CANDLE = block("template_candle", TextureKey.ALL, TextureKey.PARTICLE);
      TEMPLATE_TWO_CANDLES = block("template_two_candles", TextureKey.ALL, TextureKey.PARTICLE);
      TEMPLATE_THREE_CANDLES = block("template_three_candles", TextureKey.ALL, TextureKey.PARTICLE);
      TEMPLATE_FOUR_CANDLES = block("template_four_candles", TextureKey.ALL, TextureKey.PARTICLE);
      TEMPLATE_CAKE_WITH_CANDLE = block("template_cake_with_candle", TextureKey.CANDLE, TextureKey.BOTTOM, TextureKey.SIDE, TextureKey.TOP, TextureKey.PARTICLE);
      TEMPLATE_SCULK_SHRIEKER = block("template_sculk_shrieker", TextureKey.BOTTOM, TextureKey.SIDE, TextureKey.TOP, TextureKey.PARTICLE, TextureKey.INNER_TOP);
      TEMPLATE_VAULT = block("template_vault", TextureKey.TOP, TextureKey.BOTTOM, TextureKey.SIDE, TextureKey.FRONT);
      HANDHELD_MACE = item("handheld_mace", TextureKey.LAYER0);
   }
}
