...
public class InactivityFpsLimiter {
    ...
    extends Enum<LimitReason> {
        public static final /* enum */ LimitReason NONE = new LimitReason();
        public static final /* enum */ LimitReason WINDOW_ICONIFIED = new LimitReason();
        public static final /* enum */ LimitReason LONG_AFK = new LimitReason();
        public static final /* enum */ LimitReason SHORT_AFK = new LimitReason();
        public static final /* enum */ LimitReason OUT_OF_LEVEL_MENU = new LimitReason();
        private static final /* synthetic */ LimitReason[] field_55848;
        ...
        private static /* synthetic */ LimitReason[] method_66516() {
