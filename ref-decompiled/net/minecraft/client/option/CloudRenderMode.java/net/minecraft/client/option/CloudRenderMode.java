...
implements StringIdentifiable {
    public static final /* enum */ CloudRenderMode OFF = new CloudRenderMode("false", "options.off");
    public static final /* enum */ CloudRenderMode FAST = new CloudRenderMode("fast", "options.clouds.fast");
    public static final /* enum */ CloudRenderMode FANCY = new CloudRenderMode("true", "options.clouds.fancy");
