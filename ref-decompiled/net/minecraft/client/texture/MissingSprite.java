...
public final class MissingSprite {
    ...
    private static final Identifier MISSINGNO = Identifier.ofVanilla((String)"missingno");

    public static NativeImage createImage() {
        return MissingSprite.createImage((int)16, (int)16);
    }
    ...
    public static SpriteContents createSpriteContents() {
        NativeImage nativeImage = MissingSprite.createImage((int)16, (int)16);
