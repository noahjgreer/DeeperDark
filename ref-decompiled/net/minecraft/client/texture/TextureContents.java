...
public record TextureContents(NativeImage image, @Nullable TextureResourceMetadata metadata) implements Closeable {
   public TextureContents(NativeImage nativeImage, @Nullable TextureResourceMetadata textureResourceMetadata) {
   ...
   public static TextureContents load(ResourceManager resourceManager, Identifier textureId) throws IOException {
      ...
      TextureResourceMetadata textureResourceMetadata = (TextureResourceMetadata)resource.getMetadata().decode(TextureResourceMetadata.SERIALIZER).orElse((Object)null);
      return new TextureContents(nativeImage, textureResourceMetadata);
   }

   public static TextureContents createMissing() {
      return new TextureContents(MissingSprite.createImage(), (TextureResourceMetadata)null);
   }
