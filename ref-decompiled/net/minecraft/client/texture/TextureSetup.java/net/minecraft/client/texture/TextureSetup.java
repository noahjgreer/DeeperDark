...
public record TextureSetup(@Nullable GpuTextureView texure0, @Nullable GpuTextureView texure1, @Nullable GpuTextureView texure2, @Nullable GpuSampler sampler0, @Nullable GpuSampler sampler1, @Nullable GpuSampler sampler2) {
    ...
    public static TextureSetup withLightmap(GpuTextureView texture, GpuSampler sampler) {
        return new TextureSetup(texture, null, MinecraftClient.getInstance().gameRenderer.getLightmapTextureManager().getGlTextureView(), sampler, null, RenderSystem.getSamplerCache().get(FilterMode.LINEAR));
    }
