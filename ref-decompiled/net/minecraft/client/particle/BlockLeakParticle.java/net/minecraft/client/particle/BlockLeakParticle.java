...
extends BillboardParticle {
    ...
    implements ParticleFactory<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i, Random random) {
            Landing blockLeakParticle = new Landing(clientWorld, d, e, f, Fluids.EMPTY, this.spriteProvider.getSprite(random));
            blockLeakParticle.obsidianTear = true;
            blockLeakParticle.maxAge = (int)(28.0 / ((double)random.nextFloat() * 0.8 + 0.2));
    ...
    implements ParticleFactory<SimpleParticleType> {
        ...
        @Override
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i, Random random) {
            ContinuousFalling blockLeakParticle = new ContinuousFalling(clientWorld, d, e, f, Fluids.EMPTY, ParticleTypes.LANDING_OBSIDIAN_TEAR, this.spriteProvider.getSprite(random));
            blockLeakParticle.obsidianTear = true;
    ...
    implements ParticleFactory<SimpleParticleType> {
        ...
        @Override
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i, Random random) {
            Dripping dripping = new Dripping(clientWorld, d, e, f, Fluids.EMPTY, ParticleTypes.FALLING_OBSIDIAN_TEAR, this.spriteProvider.getSprite(random));
    ...
    implements ParticleFactory<SimpleParticleType> {
        ...
        @Override
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i, Random random) {
            Falling blockLeakParticle = new Falling(clientWorld, d, e, f, Fluids.EMPTY, this.spriteProvider.getSprite(random));
    ...
    implements ParticleFactory<SimpleParticleType> {
        ...
        @Override
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i, Random random) {
            DripstoneLavaDrip blockLeakParticle = new DripstoneLavaDrip(clientWorld, d, e, f, Fluids.LAVA, ParticleTypes.LANDING_LAVA, this.spriteProvider.getSprite(random));
    ...
    implements ParticleFactory<SimpleParticleType> {
        ...
        @Override
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i, Random random) {
            DrippingLava drippingLava = new DrippingLava(clientWorld, d, e, f, Fluids.LAVA, ParticleTypes.FALLING_DRIPSTONE_LAVA, this.spriteProvider.getSprite(random));
            return drippingLava;
        }
    }
    ...
    implements ParticleFactory<SimpleParticleType> {
        ...
        @Override
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i, Random random) {
            DripstoneLavaDrip blockLeakParticle = new DripstoneLavaDrip(clientWorld, d, e, f, Fluids.WATER, ParticleTypes.SPLASH, this.spriteProvider.getSprite(random));
    ...
    implements ParticleFactory<SimpleParticleType> {
        ...
        @Override
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i, Random random) {
            Dripping blockLeakParticle = new Dripping(clientWorld, d, e, f, Fluids.WATER, ParticleTypes.FALLING_DRIPSTONE_WATER, this.spriteProvider.getSprite(random));
            blockLeakParticle.setColor(0.2f, 0.3f, 1.0f);
            return blockLeakParticle;
        }
    }
    ...
    implements ParticleFactory<SimpleParticleType> {
        ...
        @Override
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i, Random random) {
            FallingHoney blockLeakParticle = new FallingHoney(clientWorld, d, e, f, Fluids.EMPTY, ParticleTypes.LANDING_HONEY, this.spriteProvider.getSprite(random));
            blockLeakParticle.gravityStrength = 0.01f;
    ...
    implements ParticleFactory<SimpleParticleType> {
        ...
        @Override
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i, Random random) {
            Dripping dripping = new Dripping(clientWorld, d, e, f, Fluids.EMPTY, ParticleTypes.FALLING_HONEY, this.spriteProvider.getSprite(random));
            dripping.gravityStrength *= 0.01f;
            dripping.maxAge = 100;
    ...
    implements ParticleFactory<SimpleParticleType> {
        ...
        @Override
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i, Random random) {
            Landing blockLeakParticle = new Landing(clientWorld, d, e, f, Fluids.LAVA, this.spriteProvider.getSprite(random));
            blockLeakParticle.setColor(1.0f, 0.2857143f, 0.083333336f);
            return blockLeakParticle;
        }
    }
    ...
    implements ParticleFactory<SimpleParticleType> {
        ...
        @Override
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i, Random random) {
            ContinuousFalling blockLeakParticle = new ContinuousFalling(clientWorld, d, e, f, Fluids.LAVA, ParticleTypes.LANDING_LAVA, this.spriteProvider.getSprite(random));
            blockLeakParticle.setColor(1.0f, 0.2857143f, 0.083333336f);
            return blockLeakParticle;
        }
    }
    ...
    implements ParticleFactory<SimpleParticleType> {
        ...
        @Override
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i, Random random) {
            DrippingLava drippingLava = new DrippingLava(clientWorld, d, e, f, Fluids.LAVA, ParticleTypes.FALLING_LAVA, this.spriteProvider.getSprite(random));
            return drippingLava;
        }
    }
    ...
    implements ParticleFactory<SimpleParticleType> {
        ...
        @Override
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i, Random random) {
            ContinuousFalling blockLeakParticle = new ContinuousFalling(clientWorld, d, e, f, Fluids.WATER, ParticleTypes.SPLASH, this.spriteProvider.getSprite(random));
            blockLeakParticle.setColor(0.2f, 0.3f, 1.0f);
            return blockLeakParticle;
        }
    }
    ...
    implements ParticleFactory<SimpleParticleType> {
        ...
        @Override
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i, Random random) {
            Dripping blockLeakParticle = new Dripping(clientWorld, d, e, f, Fluids.WATER, ParticleTypes.FALLING_WATER, this.spriteProvider.getSprite(random));
            blockLeakParticle.setColor(0.2f, 0.3f, 1.0f);
            return blockLeakParticle;
        }
    }
