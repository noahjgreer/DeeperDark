...
public class BubbleColumnSoundPlayer implements ClientPlayerTickable {
   ...
   public void tick() {
      ...
      BlockState blockState = (BlockState)world.getStatesInBoxIfLoaded(this.player.getBoundingBox().expand(0.0, -0.4000000059604645, 0.0).contract(1.0E-6)).filter((state) -> {
