...
public class Channel {
    ...
    public CompletableFuture<@Nullable SourceManager> createSource(SoundEngine.RunMode mode) {
        CompletableFuture<@Nullable SourceManager> completableFuture = new CompletableFuture<SourceManager>();
