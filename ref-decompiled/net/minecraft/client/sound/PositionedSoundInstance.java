...
public class PositionedSoundInstance extends AbstractSoundInstance {
   ...
   public static PositionedSoundInstance master(RegistryEntry sound, float pitch) {
   ...
   public static PositionedSoundInstance music(SoundEvent sound, float volume) {
      return new PositionedSoundInstance(sound.id(), SoundCategory.MUSIC, volume, 1.0F, SoundInstance.createRandom(), false, 0, SoundInstance.AttenuationType.NONE, 0.0, 0.0, 0.0, true);
   }
