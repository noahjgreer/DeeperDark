...
public class SpriteIdentifier {
   ...
   public VertexConsumer getVertexConsumer(VertexConsumerProvider vertexConsumers, Function layerFactory, boolean solid, boolean glint) {
   ...
   public String toString() {
      String var10000 = String.valueOf(this.atlas);
