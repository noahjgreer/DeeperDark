...
public class GlDebug {
    ...
    @Nullable GlDebug.DebugMessage lastDebugMessage;
    ...
    public static String getSource(int opcode) {
        ...
        return GlDebug.unknown((int)opcode);
    }
    ...
    private void onDebugMessage(int source, int type, int id, int severity, int length, long message, long l) {
        ...
        Queue queue = this.debugMessages;
        synchronized (queue) {
    ...
    public static @Nullable GlDebug enableDebug(int verbosity, boolean sync, Set<String> usedGlCaps) {
        ...
        if (gLCapabilities.GL_KHR_debug && GlBackend.allowGlKhrDebug) {
            ...
            for (int i = 0; i < KHR_VERBOSITY_LEVELS.size(); ++i) {
                ...
                KHRDebug.glDebugMessageControl((int)4352, (int)4352, (int)((Integer)KHR_VERBOSITY_LEVELS.get(i)), (int[])null, (boolean)bl);
            }
            KHRDebug.glDebugMessageCallback((GLDebugMessageCallbackI)((GLDebugMessageCallbackI)GLX.make((Object)GLDebugMessageCallback.create((arg_0, arg_1, arg_2, arg_3, arg_4, arg_5, arg_6) -> glDebug.onDebugMessage(arg_0, arg_1, arg_2, arg_3, arg_4, arg_5, arg_6)), Untracker::untrack)), (long)0L);
            return glDebug;
        }
        if (gLCapabilities.GL_ARB_debug_output && GlBackend.allowGlArbDebugOutput) {
            ...
            for (int i = 0; i < ARB_VERBOSITY_LEVELS.size(); ++i) {
                boolean bl = i < verbosity;
                ARBDebugOutput.glDebugMessageControlARB((int)4352, (int)4352, (int)((Integer)ARB_VERBOSITY_LEVELS.get(i)), (int[])null, (boolean)bl);
            }
            ARBDebugOutput.glDebugMessageCallbackARB((GLDebugMessageARBCallbackI)((GLDebugMessageARBCallbackI)GLX.make((Object)GLDebugMessageARBCallback.create((arg_0, arg_1, arg_2, arg_3, arg_4, arg_5, arg_6) -> glDebug.onDebugMessage(arg_0, arg_1, arg_2, arg_3, arg_4, arg_5, arg_6)), Untracker::untrack)), (long)0L);
            return glDebug;
        }
        return null;
    }
