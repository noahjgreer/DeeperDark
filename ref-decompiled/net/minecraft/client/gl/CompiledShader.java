...
implements AutoCloseable {
    ...
    public static final CompiledShader INVALID_SHADER = new CompiledShader(-1, Identifier.ofVanilla((String)"invalid"), ShaderType.VERTEX);
    ...
    public void close() {
        ...
        GlStateManager.glDeleteShader((int)this.handle);
        this.handle = -1;
    }
