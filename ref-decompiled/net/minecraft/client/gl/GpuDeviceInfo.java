...
public class GpuDeviceInfo {
    ...
    private GpuDeviceInfo(GpuDevice device) {
        ...
        this.requiresRecreateOnUploadToBuffer = GpuDeviceInfo.requiresRecreateOnUploadToBuffer((GpuDevice)device);
        this.shouldDisableArbDirectAccess = GpuDeviceInfo.shouldDisableArbDirectAccess((GpuDevice)device);
        this.useRgssOnFabulous = GpuDeviceInfo.shouldUseRgssOnFabulous((GpuDevice)device);
    }
