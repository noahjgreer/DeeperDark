...
public class PlayerListEntry {
    ...
    public PlayerListEntry(GameProfile profile, boolean secureChatEnforced) {
        ...
        this.messageVerifier = PlayerListEntry.getInitialVerifier((boolean)secureChatEnforced);
    }
    ...
    public SkinTextures getSkinTextures() {
        if (this.texturesSupplier == null) {
            this.texturesSupplier = PlayerListEntry.texturesSupplier((GameProfile)this.profile);
        }
