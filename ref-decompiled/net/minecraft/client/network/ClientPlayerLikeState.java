...
public class ClientPlayerLikeState {
    ...
    public double lerpX(float tickProgress) {
        return MathHelper.lerp((double)tickProgress, (double)this.lastX, (double)this.x);
    }

    public double lerpY(float tickProgress) {
        return MathHelper.lerp((double)tickProgress, (double)this.lastY, (double)this.y);
    }

    public double lerpZ(float tickProgress) {
        return MathHelper.lerp((double)tickProgress, (double)this.lastZ, (double)this.z);
    }
    ...
    public float lerpMovement(float tickProgress) {
        return MathHelper.lerp((float)tickProgress, (float)this.lastMovement, (float)this.movement);
    }
    ...
    public float getLerpedDistanceMoved(float tickProgress) {
        return MathHelper.lerp((float)tickProgress, (float)this.lastDistanceMoved, (float)this.distanceMoved);
    }
}
