...
public class BeaconScreenHandler extends ScreenHandler {
   ...
   public BeaconScreenHandler(int syncId, Inventory inventory, PropertyDelegate propertyDelegate, ScreenHandlerContext context) {
      ...
      this.payment = new SimpleInventory(this, 1) {
   ...
   public static int getRawIdForStatusEffect(@Nullable RegistryEntry effect) {
      return effect == null ? 0 : Registries.STATUS_EFFECT.getIndexedEntries().getRawId(effect) + 1;
   }

   @Nullable
   public static RegistryEntry getStatusEffectForRawId(int id) {
      return id == 0 ? null : (RegistryEntry)Registries.STATUS_EFFECT.getIndexedEntries().get(id - 1);
   }
   ...
   public void setEffects(Optional primary, Optional secondary) {
      if (this.paymentSlot.hasStack()) {
         this.propertyDelegate.set(1, getRawIdForStatusEffect((RegistryEntry)primary.orElse((Object)null)));
         this.propertyDelegate.set(2, getRawIdForStatusEffect((RegistryEntry)secondary.orElse((Object)null)));
