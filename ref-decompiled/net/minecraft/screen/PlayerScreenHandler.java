...
public class PlayerScreenHandler extends AbstractCraftingScreenHandler {
   ...
   private static final Map EMPTY_ARMOR_SLOT_TEXTURES;
   ...
   public PlayerScreenHandler(PlayerInventory inventory, boolean onServer, final PlayerEntity owner) {
      super((ScreenHandlerType)null, 0, 2, 2);
   ...
   public void onContentChanged(Inventory inventory) {
      World var3 = this.owner.getWorld();
      if (var3 instanceof ServerWorld serverWorld) {
         CraftingScreenHandler.updateResult(this, serverWorld, this.owner, this.craftingInventory, this.craftingResultInventory, (RecipeEntry)null);
      }
