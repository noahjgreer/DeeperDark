...
public abstract class AbstractRecipeScreenHandler extends ScreenHandler {
   ...
   public abstract PostFillAction fillInputSlots(boolean craftAll, boolean creative, RecipeEntry recipe, ServerWorld world, PlayerInventory inventory);
   ...
   public static enum PostFillAction {
      ...
      // $FF: synthetic method
      private static PostFillAction[] method_61636() {
