...
public class SmithingScreenHandler extends ForgingScreenHandler {
   ...
   private static ForgingSlotsManager createForgingSlotsManager(RecipeManager recipeManager) {
      ...
      var10000 = var10000.input(0, 8, 48, recipePropertySet2::canUse);
      Objects.requireNonNull(recipePropertySet);
      var10000 = var10000.input(1, 26, 48, recipePropertySet::canUse);
      Objects.requireNonNull(recipePropertySet3);
      return var10000.input(2, 44, 48, recipePropertySet3::canUse).output(3, 98, 48).build();
   }
   ...
   public boolean isValidIngredient(ItemStack stack) {
      if (this.templatePropertySet.canUse(stack) && !this.getSlot(0).hasStack()) {
         return true;
      } else if (this.basePropertySet.canUse(stack) && !this.getSlot(1).hasStack()) {
         return true;
      } else {
