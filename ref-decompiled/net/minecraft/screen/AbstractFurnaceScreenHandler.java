...
public abstract class AbstractFurnaceScreenHandler extends AbstractRecipeScreenHandler {
   ...
   protected AbstractFurnaceScreenHandler(ScreenHandlerType type, RecipeType recipeType, RegistryKey recipePropertySetKey, RecipeBookType category, int syncId, PlayerInventory playerInventory) {
   ...
   protected AbstractFurnaceScreenHandler(ScreenHandlerType type, RecipeType recipeType, RegistryKey recipePropertySetKey, RecipeBookType category, int syncId, PlayerInventory playerInventory, Inventory inventory, PropertyDelegate propertyDelegate) {
      super(type, syncId);
   ...
   public AbstractRecipeScreenHandler.PostFillAction fillInputSlots(boolean craftAll, boolean creative, RecipeEntry recipe, final ServerWorld world, PlayerInventory inventory) {
      final List list = List.of(this.getSlot(0), this.getSlot(2));
      return InputSlotFiller.fill(new InputSlotFiller.Handler() {
         ...
         public boolean matches(RecipeEntry entry) {
            return ((AbstractCookingRecipe)entry.value()).matches(new SingleStackRecipeInput(AbstractFurnaceScreenHandler.this.inventory.getStack(0)), world);
         }
