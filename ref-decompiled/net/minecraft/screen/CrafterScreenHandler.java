...
public class CrafterScreenHandler extends ScreenHandler implements ScreenHandlerListener {
   ...
   private void updateResult() {
      ...
      if (var2 instanceof ServerPlayerEntity serverPlayerEntity) {
         ...
         ItemStack itemStack = (ItemStack)CrafterBlock.getCraftingRecipe(serverWorld, craftingRecipeInput).map((recipeEntry) -> {
            return ((CraftingRecipe)recipeEntry.value()).craft(craftingRecipeInput, serverWorld.getRegistryManager());
