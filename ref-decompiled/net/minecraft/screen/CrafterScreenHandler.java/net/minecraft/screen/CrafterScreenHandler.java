...
implements ScreenHandlerListener {
    ...
    private void updateResult() {
        ...
        if (playerEntity instanceof ServerPlayerEntity) {
            ...
            ItemStack itemStack = CrafterBlock.getCraftingRecipe(serverWorld, craftingRecipeInput).map(recipeEntry -> ((CraftingRecipe)recipeEntry.value()).craft(craftingRecipeInput, serverWorld.getRegistryManager())).orElse(ItemStack.EMPTY);
