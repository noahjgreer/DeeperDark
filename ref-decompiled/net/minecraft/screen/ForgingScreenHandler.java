...
public abstract class ForgingScreenHandler extends ScreenHandler {
   ...
   private void addInputSlots(ForgingSlotsManager forgingSlotsManager) {
      ...
      while(var2.hasNext()) {
         final ForgingSlotsManager.ForgingSlot forgingSlot = (ForgingSlotsManager.ForgingSlot)var2.next();
   ...
   public boolean canUse(PlayerEntity player) {
      return (Boolean)this.context.get((world, pos) -> {
         return !this.canUse(world.getBlockState(pos)) ? false : player.canInteractWithBlockAt(pos, 4.0);
      }, true);
   }
