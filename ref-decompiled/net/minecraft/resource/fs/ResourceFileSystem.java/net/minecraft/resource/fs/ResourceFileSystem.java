...
extends FileSystem {
    ...
    private static ResourcePath toResourcePath(Directory root, ResourceFileSystem fileSystem, String name, @Nullable ResourcePath parent) {
        ...
        ResourcePath resourcePath = new ResourcePath(fileSystem, name, parent, new ResourceFile.Directory((Map<String, ResourcePath>)object2ObjectOpenHashMap));
        root.files.forEach((fileName, path) -> object2ObjectOpenHashMap.put(fileName, (Object)new ResourcePath(fileSystem, (String)fileName, resourcePath, new ResourceFile.File((Path)path))));
        root.children.forEach((directoryName, directory) -> object2ObjectOpenHashMap.put(directoryName, (Object)ResourceFileSystem.toResourcePath(directory, fileSystem, directoryName, resourcePath)));
    ...
    public Path getPath(String first, String ... more) {
        ...
        if (string.startsWith(SEPARATOR)) {
            ...
            for (String string2 : SEPARATOR_SPLITTER.split((CharSequence)string.substring(1))) {
                if (string2.isEmpty()) {
        ...
        for (String string2 : SEPARATOR_SPLITTER.split((CharSequence)string)) {
            if (string2.isEmpty()) {
                throw new IllegalArgumentException("Empty paths not allowed");
            }
    ...
    extends Record {
        final Map<String, Directory> children;
        ...
        private Directory(Map<String, Directory> children, Map<String, Path> files) {
        ...
        public final String toString() {
            return ObjectMethods.bootstrap("toString", new MethodHandle[]{Directory.class, "children;files", "children", "files"}, this);
        }

        @Override
        public final int hashCode() {
            return (int)ObjectMethods.bootstrap("hashCode", new MethodHandle[]{Directory.class, "children;files", "children", "files"}, this);
        }

        @Override
        public final boolean equals(Object object) {
            return (boolean)ObjectMethods.bootstrap("equals", new MethodHandle[]{Directory.class, "children;files", "children", "files"}, this, object);
        }
