...
public abstract class ResourcePackOpener {
   ...
   @Nullable
   public Object open(Path path, List foundSymlinks) throws IOException {
      Path path2 = path;
   ...
   @Nullable
   protected abstract Object openZip(Path path) throws IOException;

   @Nullable
   protected abstract Object openDirectory(Path path) throws IOException;
}
