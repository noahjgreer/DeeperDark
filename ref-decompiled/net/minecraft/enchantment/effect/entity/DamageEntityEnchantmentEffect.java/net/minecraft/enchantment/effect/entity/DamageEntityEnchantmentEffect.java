...
{
    public static final MapCodec<DamageEntityEnchantmentEffect> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)EnchantmentLevelBasedValue.CODEC.fieldOf("min_damage").forGetter(DamageEntityEnchantmentEffect::minDamage), (App)EnchantmentLevelBasedValue.CODEC.fieldOf("max_damage").forGetter(DamageEntityEnchantmentEffect::maxDamage), (App)DamageType.ENTRY_CODEC.fieldOf("damage_type").forGetter(DamageEntityEnchantmentEffect::damageType)).apply((Applicative)instance, DamageEntityEnchantmentEffect::new));
