...
extends EnchantmentLocationBasedEffect {
    public static final Codec<EnchantmentEntityEffect> CODEC = Registries.ENCHANTMENT_ENTITY_EFFECT_TYPE.getCodec().dispatch(EnchantmentEntityEffect::getCodec, Function.identity());

    public static MapCodec<? extends EnchantmentEntityEffect> registerAndGetDefault(Registry<MapCodec<? extends EnchantmentEntityEffect>> registry) {
        ...
        Registry.register(registry, "apply_impulse", ApplyImpulseEnchantmentEffect.CODEC);
        Registry.register(registry, "apply_exhaustion", ApplyExhaustionEnchantmentEffect.CODEC);
    ...
    public void apply(ServerWorld var1, int var2, EnchantmentEffectContext var3, Entity var4, Vec3d var5);

    @Override
    default public void apply(ServerWorld world, int level, EnchantmentEffectContext context, Entity user, Vec3d pos, boolean newlyApplied) {
