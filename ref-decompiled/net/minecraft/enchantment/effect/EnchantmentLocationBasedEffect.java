...
public interface EnchantmentLocationBasedEffect {
   Codec CODEC = Registries.ENCHANTMENT_LOCATION_BASED_EFFECT_TYPE.getCodec().dispatch(EnchantmentLocationBasedEffect::getCodec, Function.identity());

   static MapCodec registerAndGetDefault(Registry registry) {
      Registry.register(registry, (String)"all_of", AllOfEnchantmentEffects.LocationBasedEffects.CODEC);
      Registry.register(registry, (String)"apply_mob_effect", ApplyMobEffectEnchantmentEffect.CODEC);
      Registry.register(registry, (String)"attribute", AttributeEnchantmentEffect.CODEC);
