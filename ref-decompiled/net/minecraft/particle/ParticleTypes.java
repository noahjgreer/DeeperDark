...
public class ParticleTypes {
   ...
   public static final ParticleType BLOCK = register("block", false, BlockStateParticleEffect::createCodec, BlockStateParticleEffect::createPacketCodec);
   public static final ParticleType BLOCK_MARKER = register("block_marker", true, BlockStateParticleEffect::createCodec, BlockStateParticleEffect::createPacketCodec);
   ...
   public static final ParticleType DUST = register("dust", false, (type) -> {
      return DustParticleEffect.CODEC;
   }, (type) -> {
      return DustParticleEffect.PACKET_CODEC;
   });
   public static final ParticleType DUST_COLOR_TRANSITION = register("dust_color_transition", false, (type) -> {
      return DustColorTransitionParticleEffect.CODEC;
   }, (type) -> {
      return DustColorTransitionParticleEffect.PACKET_CODEC;
   });
   ...
   public static final ParticleType ENTITY_EFFECT = register("entity_effect", false, TintedParticleEffect::createCodec, TintedParticleEffect::createPacketCodec);
   ...
   public static final ParticleType FALLING_DUST = register("falling_dust", false, BlockStateParticleEffect::createCodec, BlockStateParticleEffect::createPacketCodec);
   ...
   public static final ParticleType TINTED_LEAVES = register("tinted_leaves", false, TintedParticleEffect::createCodec, TintedParticleEffect::createPacketCodec);
   public static final SimpleParticleType SCULK_SOUL = register("sculk_soul", false);
   public static final ParticleType SCULK_CHARGE = register("sculk_charge", true, (type) -> {
      return SculkChargeParticleEffect.CODEC;
   }, (type) -> {
      return SculkChargeParticleEffect.PACKET_CODEC;
   });
   ...
   public static final ParticleType ITEM = register("item", false, ItemStackParticleEffect::createCodec, ItemStackParticleEffect::createPacketCodec);
   public static final ParticleType VIBRATION = register("vibration", true, (type) -> {
      return VibrationParticleEffect.CODEC;
   }, (type) -> {
      return VibrationParticleEffect.PACKET_CODEC;
   });
   public static final ParticleType TRAIL = register("trail", false, (type) -> {
      return TrailParticleEffect.CODEC;
   }, (type) -> {
      return TrailParticleEffect.PACKET_CODEC;
   });
   ...
   public static final ParticleType SHRIEK = register("shriek", false, (type) -> {
      return ShriekParticleEffect.CODEC;
   }, (type) -> {
      return ShriekParticleEffect.PACKET_CODEC;
   });
   ...
   public static final ParticleType DUST_PILLAR = register("dust_pillar", false, BlockStateParticleEffect::createCodec, BlockStateParticleEffect::createPacketCodec);
   ...
   public static final ParticleType BLOCK_CRUMBLE = register("block_crumble", false, BlockStateParticleEffect::createCodec, BlockStateParticleEffect::createPacketCodec);
   ...
   private static SimpleParticleType register(String name, boolean alwaysShow) {
      return (SimpleParticleType)Registry.register(Registries.PARTICLE_TYPE, (String)name, new SimpleParticleType(alwaysShow));
   }

   private static ParticleType register(String name, boolean alwaysShow, final Function codecGetter, final Function packetCodecGetter) {
      return (ParticleType)Registry.register(Registries.PARTICLE_TYPE, (String)name, new ParticleType(alwaysShow) {
   ...
   static {
      ...
      PACKET_CODEC = PacketCodecs.registryValue(RegistryKeys.PARTICLE_TYPE).dispatch(ParticleEffect::getType, ParticleType::getPacketCodec);
   }
}
