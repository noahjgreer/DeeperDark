...
public class ParticleTypes {
    ...
    public static final ParticleType<DragonBreathParticleEffect> DRAGON_BREATH = ParticleTypes.register("dragon_breath", false, DragonBreathParticleEffect::createCodec, DragonBreathParticleEffect::createPacketCodec);
    ...
    public static final ParticleType<EffectParticleEffect> EFFECT = ParticleTypes.register("effect", false, EffectParticleEffect::createCodec, EffectParticleEffect::createPacketCodec);
    ...
    public static final ParticleType<TintedParticleEffect> ENTITY_EFFECT = ParticleTypes.register("entity_effect", false, TintedParticleEffect::createCodec, TintedParticleEffect::createPacketCodec);
    ...
    public static final ParticleType<TintedParticleEffect> TINTED_LEAVES = ParticleTypes.register("tinted_leaves", false, TintedParticleEffect::createCodec, TintedParticleEffect::createPacketCodec);
    ...
    public static final ParticleType<TintedParticleEffect> FLASH = ParticleTypes.register("flash", false, TintedParticleEffect::createCodec, TintedParticleEffect::createPacketCodec);
    ...
    public static final ParticleType<EffectParticleEffect> INSTANT_EFFECT = ParticleTypes.register("instant_effect", false, EffectParticleEffect::createCodec, EffectParticleEffect::createPacketCodec);
    ...
    public static final ParticleType<TrailParticleEffect> TRAIL = ParticleTypes.register("trail", false, type -> TrailParticleEffect.CODEC, type -> TrailParticleEffect.PACKET_CODEC);
    ...
    public static final ParticleType<BlockStateParticleEffect> BLOCK_CRUMBLE = ParticleTypes.register("block_crumble", false, BlockStateParticleEffect::createCodec, BlockStateParticleEffect::createPacketCodec);
