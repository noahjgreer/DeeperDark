...
public class ScoreboardObjective {
   ...
   private Text generateBracketedDisplayName() {
      return Texts.bracketed(this.displayName.copy().styled((style) -> {
         return style.withHoverEvent(new HoverEvent.ShowText(Text.literal(this.name)));
      }));
   }
   ...
   public static record Packed(String name, ScoreboardCriterion criteria, Text displayName, ScoreboardCriterion.RenderType renderType, boolean displayAutoUpdate, Optional numberFormat) {
      public static final Codec CODEC = RecordCodecBuilder.create((instance) -> {
         return instance.group(Codec.STRING.fieldOf("Name").forGetter(Packed::name), ScoreboardCriterion.CODEC.optionalFieldOf("CriteriaName", ScoreboardCriterion.DUMMY).forGetter(Packed::criteria), TextCodecs.CODEC.fieldOf("DisplayName").forGetter(Packed::displayName), ScoreboardCriterion.RenderType.CODEC.optionalFieldOf("RenderType", ScoreboardCriterion.RenderType.INTEGER).forGetter(Packed::renderType), Codec.BOOL.optionalFieldOf("display_auto_update", false).forGetter(Packed::displayAutoUpdate), NumberFormatTypes.CODEC.optionalFieldOf("format").forGetter(Packed::numberFormat)).apply(instance, Packed::new);
      });

      public Packed(String string, ScoreboardCriterion scoreboardCriterion, Text text, ScoreboardCriterion.RenderType renderType, boolean bl, Optional optional) {
         this.name = string;
      ...
      public ScoreboardCriterion criteria() {
