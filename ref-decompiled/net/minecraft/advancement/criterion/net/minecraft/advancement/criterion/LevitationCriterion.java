...
extends AbstractCriterion<Conditions> {
    ...
    {
        public static final Codec<Conditions> CODEC = RecordCodecBuilder.create((T instance) -> instance.group((App)EntityPredicate.LOOT_CONTEXT_PREDICATE_CODEC.optionalFieldOf("player").forGetter(Conditions::player), (App)DistancePredicate.CODEC.optionalFieldOf("distance").forGetter(Conditions::distance), (App)NumberRange.IntRange.CODEC.optionalFieldOf("duration", (Object)NumberRange.IntRange.ANY).forGetter(Conditions::duration)).apply((Applicative)instance, Conditions::new));
