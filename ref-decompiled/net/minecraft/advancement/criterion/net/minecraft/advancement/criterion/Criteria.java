...
public class Criteria {
    ...
    public static final SpearMobsCriterion SPEAR_MOBS = Criteria.register("spear_mobs", new SpearMobsCriterion());
    public static final KilledByArrowCriterion KILLED_BY_ARROW = Criteria.register("killed_by_arrow", new KilledByArrowCriterion());
    ...
    public static final PlayerInteractedWithEntityCriterion PLAYER_SHEARED_EQUIPMENT = Criteria.register("player_sheared_equipment", new PlayerInteractedWithEntityCriterion());
