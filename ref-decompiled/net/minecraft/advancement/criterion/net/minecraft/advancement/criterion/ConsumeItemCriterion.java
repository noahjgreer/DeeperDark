...
extends AbstractCriterion<Conditions> {
    ...
    {
        public static final Codec<Conditions> CODEC = RecordCodecBuilder.create(instance -> instance.group((App)EntityPredicate.LOOT_CONTEXT_PREDICATE_CODEC.optionalFieldOf("player").forGetter(Conditions::player), (App)ItemPredicate.CODEC.optionalFieldOf("item").forGetter(Conditions::item)).apply((Applicative)instance, Conditions::new));
        ...
        public static AdvancementCriterion<Conditions> item(RegistryEntryLookup<Item> itemRegistry, ItemConvertible item) {
            return Conditions.predicate(ItemPredicate.Builder.create().items(itemRegistry, item.asItem()));
        }
