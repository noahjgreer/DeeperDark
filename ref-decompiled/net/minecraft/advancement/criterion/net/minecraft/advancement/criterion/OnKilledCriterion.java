...
extends AbstractCriterion<Conditions> {
    ...
    {
        public static final Codec<Conditions> CODEC = RecordCodecBuilder.create(instance -> instance.group((App)EntityPredicate.LOOT_CONTEXT_PREDICATE_CODEC.optionalFieldOf("player").forGetter(Conditions::player), (App)EntityPredicate.LOOT_CONTEXT_PREDICATE_CODEC.optionalFieldOf("entity").forGetter(Conditions::entity), (App)DamageSourcePredicate.CODEC.optionalFieldOf("killing_blow").forGetter(Conditions::killingBlow)).apply((Applicative)instance, Conditions::new));
        ...
        public final String toString() {
            return ObjectMethods.bootstrap("toString", new MethodHandle[]{Conditions.class, "player;entityPredicate;killingBlow", "player", "entity", "killingBlow"}, this);
        }

        @Override
        public final int hashCode() {
            return (int)ObjectMethods.bootstrap("hashCode", new MethodHandle[]{Conditions.class, "player;entityPredicate;killingBlow", "player", "entity", "killingBlow"}, this);
        }

        @Override
        public final boolean equals(Object object) {
            return (boolean)ObjectMethods.bootstrap("equals", new MethodHandle[]{Conditions.class, "player;entityPredicate;killingBlow", "player", "entity", "killingBlow"}, this, object);
        }
    }
}
