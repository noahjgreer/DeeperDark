...
public class UsedTotemCriterion extends AbstractCriterion {
   ...
   public static record Conditions(Optional player, Optional item) implements AbstractCriterion.Conditions {
      ...
      public static AdvancementCriterion create(ItemPredicate itemPredicate) {
      ...
      public static AdvancementCriterion create(RegistryEntryLookup itemRegistry, ItemConvertible item) {
         return Criteria.USED_TOTEM.create(new Conditions(Optional.empty(), Optional.of(ItemPredicate.Builder.create().items(itemRegistry, item).build())));
      }
