...
public class SmithingTransformRecipeJsonBuilder {
    ...
    public void offerTo(RecipeExporter exporter, RegistryKey<Recipe<?>> recipeKey) {
        ...
        SmithingTransformRecipe smithingTransformRecipe = new SmithingTransformRecipe(Optional.of(this.template), this.base, Optional.of(this.addition), new TransmuteRecipeResult(this.result));
