...
public class StonecuttingRecipeJsonBuilder implements CraftingRecipeJsonBuilder {
   ...
   public void offerTo(RecipeExporter exporter, RegistryKey recipeKey) {
      ...
      SingleStackRecipe singleStackRecipe = this.recipeFactory.create((String)Objects.requireNonNullElse(this.group, ""), this.input, new ItemStack(this.output, this.count));
