...
public class TransmuteRecipeJsonBuilder implements CraftingRecipeJsonBuilder {
   ...
   private final RegistryEntry result;
   ...
   private TransmuteRecipeJsonBuilder(RecipeCategory category, RegistryEntry result, Ingredient input, Ingredient material) {
   ...
   public void offerTo(RecipeExporter exporter, RegistryKey recipeKey) {
      ...
      TransmuteRecipe transmuteRecipe = new TransmuteRecipe((String)Objects.requireNonNullElse(this.group, ""), CraftingRecipeJsonBuilder.toCraftingCategory(this.category), this.input, this.material, new TransmuteRecipeResult((Item)this.result.value()));
