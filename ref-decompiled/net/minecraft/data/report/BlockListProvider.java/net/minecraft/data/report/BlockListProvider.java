    ...
    public CompletableFuture<?> run(DataWriter writer) {
        ...
        return this.registriesFuture.thenCompose(registries -> {
            ...
            registries.getOrThrow(RegistryKeys.BLOCK).streamEntries().forEach(entry -> {
                ...
                JsonElement jsonElement = (JsonElement)BlockTypes.CODEC.codec().encodeStart((DynamicOps)registryOps, (Object)((Block)entry.value())).getOrThrow(string2 -> new AssertionError((Object)("Failed to serialize block " + string + " (is type registered in BlockTypes?): " + string2)));
