...
public record VanillaGiftLootTableGenerator(RegistryWrapper.WrapperLookup registries) implements LootTableGenerator {
   ...
   public void accept(BiConsumer lootTableBiConsumer) {
      ...
      lootTableBiConsumer.accept(LootTables.HERO_OF_THE_VILLAGE_FLETCHER_GIFT_GAMEPLAY, LootTable.builder().pool(LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0F)).with(ItemEntry.builder(Items.ARROW).weight(26)).with(ItemEntry.builder(Items.TIPPED_ARROW).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0F, 1.0F))).apply(SetPotionLootFunction.builder(Potions.SWIFTNESS))).with(ItemEntry.builder(Items.TIPPED_ARROW).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0F, 1.0F))).apply(SetPotionLootFunction.builder(Potions.SLOWNESS))).with(ItemEntry.builder(Items.TIPPED_ARROW).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0F, 1.0F))).apply(SetPotionLootFunction.builder(Potions.STRENGTH))).with(ItemEntry.builder(Items.TIPPED_ARROW).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0F, 1.0F))).apply(SetPotionLootFunction.builder(Potions.HEALING))).with(ItemEntry.builder(Items.TIPPED_ARROW).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0F, 1.0F))).apply(SetPotionLootFunction.builder(Potions.HARMING))).with(ItemEntry.builder(Items.TIPPED_ARROW).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0F, 1.0F))).apply(SetPotionLootFunction.builder(Potions.LEAPING))).with(ItemEntry.builder(Items.TIPPED_ARROW).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0F, 1.0F))).apply(SetPotionLootFunction.builder(Potions.REGENERATION))).with(ItemEntry.builder(Items.TIPPED_ARROW).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0F, 1.0F))).apply(SetPotionLootFunction.builder(Potions.FIRE_RESISTANCE))).with(ItemEntry.builder(Items.TIPPED_ARROW).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0F, 1.0F))).apply(SetPotionLootFunction.builder(Potions.WATER_BREATHING))).with(ItemEntry.builder(Items.TIPPED_ARROW).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0F, 1.0F))).apply(SetPotionLootFunction.builder(Potions.INVISIBILITY))).with(ItemEntry.builder(Items.TIPPED_ARROW).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0F, 1.0F))).apply(SetPotionLootFunction.builder(Potions.NIGHT_VISION))).with(ItemEntry.builder(Items.TIPPED_ARROW).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0F, 1.0F))).apply(SetPotionLootFunction.builder(Potions.WEAKNESS))).with(ItemEntry.builder(Items.TIPPED_ARROW).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0F, 1.0F))).apply(SetPotionLootFunction.builder(Potions.POISON)))));
      ...
      lootTableBiConsumer.accept(LootTables.PANDA_SNEEZE_GAMEPLAY, LootTable.builder().pool(LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0F)).with(ItemEntry.builder(Items.SLIME_BALL).weight(1)).with(EmptyEntry.builder().weight(699))));
      lootTableBiConsumer.accept(LootTables.CHICKEN_LAY_GAMEPLAY, LootTable.builder().pool(LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0F)).with(AlternativeEntry.builder(ItemEntry.builder(Items.EGG).conditionally(EntityPropertiesLootCondition.builder(LootContext.EntityTarget.THIS, EntityPredicate.Builder.create().components(ComponentsPredicate.Builder.create().exact(ComponentMapPredicate.of(DataComponentTypes.CHICKEN_VARIANT, new LazyRegistryEntryReference(registryEntryLookup.getOrThrow(ChickenVariants.TEMPERATE)))).build()))), ItemEntry.builder(Items.BROWN_EGG).conditionally(EntityPropertiesLootCondition.builder(LootContext.EntityTarget.THIS, EntityPredicate.Builder.create().components(ComponentsPredicate.Builder.create().exact(ComponentMapPredicate.of(DataComponentTypes.CHICKEN_VARIANT, new LazyRegistryEntryReference(registryEntryLookup.getOrThrow(ChickenVariants.WARM)))).build()))), ItemEntry.builder(Items.BLUE_EGG).conditionally(EntityPropertiesLootCondition.builder(LootContext.EntityTarget.THIS, EntityPredicate.Builder.create().components(ComponentsPredicate.Builder.create().exact(ComponentMapPredicate.of(DataComponentTypes.CHICKEN_VARIANT, new LazyRegistryEntryReference(registryEntryLookup.getOrThrow(ChickenVariants.COLD)))).build())))))));
