...
extends BlockLootTableGenerator {
    ...
    protected void generate() {
        ...
        RegistryEntryLookup impl2 = this.registries.getOrThrow(RegistryKeys.ITEM);
        ...
        this.addDrop(Blocks.SUSPICIOUS_SAND, VanillaBlockLootTableGenerator.dropsNothing());
        this.addDrop(Blocks.SUSPICIOUS_GRAVEL, VanillaBlockLootTableGenerator.dropsNothing());
        ...
        Blocks.COPPER_BARS.forEach(block -> this.addDrop((Block)block));
        ...
        Blocks.COPPER_CHAINS.forEach(block -> this.addDrop((Block)block));
        ...
        this.addDrop(Blocks.SCULK_VEIN, (Block block) -> this.multifaceGrowthDrops((Block)block, this.createSilkTouchCondition()));
        ...
        this.addDrop(Blocks.PALE_MOSS_CARPET, (Block block) -> this.paleMossCarpetDrops((Block)block));
        this.addDrop(Blocks.PALE_HANGING_MOSS, (Block block) -> this.dropsWithSilkTouchOrShears((ItemConvertible)block));
        ...
        this.addDrop(Blocks.TUFF_SLAB, (Block block) -> this.slabDrops((Block)block));
        this.addDrop(Blocks.TUFF_BRICK_SLAB, (Block block) -> this.slabDrops((Block)block));
        this.addDrop(Blocks.POLISHED_TUFF_SLAB, (Block block) -> this.slabDrops((Block)block));
        ...
        this.addDrop(Blocks.COPPER_GOLEM_STATUE, (Block block) -> this.copperGolemStatueDrops((Block)block));
        this.addDrop(Blocks.EXPOSED_COPPER_GOLEM_STATUE, (Block block) -> this.copperGolemStatueDrops((Block)block));
        this.addDrop(Blocks.WEATHERED_COPPER_GOLEM_STATUE, (Block block) -> this.copperGolemStatueDrops((Block)block));
        this.addDrop(Blocks.OXIDIZED_COPPER_GOLEM_STATUE, (Block block) -> this.copperGolemStatueDrops((Block)block));
        this.addDrop(Blocks.WAXED_COPPER_GOLEM_STATUE, (Block block) -> this.copperGolemStatueDrops((Block)block));
        this.addDrop(Blocks.WAXED_EXPOSED_COPPER_GOLEM_STATUE, (Block block) -> this.copperGolemStatueDrops((Block)block));
        this.addDrop(Blocks.WAXED_WEATHERED_COPPER_GOLEM_STATUE, (Block block) -> this.copperGolemStatueDrops((Block)block));
        this.addDrop(Blocks.WAXED_OXIDIZED_COPPER_GOLEM_STATUE, (Block block) -> this.copperGolemStatueDrops((Block)block));
        ...
        this.addDrop(Blocks.PALE_OAK_SLAB, (Block block) -> this.slabDrops((Block)block));
        ...
        this.addDrop(Blocks.RESIN_BRICK_SLAB, (Block block) -> this.slabDrops((Block)block));
        ...
        this.addDrop(Blocks.PALE_OAK_DOOR, (Block block) -> this.doorDrops((Block)block));
        ...
        this.addDrop(Blocks.COPPER_DOOR, (Block block) -> this.doorDrops((Block)block));
        this.addDrop(Blocks.EXPOSED_COPPER_DOOR, (Block block) -> this.doorDrops((Block)block));
        this.addDrop(Blocks.WEATHERED_COPPER_DOOR, (Block block) -> this.doorDrops((Block)block));
        this.addDrop(Blocks.OXIDIZED_COPPER_DOOR, (Block block) -> this.doorDrops((Block)block));
        this.addDrop(Blocks.WAXED_COPPER_DOOR, (Block block) -> this.doorDrops((Block)block));
        this.addDrop(Blocks.WAXED_EXPOSED_COPPER_DOOR, (Block block) -> this.doorDrops((Block)block));
        this.addDrop(Blocks.WAXED_WEATHERED_COPPER_DOOR, (Block block) -> this.doorDrops((Block)block));
        this.addDrop(Blocks.WAXED_OXIDIZED_COPPER_DOOR, (Block block) -> this.doorDrops((Block)block));
        ...
        this.addDrop(Blocks.CAVE_VINES, (Block block) -> this.glowBerryDrops((Block)block));
        this.addDrop(Blocks.CAVE_VINES_PLANT, (Block block) -> this.glowBerryDrops((Block)block));
        ...
        this.addDrop(Blocks.COPPER_CHEST, (Block block) -> this.nameableContainerDrops((Block)block));
        this.addDrop(Blocks.EXPOSED_COPPER_CHEST, (Block block) -> this.nameableContainerDrops((Block)block));
        this.addDrop(Blocks.WEATHERED_COPPER_CHEST, (Block block) -> this.nameableContainerDrops((Block)block));
        this.addDrop(Blocks.OXIDIZED_COPPER_CHEST, (Block block) -> this.nameableContainerDrops((Block)block));
        this.addDrop(Blocks.WAXED_COPPER_CHEST, (Block block) -> this.nameableContainerDrops((Block)block));
        this.addDrop(Blocks.WAXED_EXPOSED_COPPER_CHEST, (Block block) -> this.nameableContainerDrops((Block)block));
        this.addDrop(Blocks.WAXED_WEATHERED_COPPER_CHEST, (Block block) -> this.nameableContainerDrops((Block)block));
        this.addDrop(Blocks.WAXED_OXIDIZED_COPPER_CHEST, (Block block) -> this.nameableContainerDrops((Block)block));
        ...
        Blocks.COPPER_LANTERNS.forEach(block -> this.addDrop((Block)block, this::drops));
        ...
        this.addDrop(Blocks.PLAYER_HEAD, (Block block) -> LootTable.builder().pool(this.addSurvivesExplosionCondition((ItemConvertible)block, LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0f)).with((LootPoolEntry.Builder<?>)((Object)ItemEntry.builder(block).apply(CopyComponentsLootFunction.blockEntity(LootContextParameters.BLOCK_ENTITY).include(DataComponentTypes.PROFILE).include(DataComponentTypes.NOTE_BLOCK_SOUND).include(DataComponentTypes.CUSTOM_NAME)))))));
        ...
        this.addDrop(Blocks.BEE_NEST, (Block block) -> this.beeNestDrops((Block)block));
        this.addDrop(Blocks.BEEHIVE, (Block block) -> this.beehiveDrops((Block)block));
        ...
        this.addDrop(Blocks.PALE_OAK_LEAVES, (Block block) -> this.leavesDrops((Block)block, Blocks.PALE_OAK_SAPLING, SAPLING_DROP_CHANCE));
        ...
        this.addDrop(Blocks.CARROTS, this.applyExplosionDecay(Blocks.CARROTS, LootTable.builder().pool(LootPool.builder().with(ItemEntry.builder(Items.CARROT))).pool(LootPool.builder().conditionally(builder3).with((LootPoolEntry.Builder<?>)((Object)ItemEntry.builder(Items.CARROT).apply(ApplyBonusLootFunction.binomialWithBonusCount(impl.getOrThrow(Enchantments.FORTUNE), 0.5714286f, 3)))))));
        ...
        this.addDrop(Blocks.POTATOES, this.applyExplosionDecay(Blocks.POTATOES, LootTable.builder().pool(LootPool.builder().with(ItemEntry.builder(Items.POTATO))).pool(LootPool.builder().conditionally(builder5).with((LootPoolEntry.Builder<?>)((Object)ItemEntry.builder(Items.POTATO).apply(ApplyBonusLootFunction.binomialWithBonusCount(impl.getOrThrow(Enchantments.FORTUNE), 0.5714286f, 3))))).pool(LootPool.builder().conditionally(builder5).with((LootPoolEntry.Builder<?>)ItemEntry.builder(Items.POISONOUS_POTATO).conditionally(RandomChanceLootCondition.builder(0.02f))))));
        this.addDrop(Blocks.SWEET_BERRY_BUSH, arg_0 -> this.method_60416((RegistryWrapper.Impl)impl, arg_0));
        ...
        this.addDrop(Blocks.NETHER_GOLD_ORE, arg_0 -> this.method_60415((RegistryWrapper.Impl)impl, arg_0));
        ...
        this.addDrop(Blocks.COBWEB, (Block block) -> this.dropsWithSilkTouchOrShears((Block)block, (LootPoolEntry.Builder)this.addSurvivesExplosionCondition((ItemConvertible)block, ItemEntry.builder(Items.STRING))));
        this.addDrop(Blocks.DEAD_BUSH, (Block block) -> this.dropsWithShears((Block)block, (LootPoolEntry.Builder)this.applyExplosionDecay((ItemConvertible)block, ItemEntry.builder(Items.STICK).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0f, 2.0f))))));
        this.addDrop(Blocks.SHORT_DRY_GRASS, (Block block) -> this.dropsWithSilkTouchOrShears((ItemConvertible)block));
        this.addDrop(Blocks.TALL_DRY_GRASS, (Block block) -> this.dropsWithSilkTouchOrShears((ItemConvertible)block));
        this.addDrop(Blocks.BUSH, (Block block) -> this.dropsWithSilkTouchOrShears((ItemConvertible)block));
        this.addDrop(Blocks.NETHER_SPROUTS, (Block block) -> this.dropsWithShears((ItemConvertible)block));
        this.addDrop(Blocks.SEAGRASS, (Block block) -> this.dropsWithShears((ItemConvertible)block));
        this.addDrop(Blocks.VINE, (Block block) -> this.dropsWithShears((ItemConvertible)block));
        this.addDrop(Blocks.GLOW_LICHEN, (Block block) -> this.multifaceGrowthDrops((Block)block, this.createWithShearsCondition()));
        this.addDrop(Blocks.RESIN_CLUMP, (Block block) -> this.multifaceGrowthDrops((Block)block));
        this.addDrop(Blocks.HANGING_ROOTS, (Block block) -> this.dropsWithShears((ItemConvertible)block));
        this.addDrop(Blocks.SMALL_DRIPLEAF, (Block block) -> this.dropsWithShears((ItemConvertible)block));
        ...
        this.addDrop(Blocks.LARGE_FERN, (Block block) -> this.tallPlantDrops((Block)block, Blocks.FERN));
        this.addDrop(Blocks.TALL_GRASS, (Block block) -> this.tallPlantDrops((Block)block, Blocks.SHORT_GRASS));
        ...
        this.addDrop(Blocks.CHORUS_FLOWER, (Block block) -> LootTable.builder().pool(LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0f)).with((LootPoolEntry.Builder<?>)((LeafEntry.Builder)this.addSurvivesExplosionCondition((ItemConvertible)block, ItemEntry.builder(block))).conditionally(EntityPropertiesLootCondition.create(LootContext.EntityReference.THIS)))));
        this.addDrop(Blocks.FERN, (Block block) -> this.shortPlantDrops((Block)block));
        this.addDrop(Blocks.SHORT_GRASS, (Block block) -> this.shortPlantDrops((Block)block));
        this.addDrop(Blocks.GLOWSTONE, arg_0 -> this.method_60414((RegistryWrapper.Impl)impl, arg_0));
        this.addDrop(Blocks.MELON, arg_0 -> this.method_60413((RegistryWrapper.Impl)impl, arg_0));
        ...
        this.addDrop(Blocks.SEA_LANTERN, arg_0 -> this.method_60412((RegistryWrapper.Impl)impl, arg_0));
        this.addDrop(Blocks.CREAKING_HEART, arg_0 -> this.method_65288((RegistryWrapper.Impl)impl, arg_0));
        this.addDrop(Blocks.NETHER_WART, arg_0 -> this.method_32226((RegistryWrapper.Impl)impl, arg_0));
        this.addDrop(Blocks.SNOW, (Block block) -> LootTable.builder().pool(LootPool.builder().conditionally(EntityPropertiesLootCondition.create(LootContext.EntityReference.THIS)).with(AlternativeEntry.builder(new LootPoolEntry.Builder[]{AlternativeEntry.builder(SnowBlock.LAYERS.getValues(), layers -> ((LeafEntry.Builder)ItemEntry.builder(Items.SNOWBALL).conditionally(BlockStatePropertyLootCondition.builder(block).properties(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, layers.intValue())))).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(layers.intValue())))).conditionally(this.createWithoutSilkTouchCondition()), AlternativeEntry.builder(SnowBlock.LAYERS.getValues(), layers -> layers == 8 ? ItemEntry.builder(Blocks.SNOW_BLOCK) : ((LootPoolEntry.Builder)((Object)ItemEntry.builder(Blocks.SNOW).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(layers.intValue()))))).conditionally(BlockStatePropertyLootCondition.builder(block).properties(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, layers.intValue()))))}))));
        this.addDrop(Blocks.GRAVEL, arg_0 -> this.method_60411((RegistryWrapper.Impl)impl, arg_0));
        this.addDrop(Blocks.CAMPFIRE, (Block block) -> this.dropsWithSilkTouch((Block)block, (LootPoolEntry.Builder)this.addSurvivesExplosionCondition((ItemConvertible)block, ItemEntry.builder(Items.CHARCOAL).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(2.0f))))));
        this.addDrop(Blocks.GILDED_BLACKSTONE, arg_0 -> this.method_60407((RegistryWrapper.Impl)impl, arg_0));
        this.addDrop(Blocks.SOUL_CAMPFIRE, (Block block) -> this.dropsWithSilkTouch((Block)block, (LootPoolEntry.Builder)this.addSurvivesExplosionCondition((ItemConvertible)block, ItemEntry.builder(Items.SOUL_SOIL).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0f))))));
        this.addDrop(Blocks.AMETHYST_CLUSTER, arg_0 -> this.method_60395((RegistryWrapper.Impl)impl, (RegistryWrapper.Impl)impl2, arg_0));
        ...
        this.addDrop(Blocks.TRIAL_SPAWNER, VanillaBlockLootTableGenerator.dropsNothing());
        this.addDrop(Blocks.VAULT, VanillaBlockLootTableGenerator.dropsNothing());
    ...
    private LootTable.Builder decoratedPotDrops(Block block) {
        return LootTable.builder().pool(LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0f)).with(((LeafEntry.Builder)DynamicEntry.builder(DecoratedPotBlock.SHERDS_DYNAMIC_DROP_ID).conditionally(BlockStatePropertyLootCondition.builder(block).properties(StatePredicate.Builder.create().exactMatch(DecoratedPotBlock.CRACKED, true)))).alternatively((LootPoolEntry.Builder<?>)((Object)ItemEntry.builder(block).apply(CopyComponentsLootFunction.blockEntity(LootContextParameters.BLOCK_ENTITY).include(DataComponentTypes.POT_DECORATIONS))))));
    }
    ...
    private LootTable.Builder skullDrops(Block skull) {
        return LootTable.builder().pool(this.addSurvivesExplosionCondition(skull, LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0f)).with((LootPoolEntry.Builder<?>)((Object)ItemEntry.builder(skull).apply(CopyComponentsLootFunction.blockEntity(LootContextParameters.BLOCK_ENTITY).include(DataComponentTypes.CUSTOM_NAME))))));
    }

    private /* synthetic */ LootTable.Builder method_60395(RegistryWrapper.Impl impl, RegistryWrapper.Impl impl2, Block block) {
        return this.dropsWithSilkTouch(block, ((LeafEntry.Builder)((LootPoolEntry.Builder)((Object)((LeafEntry.Builder)ItemEntry.builder(Items.AMETHYST_SHARD).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(4.0f)))).apply(ApplyBonusLootFunction.oreDrops(impl.getOrThrow(Enchantments.FORTUNE))))).conditionally(MatchToolLootCondition.builder(ItemPredicate.Builder.create().tag(impl2, ItemTags.CLUSTER_MAX_HARVESTABLES)))).alternatively((LootPoolEntry.Builder)this.applyExplosionDecay(block, ItemEntry.builder(Items.AMETHYST_SHARD).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(2.0f))))));
    }

    private /* synthetic */ LootTable.Builder method_60407(RegistryWrapper.Impl impl, Block block) {
        return this.dropsWithSilkTouch(block, this.addSurvivesExplosionCondition(block, ((LeafEntry.Builder)((LootPoolEntry.Builder)((Object)ItemEntry.builder(Items.GOLD_NUGGET).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(2.0f, 5.0f))))).conditionally(TableBonusLootCondition.builder(impl.getOrThrow(Enchantments.FORTUNE), 0.1f, 0.14285715f, 0.25f, 1.0f))).alternatively(ItemEntry.builder(block))));
    }

    private /* synthetic */ LootTable.Builder method_60411(RegistryWrapper.Impl impl, Block block) {
        return this.dropsWithSilkTouch(block, this.addSurvivesExplosionCondition(block, ((LeafEntry.Builder)ItemEntry.builder(Items.FLINT).conditionally(TableBonusLootCondition.builder(impl.getOrThrow(Enchantments.FORTUNE), 0.1f, 0.14285715f, 0.25f, 1.0f))).alternatively(ItemEntry.builder(block))));
    }

    private /* synthetic */ LootTable.Builder method_32226(RegistryWrapper.Impl impl, Block block) {
        return LootTable.builder().pool(this.applyExplosionDecay(block, LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0f)).with((LootPoolEntry.Builder<?>)((Object)((LeafEntry.Builder)ItemEntry.builder(Items.NETHER_WART).apply((LootFunction.Builder)((Object)SetCountLootFunction.builder(UniformLootNumberProvider.create(2.0f, 4.0f)).conditionally(BlockStatePropertyLootCondition.builder(block).properties(StatePredicate.Builder.create().exactMatch(NetherWartBlock.AGE, 3)))))).apply((LootFunction.Builder)((Object)ApplyBonusLootFunction.uniformBonusCount(impl.getOrThrow(Enchantments.FORTUNE)).conditionally(BlockStatePropertyLootCondition.builder(block).properties(StatePredicate.Builder.create().exactMatch(NetherWartBlock.AGE, 3)))))))));
    }

    private /* synthetic */ LootTable.Builder method_65288(RegistryWrapper.Impl impl, Block block) {
        return this.dropsWithSilkTouch(block, (LootPoolEntry.Builder)this.applyExplosionDecay(block, ((LeafEntry.Builder)((LeafEntry.Builder)ItemEntry.builder(Items.RESIN_CLUMP).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0f, 3.0f)))).apply(ApplyBonusLootFunction.uniformBonusCount(impl.getOrThrow(Enchantments.FORTUNE)))).apply(LimitCountLootFunction.builder(BoundedIntUnaryOperator.createMax(9)))));
    }

    private /* synthetic */ LootTable.Builder method_60412(RegistryWrapper.Impl impl, Block block) {
    ...
    private /* synthetic */ LootTable.Builder method_60413(RegistryWrapper.Impl impl, Block block) {
        return this.dropsWithSilkTouch(block, (LootPoolEntry.Builder)this.applyExplosionDecay(block, ((LeafEntry.Builder)((LeafEntry.Builder)ItemEntry.builder(Items.MELON_SLICE).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(3.0f, 7.0f)))).apply(ApplyBonusLootFunction.uniformBonusCount(impl.getOrThrow(Enchantments.FORTUNE)))).apply(LimitCountLootFunction.builder(BoundedIntUnaryOperator.createMax(9)))));
    }

    private /* synthetic */ LootTable.Builder method_60414(RegistryWrapper.Impl impl, Block block) {
    ...
    private /* synthetic */ LootTable.Builder method_60415(RegistryWrapper.Impl impl, Block block) {
        return this.dropsWithSilkTouch(block, (LootPoolEntry.Builder)this.applyExplosionDecay(block, ((LeafEntry.Builder)ItemEntry.builder(Items.GOLD_NUGGET).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(2.0f, 6.0f)))).apply(ApplyBonusLootFunction.oreDrops(impl.getOrThrow(Enchantments.FORTUNE)))));
    }

    private /* synthetic */ LootTable.Builder method_60416(RegistryWrapper.Impl impl, Block block) {
