...
public class VanillaBlockLootTableGenerator extends BlockLootTableGenerator {
   ...
   private static final Set EXPLOSION_IMMUNE;
   ...
   protected void generate() {
      ...
      RegistryWrapper.Impl impl2 = this.registries.getOrThrow(RegistryKeys.ITEM);
      ...
      this.addDrop(Blocks.SCULK_VEIN, (block) -> {
         return this.multifaceGrowthDrops(block, this.createSilkTouchCondition());
      });
      ...
      this.addDrop(Blocks.PALE_MOSS_CARPET, (block) -> {
         return this.paleMossCarpetDrops(block);
      });
      this.addDrop(Blocks.PALE_HANGING_MOSS, (block) -> {
         return this.dropsWithSilkTouchOrShears(block);
      });
      ...
      this.addDrop(Blocks.TUFF_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.TUFF_BRICK_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.POLISHED_TUFF_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      ...
      this.addDrop(Blocks.STONE, (block) -> {
         return this.drops(block, Blocks.COBBLESTONE);
      });
      this.addDrop(Blocks.DEEPSLATE, (block) -> {
         return this.drops(block, Blocks.COBBLED_DEEPSLATE);
      });
      this.addDrop(Blocks.GRASS_BLOCK, (block) -> {
         return this.drops(block, Blocks.DIRT);
      });
      this.addDrop(Blocks.PODZOL, (block) -> {
         return this.drops(block, Blocks.DIRT);
      });
      this.addDrop(Blocks.MYCELIUM, (block) -> {
         return this.drops(block, Blocks.DIRT);
      });
      this.addDrop(Blocks.TUBE_CORAL_BLOCK, (block) -> {
         return this.drops(block, Blocks.DEAD_TUBE_CORAL_BLOCK);
      });
      this.addDrop(Blocks.BRAIN_CORAL_BLOCK, (block) -> {
         return this.drops(block, Blocks.DEAD_BRAIN_CORAL_BLOCK);
      });
      this.addDrop(Blocks.BUBBLE_CORAL_BLOCK, (block) -> {
         return this.drops(block, Blocks.DEAD_BUBBLE_CORAL_BLOCK);
      });
      this.addDrop(Blocks.FIRE_CORAL_BLOCK, (block) -> {
         return this.drops(block, Blocks.DEAD_FIRE_CORAL_BLOCK);
      });
      this.addDrop(Blocks.HORN_CORAL_BLOCK, (block) -> {
         return this.drops(block, Blocks.DEAD_HORN_CORAL_BLOCK);
      });
      this.addDrop(Blocks.CRIMSON_NYLIUM, (block) -> {
         return this.drops(block, Blocks.NETHERRACK);
      });
      this.addDrop(Blocks.WARPED_NYLIUM, (block) -> {
         return this.drops(block, Blocks.NETHERRACK);
      });
      this.addDrop(Blocks.BOOKSHELF, (block) -> {
         return this.drops(block, Items.BOOK, ConstantLootNumberProvider.create(3.0F));
      });
      this.addDrop(Blocks.CLAY, (block) -> {
         return this.drops(block, Items.CLAY_BALL, ConstantLootNumberProvider.create(4.0F));
      });
      this.addDrop(Blocks.ENDER_CHEST, (block) -> {
         return this.drops(block, Blocks.OBSIDIAN, ConstantLootNumberProvider.create(8.0F));
      });
      this.addDrop(Blocks.SNOW_BLOCK, (block) -> {
         return this.drops(block, Items.SNOWBALL, ConstantLootNumberProvider.create(4.0F));
      });
      ...
      this.addDrop(Blocks.OAK_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.PETRIFIED_OAK_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.SPRUCE_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.BIRCH_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.JUNGLE_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.ACACIA_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.DARK_OAK_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.PALE_OAK_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.MANGROVE_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.CHERRY_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.BAMBOO_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.BAMBOO_MOSAIC_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.BRICK_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.COBBLESTONE_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.DARK_PRISMARINE_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.NETHER_BRICK_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.PRISMARINE_BRICK_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.PRISMARINE_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.PURPUR_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.QUARTZ_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.RED_SANDSTONE_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.SANDSTONE_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.CUT_RED_SANDSTONE_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.CUT_SANDSTONE_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.STONE_BRICK_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.STONE_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.SMOOTH_STONE_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.POLISHED_GRANITE_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.SMOOTH_RED_SANDSTONE_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.MOSSY_STONE_BRICK_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.POLISHED_DIORITE_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.MOSSY_COBBLESTONE_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.END_STONE_BRICK_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.SMOOTH_SANDSTONE_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.SMOOTH_QUARTZ_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.GRANITE_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.ANDESITE_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.RED_NETHER_BRICK_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.POLISHED_ANDESITE_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.DIORITE_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.CRIMSON_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.WARPED_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.BLACKSTONE_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.POLISHED_BLACKSTONE_BRICK_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.POLISHED_BLACKSTONE_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.OXIDIZED_CUT_COPPER_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.WEATHERED_CUT_COPPER_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.EXPOSED_CUT_COPPER_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.CUT_COPPER_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.WAXED_OXIDIZED_CUT_COPPER_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.WAXED_WEATHERED_CUT_COPPER_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.WAXED_EXPOSED_CUT_COPPER_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.WAXED_CUT_COPPER_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.COBBLED_DEEPSLATE_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.POLISHED_DEEPSLATE_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.DEEPSLATE_TILE_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.DEEPSLATE_BRICK_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.MUD_BRICK_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.RESIN_BRICK_SLAB, (block) -> {
         return this.slabDrops(block);
      });
      this.addDrop(Blocks.OAK_DOOR, (block) -> {
         return this.doorDrops(block);
      });
      this.addDrop(Blocks.SPRUCE_DOOR, (block) -> {
         return this.doorDrops(block);
      });
      this.addDrop(Blocks.BIRCH_DOOR, (block) -> {
         return this.doorDrops(block);
      });
      this.addDrop(Blocks.JUNGLE_DOOR, (block) -> {
         return this.doorDrops(block);
      });
      this.addDrop(Blocks.ACACIA_DOOR, (block) -> {
         return this.doorDrops(block);
      });
      this.addDrop(Blocks.DARK_OAK_DOOR, (block) -> {
         return this.doorDrops(block);
      });
      this.addDrop(Blocks.PALE_OAK_DOOR, (block) -> {
         return this.doorDrops(block);
      });
      this.addDrop(Blocks.MANGROVE_DOOR, (block) -> {
         return this.doorDrops(block);
      });
      this.addDrop(Blocks.CHERRY_DOOR, (block) -> {
         return this.doorDrops(block);
      });
      this.addDrop(Blocks.BAMBOO_DOOR, (block) -> {
         return this.doorDrops(block);
      });
      this.addDrop(Blocks.WARPED_DOOR, (block) -> {
         return this.doorDrops(block);
      });
      this.addDrop(Blocks.CRIMSON_DOOR, (block) -> {
         return this.doorDrops(block);
      });
      this.addDrop(Blocks.IRON_DOOR, (block) -> {
         return this.doorDrops(block);
      });
      this.addDrop(Blocks.COPPER_DOOR, (block) -> {
         return this.doorDrops(block);
      });
      this.addDrop(Blocks.EXPOSED_COPPER_DOOR, (block) -> {
         return this.doorDrops(block);
      });
      this.addDrop(Blocks.WEATHERED_COPPER_DOOR, (block) -> {
         return this.doorDrops(block);
      });
      this.addDrop(Blocks.OXIDIZED_COPPER_DOOR, (block) -> {
         return this.doorDrops(block);
      });
      this.addDrop(Blocks.WAXED_COPPER_DOOR, (block) -> {
         return this.doorDrops(block);
      });
      this.addDrop(Blocks.WAXED_EXPOSED_COPPER_DOOR, (block) -> {
         return this.doorDrops(block);
      });
      this.addDrop(Blocks.WAXED_WEATHERED_COPPER_DOOR, (block) -> {
         return this.doorDrops(block);
      });
      this.addDrop(Blocks.WAXED_OXIDIZED_COPPER_DOOR, (block) -> {
         return this.doorDrops(block);
      });
      this.addDrop(Blocks.BLACK_BED, (block) -> {
         return this.dropsWithProperty(block, BedBlock.PART, BedPart.HEAD);
      });
      this.addDrop(Blocks.BLUE_BED, (block) -> {
         return this.dropsWithProperty(block, BedBlock.PART, BedPart.HEAD);
      });
      this.addDrop(Blocks.BROWN_BED, (block) -> {
         return this.dropsWithProperty(block, BedBlock.PART, BedPart.HEAD);
      });
      this.addDrop(Blocks.CYAN_BED, (block) -> {
         return this.dropsWithProperty(block, BedBlock.PART, BedPart.HEAD);
      });
      this.addDrop(Blocks.GRAY_BED, (block) -> {
         return this.dropsWithProperty(block, BedBlock.PART, BedPart.HEAD);
      });
      this.addDrop(Blocks.GREEN_BED, (block) -> {
         return this.dropsWithProperty(block, BedBlock.PART, BedPart.HEAD);
      });
      this.addDrop(Blocks.LIGHT_BLUE_BED, (block) -> {
         return this.dropsWithProperty(block, BedBlock.PART, BedPart.HEAD);
      });
      this.addDrop(Blocks.LIGHT_GRAY_BED, (block) -> {
         return this.dropsWithProperty(block, BedBlock.PART, BedPart.HEAD);
      });
      this.addDrop(Blocks.LIME_BED, (block) -> {
         return this.dropsWithProperty(block, BedBlock.PART, BedPart.HEAD);
      });
      this.addDrop(Blocks.MAGENTA_BED, (block) -> {
         return this.dropsWithProperty(block, BedBlock.PART, BedPart.HEAD);
      });
      this.addDrop(Blocks.PURPLE_BED, (block) -> {
         return this.dropsWithProperty(block, BedBlock.PART, BedPart.HEAD);
      });
      this.addDrop(Blocks.ORANGE_BED, (block) -> {
         return this.dropsWithProperty(block, BedBlock.PART, BedPart.HEAD);
      });
      this.addDrop(Blocks.PINK_BED, (block) -> {
         return this.dropsWithProperty(block, BedBlock.PART, BedPart.HEAD);
      });
      this.addDrop(Blocks.RED_BED, (block) -> {
         return this.dropsWithProperty(block, BedBlock.PART, BedPart.HEAD);
      });
      this.addDrop(Blocks.WHITE_BED, (block) -> {
         return this.dropsWithProperty(block, BedBlock.PART, BedPart.HEAD);
      });
      this.addDrop(Blocks.YELLOW_BED, (block) -> {
         return this.dropsWithProperty(block, BedBlock.PART, BedPart.HEAD);
      });
      this.addDrop(Blocks.LILAC, (block) -> {
         return this.dropsWithProperty(block, TallPlantBlock.HALF, DoubleBlockHalf.LOWER);
      });
      this.addDrop(Blocks.SUNFLOWER, (block) -> {
         return this.dropsWithProperty(block, TallPlantBlock.HALF, DoubleBlockHalf.LOWER);
      });
      this.addDrop(Blocks.PEONY, (block) -> {
         return this.dropsWithProperty(block, TallPlantBlock.HALF, DoubleBlockHalf.LOWER);
      });
      this.addDrop(Blocks.ROSE_BUSH, (block) -> {
         return this.dropsWithProperty(block, TallPlantBlock.HALF, DoubleBlockHalf.LOWER);
      });
      this.addDrop(Blocks.TNT, LootTable.builder().pool((LootPool.Builder)this.addSurvivesExplosionCondition(Blocks.TNT, LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0F)).with(ItemEntry.builder(Blocks.TNT).conditionally(BlockStatePropertyLootCondition.builder(Blocks.TNT).properties(StatePredicate.Builder.create().exactMatch(TntBlock.UNSTABLE, false)))))));
      this.addDrop(Blocks.COCOA, (block) -> {
         return LootTable.builder().pool(LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0F)).with((LootPoolEntry.Builder)this.applyExplosionDecay(block, ItemEntry.builder(Items.COCOA_BEANS).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(3.0F)).conditionally(BlockStatePropertyLootCondition.builder(block).properties(StatePredicate.Builder.create().exactMatch(CocoaBlock.AGE, 2)))))));
      });
      this.addDrop(Blocks.SEA_PICKLE, (block) -> {
         return LootTable.builder().pool(LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0F)).with((LootPoolEntry.Builder)this.applyExplosionDecay(Blocks.SEA_PICKLE, ItemEntry.builder(block).apply(List.of(2, 3, 4), (pickles) -> {
            return SetCountLootFunction.builder(ConstantLootNumberProvider.create((float)pickles)).conditionally(BlockStatePropertyLootCondition.builder(block).properties(StatePredicate.Builder.create().exactMatch(SeaPickleBlock.PICKLES, pickles)));
         }))));
      });
      this.addDrop(Blocks.COMPOSTER, (block) -> {
      ...
      this.addDrop(Blocks.CAVE_VINES, (block) -> {
         return this.glowBerryDrops(block);
      });
      this.addDrop(Blocks.CAVE_VINES_PLANT, (block) -> {
         return this.glowBerryDrops(block);
      });
      this.addDrop(Blocks.CANDLE, (block) -> {
         return this.candleDrops(block);
      });
      this.addDrop(Blocks.WHITE_CANDLE, (block) -> {
         return this.candleDrops(block);
      });
      this.addDrop(Blocks.ORANGE_CANDLE, (block) -> {
         return this.candleDrops(block);
      });
      this.addDrop(Blocks.MAGENTA_CANDLE, (block) -> {
         return this.candleDrops(block);
      });
      this.addDrop(Blocks.LIGHT_BLUE_CANDLE, (block) -> {
         return this.candleDrops(block);
      });
      this.addDrop(Blocks.YELLOW_CANDLE, (block) -> {
         return this.candleDrops(block);
      });
      this.addDrop(Blocks.LIME_CANDLE, (block) -> {
         return this.candleDrops(block);
      });
      this.addDrop(Blocks.PINK_CANDLE, (block) -> {
         return this.candleDrops(block);
      });
      this.addDrop(Blocks.GRAY_CANDLE, (block) -> {
         return this.candleDrops(block);
      });
      this.addDrop(Blocks.LIGHT_GRAY_CANDLE, (block) -> {
         return this.candleDrops(block);
      });
      this.addDrop(Blocks.CYAN_CANDLE, (block) -> {
         return this.candleDrops(block);
      });
      this.addDrop(Blocks.PURPLE_CANDLE, (block) -> {
         return this.candleDrops(block);
      });
      this.addDrop(Blocks.BLUE_CANDLE, (block) -> {
         return this.candleDrops(block);
      });
      this.addDrop(Blocks.BROWN_CANDLE, (block) -> {
         return this.candleDrops(block);
      });
      this.addDrop(Blocks.GREEN_CANDLE, (block) -> {
         return this.candleDrops(block);
      });
      this.addDrop(Blocks.RED_CANDLE, (block) -> {
         return this.candleDrops(block);
      });
      this.addDrop(Blocks.BLACK_CANDLE, (block) -> {
         return this.candleDrops(block);
      });
      this.addDrop(Blocks.BEACON, (block) -> {
         return this.nameableContainerDrops(block);
      });
      this.addDrop(Blocks.BREWING_STAND, (block) -> {
         return this.nameableContainerDrops(block);
      });
      this.addDrop(Blocks.CHEST, (block) -> {
         return this.nameableContainerDrops(block);
      });
      this.addDrop(Blocks.DISPENSER, (block) -> {
         return this.nameableContainerDrops(block);
      });
      this.addDrop(Blocks.DROPPER, (block) -> {
         return this.nameableContainerDrops(block);
      });
      this.addDrop(Blocks.ENCHANTING_TABLE, (block) -> {
         return this.nameableContainerDrops(block);
      });
      this.addDrop(Blocks.FURNACE, (block) -> {
         return this.nameableContainerDrops(block);
      });
      this.addDrop(Blocks.HOPPER, (block) -> {
         return this.nameableContainerDrops(block);
      });
      this.addDrop(Blocks.TRAPPED_CHEST, (block) -> {
         return this.nameableContainerDrops(block);
      });
      this.addDrop(Blocks.SMOKER, (block) -> {
         return this.nameableContainerDrops(block);
      });
      this.addDrop(Blocks.BLAST_FURNACE, (block) -> {
         return this.nameableContainerDrops(block);
      });
      this.addDrop(Blocks.BARREL, (block) -> {
         return this.nameableContainerDrops(block);
      });
      ...
      this.addDrop(Blocks.SHULKER_BOX, (block) -> {
         return this.shulkerBoxDrops(block);
      });
      this.addDrop(Blocks.BLACK_SHULKER_BOX, (block) -> {
         return this.shulkerBoxDrops(block);
      });
      this.addDrop(Blocks.BLUE_SHULKER_BOX, (block) -> {
         return this.shulkerBoxDrops(block);
      });
      this.addDrop(Blocks.BROWN_SHULKER_BOX, (block) -> {
         return this.shulkerBoxDrops(block);
      });
      this.addDrop(Blocks.CYAN_SHULKER_BOX, (block) -> {
         return this.shulkerBoxDrops(block);
      });
      this.addDrop(Blocks.GRAY_SHULKER_BOX, (block) -> {
         return this.shulkerBoxDrops(block);
      });
      this.addDrop(Blocks.GREEN_SHULKER_BOX, (block) -> {
         return this.shulkerBoxDrops(block);
      });
      this.addDrop(Blocks.LIGHT_BLUE_SHULKER_BOX, (block) -> {
         return this.shulkerBoxDrops(block);
      });
      this.addDrop(Blocks.LIGHT_GRAY_SHULKER_BOX, (block) -> {
         return this.shulkerBoxDrops(block);
      });
      this.addDrop(Blocks.LIME_SHULKER_BOX, (block) -> {
         return this.shulkerBoxDrops(block);
      });
      this.addDrop(Blocks.MAGENTA_SHULKER_BOX, (block) -> {
         return this.shulkerBoxDrops(block);
      });
      this.addDrop(Blocks.ORANGE_SHULKER_BOX, (block) -> {
         return this.shulkerBoxDrops(block);
      });
      this.addDrop(Blocks.PINK_SHULKER_BOX, (block) -> {
         return this.shulkerBoxDrops(block);
      });
      this.addDrop(Blocks.PURPLE_SHULKER_BOX, (block) -> {
         return this.shulkerBoxDrops(block);
      });
      this.addDrop(Blocks.RED_SHULKER_BOX, (block) -> {
         return this.shulkerBoxDrops(block);
      });
      this.addDrop(Blocks.WHITE_SHULKER_BOX, (block) -> {
         return this.shulkerBoxDrops(block);
      });
      this.addDrop(Blocks.YELLOW_SHULKER_BOX, (block) -> {
         return this.shulkerBoxDrops(block);
      });
      this.addDrop(Blocks.BLACK_BANNER, (block) -> {
         return this.bannerDrops(block);
      });
      this.addDrop(Blocks.BLUE_BANNER, (block) -> {
         return this.bannerDrops(block);
      });
      this.addDrop(Blocks.BROWN_BANNER, (block) -> {
         return this.bannerDrops(block);
      });
      this.addDrop(Blocks.CYAN_BANNER, (block) -> {
         return this.bannerDrops(block);
      });
      this.addDrop(Blocks.GRAY_BANNER, (block) -> {
         return this.bannerDrops(block);
      });
      this.addDrop(Blocks.GREEN_BANNER, (block) -> {
         return this.bannerDrops(block);
      });
      this.addDrop(Blocks.LIGHT_BLUE_BANNER, (block) -> {
         return this.bannerDrops(block);
      });
      this.addDrop(Blocks.LIGHT_GRAY_BANNER, (block) -> {
         return this.bannerDrops(block);
      });
      this.addDrop(Blocks.LIME_BANNER, (block) -> {
         return this.bannerDrops(block);
      });
      this.addDrop(Blocks.MAGENTA_BANNER, (block) -> {
         return this.bannerDrops(block);
      });
      this.addDrop(Blocks.ORANGE_BANNER, (block) -> {
         return this.bannerDrops(block);
      });
      this.addDrop(Blocks.PINK_BANNER, (block) -> {
         return this.bannerDrops(block);
      });
      this.addDrop(Blocks.PURPLE_BANNER, (block) -> {
         return this.bannerDrops(block);
      });
      this.addDrop(Blocks.RED_BANNER, (block) -> {
         return this.bannerDrops(block);
      });
      this.addDrop(Blocks.WHITE_BANNER, (block) -> {
         return this.bannerDrops(block);
      });
      this.addDrop(Blocks.YELLOW_BANNER, (block) -> {
         return this.bannerDrops(block);
      });
      this.addDrop(Blocks.PLAYER_HEAD, (block) -> {
         return LootTable.builder().pool((LootPool.Builder)this.addSurvivesExplosionCondition(block, LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0F)).with(ItemEntry.builder(block).apply(CopyComponentsLootFunction.builder(CopyComponentsLootFunction.Source.BLOCK_ENTITY).include(DataComponentTypes.PROFILE).include(DataComponentTypes.NOTE_BLOCK_SOUND).include(DataComponentTypes.CUSTOM_NAME)))));
      });
      this.addDrop(Blocks.BEE_NEST, (block) -> {
         return this.beeNestDrops(block);
      });
      this.addDrop(Blocks.BEEHIVE, (block) -> {
         return this.beehiveDrops(block);
      });
      this.addDrop(Blocks.OAK_LEAVES, (block) -> {
         return this.oakLeavesDrops(block, Blocks.OAK_SAPLING, SAPLING_DROP_CHANCE);
      });
      this.addDrop(Blocks.SPRUCE_LEAVES, (block) -> {
         return this.leavesDrops(block, Blocks.SPRUCE_SAPLING, SAPLING_DROP_CHANCE);
      });
      this.addDrop(Blocks.BIRCH_LEAVES, (block) -> {
         return this.leavesDrops(block, Blocks.BIRCH_SAPLING, SAPLING_DROP_CHANCE);
      });
      this.addDrop(Blocks.JUNGLE_LEAVES, (block) -> {
         return this.leavesDrops(block, Blocks.JUNGLE_SAPLING, JUNGLE_SAPLING_DROP_CHANCE);
      });
      this.addDrop(Blocks.ACACIA_LEAVES, (block) -> {
         return this.leavesDrops(block, Blocks.ACACIA_SAPLING, SAPLING_DROP_CHANCE);
      });
      this.addDrop(Blocks.DARK_OAK_LEAVES, (block) -> {
         return this.oakLeavesDrops(block, Blocks.DARK_OAK_SAPLING, SAPLING_DROP_CHANCE);
      });
      this.addDrop(Blocks.PALE_OAK_LEAVES, (block) -> {
         return this.leavesDrops(block, Blocks.PALE_OAK_SAPLING, SAPLING_DROP_CHANCE);
      });
      this.addDrop(Blocks.CHERRY_LEAVES, (block) -> {
         return this.leavesDrops(block, Blocks.CHERRY_SAPLING, SAPLING_DROP_CHANCE);
      });
      this.addDrop(Blocks.AZALEA_LEAVES, (block) -> {
         return this.leavesDrops(block, Blocks.AZALEA, SAPLING_DROP_CHANCE);
      });
      this.addDrop(Blocks.FLOWERING_AZALEA_LEAVES, (block) -> {
         return this.leavesDrops(block, Blocks.FLOWERING_AZALEA, SAPLING_DROP_CHANCE);
      });
      ...
      LootCondition.Builder builder4 = BlockStatePropertyLootCondition.builder(Blocks.MANGROVE_PROPAGULE).properties(StatePredicate.Builder.create().exactMatch(PropaguleBlock.AGE, 4));
      this.addDrop(Blocks.MANGROVE_PROPAGULE, (LootTable.Builder)this.applyExplosionDecay(Blocks.MANGROVE_PROPAGULE, LootTable.builder().pool(LootPool.builder().conditionally(builder4).with(ItemEntry.builder(Items.MANGROVE_PROPAGULE)))));
      this.addDrop(Blocks.TORCHFLOWER_CROP, (LootTable.Builder)this.applyExplosionDecay(Blocks.TORCHFLOWER_CROP, LootTable.builder().pool(LootPool.builder().with(ItemEntry.builder(Items.TORCHFLOWER_SEEDS)))));
      this.addDrop(Blocks.SNIFFER_EGG);
      this.addDrop(Blocks.DRIED_GHAST);
      this.addDrop(Blocks.PITCHER_CROP, (block) -> {
         return this.pitcherCropDrops();
      });
      this.addDrop(Blocks.PITCHER_PLANT);
      this.addDrop(Blocks.PITCHER_PLANT, (LootTable.Builder)this.applyExplosionDecay(Blocks.PITCHER_PLANT, LootTable.builder().pool(LootPool.builder().with(ItemEntry.builder(Items.PITCHER_PLANT).conditionally(BlockStatePropertyLootCondition.builder(Blocks.PITCHER_PLANT).properties(StatePredicate.Builder.create().exactMatch(TallPlantBlock.HALF, (Comparable)DoubleBlockHalf.LOWER)))))));
      this.addDrop(Blocks.CARROTS, (LootTable.Builder)this.applyExplosionDecay(Blocks.CARROTS, LootTable.builder().pool(LootPool.builder().with(ItemEntry.builder(Items.CARROT))).pool(LootPool.builder().conditionally(builder3).with(ItemEntry.builder(Items.CARROT).apply(ApplyBonusLootFunction.binomialWithBonusCount(impl.getOrThrow(Enchantments.FORTUNE), 0.5714286F, 3))))));
      LootCondition.Builder builder5 = BlockStatePropertyLootCondition.builder(Blocks.POTATOES).properties(StatePredicate.Builder.create().exactMatch(PotatoesBlock.AGE, 7));
      this.addDrop(Blocks.POTATOES, (LootTable.Builder)this.applyExplosionDecay(Blocks.POTATOES, LootTable.builder().pool(LootPool.builder().with(ItemEntry.builder(Items.POTATO))).pool(LootPool.builder().conditionally(builder5).with(ItemEntry.builder(Items.POTATO).apply(ApplyBonusLootFunction.binomialWithBonusCount(impl.getOrThrow(Enchantments.FORTUNE), 0.5714286F, 3)))).pool(LootPool.builder().conditionally(builder5).with(ItemEntry.builder(Items.POISONOUS_POTATO).conditionally(RandomChanceLootCondition.builder(0.02F))))));
      this.addDrop(Blocks.SWEET_BERRY_BUSH, (block) -> {
         return (LootTable.Builder)this.applyExplosionDecay(block, LootTable.builder().pool(LootPool.builder().conditionally(BlockStatePropertyLootCondition.builder(Blocks.SWEET_BERRY_BUSH).properties(StatePredicate.Builder.create().exactMatch(SweetBerryBushBlock.AGE, 3))).with(ItemEntry.builder(Items.SWEET_BERRIES)).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(2.0F, 3.0F))).apply(ApplyBonusLootFunction.uniformBonusCount(impl.getOrThrow(Enchantments.FORTUNE)))).pool(LootPool.builder().conditionally(BlockStatePropertyLootCondition.builder(Blocks.SWEET_BERRY_BUSH).properties(StatePredicate.Builder.create().exactMatch(SweetBerryBushBlock.AGE, 2))).with(ItemEntry.builder(Items.SWEET_BERRIES)).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 2.0F))).apply(ApplyBonusLootFunction.uniformBonusCount(impl.getOrThrow(Enchantments.FORTUNE)))));
      });
      this.addDrop(Blocks.BROWN_MUSHROOM_BLOCK, (block) -> {
         return this.mushroomBlockDrops(block, Blocks.BROWN_MUSHROOM);
      });
      this.addDrop(Blocks.RED_MUSHROOM_BLOCK, (block) -> {
         return this.mushroomBlockDrops(block, Blocks.RED_MUSHROOM);
      });
      this.addDrop(Blocks.COAL_ORE, (block) -> {
         return this.oreDrops(block, Items.COAL);
      });
      this.addDrop(Blocks.DEEPSLATE_COAL_ORE, (block) -> {
         return this.oreDrops(block, Items.COAL);
      });
      this.addDrop(Blocks.EMERALD_ORE, (block) -> {
         return this.oreDrops(block, Items.EMERALD);
      });
      this.addDrop(Blocks.DEEPSLATE_EMERALD_ORE, (block) -> {
         return this.oreDrops(block, Items.EMERALD);
      });
      this.addDrop(Blocks.NETHER_QUARTZ_ORE, (block) -> {
         return this.oreDrops(block, Items.QUARTZ);
      });
      this.addDrop(Blocks.DIAMOND_ORE, (block) -> {
         return this.oreDrops(block, Items.DIAMOND);
      });
      this.addDrop(Blocks.DEEPSLATE_DIAMOND_ORE, (block) -> {
         return this.oreDrops(block, Items.DIAMOND);
      });
      this.addDrop(Blocks.COPPER_ORE, (block) -> {
         return this.copperOreDrops(block);
      });
      this.addDrop(Blocks.DEEPSLATE_COPPER_ORE, (block) -> {
         return this.copperOreDrops(block);
      });
      this.addDrop(Blocks.IRON_ORE, (block) -> {
         return this.oreDrops(block, Items.RAW_IRON);
      });
      this.addDrop(Blocks.DEEPSLATE_IRON_ORE, (block) -> {
         return this.oreDrops(block, Items.RAW_IRON);
      });
      this.addDrop(Blocks.GOLD_ORE, (block) -> {
         return this.oreDrops(block, Items.RAW_GOLD);
      });
      this.addDrop(Blocks.DEEPSLATE_GOLD_ORE, (block) -> {
         return this.oreDrops(block, Items.RAW_GOLD);
      });
      this.addDrop(Blocks.NETHER_GOLD_ORE, (block) -> {
         return this.dropsWithSilkTouch(block, (LootPoolEntry.Builder)this.applyExplosionDecay(block, ItemEntry.builder(Items.GOLD_NUGGET).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(2.0F, 6.0F))).apply(ApplyBonusLootFunction.oreDrops(impl.getOrThrow(Enchantments.FORTUNE)))));
      });
      this.addDrop(Blocks.LAPIS_ORE, (block) -> {
         return this.lapisOreDrops(block);
      });
      this.addDrop(Blocks.DEEPSLATE_LAPIS_ORE, (block) -> {
         return this.lapisOreDrops(block);
      });
      this.addDrop(Blocks.COBWEB, (block) -> {
         return this.dropsWithSilkTouchOrShears(block, (LootPoolEntry.Builder)this.addSurvivesExplosionCondition(block, ItemEntry.builder(Items.STRING)));
      });
      this.addDrop(Blocks.DEAD_BUSH, (block) -> {
         return this.dropsWithShears(block, (LootPoolEntry.Builder)this.applyExplosionDecay(block, ItemEntry.builder(Items.STICK).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0F, 2.0F)))));
      });
      this.addDrop(Blocks.SHORT_DRY_GRASS, (block) -> {
         return this.dropsWithSilkTouchOrShears(block);
      });
      this.addDrop(Blocks.TALL_DRY_GRASS, (block) -> {
         return this.dropsWithSilkTouchOrShears(block);
      });
      this.addDrop(Blocks.BUSH, (block) -> {
         return this.dropsWithSilkTouchOrShears(block);
      });
      this.addDrop(Blocks.NETHER_SPROUTS, (block) -> {
         return this.dropsWithShears(block);
      });
      this.addDrop(Blocks.SEAGRASS, (block) -> {
         return this.dropsWithShears(block);
      });
      this.addDrop(Blocks.VINE, (block) -> {
         return this.dropsWithShears(block);
      });
      this.addDrop(Blocks.GLOW_LICHEN, (block) -> {
         return this.multifaceGrowthDrops(block, this.createWithShearsCondition());
      });
      this.addDrop(Blocks.RESIN_CLUMP, (block) -> {
         return this.multifaceGrowthDrops(block);
      });
      this.addDrop(Blocks.HANGING_ROOTS, (block) -> {
         return this.dropsWithShears(block);
      });
      this.addDrop(Blocks.SMALL_DRIPLEAF, (block) -> {
         return this.dropsWithShears(block);
      });
      this.addDrop(Blocks.MANGROVE_LEAVES, (block) -> {
         return this.mangroveLeavesDrops(block);
      });
      this.addDrop(Blocks.TALL_SEAGRASS, this.seagrassDrops(Blocks.SEAGRASS));
      this.addDrop(Blocks.LARGE_FERN, (block) -> {
         return this.tallPlantDrops(block, Blocks.FERN);
      });
      this.addDrop(Blocks.TALL_GRASS, (block) -> {
         return this.tallPlantDrops(block, Blocks.SHORT_GRASS);
      });
      this.addDrop(Blocks.MELON_STEM, (block) -> {
         return this.cropStemDrops(block, Items.MELON_SEEDS);
      });
      this.addDrop(Blocks.ATTACHED_MELON_STEM, (block) -> {
         return this.attachedCropStemDrops(block, Items.MELON_SEEDS);
      });
      this.addDrop(Blocks.PUMPKIN_STEM, (block) -> {
         return this.cropStemDrops(block, Items.PUMPKIN_SEEDS);
      });
      this.addDrop(Blocks.ATTACHED_PUMPKIN_STEM, (block) -> {
         return this.attachedCropStemDrops(block, Items.PUMPKIN_SEEDS);
      });
      this.addDrop(Blocks.CHORUS_FLOWER, (block) -> {
         return LootTable.builder().pool(LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0F)).with(((LeafEntry.Builder)this.addSurvivesExplosionCondition(block, ItemEntry.builder(block))).conditionally(EntityPropertiesLootCondition.create(LootContext.EntityTarget.THIS))));
      });
      this.addDrop(Blocks.FERN, (block) -> {
         return this.shortPlantDrops(block);
      });
      this.addDrop(Blocks.SHORT_GRASS, (block) -> {
         return this.shortPlantDrops(block);
      });
      this.addDrop(Blocks.GLOWSTONE, (block) -> {
      ...
      this.addDrop(Blocks.MELON, (block) -> {
         return this.dropsWithSilkTouch(block, (LootPoolEntry.Builder)this.applyExplosionDecay(block, ItemEntry.builder(Items.MELON_SLICE).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(3.0F, 7.0F))).apply(ApplyBonusLootFunction.uniformBonusCount(impl.getOrThrow(Enchantments.FORTUNE))).apply(LimitCountLootFunction.builder(BoundedIntUnaryOperator.createMax(9)))));
      });
      this.addDrop(Blocks.REDSTONE_ORE, (block) -> {
         return this.redstoneOreDrops(block);
      });
      this.addDrop(Blocks.DEEPSLATE_REDSTONE_ORE, (block) -> {
         return this.redstoneOreDrops(block);
      });
      this.addDrop(Blocks.SEA_LANTERN, (block) -> {
         return this.dropsWithSilkTouch(block, (LootPoolEntry.Builder)this.applyExplosionDecay(block, ItemEntry.builder(Items.PRISMARINE_CRYSTALS).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(2.0F, 3.0F))).apply(ApplyBonusLootFunction.uniformBonusCount(impl.getOrThrow(Enchantments.FORTUNE))).apply(LimitCountLootFunction.builder(BoundedIntUnaryOperator.create(1, 5)))));
      });
      this.addDrop(Blocks.CREAKING_HEART, (block) -> {
         return this.dropsWithSilkTouch(block, (LootPoolEntry.Builder)this.applyExplosionDecay(block, ItemEntry.builder(Items.RESIN_CLUMP).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 3.0F))).apply(ApplyBonusLootFunction.uniformBonusCount(impl.getOrThrow(Enchantments.FORTUNE))).apply(LimitCountLootFunction.builder(BoundedIntUnaryOperator.createMax(9)))));
      });
      this.addDrop(Blocks.NETHER_WART, (block) -> {
         return LootTable.builder().pool((LootPool.Builder)this.applyExplosionDecay(block, LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0F)).with(ItemEntry.builder(Items.NETHER_WART).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(2.0F, 4.0F)).conditionally(BlockStatePropertyLootCondition.builder(block).properties(StatePredicate.Builder.create().exactMatch(NetherWartBlock.AGE, 3)))).apply(ApplyBonusLootFunction.uniformBonusCount(impl.getOrThrow(Enchantments.FORTUNE)).conditionally(BlockStatePropertyLootCondition.builder(block).properties(StatePredicate.Builder.create().exactMatch(NetherWartBlock.AGE, 3)))))));
      });
      this.addDrop(Blocks.SNOW, (block) -> {
         return LootTable.builder().pool(LootPool.builder().conditionally(EntityPropertiesLootCondition.create(LootContext.EntityTarget.THIS)).with(AlternativeEntry.builder(AlternativeEntry.builder(SnowBlock.LAYERS.getValues(), (layers) -> {
            return ((LeafEntry.Builder)ItemEntry.builder(Items.SNOWBALL).conditionally(BlockStatePropertyLootCondition.builder(block).properties(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, layers)))).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create((float)layers)));
         }).conditionally(this.createWithoutSilkTouchCondition()), AlternativeEntry.builder(SnowBlock.LAYERS.getValues(), (layers) -> {
            return (LootPoolEntry.Builder)(layers == 8 ? ItemEntry.builder(Blocks.SNOW_BLOCK) : ItemEntry.builder(Blocks.SNOW).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create((float)layers))).conditionally(BlockStatePropertyLootCondition.builder(block).properties(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, layers))));
         }))));
      });
      this.addDrop(Blocks.GRAVEL, (block) -> {
         return this.dropsWithSilkTouch(block, (LootPoolEntry.Builder)this.addSurvivesExplosionCondition(block, ((LeafEntry.Builder)ItemEntry.builder(Items.FLINT).conditionally(TableBonusLootCondition.builder(impl.getOrThrow(Enchantments.FORTUNE), 0.1F, 0.14285715F, 0.25F, 1.0F))).alternatively(ItemEntry.builder(block))));
      });
      this.addDrop(Blocks.CAMPFIRE, (block) -> {
         return this.dropsWithSilkTouch(block, (LootPoolEntry.Builder)this.addSurvivesExplosionCondition(block, ItemEntry.builder(Items.CHARCOAL).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(2.0F)))));
      });
      this.addDrop(Blocks.GILDED_BLACKSTONE, (block) -> {
         return this.dropsWithSilkTouch(block, (LootPoolEntry.Builder)this.addSurvivesExplosionCondition(block, ((LeafEntry.Builder)ItemEntry.builder(Items.GOLD_NUGGET).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(2.0F, 5.0F))).conditionally(TableBonusLootCondition.builder(impl.getOrThrow(Enchantments.FORTUNE), 0.1F, 0.14285715F, 0.25F, 1.0F))).alternatively(ItemEntry.builder(block))));
      });
      this.addDrop(Blocks.SOUL_CAMPFIRE, (block) -> {
         return this.dropsWithSilkTouch(block, (LootPoolEntry.Builder)this.addSurvivesExplosionCondition(block, ItemEntry.builder(Items.SOUL_SOIL).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0F)))));
      });
      this.addDrop(Blocks.AMETHYST_CLUSTER, (block) -> {
         return this.dropsWithSilkTouch(block, ((LeafEntry.Builder)ItemEntry.builder(Items.AMETHYST_SHARD).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(4.0F))).apply(ApplyBonusLootFunction.oreDrops(impl.getOrThrow(Enchantments.FORTUNE))).conditionally(MatchToolLootCondition.builder(ItemPredicate.Builder.create().tag(impl2, ItemTags.CLUSTER_MAX_HARVESTABLES)))).alternatively((LootPoolEntry.Builder)this.applyExplosionDecay(block, ItemEntry.builder(Items.AMETHYST_SHARD).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(2.0F))))));
      });
   ...
   private LootTable.Builder pitcherCropDrops() {
      return (LootTable.Builder)this.applyExplosionDecay(Blocks.PITCHER_CROP, LootTable.builder().pool(LootPool.builder().with(AlternativeEntry.builder(PitcherCropBlock.AGE.getValues(), (age) -> {
         BlockStatePropertyLootCondition.Builder builder = BlockStatePropertyLootCondition.builder(Blocks.PITCHER_CROP).properties(StatePredicate.Builder.create().exactMatch(TallPlantBlock.HALF, (Comparable)DoubleBlockHalf.LOWER));
         BlockStatePropertyLootCondition.Builder builder2 = BlockStatePropertyLootCondition.builder(Blocks.PITCHER_CROP).properties(StatePredicate.Builder.create().exactMatch(PitcherCropBlock.AGE, age));
         return age == 4 ? ((LeafEntry.Builder)((LeafEntry.Builder)ItemEntry.builder(Items.PITCHER_PLANT).conditionally(builder2)).conditionally(builder)).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0F))) : ((LeafEntry.Builder)((LeafEntry.Builder)ItemEntry.builder(Items.PITCHER_POD).conditionally(builder2)).conditionally(builder)).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0F)));
      }))));
   }
