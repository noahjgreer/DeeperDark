...
extends TagProvider<T> {
    protected SimpleTagProvider(DataOutput dataOutput, RegistryKey<? extends Registry<T>> registryKey, CompletableFuture<RegistryWrapper.WrapperLookup> completableFuture) {
