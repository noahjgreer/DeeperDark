...
public class BlockFamilies {
    ...
    public static final BlockFamily WAXED_CUT_COPPER = BlockFamilies.register(Blocks.WAXED_CUT_COPPER).slab(Blocks.WAXED_CUT_COPPER_SLAB).stairs(Blocks.WAXED_CUT_COPPER_STAIRS).group("waxed_cut_copper").noGenerateModels().build();
    ...
    public static final BlockFamily WAXED_EXPOSED_CUT_COPPER = BlockFamilies.register(Blocks.WAXED_EXPOSED_CUT_COPPER).slab(Blocks.WAXED_EXPOSED_CUT_COPPER_SLAB).stairs(Blocks.WAXED_EXPOSED_CUT_COPPER_STAIRS).group("waxed_exposed_cut_copper").noGenerateModels().build();
    ...
    public static final BlockFamily WAXED_WEATHERED_CUT_COPPER = BlockFamilies.register(Blocks.WAXED_WEATHERED_CUT_COPPER).slab(Blocks.WAXED_WEATHERED_CUT_COPPER_SLAB).stairs(Blocks.WAXED_WEATHERED_CUT_COPPER_STAIRS).group("waxed_weathered_cut_copper").noGenerateModels().build();
    ...
    public static final BlockFamily WAXED_OXIDIZED_CUT_COPPER = BlockFamilies.register(Blocks.WAXED_OXIDIZED_CUT_COPPER).slab(Blocks.WAXED_OXIDIZED_CUT_COPPER_SLAB).stairs(Blocks.WAXED_OXIDIZED_CUT_COPPER_STAIRS).group("waxed_oxidized_cut_copper").noGenerateModels().build();
    ...
    public static final BlockFamily RESIN_BRICK = BlockFamilies.register(Blocks.RESIN_BRICKS).wall(Blocks.RESIN_BRICK_WALL).stairs(Blocks.RESIN_BRICK_STAIRS).slab(Blocks.RESIN_BRICK_SLAB).chiseled(Blocks.CHISELED_RESIN_BRICKS).build();
