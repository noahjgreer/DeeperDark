...
public class BlockFamilies {
   private static final Map BASE_BLOCKS_TO_FAMILIES = Maps.newHashMap();
   ...
   public static final BlockFamily CHERRY;
   ...
   public static final BlockFamily RESIN_BRICK;
   ...
   static {
      ...
      PALE_OAK = register(Blocks.PALE_OAK_PLANKS).button(Blocks.PALE_OAK_BUTTON).fence(Blocks.PALE_OAK_FENCE).fenceGate(Blocks.PALE_OAK_FENCE_GATE).pressurePlate(Blocks.PALE_OAK_PRESSURE_PLATE).sign(Blocks.PALE_OAK_SIGN, Blocks.PALE_OAK_WALL_SIGN).slab(Blocks.PALE_OAK_SLAB).stairs(Blocks.PALE_OAK_STAIRS).door(Blocks.PALE_OAK_DOOR).trapdoor(Blocks.PALE_OAK_TRAPDOOR).group("wooden").unlockCriterionName("has_planks").build();
      ...
      MANGROVE = register(Blocks.MANGROVE_PLANKS).button(Blocks.MANGROVE_BUTTON).slab(Blocks.MANGROVE_SLAB).stairs(Blocks.MANGROVE_STAIRS).fence(Blocks.MANGROVE_FENCE).fenceGate(Blocks.MANGROVE_FENCE_GATE).pressurePlate(Blocks.MANGROVE_PRESSURE_PLATE).sign(Blocks.MANGROVE_SIGN, Blocks.MANGROVE_WALL_SIGN).door(Blocks.MANGROVE_DOOR).trapdoor(Blocks.MANGROVE_TRAPDOOR).group("wooden").unlockCriterionName("has_planks").build();
      BAMBOO = register(Blocks.BAMBOO_PLANKS).button(Blocks.BAMBOO_BUTTON).slab(Blocks.BAMBOO_SLAB).stairs(Blocks.BAMBOO_STAIRS).customFence(Blocks.BAMBOO_FENCE).customFenceGate(Blocks.BAMBOO_FENCE_GATE).pressurePlate(Blocks.BAMBOO_PRESSURE_PLATE).sign(Blocks.BAMBOO_SIGN, Blocks.BAMBOO_WALL_SIGN).door(Blocks.BAMBOO_DOOR).trapdoor(Blocks.BAMBOO_TRAPDOOR).mosaic(Blocks.BAMBOO_MOSAIC).group("wooden").unlockCriterionName("has_planks").build();
      BAMBOO_MOSAIC = register(Blocks.BAMBOO_MOSAIC).slab(Blocks.BAMBOO_MOSAIC_SLAB).stairs(Blocks.BAMBOO_MOSAIC_STAIRS).build();
      MUD_BRICK = register(Blocks.MUD_BRICKS).wall(Blocks.MUD_BRICK_WALL).stairs(Blocks.MUD_BRICK_STAIRS).slab(Blocks.MUD_BRICK_SLAB).build();
      ...
      CUT_COPPER = register(Blocks.CUT_COPPER).slab(Blocks.CUT_COPPER_SLAB).stairs(Blocks.CUT_COPPER_STAIRS).chiseled(Blocks.CHISELED_COPPER).noGenerateModels().build();
      ...
      WAXED_CUT_COPPER = register(Blocks.WAXED_CUT_COPPER).slab(Blocks.WAXED_CUT_COPPER_SLAB).stairs(Blocks.WAXED_CUT_COPPER_STAIRS).chiseled(Blocks.WAXED_CHISELED_COPPER).group("waxed_cut_copper").noGenerateModels().build();
      EXPOSED_COPPER = register(Blocks.EXPOSED_COPPER).cut(Blocks.EXPOSED_CUT_COPPER).noGenerateModels().build();
      EXPOSED_CUT_COPPER = register(Blocks.EXPOSED_CUT_COPPER).slab(Blocks.EXPOSED_CUT_COPPER_SLAB).stairs(Blocks.EXPOSED_CUT_COPPER_STAIRS).chiseled(Blocks.EXPOSED_CHISELED_COPPER).noGenerateModels().build();
      ...
      WAXED_EXPOSED_CUT_COPPER = register(Blocks.WAXED_EXPOSED_CUT_COPPER).slab(Blocks.WAXED_EXPOSED_CUT_COPPER_SLAB).stairs(Blocks.WAXED_EXPOSED_CUT_COPPER_STAIRS).chiseled(Blocks.WAXED_EXPOSED_CHISELED_COPPER).group("waxed_exposed_cut_copper").noGenerateModels().build();
      WEATHERED_COPPER = register(Blocks.WEATHERED_COPPER).cut(Blocks.WEATHERED_CUT_COPPER).noGenerateModels().build();
      WEATHERED_CUT_COPPER = register(Blocks.WEATHERED_CUT_COPPER).slab(Blocks.WEATHERED_CUT_COPPER_SLAB).stairs(Blocks.WEATHERED_CUT_COPPER_STAIRS).chiseled(Blocks.WEATHERED_CHISELED_COPPER).noGenerateModels().build();
      ...
      WAXED_WEATHERED_CUT_COPPER = register(Blocks.WAXED_WEATHERED_CUT_COPPER).slab(Blocks.WAXED_WEATHERED_CUT_COPPER_SLAB).stairs(Blocks.WAXED_WEATHERED_CUT_COPPER_STAIRS).chiseled(Blocks.WAXED_WEATHERED_CHISELED_COPPER).group("waxed_weathered_cut_copper").noGenerateModels().build();
      OXIDIZED_COPPER = register(Blocks.OXIDIZED_COPPER).cut(Blocks.OXIDIZED_CUT_COPPER).noGenerateModels().build();
      OXIDIZED_CUT_COPPER = register(Blocks.OXIDIZED_CUT_COPPER).slab(Blocks.OXIDIZED_CUT_COPPER_SLAB).stairs(Blocks.OXIDIZED_CUT_COPPER_STAIRS).chiseled(Blocks.OXIDIZED_CHISELED_COPPER).noGenerateModels().build();
      ...
      WAXED_OXIDIZED_CUT_COPPER = register(Blocks.WAXED_OXIDIZED_CUT_COPPER).slab(Blocks.WAXED_OXIDIZED_CUT_COPPER_SLAB).stairs(Blocks.WAXED_OXIDIZED_CUT_COPPER_STAIRS).chiseled(Blocks.WAXED_OXIDIZED_CHISELED_COPPER).group("waxed_oxidized_cut_copper").noGenerateModels().build();
      ...
      TUFF = register(Blocks.TUFF).wall(Blocks.TUFF_WALL).stairs(Blocks.TUFF_STAIRS).slab(Blocks.TUFF_SLAB).chiseled(Blocks.CHISELED_TUFF).polished(Blocks.POLISHED_TUFF).build();
      POLISHED_TUFF = register(Blocks.POLISHED_TUFF).wall(Blocks.POLISHED_TUFF_WALL).stairs(Blocks.POLISHED_TUFF_STAIRS).slab(Blocks.POLISHED_TUFF_SLAB).polished(Blocks.TUFF_BRICKS).build();
      TUFF_BRICK = register(Blocks.TUFF_BRICKS).wall(Blocks.TUFF_BRICK_WALL).stairs(Blocks.TUFF_BRICK_STAIRS).slab(Blocks.TUFF_BRICK_SLAB).chiseled(Blocks.CHISELED_TUFF_BRICKS).build();
      RESIN_BRICK = register(Blocks.RESIN_BRICKS).wall(Blocks.RESIN_BRICK_WALL).stairs(Blocks.RESIN_BRICK_STAIRS).slab(Blocks.RESIN_BRICK_SLAB).chiseled(Blocks.CHISELED_RESIN_BRICKS).build();
