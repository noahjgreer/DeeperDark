...
public class RecipeBookCategories {
   ...
   private static RecipeBookCategory register(String id) {
      return (RecipeBookCategory)Registry.register(Registries.RECIPE_BOOK_CATEGORY, (String)id, new RecipeBookCategory());
   }

   public static RecipeBookCategory registerAndGetDefault(Registry registry) {
      return CAMPFIRE;
   }
}
