...
public class Potions {
    public static final RegistryEntry<Potion> WATER = Potions.register("water", new Potion("water", new StatusEffectInstance[0]));
    public static final RegistryEntry<Potion> MUNDANE = Potions.register("mundane", new Potion("mundane", new StatusEffectInstance[0]));
    public static final RegistryEntry<Potion> THICK = Potions.register("thick", new Potion("thick", new StatusEffectInstance[0]));
    public static final RegistryEntry<Potion> AWKWARD = Potions.register("awkward", new Potion("awkward", new StatusEffectInstance[0]));
    public static final RegistryEntry<Potion> NIGHT_VISION = Potions.register("night_vision", new Potion("night_vision", new StatusEffectInstance(StatusEffects.NIGHT_VISION, 3600)));
    ...
    public static final RegistryEntry<Potion> INVISIBILITY = Potions.register("invisibility", new Potion("invisibility", new StatusEffectInstance(StatusEffects.INVISIBILITY, 3600)));
    ...
    public static final RegistryEntry<Potion> LEAPING = Potions.register("leaping", new Potion("leaping", new StatusEffectInstance(StatusEffects.JUMP_BOOST, 3600)));
    ...
    public static final RegistryEntry<Potion> FIRE_RESISTANCE = Potions.register("fire_resistance", new Potion("fire_resistance", new StatusEffectInstance(StatusEffects.FIRE_RESISTANCE, 3600)));
    ...
    public static final RegistryEntry<Potion> SWIFTNESS = Potions.register("swiftness", new Potion("swiftness", new StatusEffectInstance(StatusEffects.SPEED, 3600)));
    ...
    public static final RegistryEntry<Potion> SLOWNESS = Potions.register("slowness", new Potion("slowness", new StatusEffectInstance(StatusEffects.SLOWNESS, 1800)));
    ...
    public static final RegistryEntry<Potion> WATER_BREATHING = Potions.register("water_breathing", new Potion("water_breathing", new StatusEffectInstance(StatusEffects.WATER_BREATHING, 3600)));
    ...
    public static final RegistryEntry<Potion> HEALING = Potions.register("healing", new Potion("healing", new StatusEffectInstance(StatusEffects.INSTANT_HEALTH, 1)));
    ...
    public static final RegistryEntry<Potion> HARMING = Potions.register("harming", new Potion("harming", new StatusEffectInstance(StatusEffects.INSTANT_DAMAGE, 1)));
    ...
    public static final RegistryEntry<Potion> POISON = Potions.register("poison", new Potion("poison", new StatusEffectInstance(StatusEffects.POISON, 900)));
    ...
    public static final RegistryEntry<Potion> REGENERATION = Potions.register("regeneration", new Potion("regeneration", new StatusEffectInstance(StatusEffects.REGENERATION, 900)));
    ...
    public static final RegistryEntry<Potion> STRENGTH = Potions.register("strength", new Potion("strength", new StatusEffectInstance(StatusEffects.STRENGTH, 3600)));
    ...
    public static final RegistryEntry<Potion> WEAKNESS = Potions.register("weakness", new Potion("weakness", new StatusEffectInstance(StatusEffects.WEAKNESS, 1800)));
    ...
    public static final RegistryEntry<Potion> SLOW_FALLING = Potions.register("slow_falling", new Potion("slow_falling", new StatusEffectInstance(StatusEffects.SLOW_FALLING, 1800)));
