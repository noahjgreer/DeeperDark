...
public class ChunkUpdateState extends PersistentState {
   ...
   private static final Codec LONG_SET_CODEC;
   ...
   static {
      LONG_SET_CODEC = Codec.LONG_STREAM.xmap(LongOpenHashSet::toSet, LongCollection::longStream);
      CODEC = RecordCodecBuilder.create((instance) -> {
         return instance.group(LONG_SET_CODEC.fieldOf("All").forGetter((state) -> {
            return state.all;
         }), LONG_SET_CODEC.fieldOf("Remaining").forGetter((state) -> {
