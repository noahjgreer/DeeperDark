...
public class SimpleGameEventDispatcher implements GameEventDispatcher {
   ...
   public boolean dispatch(RegistryEntry event, Vec3d pos, GameEvent.Emitter emitter, GameEventDispatcher.DispatchCallback callback) {
      ...
      try {
         ...
         while(iterator.hasNext()) {
            ...
            if (this.toRemove.remove(gameEventListener)) {
               ...
               Optional optional = dispatchTo(this.world, pos, gameEventListener);
