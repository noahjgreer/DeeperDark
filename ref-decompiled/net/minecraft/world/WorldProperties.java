...
public interface WorldProperties {
   ...
   default void populateCrashReport(CrashReportSection reportSection, HeightLimitView world) {
      reportSection.add("Level spawn location", () -> {
         return CrashReportSection.createPositionString(world, this.getSpawnPos());
      });
      reportSection.add("Level time", () -> {
         return String.format(Locale.ROOT, "%d game time, %d day time", this.getTime(), this.getTimeOfDay());
      });
   }
}
