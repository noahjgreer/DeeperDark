...
public class AdvancedExplosionBehavior extends ExplosionBehavior {
   ...
   private final Optional knockbackModifier;
   private final Optional immuneBlocks;

   public AdvancedExplosionBehavior(boolean destroyBlocks, boolean damageEntities, Optional knockbackModifier, Optional immuneBlocks) {
   ...
   public Optional getBlastResistance(Explosion explosion, BlockView world, BlockPos pos, BlockState blockState, FluidState fluidState) {
      if (this.immuneBlocks.isPresent()) {
         return blockState.isIn((RegistryEntryList)this.immuneBlocks.get()) ? Optional.of(3600000.0F) : Optional.empty();
      } else {
   ...
   public float getKnockbackModifier(Entity entity) {
      ...
      boolean bl = var10000;
      return bl ? 0.0F : (Float)this.knockbackModifier.orElseGet(() -> {
