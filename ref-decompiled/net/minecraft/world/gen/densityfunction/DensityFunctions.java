...
public class DensityFunctions {
   ...
   public static RegistryEntry bootstrap(Registerable densityFunctionRegisterable) {
      RegistryEntryLookup registryEntryLookup = densityFunctionRegisterable.getRegistryLookup(RegistryKeys.NOISE_PARAMETERS);
      RegistryEntryLookup registryEntryLookup2 = densityFunctionRegisterable.getRegistryLookup(RegistryKeys.DENSITY_FUNCTION);
      ...
      DensityFunction densityFunction = registerAndGetHolder(densityFunctionRegisterable, SHIFT_X, DensityFunctionTypes.flatCache(DensityFunctionTypes.cache2d(DensityFunctionTypes.shiftA(registryEntryLookup.getOrThrow(NoiseParametersKeys.OFFSET)))));
      DensityFunction densityFunction2 = registerAndGetHolder(densityFunctionRegisterable, SHIFT_Z, DensityFunctionTypes.flatCache(DensityFunctionTypes.cache2d(DensityFunctionTypes.shiftB(registryEntryLookup.getOrThrow(NoiseParametersKeys.OFFSET)))));
      ...
      RegistryEntry registryEntry = densityFunctionRegisterable.register(CONTINENTS_OVERWORLD, DensityFunctionTypes.flatCache(DensityFunctionTypes.shiftedNoise(densityFunction, densityFunction2, 0.25, registryEntryLookup.getOrThrow(NoiseParametersKeys.CONTINENTALNESS))));
      RegistryEntry registryEntry2 = densityFunctionRegisterable.register(EROSION_OVERWORLD, DensityFunctionTypes.flatCache(DensityFunctionTypes.shiftedNoise(densityFunction, densityFunction2, 0.25, registryEntryLookup.getOrThrow(NoiseParametersKeys.EROSION))));
      DensityFunction densityFunction3 = registerAndGetHolder(densityFunctionRegisterable, RIDGES_OVERWORLD, DensityFunctionTypes.flatCache(DensityFunctionTypes.shiftedNoise(densityFunction, densityFunction2, 0.25, registryEntryLookup.getOrThrow(NoiseParametersKeys.RIDGE))));
      ...
      registerSlopedCheeseFunction(densityFunctionRegisterable, registryEntryLookup2, densityFunction4, registryEntry, registryEntry2, OFFSET_OVERWORLD, FACTOR_OVERWORLD, JAGGEDNESS_OVERWORLD, DEPTH_OVERWORLD, SLOPED_CHEESE_OVERWORLD, false);
      RegistryEntry registryEntry3 = densityFunctionRegisterable.register(CONTINENTS_OVERWORLD_LARGE_BIOME, DensityFunctionTypes.flatCache(DensityFunctionTypes.shiftedNoise(densityFunction, densityFunction2, 0.25, registryEntryLookup.getOrThrow(NoiseParametersKeys.CONTINENTALNESS_LARGE))));
      RegistryEntry registryEntry4 = densityFunctionRegisterable.register(EROSION_OVERWORLD_LARGE_BIOME, DensityFunctionTypes.flatCache(DensityFunctionTypes.shiftedNoise(densityFunction, densityFunction2, 0.25, registryEntryLookup.getOrThrow(NoiseParametersKeys.EROSION_LARGE))));
      registerSlopedCheeseFunction(densityFunctionRegisterable, registryEntryLookup2, densityFunction4, registryEntry3, registryEntry4, OFFSET_OVERWORLD_LARGE_BIOME, FACTOR_OVERWORLD_LARGE_BIOME, JAGGEDNESS_OVERWORLD_LARGE_BIOME, DEPTH_OVERWORLD_LARGE_BIOME, SLOPED_CHEESE_OVERWORLD_LARGE_BIOME, false);
      registerSlopedCheeseFunction(densityFunctionRegisterable, registryEntryLookup2, densityFunction4, registryEntry, registryEntry2, OFFSET_OVERWORLD_AMPLIFIED, FACTOR_OVERWORLD_AMPLIFIED, JAGGEDNESS_OVERWORLD_AMPLIFIED, DEPTH_OVERWORLD_AMPLIFIED, SLOPED_CHEESE_OVERWORLD_AMPLIFIED, true);
      densityFunctionRegisterable.register(SLOPED_CHEESE_END, DensityFunctionTypes.add(DensityFunctionTypes.endIslands(0L), entryHolder(registryEntryLookup2, BASE_3D_NOISE_END)));
   ...
   private static void registerSlopedCheeseFunction(Registerable densityFunctionRegisterable, RegistryEntryLookup densityFunctionLookup, DensityFunction jaggedNoise, RegistryEntry continents, RegistryEntry erosion, RegistryKey offsetKey, RegistryKey factorKey, RegistryKey jaggednessKey, RegistryKey depthKey, RegistryKey slopedCheeseKey, boolean amplified) {
      ...
      DensityFunction densityFunction = registerAndGetHolder(densityFunctionRegisterable, offsetKey, applyBlending(DensityFunctionTypes.add(DensityFunctionTypes.constant(-0.5037500262260437), DensityFunctionTypes.spline(VanillaTerrainParametersCreator.createOffsetSpline(densityFunctionWrapper, densityFunctionWrapper2, densityFunctionWrapper4, amplified))), DensityFunctionTypes.blendOffset()));
      DensityFunction densityFunction2 = registerAndGetHolder(densityFunctionRegisterable, factorKey, applyBlending(DensityFunctionTypes.spline(VanillaTerrainParametersCreator.createFactorSpline(densityFunctionWrapper, densityFunctionWrapper2, densityFunctionWrapper3, densityFunctionWrapper4, amplified)), TEN_FUNCTION));
      DensityFunction densityFunction3 = registerAndGetHolder(densityFunctionRegisterable, depthKey, DensityFunctionTypes.add(DensityFunctionTypes.yClampedGradient(-64, 320, 1.5, -1.5), densityFunction));
      DensityFunction densityFunction4 = registerAndGetHolder(densityFunctionRegisterable, jaggednessKey, applyBlending(DensityFunctionTypes.spline(VanillaTerrainParametersCreator.createJaggednessSpline(densityFunctionWrapper, densityFunctionWrapper2, densityFunctionWrapper3, densityFunctionWrapper4, amplified)), ZERO_FUNCTION));
   ...
   private static DensityFunction createCavesNoodleOverworldFunction(RegistryEntryLookup densityFunctionLookup, RegistryEntryLookup noiseParametersLookup) {
      ...
      int j = true;
      int k = true;
      DensityFunction densityFunction2 = verticalRangeChoice(densityFunction, DensityFunctionTypes.noise(noiseParametersLookup.getOrThrow(NoiseParametersKeys.NOODLE), 1.0, 1.0), -60, 320, -1);
      DensityFunction densityFunction3 = verticalRangeChoice(densityFunction, DensityFunctionTypes.noiseInRange(noiseParametersLookup.getOrThrow(NoiseParametersKeys.NOODLE_THICKNESS), 1.0, 1.0, -0.05, -0.1), -60, 320, 0);
      double d = 2.6666666666666665;
      DensityFunction densityFunction4 = verticalRangeChoice(densityFunction, DensityFunctionTypes.noise(noiseParametersLookup.getOrThrow(NoiseParametersKeys.NOODLE_RIDGE_A), 2.6666666666666665, 2.6666666666666665), -60, 320, 0);
      DensityFunction densityFunction5 = verticalRangeChoice(densityFunction, DensityFunctionTypes.noise(noiseParametersLookup.getOrThrow(NoiseParametersKeys.NOODLE_RIDGE_B), 2.6666666666666665, 2.6666666666666665), -60, 320, 0);
   ...
   private static DensityFunction createCavesSpaghetti2dOverworldFunction(RegistryEntryLookup densityFunctionLookup, RegistryEntryLookup noiseParametersLookup) {
      ...
      DensityFunction densityFunction3 = DensityFunctionTypes.noiseInRange(noiseParametersLookup.getOrThrow(NoiseParametersKeys.SPAGHETTI_2D_ELEVATION), 0.0, (double)Math.floorDiv(-64, 8), 8.0);
   ...
   private static DensityFunction createCavesFunction(RegistryEntryLookup densityFunctionLookup, RegistryEntryLookup noiseParametersLookup, DensityFunction slopedCheese) {
      ...
      DensityFunction densityFunction8 = DensityFunctionTypes.min(DensityFunctionTypes.min(densityFunction7, entryHolder(densityFunctionLookup, CAVES_ENTRANCES_OVERWORLD)), DensityFunctionTypes.add(densityFunction, densityFunction2));
   ...
   protected static NoiseRouter createSurfaceNoiseRouter(RegistryEntryLookup densityFunctionLookup, RegistryEntryLookup noiseParametersLookup, boolean largeBiomes, boolean amplified) {
      ...
      DensityFunction densityFunction9 = entryHolder(densityFunctionLookup, largeBiomes ? FACTOR_OVERWORLD_LARGE_BIOME : (amplified ? FACTOR_OVERWORLD_AMPLIFIED : FACTOR_OVERWORLD));
      DensityFunction densityFunction10 = entryHolder(densityFunctionLookup, largeBiomes ? DEPTH_OVERWORLD_LARGE_BIOME : (amplified ? DEPTH_OVERWORLD_AMPLIFIED : DEPTH_OVERWORLD));
      ...
      DensityFunction densityFunction12 = entryHolder(densityFunctionLookup, largeBiomes ? SLOPED_CHEESE_OVERWORLD_LARGE_BIOME : (amplified ? SLOPED_CHEESE_OVERWORLD_AMPLIFIED : SLOPED_CHEESE_OVERWORLD));
      DensityFunction densityFunction13 = DensityFunctionTypes.min(densityFunction12, DensityFunctionTypes.mul(DensityFunctionTypes.constant(5.0), entryHolder(densityFunctionLookup, CAVES_ENTRANCES_OVERWORLD)));
      DensityFunction densityFunction14 = DensityFunctionTypes.rangeChoice(densityFunction12, -1000000.0, 1.5625, densityFunction13, createCavesFunction(densityFunctionLookup, noiseParametersLookup, densityFunction12));
      DensityFunction densityFunction15 = DensityFunctionTypes.min(applyBlendDensity(applySurfaceSlides(amplified, densityFunction14)), entryHolder(densityFunctionLookup, CAVES_NOODLE_OVERWORLD));
      ...
      DensityFunction densityFunction17 = verticalRangeChoice(densityFunction16, DensityFunctionTypes.noise(noiseParametersLookup.getOrThrow(NoiseParametersKeys.ORE_VEININESS), 1.5, 1.5), i, j, 0);
      float f = 4.0F;
      DensityFunction densityFunction18 = verticalRangeChoice(densityFunction16, DensityFunctionTypes.noise(noiseParametersLookup.getOrThrow(NoiseParametersKeys.ORE_VEIN_A), 4.0, 4.0), i, j, 0).abs();
      DensityFunction densityFunction19 = verticalRangeChoice(densityFunction16, DensityFunctionTypes.noise(noiseParametersLookup.getOrThrow(NoiseParametersKeys.ORE_VEIN_B), 4.0, 4.0), i, j, 0).abs();
      DensityFunction densityFunction20 = DensityFunctionTypes.add(DensityFunctionTypes.constant(-0.07999999821186066), DensityFunctionTypes.max(densityFunction18, densityFunction19));
      ...
      return new NoiseRouter(densityFunction, densityFunction2, densityFunction3, densityFunction4, densityFunction7, densityFunction8, entryHolder(densityFunctionLookup, largeBiomes ? CONTINENTS_OVERWORLD_LARGE_BIOME : CONTINENTS_OVERWORLD), entryHolder(densityFunctionLookup, largeBiomes ? EROSION_OVERWORLD_LARGE_BIOME : EROSION_OVERWORLD), densityFunction10, entryHolder(densityFunctionLookup, RIDGES_OVERWORLD), applySurfaceSlides(amplified, DensityFunctionTypes.add(densityFunction11, DensityFunctionTypes.constant(-0.703125)).clamp(-64.0, 64.0)), densityFunction15, densityFunction17, densityFunction20, densityFunction21);
   }
