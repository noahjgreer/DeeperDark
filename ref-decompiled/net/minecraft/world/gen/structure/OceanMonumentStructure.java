...
public class OceanMonumentStructure extends Structure {
   public static final MapCodec CODEC = createCodec(OceanMonumentStructure::new);
   ...
   public Optional getStructurePosition(Structure.Context context) {
      ...
      do {
         ...
         registryEntry = (RegistryEntry)var5.next();
      } while(registryEntry.isIn(BiomeTags.REQUIRED_OCEAN_MONUMENT_SURROUNDING));
