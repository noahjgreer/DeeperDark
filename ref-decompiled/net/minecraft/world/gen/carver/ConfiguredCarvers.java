...
public class ConfiguredCarvers {
   public static final RegistryKey CAVE = register("cave");
   public static final RegistryKey CAVE_EXTRA_UNDERGROUND = register("cave_extra_underground");
   public static final RegistryKey CANYON = register("canyon");
   public static final RegistryKey NETHER_CAVE = register("nether_cave");
   ...
   public static void bootstrap(Registerable carverRegisterable) {
      RegistryEntryLookup registryEntryLookup = carverRegisterable.getRegistryLookup(RegistryKeys.BLOCK);
