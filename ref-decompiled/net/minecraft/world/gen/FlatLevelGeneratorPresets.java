...
public class FlatLevelGeneratorPresets {
   ...
   private static class Registrar {
      ...
      private void createAndRegister(RegistryKey registryKey, ItemConvertible icon, RegistryKey biome, Set structureSetKeys, boolean hasFeatures, boolean hasLakes, FlatChunkGeneratorLayer... layers) {
         RegistryEntryLookup registryEntryLookup = this.presetRegisterable.getRegistryLookup(RegistryKeys.STRUCTURE_SET);
         RegistryEntryLookup registryEntryLookup2 = this.presetRegisterable.getRegistryLookup(RegistryKeys.PLACED_FEATURE);
         RegistryEntryLookup registryEntryLookup3 = this.presetRegisterable.getRegistryLookup(RegistryKeys.BIOME);
         Stream var10000 = structureSetKeys.stream();
         Objects.requireNonNull(registryEntryLookup);
         RegistryEntryList.Direct direct = RegistryEntryList.of((List)var10000.map(registryEntryLookup::getOrThrow).collect(Collectors.toList()));
