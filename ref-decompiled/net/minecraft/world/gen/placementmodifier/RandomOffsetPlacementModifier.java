...
public class RandomOffsetPlacementModifier extends PlacementModifier {
   public static final MapCodec MODIFIER_CODEC = RecordCodecBuilder.mapCodec((instance) -> {
      return instance.group(IntProvider.createValidatingCodec(-16, 16).fieldOf("xz_spread").forGetter((placementModifier) -> {
         return placementModifier.spreadXz;
      }), IntProvider.createValidatingCodec(-16, 16).fieldOf("y_spread").forGetter((placementModifier) -> {
         return placementModifier.spreadY;
