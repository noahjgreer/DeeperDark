...
public class SurfaceThresholdFilterPlacementModifier extends AbstractConditionalPlacementModifier {
   public static final MapCodec MODIFIER_CODEC = RecordCodecBuilder.mapCodec((instance) -> {
      return instance.group(Heightmap.Type.CODEC.fieldOf("heightmap").forGetter((placementModifier) -> {
         return placementModifier.heightmap;
      }), Codec.INT.optionalFieldOf("min_inclusive", Integer.MIN_VALUE).forGetter((placementModifier) -> {
         return placementModifier.min;
      }), Codec.INT.optionalFieldOf("max_inclusive", Integer.MAX_VALUE).forGetter((placementModifier) -> {
         return placementModifier.max;
