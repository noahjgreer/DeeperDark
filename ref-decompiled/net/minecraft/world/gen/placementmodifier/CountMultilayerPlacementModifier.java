...
public class CountMultilayerPlacementModifier extends PlacementModifier {
   public static final MapCodec MODIFIER_CODEC = IntProvider.createValidatingCodec(0, 256).fieldOf("count").xmap(CountMultilayerPlacementModifier::new, (placementModifier) -> {
      return placementModifier.count;
   });
