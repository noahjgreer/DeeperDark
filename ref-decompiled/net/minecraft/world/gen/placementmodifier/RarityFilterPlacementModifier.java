...
public class RarityFilterPlacementModifier extends AbstractConditionalPlacementModifier {
   public static final MapCodec MODIFIER_CODEC;
   ...
   static {
      MODIFIER_CODEC = Codecs.POSITIVE_INT.fieldOf("chance").xmap(RarityFilterPlacementModifier::new, (placementModifier) -> {
         return placementModifier.chance;
      });
   }
}
