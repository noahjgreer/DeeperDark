...
public class OreFeature extends Feature {
   ...
   public static boolean shouldPlace(BlockState state, Function posToState, Random random, OreFeatureConfig config, OreFeatureConfig.Target target, BlockPos.Mutable pos) {
