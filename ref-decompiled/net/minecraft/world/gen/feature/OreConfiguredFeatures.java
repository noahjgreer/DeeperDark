...
public class OreConfiguredFeatures {
   public static final RegistryKey ORE_MAGMA = ConfiguredFeatures.of("ore_magma");
   public static final RegistryKey ORE_SOUL_SAND = ConfiguredFeatures.of("ore_soul_sand");
   public static final RegistryKey ORE_NETHER_GOLD = ConfiguredFeatures.of("ore_nether_gold");
   public static final RegistryKey ORE_QUARTZ = ConfiguredFeatures.of("ore_quartz");
   public static final RegistryKey ORE_GRAVEL_NETHER = ConfiguredFeatures.of("ore_gravel_nether");
   public static final RegistryKey ORE_BLACKSTONE = ConfiguredFeatures.of("ore_blackstone");
   public static final RegistryKey ORE_DIRT = ConfiguredFeatures.of("ore_dirt");
   public static final RegistryKey ORE_GRAVEL = ConfiguredFeatures.of("ore_gravel");
   public static final RegistryKey ORE_GRANITE = ConfiguredFeatures.of("ore_granite");
   public static final RegistryKey ORE_DIORITE = ConfiguredFeatures.of("ore_diorite");
   public static final RegistryKey ORE_ANDESITE = ConfiguredFeatures.of("ore_andesite");
   public static final RegistryKey ORE_TUFF = ConfiguredFeatures.of("ore_tuff");
   public static final RegistryKey ORE_COAL = ConfiguredFeatures.of("ore_coal");
   public static final RegistryKey ORE_COAL_BURIED = ConfiguredFeatures.of("ore_coal_buried");
   public static final RegistryKey ORE_IRON = ConfiguredFeatures.of("ore_iron");
   public static final RegistryKey ORE_IRON_SMALL = ConfiguredFeatures.of("ore_iron_small");
   public static final RegistryKey ORE_GOLD = ConfiguredFeatures.of("ore_gold");
   public static final RegistryKey ORE_GOLD_BURIED = ConfiguredFeatures.of("ore_gold_buried");
   public static final RegistryKey ORE_REDSTONE = ConfiguredFeatures.of("ore_redstone");
   public static final RegistryKey ORE_DIAMOND_SMALL = ConfiguredFeatures.of("ore_diamond_small");
   public static final RegistryKey ORE_DIAMOND_MEDIUM = ConfiguredFeatures.of("ore_diamond_medium");
   public static final RegistryKey ORE_DIAMOND_LARGE = ConfiguredFeatures.of("ore_diamond_large");
   public static final RegistryKey ORE_DIAMOND_BURIED = ConfiguredFeatures.of("ore_diamond_buried");
   public static final RegistryKey ORE_LAPIS = ConfiguredFeatures.of("ore_lapis");
   public static final RegistryKey ORE_LAPIS_BURIED = ConfiguredFeatures.of("ore_lapis_buried");
   public static final RegistryKey ORE_INFESTED = ConfiguredFeatures.of("ore_infested");
   public static final RegistryKey ORE_EMERALD = ConfiguredFeatures.of("ore_emerald");
   public static final RegistryKey ORE_ANCIENT_DEBRIS_LARGE = ConfiguredFeatures.of("ore_ancient_debris_large");
   public static final RegistryKey ORE_ANCIENT_DEBRIS_SMALL = ConfiguredFeatures.of("ore_ancient_debris_small");
   public static final RegistryKey ORE_COPPER_SMALL = ConfiguredFeatures.of("ore_copper_small");
   public static final RegistryKey ORE_COPPER_LARGE = ConfiguredFeatures.of("ore_copper_large");
   public static final RegistryKey ORE_CLAY = ConfiguredFeatures.of("ore_clay");
   ...
   public static void bootstrap(Registerable featureRegisterable) {
      ...
      List list = List.of(OreFeatureConfig.createTarget(ruleTest2, Blocks.IRON_ORE.getDefaultState()), OreFeatureConfig.createTarget(ruleTest3, Blocks.DEEPSLATE_IRON_ORE.getDefaultState()));
      List list2 = List.of(OreFeatureConfig.createTarget(ruleTest2, Blocks.GOLD_ORE.getDefaultState()), OreFeatureConfig.createTarget(ruleTest3, Blocks.DEEPSLATE_GOLD_ORE.getDefaultState()));
      List list3 = List.of(OreFeatureConfig.createTarget(ruleTest2, Blocks.DIAMOND_ORE.getDefaultState()), OreFeatureConfig.createTarget(ruleTest3, Blocks.DEEPSLATE_DIAMOND_ORE.getDefaultState()));
      List list4 = List.of(OreFeatureConfig.createTarget(ruleTest2, Blocks.LAPIS_ORE.getDefaultState()), OreFeatureConfig.createTarget(ruleTest3, Blocks.DEEPSLATE_LAPIS_ORE.getDefaultState()));
      List list5 = List.of(OreFeatureConfig.createTarget(ruleTest2, Blocks.COPPER_ORE.getDefaultState()), OreFeatureConfig.createTarget(ruleTest3, Blocks.DEEPSLATE_COPPER_ORE.getDefaultState()));
      List list6 = List.of(OreFeatureConfig.createTarget(ruleTest2, Blocks.COAL_ORE.getDefaultState()), OreFeatureConfig.createTarget(ruleTest3, Blocks.DEEPSLATE_COAL_ORE.getDefaultState()));
      ...
      ConfiguredFeatures.register(featureRegisterable, ORE_INFESTED, Feature.ORE, new OreFeatureConfig(List.of(OreFeatureConfig.createTarget(ruleTest2, Blocks.INFESTED_STONE.getDefaultState()), OreFeatureConfig.createTarget(ruleTest3, Blocks.INFESTED_DEEPSLATE.getDefaultState())), 9));
