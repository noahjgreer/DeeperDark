...
public class FossilFeature extends Feature {
   ...
   public boolean generate(FeatureContext context) {
      ...
      FossilFeatureConfig fossilFeatureConfig = (FossilFeatureConfig)context.getConfig();
      ...
      BlockBox blockBox = new BlockBox(chunkPos.getStartX() - 16, structureWorldAccess.getBottomY(), chunkPos.getStartZ() - 16, chunkPos.getEndX() + 16, structureWorldAccess.getTopYInclusive(), chunkPos.getEndZ() + 16);
      ...
      if (getEmptyCorners(structureWorldAccess, structureTemplate.calculateBoundingBox(structurePlacementData, blockPos3)) > fossilFeatureConfig.maxEmptyCorners) {
         ...
         List var10000 = ((StructureProcessorList)fossilFeatureConfig.fossilProcessors.value()).getList();
