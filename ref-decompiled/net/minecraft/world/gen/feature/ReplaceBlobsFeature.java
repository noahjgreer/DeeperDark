...
public class ReplaceBlobsFeature extends Feature {
   ...
   public boolean generate(FeatureContext context) {
      ...
      BlockPos blockPos = moveDownToTarget(structureWorldAccess, context.getOrigin().mutableCopy().clamp(Direction.Axis.Y, structureWorldAccess.getBottomY() + 1, structureWorldAccess.getTopYInclusive()), block);
      if (blockPos == null) {
         return false;
      } else {
