...
public class PileConfiguredFeatures {
   public static final RegistryKey PILE_HAY = ConfiguredFeatures.of("pile_hay");
   public static final RegistryKey PILE_MELON = ConfiguredFeatures.of("pile_melon");
   public static final RegistryKey PILE_SNOW = ConfiguredFeatures.of("pile_snow");
   public static final RegistryKey PILE_ICE = ConfiguredFeatures.of("pile_ice");
   public static final RegistryKey PILE_PUMPKIN = ConfiguredFeatures.of("pile_pumpkin");
