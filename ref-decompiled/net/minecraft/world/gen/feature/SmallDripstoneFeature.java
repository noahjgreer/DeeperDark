...
public class SmallDripstoneFeature extends Feature {
   ...
   public boolean generate(FeatureContext context) {
      ...
      Optional optional = getDirection(worldAccess, blockPos, random);
      if (optional.isEmpty()) {
         return false;
      } else {
         ...
         int i = random.nextFloat() < smallDripstoneFeatureConfig.chanceOfTallerDripstone && DripstoneHelper.canGenerate(worldAccess.getBlockState(blockPos.offset((Direction)optional.get()))) ? 2 : 1;
