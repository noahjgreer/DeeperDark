...
public class BiasedToBottomHeightProvider extends HeightProvider {
   public static final MapCodec BIASED_TO_BOTTOM_CODEC = RecordCodecBuilder.mapCodec((instance) -> {
   ...
   public String toString() {
      String var10000 = String.valueOf(this.minOffset);
      return "biased[" + var10000 + "-" + String.valueOf(this.maxOffset) + " inner: " + this.inner + "]";
   }
}
