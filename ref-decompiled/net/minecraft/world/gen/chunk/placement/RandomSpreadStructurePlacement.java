...
public class RandomSpreadStructurePlacement extends StructurePlacement {
   ...
   private static DataResult validate(RandomSpreadStructurePlacement structurePlacement) {
      return structurePlacement.spacing <= structurePlacement.separation ? DataResult.error(() -> {
