...
public abstract class AbstractNoiseBlockStateProvider extends BlockStateProvider {
   ...
   protected static Products.P3 fillCodecFields(RecordCodecBuilder.Instance instance) {
      return instance.group(Codec.LONG.fieldOf("seed").forGetter((abstractNoiseBlockStateProvider) -> {
         return abstractNoiseBlockStateProvider.seed;
      }), DoublePerlinNoiseSampler.NoiseParameters.CODEC.fieldOf("noise").forGetter((abstractNoiseBlockStateProvider) -> {
         return abstractNoiseBlockStateProvider.noiseParameters;
      }), Codecs.POSITIVE_FLOAT.fieldOf("scale").forGetter((abstractNoiseBlockStateProvider) -> {
         return abstractNoiseBlockStateProvider.scale;
      }));
   }
