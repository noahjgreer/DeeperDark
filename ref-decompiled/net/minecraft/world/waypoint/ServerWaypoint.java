...
public interface ServerWaypoint extends Waypoint {
   ...
   Optional createTracker(ServerPlayerEntity receiver);
   ...
   public static class AzimuthWaypointTracker implements WaypointTracker {
      ...
      public AzimuthWaypointTracker(LivingEntity source, Waypoint.Config config, ServerPlayerEntity receiver) {
         ...
         Vec3d vec3d = receiver.getPos().subtract(source.getPos()).rotateYClockwise();
      ...
      public void update() {
         Vec3d vec3d = this.receiver.getPos().subtract(this.source.getPos()).rotateYClockwise();
   ...
   public static class ChunkWaypointTracker implements ChebyshevDistanceValidatedTracker {
      private final LivingEntity source;
      private final Waypoint.Config config;
      private final ServerPlayerEntity receiver;
      ...
      public boolean isInvalid() {
         return !ServerWaypoint.ChebyshevDistanceValidatedTracker.super.isInvalid() && !ServerWaypoint.cannotReceive(this.source, this.receiver) ? ServerWaypoint.canReceive(this.chunkPos, this.receiver) : true;
      }
   }

   public interface ChebyshevDistanceValidatedTracker extends WaypointTracker {
   ...
   public static class PositionalWaypointTracker implements ManhattanDistanceValidatedTracker {
      private final LivingEntity source;
      private final Waypoint.Config config;
      private final ServerPlayerEntity receiver;
   ...
   public interface ManhattanDistanceValidatedTracker extends WaypointTracker {
      int getDistanceToOriginalPos();
