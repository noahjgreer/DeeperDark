...
public interface NeighborUpdater {
   ...
   default void updateNeighbors(BlockPos pos, Block sourceBlock, @Nullable Direction except, @Nullable WireOrientation orientation) {
      ...
      for(int var7 = 0; var7 < var6; ++var7) {
         ...
         if (direction != except) {
            this.updateNeighbor(pos.offset(direction), sourceBlock, (WireOrientation)null);
         }
      }

   }

   static void replaceWithStateForNeighborUpdate(WorldAccess world, Direction direction, BlockPos pos, BlockPos neighborPos, BlockState neighborState, int flags, int maxUpdateDepth) {
