...
public abstract class BuiltinBiomes {
   public static void bootstrap(Registerable biomeRegisterable) {
      RegistryEntryLookup registryEntryLookup = biomeRegisterable.getRegistryLookup(RegistryKeys.PLACED_FEATURE);
      RegistryEntryLookup registryEntryLookup2 = biomeRegisterable.getRegistryLookup(RegistryKeys.CONFIGURED_CARVER);
      ...
      biomeRegisterable.register(BiomeKeys.PALE_GARDEN, OverworldBiomeCreator.createDenseForest(registryEntryLookup, registryEntryLookup2, true));
      biomeRegisterable.register(BiomeKeys.OLD_GROWTH_BIRCH_FOREST, OverworldBiomeCreator.createNormalForest(registryEntryLookup, registryEntryLookup2, true, true, false));
