...
public class VanillaTerrainParametersCreator {
   ...
   public static Spline createOffsetSpline(ToFloatFunction continents, ToFloatFunction erosion, ToFloatFunction ridgesFolded, boolean amplified) {
      ToFloatFunction toFloatFunction = amplified ? OFFSET_AMPLIFIER : IDENTITY;
      Spline spline = createContinentalOffsetSpline(erosion, ridgesFolded, -0.15F, 0.0F, 0.0F, 0.1F, 0.0F, -0.03F, false, false, toFloatFunction);
      Spline spline2 = createContinentalOffsetSpline(erosion, ridgesFolded, -0.1F, 0.03F, 0.1F, 0.1F, 0.01F, -0.03F, false, false, toFloatFunction);
      Spline spline3 = createContinentalOffsetSpline(erosion, ridgesFolded, -0.1F, 0.03F, 0.1F, 0.7F, 0.01F, -0.03F, true, true, toFloatFunction);
      Spline spline4 = createContinentalOffsetSpline(erosion, ridgesFolded, -0.05F, 0.03F, 0.1F, 1.0F, 0.01F, 0.01F, true, true, toFloatFunction);
   ...
   public static Spline createFactorSpline(ToFloatFunction continents, ToFloatFunction erosion, ToFloatFunction ridges, ToFloatFunction ridgesFolded, boolean amplified) {
      ToFloatFunction toFloatFunction = amplified ? FACTOR_AMPLIFIER : IDENTITY;
      return Spline.builder(continents, IDENTITY).add(-0.19F, 3.95F).add(-0.15F, method_42054(erosion, ridges, ridgesFolded, 6.25F, true, IDENTITY)).add(-0.1F, method_42054(erosion, ridges, ridgesFolded, 5.47F, true, toFloatFunction)).add(0.03F, method_42054(erosion, ridges, ridgesFolded, 5.08F, true, toFloatFunction)).add(0.06F, method_42054(erosion, ridges, ridgesFolded, 4.69F, false, toFloatFunction)).build();
   }
   ...
   public static Spline createJaggednessSpline(ToFloatFunction continents, ToFloatFunction erosion, ToFloatFunction ridges, ToFloatFunction ridgesFolded, boolean amplified) {
      ToFloatFunction toFloatFunction = amplified ? JAGGEDNESS_AMPLIFIER : IDENTITY;
      float f = 0.65F;
      return Spline.builder(continents, toFloatFunction).add(-0.11F, 0.0F).add(0.03F, method_42053(erosion, ridges, ridgesFolded, 1.0F, 0.5F, 0.0F, 0.0F, toFloatFunction)).add(0.65F, method_42053(erosion, ridges, ridgesFolded, 1.0F, 1.0F, 1.0F, 0.0F, toFloatFunction)).build();
   }
   ...
   private static Spline method_42053(ToFloatFunction erosion, ToFloatFunction ridges, ToFloatFunction ridgesFolded, float f, float g, float h, float i, ToFloatFunction amplifier) {
      float j = -0.5775F;
      Spline spline = method_42052(ridges, ridgesFolded, f, h, amplifier);
      Spline spline2 = method_42052(ridges, ridgesFolded, g, i, amplifier);
   ...
   private static Spline method_42054(ToFloatFunction erosion, ToFloatFunction ridges, ToFloatFunction ridgesFolded, float f, boolean bl, ToFloatFunction amplifier) {
      ...
      Spline spline3;
      if (bl) {
         spline2 = Spline.builder(ridges, amplifier).add(0.0F, f).add(0.1F, 0.625F).build();
         spline3 = Spline.builder(ridgesFolded, amplifier).add(-0.9F, f).add(-0.69F, spline2).build();
         builder.add(0.35F, f).add(0.45F, spline3).add(0.55F, spline3).add(0.62F, f);
      } else {
         spline2 = Spline.builder(ridgesFolded, amplifier).add(-0.7F, spline).add(-0.15F, 1.37F).build();
         spline3 = Spline.builder(ridgesFolded, amplifier).add(0.45F, spline).add(0.7F, 1.56F).build();
   ...
   public static Spline createContinentalOffsetSpline(ToFloatFunction erosion, ToFloatFunction ridgesFolded, float continentalness, float f, float g, float h, float i, float j, boolean bl, boolean bl2, ToFloatFunction amplifier) {
      float k = 0.6F;
      float l = 0.5F;
      float m = 0.5F;
      Spline spline = method_42050(ridgesFolded, MathHelper.lerp(h, 0.6F, 1.5F), bl2, amplifier);
      Spline spline2 = method_42050(ridgesFolded, MathHelper.lerp(h, 0.6F, 1.0F), bl2, amplifier);
      Spline spline3 = method_42050(ridgesFolded, h, bl2, amplifier);
      Spline spline4 = method_42048(ridgesFolded, continentalness - 0.15F, 0.5F * h, MathHelper.lerp(0.5F, 0.5F, 0.5F) * h, 0.5F * h, 0.6F * h, 0.5F, amplifier);
      Spline spline5 = method_42048(ridgesFolded, continentalness, i * h, f * h, 0.5F * h, 0.6F * h, 0.5F, amplifier);
      Spline spline6 = method_42048(ridgesFolded, continentalness, i, i, f, g, 0.5F, amplifier);
      Spline spline7 = method_42048(ridgesFolded, continentalness, i, i, f, g, 0.5F, amplifier);
      Spline spline8 = Spline.builder(ridgesFolded, amplifier).add(-1.0F, continentalness).add(-0.4F, spline6).add(0.0F, g + 0.07F).build();
      Spline spline9 = method_42048(ridgesFolded, -0.02F, j, j, f, g, 0.0F, amplifier);
      Spline.Builder builder = Spline.builder(erosion, amplifier).add(-0.85F, spline).add(-0.7F, spline2).add(-0.4F, spline3).add(-0.35F, spline4).add(-0.1F, spline5).add(0.2F, spline6);
      if (bl) {
   ...
   private static Spline method_42048(ToFloatFunction ridgesFolded, float continentalness, float f, float g, float h, float i, float j, ToFloatFunction amplifier) {
