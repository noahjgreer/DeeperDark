...
public class LightingProvider implements LightingView {
   ...
   public boolean isLightingEnabled(long sectionPos) {
      return this.blockLightProvider == null || this.blockLightProvider.lightStorage.isColumnEnabled(sectionPos) && (this.skyLightProvider == null || this.skyLightProvider.lightStorage.isColumnEnabled(sectionPos));
   }
