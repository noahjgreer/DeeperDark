...
public class EntitySelectorReader implements FabricEntitySelectorReader {
   ...
   public static final DynamicCommandExceptionType UNKNOWN_SELECTOR_EXCEPTION = new DynamicCommandExceptionType((selectorType) -> {
      return Text.stringifiedTranslatable("argument.entity.selector.unknown", selectorType);
   });
   ...
   public static final DynamicCommandExceptionType VALUELESS_EXCEPTION = new DynamicCommandExceptionType((option) -> {
      return Text.stringifiedTranslatable("argument.entity.options.valueless", option);
   });
   ...
   public EntitySelectorReader(StringReader reader, boolean atAllowed) {
      this.distance = NumberRange.DoubleRange.ANY;
   ...
   public static boolean shouldAllowAtSelectors(Object source) {
      boolean var10000;
      if (source instanceof PermissionLevelSource permissionLevelSource) {
         if (permissionLevelSource.hasElevatedPermissions()) {
            var10000 = true;
            return var10000;
         }
      }
