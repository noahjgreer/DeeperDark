...
implements ArgumentType<EnumSet<Direction.Axis>> {
    ...
    private static final SimpleCommandExceptionType INVALID_SWIZZLE_EXCEPTION = new SimpleCommandExceptionType((Message)Text.translatable("arguments.swizzle.invalid"));
    ...
    public EnumSet<Direction.Axis> parse(StringReader stringReader) throws CommandSyntaxException {
        ...
        while (stringReader.canRead() && stringReader.peek() != ' ') {
            ...
            Direction.Axis axis = switch (c) {
                ...
                default -> throw INVALID_SWIZZLE_EXCEPTION.createWithContext((ImmutableStringReader)stringReader);
            };
            if (enumSet.contains(axis)) {
                throw INVALID_SWIZZLE_EXCEPTION.createWithContext((ImmutableStringReader)stringReader);
            }
            enumSet.add(axis);
        }
        return enumSet;
