...
implements ArgumentType<T> {
    ...
    public T parse(StringReader stringReader) throws CommandSyntaxException {
        ...
        return (T)((Enum)this.codec.parse((DynamicOps)JsonOps.INSTANCE, (Object)new JsonPrimitive(string)).result().orElseThrow(() -> INVALID_ENUM_EXCEPTION.createWithContext((ImmutableStringReader)stringReader, (Object)string)));
    }
