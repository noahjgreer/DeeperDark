...
public class ArgumentTypes {
    ...
    public static ArgumentSerializer<?, ?> register(Registry<ArgumentSerializer<?, ?>> registry) {
        ...
        ArgumentTypes.register(registry, "hex_color", HexColorArgumentType.class, ConstantArgumentSerializer.of(HexColorArgumentType::hexColor));
        ...
        ArgumentTypes.register(registry, "resource_selector", ArgumentTypes.upcast(RegistrySelectorArgumentType.class), new RegistrySelectorArgumentType.Serializer());
        ...
        ArgumentTypes.register(registry, "dialog", RegistryEntryArgumentType.DialogArgumentType.class, ConstantArgumentSerializer.of(RegistryEntryArgumentType::dialog));
