...
public class ArgumentTypes {
   private static final Map CLASS_MAP = Maps.newHashMap();

   private static ArgumentSerializer register(Registry registry, String id, Class clazz, ArgumentSerializer serializer) {
      CLASS_MAP.put(clazz, serializer);
      return (ArgumentSerializer)Registry.register(registry, (String)id, serializer);
   }

   public static ArgumentSerializer register(Registry registry) {
      ...
      register(registry, "hex_color", HexColorArgumentType.class, ConstantArgumentSerializer.of(HexColorArgumentType::hexColor));
      ...
      register(registry, "dialog", RegistryEntryArgumentType.DialogArgumentType.class, ConstantArgumentSerializer.of(RegistryEntryArgumentType::dialog));
      return register(registry, "uuid", UuidArgumentType.class, ConstantArgumentSerializer.of(UuidArgumentType::uuid));
   }

   private static Class upcast(Class clazz) {
      return clazz;
   }
   ...
   public static ArgumentSerializer get(ArgumentType argumentType) {
   ...
   public static ArgumentSerializer.ArgumentTypeProperties getArgumentTypeProperties(ArgumentType argumentType) {
