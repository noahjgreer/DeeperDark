...
public record DamagePredicate(NumberRange.DoubleRange dealt, NumberRange.DoubleRange taken, Optional<EntityPredicate> sourceEntity, Optional<Boolean> blocked, Optional<DamageSourcePredicate> type) {
    public static final Codec<DamagePredicate> CODEC = RecordCodecBuilder.create(instance -> instance.group((App)NumberRange.DoubleRange.CODEC.optionalFieldOf("dealt", (Object)NumberRange.DoubleRange.ANY).forGetter(DamagePredicate::dealt), (App)NumberRange.DoubleRange.CODEC.optionalFieldOf("taken", (Object)NumberRange.DoubleRange.ANY).forGetter(DamagePredicate::taken), (App)EntityPredicate.CODEC.optionalFieldOf("source_entity").forGetter(DamagePredicate::sourceEntity), (App)Codec.BOOL.optionalFieldOf("blocked").forGetter(DamagePredicate::blocked), (App)DamageSourcePredicate.CODEC.optionalFieldOf("type").forGetter(DamagePredicate::type)).apply((Applicative)instance, DamagePredicate::new));
    ...
    public final String toString() {
        return ObjectMethods.bootstrap("toString", new MethodHandle[]{DamagePredicate.class, "dealtDamage;takenDamage;sourceEntity;blocked;type", "dealt", "taken", "sourceEntity", "blocked", "type"}, this);
    }

    @Override
    public final int hashCode() {
        return (int)ObjectMethods.bootstrap("hashCode", new MethodHandle[]{DamagePredicate.class, "dealtDamage;takenDamage;sourceEntity;blocked;type", "dealt", "taken", "sourceEntity", "blocked", "type"}, this);
    }

    @Override
    public final boolean equals(Object object) {
        return (boolean)ObjectMethods.bootstrap("equals", new MethodHandle[]{DamagePredicate.class, "dealtDamage;takenDamage;sourceEntity;blocked;type", "dealt", "taken", "sourceEntity", "blocked", "type"}, this, object);
    }
