...
public class BlockSoundGroup {
   public static final BlockSoundGroup INTENTIONALLY_EMPTY;
   ...
   public static final BlockSoundGroup CACTUS_FLOWER;
   ...
   public static final BlockSoundGroup FLOWERBED;
   public static final BlockSoundGroup LEAF_LITTER;
   ...
   public static final BlockSoundGroup TRIAL_SPAWNER;
   public static final BlockSoundGroup SPONGE;
   public static final BlockSoundGroup WET_SPONGE;
   public static final BlockSoundGroup VAULT;
   public static final BlockSoundGroup CREAKING_HEART;
   public static final BlockSoundGroup HEAVY_CORE;
   public static final BlockSoundGroup COBWEB;
   public static final BlockSoundGroup SPAWNER;
   public static final BlockSoundGroup RESIN;
   public static final BlockSoundGroup RESIN_BRICKS;
   public static final BlockSoundGroup IRON;
   public static final BlockSoundGroup DRIED_GHAST;
   ...
   static {
      INTENTIONALLY_EMPTY = new BlockSoundGroup(1.0F, 1.0F, SoundEvents.INTENTIONALLY_EMPTY, SoundEvents.INTENTIONALLY_EMPTY, SoundEvents.INTENTIONALLY_EMPTY, SoundEvents.INTENTIONALLY_EMPTY, SoundEvents.INTENTIONALLY_EMPTY);
      ...
      TUFF_BRICKS = new BlockSoundGroup(1.0F, 1.0F, SoundEvents.BLOCK_TUFF_BRICKS_BREAK, SoundEvents.BLOCK_TUFF_BRICKS_STEP, SoundEvents.BLOCK_TUFF_BRICKS_PLACE, SoundEvents.BLOCK_TUFF_BRICKS_HIT, SoundEvents.BLOCK_TUFF_BRICKS_FALL);
      POLISHED_TUFF = new BlockSoundGroup(1.0F, 1.0F, SoundEvents.BLOCK_POLISHED_TUFF_BREAK, SoundEvents.BLOCK_POLISHED_TUFF_STEP, SoundEvents.BLOCK_POLISHED_TUFF_PLACE, SoundEvents.BLOCK_POLISHED_TUFF_HIT, SoundEvents.BLOCK_POLISHED_TUFF_FALL);
      ...
      COPPER_BULB = new BlockSoundGroup(1.0F, 1.0F, SoundEvents.BLOCK_COPPER_BULB_BREAK, SoundEvents.BLOCK_COPPER_BULB_STEP, SoundEvents.BLOCK_COPPER_BULB_PLACE, SoundEvents.BLOCK_COPPER_BULB_HIT, SoundEvents.BLOCK_COPPER_BULB_FALL);
      COPPER_GRATE = new BlockSoundGroup(1.0F, 1.0F, SoundEvents.BLOCK_COPPER_GRATE_BREAK, SoundEvents.BLOCK_COPPER_GRATE_STEP, SoundEvents.BLOCK_COPPER_GRATE_PLACE, SoundEvents.BLOCK_COPPER_GRATE_HIT, SoundEvents.BLOCK_COPPER_GRATE_FALL);
      ...
      CACTUS_FLOWER = new BlockSoundGroup(1.0F, 1.0F, SoundEvents.BLOCK_CACTUS_FLOWER_BREAK, SoundEvents.INTENTIONALLY_EMPTY, SoundEvents.BLOCK_CACTUS_FLOWER_PLACE, SoundEvents.INTENTIONALLY_EMPTY, SoundEvents.INTENTIONALLY_EMPTY);
      ...
      FLOWERBED = new BlockSoundGroup(1.0F, 1.0F, SoundEvents.BLOCK_PINK_PETALS_BREAK, SoundEvents.BLOCK_PINK_PETALS_STEP, SoundEvents.BLOCK_PINK_PETALS_PLACE, SoundEvents.BLOCK_PINK_PETALS_HIT, SoundEvents.BLOCK_PINK_PETALS_FALL);
      LEAF_LITTER = new BlockSoundGroup(1.0F, 1.0F, SoundEvents.BLOCK_LEAF_LITTER_BREAK, SoundEvents.BLOCK_LEAF_LITTER_STEP, SoundEvents.BLOCK_LEAF_LITTER_PLACE, SoundEvents.BLOCK_LEAF_LITTER_HIT, SoundEvents.BLOCK_LEAF_LITTER_FALL);
      ...
      TRIAL_SPAWNER = new BlockSoundGroup(1.0F, 1.0F, SoundEvents.BLOCK_TRIAL_SPAWNER_BREAK, SoundEvents.BLOCK_TRIAL_SPAWNER_STEP, SoundEvents.BLOCK_TRIAL_SPAWNER_PLACE, SoundEvents.BLOCK_TRIAL_SPAWNER_HIT, SoundEvents.BLOCK_TRIAL_SPAWNER_FALL);
      SPONGE = new BlockSoundGroup(1.0F, 1.0F, SoundEvents.BLOCK_SPONGE_BREAK, SoundEvents.BLOCK_SPONGE_STEP, SoundEvents.BLOCK_SPONGE_PLACE, SoundEvents.BLOCK_SPONGE_HIT, SoundEvents.BLOCK_SPONGE_FALL);
      WET_SPONGE = new BlockSoundGroup(1.0F, 1.0F, SoundEvents.BLOCK_WET_SPONGE_BREAK, SoundEvents.BLOCK_WET_SPONGE_STEP, SoundEvents.BLOCK_WET_SPONGE_PLACE, SoundEvents.BLOCK_WET_SPONGE_HIT, SoundEvents.BLOCK_WET_SPONGE_FALL);
      VAULT = new BlockSoundGroup(1.0F, 1.0F, SoundEvents.BLOCK_VAULT_BREAK, SoundEvents.BLOCK_VAULT_STEP, SoundEvents.BLOCK_VAULT_PLACE, SoundEvents.BLOCK_VAULT_HIT, SoundEvents.BLOCK_VAULT_FALL);
      CREAKING_HEART = new BlockSoundGroup(1.0F, 1.0F, SoundEvents.BLOCK_CREAKING_HEART_BREAK, SoundEvents.BLOCK_CREAKING_HEART_STEP, SoundEvents.BLOCK_CREAKING_HEART_PLACE, SoundEvents.BLOCK_CREAKING_HEART_HIT, SoundEvents.BLOCK_CREAKING_HEART_FALL);
      HEAVY_CORE = new BlockSoundGroup(1.0F, 1.0F, SoundEvents.BLOCK_HEAVY_CORE_BREAK, SoundEvents.BLOCK_HEAVY_CORE_STEP, SoundEvents.BLOCK_HEAVY_CORE_PLACE, SoundEvents.BLOCK_HEAVY_CORE_HIT, SoundEvents.BLOCK_HEAVY_CORE_FALL);
      COBWEB = new BlockSoundGroup(1.0F, 1.0F, SoundEvents.BLOCK_COBWEB_BREAK, SoundEvents.BLOCK_COBWEB_STEP, SoundEvents.BLOCK_COBWEB_PLACE, SoundEvents.BLOCK_COBWEB_HIT, SoundEvents.BLOCK_COBWEB_FALL);
      SPAWNER = new BlockSoundGroup(1.0F, 1.0F, SoundEvents.BLOCK_SPAWNER_BREAK, SoundEvents.BLOCK_SPAWNER_STEP, SoundEvents.BLOCK_SPAWNER_PLACE, SoundEvents.BLOCK_SPAWNER_HIT, SoundEvents.BLOCK_SPAWNER_FALL);
      RESIN = new BlockSoundGroup(1.0F, 1.0F, SoundEvents.BLOCK_RESIN_BREAK, SoundEvents.BLOCK_RESIN_STEP, SoundEvents.BLOCK_RESIN_PLACE, SoundEvents.INTENTIONALLY_EMPTY, SoundEvents.BLOCK_RESIN_FALL);
      RESIN_BRICKS = new BlockSoundGroup(1.0F, 1.0F, SoundEvents.BLOCK_RESIN_BRICKS_BREAK, SoundEvents.BLOCK_RESIN_BRICKS_STEP, SoundEvents.BLOCK_RESIN_BRICKS_PLACE, SoundEvents.BLOCK_RESIN_BRICKS_HIT, SoundEvents.BLOCK_RESIN_BRICKS_FALL);
      IRON = new BlockSoundGroup(1.0F, 1.0F, SoundEvents.BLOCK_IRON_BREAK, SoundEvents.BLOCK_IRON_STEP, SoundEvents.BLOCK_IRON_PLACE, SoundEvents.BLOCK_IRON_HIT, SoundEvents.BLOCK_IRON_FALL);
      DRIED_GHAST = new BlockSoundGroup(1.0F, 1.0F, SoundEvents.BLOCK_DRIED_GHAST_BREAK, SoundEvents.BLOCK_DRIED_GHAST_STEP, SoundEvents.INTENTIONALLY_EMPTY, SoundEvents.INTENTIONALLY_EMPTY, SoundEvents.BLOCK_DRIED_GHAST_FALL);
   }
}
