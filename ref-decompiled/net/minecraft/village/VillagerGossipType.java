...
public enum VillagerGossipType implements StringIdentifiable {
   ...
   public static final Codec CODEC = StringIdentifiable.createCodec(VillagerGossipType::values);

   private VillagerGossipType(final String id, final int multiplier, final int maxReputation, final int decay, final int shareDecrement) {
      this.id = id;
