...
public class Stats {
    ...
    public static final Identifier HAPPY_GHAST_ONE_CM = Stats.register("happy_ghast_one_cm", StatFormatter.DISTANCE);
    ...
    public static final Identifier NAUTILUS_ONE_CM = Stats.register("nautilus_one_cm", StatFormatter.DISTANCE);
