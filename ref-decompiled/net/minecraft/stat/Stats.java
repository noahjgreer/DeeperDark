...
public class Stats {
   ...
   private static StatType registerType(String id, Registry registry) {
      ...
      return (StatType)Registry.register(Registries.STAT_TYPE, (String)id, new StatType(registry, text));
   }
   ...
   static {
      ...
      HAPPY_GHAST_ONE_CM = register("happy_ghast_one_cm", StatFormatter.DISTANCE);
