...
public class DamageSources {
    ...
    public final DamageSource create(RegistryKey<DamageType> key, @Nullable Entity attacker) {
        return new DamageSource((RegistryEntry<DamageType>)this.registry.getOrThrow(key), attacker);
    }
    ...
    public DamageSource fireball(AbstractFireballEntity source, @Nullable Entity attacker) {
        if (attacker == null) {
            return this.create(DamageTypes.UNATTRIBUTED_FIREBALL, source);
        }
        return this.create(DamageTypes.FIREBALL, source, attacker);
    }
    ...
    public DamageSource badRespawnPoint(Vec3d position) {
        return new DamageSource((RegistryEntry<DamageType>)this.registry.getOrThrow(DamageTypes.BAD_RESPAWN_POINT), position);
    }
