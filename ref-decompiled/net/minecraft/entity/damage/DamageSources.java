...
public class DamageSources {
   ...
   public final DamageSource create(RegistryKey key) {
      return new DamageSource(this.registry.getOrThrow(key));
   }

   public final DamageSource create(RegistryKey key, @Nullable Entity attacker) {
      return new DamageSource(this.registry.getOrThrow(key), attacker);
   }

   public final DamageSource create(RegistryKey key, @Nullable Entity source, @Nullable Entity attacker) {
   ...
   public DamageSource explosion(@Nullable Explosion explosion) {
      return explosion != null ? this.explosion(explosion.getEntity(), explosion.getCausingEntity()) : this.explosion((Entity)null, (Entity)null);
   }
