...
public interface DamageTypes {
    ...
    public static final RegistryKey<DamageType> SPEAR = RegistryKey.of(RegistryKeys.DAMAGE_TYPE, Identifier.ofVanilla("spear"));
    ...
    public static void bootstrap(Registerable<DamageType> damageTypeRegisterable) {
        ...
        damageTypeRegisterable.register(SPEAR, new DamageType("spear", 0.1f));
