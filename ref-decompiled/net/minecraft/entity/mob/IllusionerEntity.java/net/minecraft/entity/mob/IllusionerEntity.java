...
implements RangedAttackMob {
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(3, new FleeEntityGoal<CreakingEntity>(this, CreakingEntity.class, 8.0f, 1.0, 1.2));
    ...
    public static DefaultAttributeContainer.Builder createIllusionerAttributes() {
        return HostileEntity.createHostileAttributes().add(EntityAttributes.MOVEMENT_SPEED, 0.5).add(EntityAttributes.FOLLOW_RANGE, 18.0).add(EntityAttributes.MAX_HEALTH, 32.0);
    }
    ...
    extends SpellcastingIllagerEntity.CastSpellGoal {
        ...
        public boolean canStart() {
            ...
            return BlindTargetGoal.getServerWorld(IllusionerEntity.this).getLocalDifficulty(IllusionerEntity.this.getBlockPos()).isHarderThan(Difficulty.NORMAL.ordinal());
        }
