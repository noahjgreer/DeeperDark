...
public abstract class PatrolEntity extends HostileEntity {
   ...
   protected void readCustomData(ReadView view) {
      ...
      this.patrolTarget = (BlockPos)view.read("patrol_target", BlockPos.CODEC).orElse((Object)null);
   ...
   public static class PatrolGoal extends Goal {
      ...
      private List findPatrolTargets() {
         return this.entity.getWorld().getEntitiesByClass(PatrolEntity.class, this.entity.getBoundingBox().expand(16.0), (patrolEntity) -> {
