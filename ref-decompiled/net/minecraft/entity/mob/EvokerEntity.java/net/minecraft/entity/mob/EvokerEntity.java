...
extends SpellcastingIllagerEntity {
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(3, new FleeEntityGoal<CreakingEntity>(this, CreakingEntity.class, 8.0f, 0.6, 1.0));
    ...
    protected boolean isInSameTeam(Entity other) {
        ...
        if (other instanceof VexEntity && (vexEntity = (VexEntity)other).getOwner() != null) {
    ...
    extends SpellcastingIllagerEntity.CastSpellGoal {
        ...
        public boolean canStart() {
            ...
            int i = SummonVexGoal.castToServerWorld(EvokerEntity.this.getEntityWorld()).getTargets(VexEntity.class, this.closeVexPredicate, EvokerEntity.this, EvokerEntity.this.getBoundingBox().expand(16.0)).size();
    ...
    extends SpellcastingIllagerEntity.CastSpellGoal {
        ...
        public boolean canStart() {
            ...
            ServerWorld serverWorld = WololoGoal.castToServerWorld(EvokerEntity.this.getEntityWorld());
