...
public class HoglinBrain {
   ...
   private static void avoidEnemy(HoglinEntity hoglin, LivingEntity target) {
      Brain brain = hoglin.getBrain();
      LivingEntity livingEntity = TargetUtil.getCloserEntity(hoglin, (Optional)brain.getOptionalRegisteredMemory(MemoryModuleType.AVOID_TARGET), target);
      livingEntity = TargetUtil.getCloserEntity(hoglin, (Optional)brain.getOptionalRegisteredMemory(MemoryModuleType.ATTACK_TARGET), livingEntity);
   ...
   private static Optional getNearestVisibleTargetablePlayer(ServerWorld world, HoglinEntity hoglin) {
   ...
   private static void setAttackTargetIfCloser(HoglinEntity hoglin, LivingEntity targetCandidate) {
      if (!isNearPlayer(hoglin)) {
         ...
         LivingEntity livingEntity = TargetUtil.getCloserEntity(hoglin, (Optional)optional, targetCandidate);
