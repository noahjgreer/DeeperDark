...
public class VindicatorEntity extends IllagerEntity {
   ...
   public VindicatorEntity(EntityType entityType, World world) {
   ...
   public static DefaultAttributeContainer.Builder createVindicatorAttributes() {
      return HostileEntity.createHostileAttributes().add(EntityAttributes.MOVEMENT_SPEED, 0.3499999940395355).add(EntityAttributes.FOLLOW_RANGE, 12.0).add(EntityAttributes.MAX_HEALTH, 24.0).add(EntityAttributes.ATTACK_DAMAGE, 5.0);
   }
   ...
   public void addBonusForWave(ServerWorld world, int wave, boolean unused) {
      ...
      if (bl) {
         RegistryKey registryKey = wave > raid.getMaxWaves(Difficulty.NORMAL) ? EnchantmentProviders.VINDICATOR_POST_WAVE_5_RAID : EnchantmentProviders.VINDICATOR_RAID;
   ...
   static class TargetGoal extends ActiveTargetGoal {
      public TargetGoal(VindicatorEntity vindicator) {
         super(vindicator, LivingEntity.class, 0, true, true, (target, world) -> {
            return target.isMobOrPlayer();
         });
      }
