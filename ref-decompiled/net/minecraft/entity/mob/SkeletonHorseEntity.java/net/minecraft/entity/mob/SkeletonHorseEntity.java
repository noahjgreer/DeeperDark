...
extends AbstractHorseEntity {
    ...
    public static DefaultAttributeContainer.Builder createSkeletonHorseAttributes() {
        return SkeletonHorseEntity.createBaseHorseAttributes().add(EntityAttributes.MAX_HEALTH, 15.0).add(EntityAttributes.MOVEMENT_SPEED, 0.2f);
    }
    ...
    protected void initAttributes(Random random) {
        this.getAttributeInstance(EntityAttributes.JUMP_STRENGTH).setBaseValue(SkeletonHorseEntity.getChildJumpStrengthBonus(random::nextDouble));
    }
