...
public abstract class AbstractPiglinEntity extends HostileEntity {
   ...
   public AbstractPiglinEntity(EntityType entityType, World world) {
   ...
   protected void zombify(ServerWorld world) {
      this.convertTo(EntityType.ZOMBIFIED_PIGLIN, EntityConversionContext.create(this, true, true), (zombifiedPiglin) -> {
         zombifiedPiglin.addStatusEffect(new StatusEffectInstance(StatusEffects.NAUSEA, 200, 0));
      });
   }
