...
extends HostileEntity {
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(2, new FleeEntityGoal<ArmadilloEntity>(this, ArmadilloEntity.class, 6.0f, 1.0, 1.2, entity -> !((ArmadilloEntity)entity).isNotIdle()));
    ...
    public @Nullable EntityData initialize(ServerWorldAccess world, LocalDifficulty difficulty, SpawnReason spawnReason, @Nullable EntityData entityData) {
        ...
        if (random.nextInt(100) == 0 && (skeletonEntity = EntityType.SKELETON.create(this.getEntityWorld(), SpawnReason.JOCKEY)) != null) {
    ...
    public Vec3d getVehicleAttachmentPos(Entity vehicle) {
        if (vehicle.getWidth() <= this.getWidth()) {
            return new Vec3d(0.0, 0.3125 * (double)this.getScale(), 0.0);
        }
