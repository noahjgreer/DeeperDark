...
public class EntityAttribute {
    ...
    extends Enum<Category> {
        public static final /* enum */ Category POSITIVE = new Category();
        public static final /* enum */ Category NEUTRAL = new Category();
        public static final /* enum */ Category NEGATIVE = new Category();
        private static final /* synthetic */ Category[] field_51888;

        public static Category[] values() {
            return (Category[])field_51888.clone();
        }
        ...
        private static /* synthetic */ Category[] method_60495() {
            return new Category[]{POSITIVE, NEUTRAL, NEGATIVE};
        }

        static {
            field_51888 = Category.method_60495();
        }
    }
}
