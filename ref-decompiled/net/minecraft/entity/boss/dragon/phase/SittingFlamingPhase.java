   ...
   public void clientTick() {
      ...
      if (this.ticks % 2 == 0 && this.ticks < 10) {
         ...
         for(int i = 0; i < 8; ++i) {
            ...
            for(int k = 0; k < 6; ++k) {
               this.dragon.getWorld().addParticleClient(ParticleTypes.DRAGON_BREATH, g, h, j, -vec3d.x * 0.07999999821186066 * (double)k, -vec3d.y * 0.6000000238418579, -vec3d.z * 0.07999999821186066 * (double)k);
            }
