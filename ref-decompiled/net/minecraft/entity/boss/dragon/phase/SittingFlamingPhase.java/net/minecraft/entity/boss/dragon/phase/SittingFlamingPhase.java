    ...
    public void clientTick() {
        ...
        if (this.ticks % 2 == 0 && this.ticks < 10) {
            ...
            for (int i = 0; i < 8; ++i) {
                ...
                for (int k = 0; k < 6; ++k) {
                    this.dragon.getEntityWorld().addParticleClient(DragonBreathParticleEffect.of(ParticleTypes.DRAGON_BREATH, 1.0f), g, h, j, -vec3d.x * (double)0.08f * (double)k, -vec3d.y * (double)0.6f, -vec3d.z * (double)0.08f * (double)k);
                }
