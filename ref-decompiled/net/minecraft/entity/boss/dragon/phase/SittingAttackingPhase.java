...
public class SittingAttackingPhase extends AbstractSittingPhase {
   ...
   public void clientTick() {
      this.dragon.getWorld().playSoundClient(this.dragon.getX(), this.dragon.getY(), this.dragon.getZ(), SoundEvents.ENTITY_ENDER_DRAGON_GROWL, this.dragon.getSoundCategory(), 2.5F, 0.8F + this.dragon.getRandom().nextFloat() * 0.3F, false);
   }
