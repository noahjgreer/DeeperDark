...
public class LandingPhase extends AbstractPhase {
   ...
   public void clientTick() {
      ...
      for(int i = 0; i < 8; ++i) {
         ...
         this.dragon.getWorld().addParticleClient(ParticleTypes.DRAGON_BREATH, g, h, j, -vec3d.x * 0.07999999821186066 + vec3d2.x, -vec3d.y * 0.30000001192092896 + vec3d2.y, -vec3d.z * 0.07999999821186066 + vec3d2.z);
