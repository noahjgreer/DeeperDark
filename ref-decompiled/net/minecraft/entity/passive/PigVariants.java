...
public class PigVariants {
   ...
   private static void register(Registerable registry, RegistryKey key, PigVariant.Model model, String textureName, TagKey biomes) {
   ...
   private static void register(Registerable registry, RegistryKey key, PigVariant.Model model, String textureName, SpawnConditionSelectors spawnConditions) {
