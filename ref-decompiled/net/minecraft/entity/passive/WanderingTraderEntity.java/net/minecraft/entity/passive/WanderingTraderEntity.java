...
implements ConsumableComponent.ConsumableSoundProvider {
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(0, new HoldInHandsGoal<WanderingTraderEntity>(this, PotionContentsComponent.createStack(Items.POTION, Potions.INVISIBILITY), SoundEvents.ENTITY_WANDERING_TRADER_DISAPPEARED, wanderingTrader -> this.getEntityWorld().isNight() && !wanderingTrader.isInvisible()));
        this.goalSelector.add(0, new HoldInHandsGoal<WanderingTraderEntity>(this, new ItemStack(Items.MILK_BUCKET), SoundEvents.ENTITY_WANDERING_TRADER_REAPPEARED, wanderingTrader -> this.getEntityWorld().isDay() && wanderingTrader.isInvisible()));
    ...
    protected void fillRecipes(ServerWorld world) {
        ...
        for (Pair<TradeOffers.Factory[], Integer> pair : TradeOffers.WANDERING_TRADER_TRADES) {
            ...
            this.fillRecipesFromPool(world, tradeOfferList, factorys, (Integer)pair.getRight());
        }
    }
    ...
    protected void readCustomData(ReadView view) {
        ...
        this.wanderTarget = view.read("wander_target", BlockPos.CODEC).orElse(null);
