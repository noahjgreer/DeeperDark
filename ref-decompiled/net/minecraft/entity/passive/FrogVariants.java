...
public interface FrogVariants {
   RegistryKey TEMPERATE = of(AnimalTemperature.TEMPERATE);
   RegistryKey WARM = of(AnimalTemperature.WARM);
   RegistryKey COLD = of(AnimalTemperature.COLD);
   ...
   private static void register(Registerable registry, RegistryKey key, String assetId, TagKey requiredBiomes) {
      RegistryEntryList registryEntryList = registry.getRegistryLookup(RegistryKeys.BIOME).getOrThrow(requiredBiomes);
