...
public class OcelotEntity extends AnimalEntity {
   ...
   public OcelotEntity(EntityType entityType, World world) {
   ...
   protected void initGoals() {
      this.temptGoal = new OcelotTemptGoal(this, 0.6, (stack) -> {
   ...
   public OcelotEntity createChild(ServerWorld serverWorld, PassiveEntity passiveEntity) {
      return (OcelotEntity)EntityType.OCELOT.create(serverWorld, SpawnReason.BREEDING);
   }
   ...
   private static class OcelotTemptGoal extends TemptGoal {
      ...
      public OcelotTemptGoal(OcelotEntity ocelot, double speed, Predicate foodPredicate, boolean canBeScared) {
