...
public class TadpoleEntity extends FishEntity {
   ...
   public TadpoleEntity(EntityType entityType, World world) {
   ...
   private void growUp() {
      ...
      if (var2 instanceof ServerWorld serverWorld) {
         this.convertTo(EntityType.FROG, EntityConversionContext.create(this, false, false), (frog) -> {
            frog.initialize(serverWorld, this.getWorld().getLocalDifficulty(frog.getBlockPos()), SpawnReason.CONVERSION, (EntityData)null);
            frog.setPersistent();
