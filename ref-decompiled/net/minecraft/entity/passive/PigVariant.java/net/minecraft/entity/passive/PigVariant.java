...
public record PigVariant(ModelAndTexture<Model> modelAndTexture, SpawnConditionSelectors spawnConditions) implements VariantSelectorProvider<SpawnContext, SpawnCondition>
{
    ...
    public static final Codec<PigVariant> NETWORK_CODEC = RecordCodecBuilder.create(instance -> instance.group((App)ModelAndTexture.createMapCodec(Model.CODEC, Model.NORMAL).forGetter(PigVariant::modelAndTexture)).apply((Applicative)instance, PigVariant::new));
    ...
    implements StringIdentifiable {
        ...
        private static final /* synthetic */ Model[] field_55695;
        ...
        private static /* synthetic */ Model[] method_66311() {
