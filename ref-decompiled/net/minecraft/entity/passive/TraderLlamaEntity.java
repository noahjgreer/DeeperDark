...
public class TraderLlamaEntity extends LlamaEntity {
   ...
   public TraderLlamaEntity(EntityType entityType, World world) {
   ...
   protected LlamaEntity createChild() {
      return (LlamaEntity)EntityType.TRADER_LLAMA.create(this.getWorld(), SpawnReason.BREEDING);
   }
   ...
   protected void initGoals() {
      ...
      this.targetSelector.add(2, new ActiveTargetGoal(this, ZombieEntity.class, true, (entity, serverWorld) -> {
         return entity.getType() != EntityType.ZOMBIFIED_PIGLIN;
      }));
