...
extends LlamaEntity {
    ...
    protected void initGoals() {
        ...
        this.targetSelector.add(2, new ActiveTargetGoal<ZombieEntity>((MobEntity)this, ZombieEntity.class, true, (entity, serverWorld) -> entity.getType() != EntityType.ZOMBIFIED_PIGLIN));
