...
public record ChickenVariant(ModelAndTexture<Model> modelAndTexture, SpawnConditionSelectors spawnConditions) implements VariantSelectorProvider<SpawnContext, SpawnCondition>
{
    public static final Codec<ChickenVariant> CODEC = RecordCodecBuilder.create(instance -> instance.group((App)ModelAndTexture.createMapCodec(Model.CODEC, Model.NORMAL).forGetter(ChickenVariant::modelAndTexture), (App)SpawnConditionSelectors.CODEC.fieldOf("spawn_conditions").forGetter(ChickenVariant::spawnConditions)).apply((Applicative)instance, ChickenVariant::new));
    public static final Codec<ChickenVariant> NETWORK_CODEC = RecordCodecBuilder.create(instance -> instance.group((App)ModelAndTexture.createMapCodec(Model.CODEC, Model.NORMAL).forGetter(ChickenVariant::modelAndTexture)).apply((Applicative)instance, ChickenVariant::new));
    ...
    private ChickenVariant(ModelAndTexture<Model> modelAndTexture) {
    ...
    implements StringIdentifiable {
        ...
        public static final /* enum */ Model COLD = new Model("cold");
        public static final Codec<Model> CODEC;
        private final String id;
        private static final /* synthetic */ Model[] field_56546;

        public static Model[] values() {
            return (Model[])field_56546.clone();
        }
        ...
        private static /* synthetic */ Model[] method_67525() {
            return new Model[]{NORMAL, COLD};
        }

        static {
            field_56546 = Model.method_67525();
