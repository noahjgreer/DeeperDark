...
public abstract class AbstractCowEntity extends AnimalEntity {
   ...
   public AbstractCowEntity(EntityType entityType, World world) {
   ...
   public static DefaultAttributeContainer.Builder createCowAttributes() {
      return AnimalEntity.createAnimalAttributes().add(EntityAttributes.MAX_HEALTH, 10.0).add(EntityAttributes.MOVEMENT_SPEED, 0.20000000298023224);
   }
