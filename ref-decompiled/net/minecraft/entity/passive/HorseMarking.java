...
public enum HorseMarking {
   ...
   private static final IntFunction INDEX_MAPPER = ValueLists.createIndexToValueFunction(HorseMarking::getIndex, values(), (ValueLists.OutOfBoundsHandling)ValueLists.OutOfBoundsHandling.WRAP);
