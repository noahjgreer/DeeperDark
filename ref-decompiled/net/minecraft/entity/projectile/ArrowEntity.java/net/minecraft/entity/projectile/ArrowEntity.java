...
extends PersistentProjectileEntity {
    ...
    private void spawnParticles(int amount) {
        ...
        for (int j = 0; j < amount; ++j) {
            this.getEntityWorld().addParticleClient(TintedParticleEffect.create(ParticleTypes.ENTITY_EFFECT, i), this.getParticleX(0.5), this.getRandomBodyY(), this.getParticleZ(0.5), 0.0, 0.0, 0.0);
        }
    }
    ...
    protected void onHit(LivingEntity target) {
        ...
        potionContentsComponent.forEachEffect(effect -> target.addStatusEffect((StatusEffectInstance)effect, entity), f);
    }
