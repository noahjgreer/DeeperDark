...
public interface SpawnLocationTypes {
   SpawnLocation UNRESTRICTED = (world, pos, entityType) -> {
      return true;
   };
   ...
   SpawnLocation IN_LAVA = (world, pos, entityType) -> {
      return entityType != null && world.getWorldBorder().contains(pos) ? world.getFluidState(pos).isIn(FluidTags.LAVA) : false;
   };
