...
public class PositionInterpolator {
   ...
   public PositionInterpolator(Entity entity, int lerpDuration) {
      this(entity, lerpDuration, (Consumer)null);
   }

   public PositionInterpolator(Entity entity, @Nullable Consumer callback) {
      this(entity, 3, callback);
   }

   public PositionInterpolator(Entity entity, int lerpDuration, @Nullable Consumer callback) {
      this.data = new Data(0, Vec3d.ZERO, 0.0F, 0.0F);
