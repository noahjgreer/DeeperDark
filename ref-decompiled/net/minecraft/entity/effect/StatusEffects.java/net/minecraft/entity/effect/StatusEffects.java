...
public class StatusEffects {
    ...
    public static final RegistryEntry<StatusEffect> SPEED = StatusEffects.register("speed", new StatusEffect(StatusEffectCategory.BENEFICIAL, 3402751).addAttributeModifier(EntityAttributes.MOVEMENT_SPEED, Identifier.ofVanilla("effect.speed"), 0.2f, EntityAttributeModifier.Operation.ADD_MULTIPLIED_TOTAL));
    public static final RegistryEntry<StatusEffect> SLOWNESS = StatusEffects.register("slowness", new StatusEffect(StatusEffectCategory.HARMFUL, 9154528).addAttributeModifier(EntityAttributes.MOVEMENT_SPEED, Identifier.ofVanilla("effect.slowness"), -0.15f, EntityAttributeModifier.Operation.ADD_MULTIPLIED_TOTAL));
    public static final RegistryEntry<StatusEffect> HASTE = StatusEffects.register("haste", new StatusEffect(StatusEffectCategory.BENEFICIAL, 14270531).addAttributeModifier(EntityAttributes.ATTACK_SPEED, Identifier.ofVanilla("effect.haste"), 0.1f, EntityAttributeModifier.Operation.ADD_MULTIPLIED_TOTAL));
    public static final RegistryEntry<StatusEffect> MINING_FATIGUE = StatusEffects.register("mining_fatigue", new StatusEffect(StatusEffectCategory.HARMFUL, 4866583).addAttributeModifier(EntityAttributes.ATTACK_SPEED, Identifier.ofVanilla("effect.mining_fatigue"), -0.1f, EntityAttributeModifier.Operation.ADD_MULTIPLIED_TOTAL));
    public static final RegistryEntry<StatusEffect> STRENGTH = StatusEffects.register("strength", new StatusEffect(StatusEffectCategory.BENEFICIAL, 16762624).addAttributeModifier(EntityAttributes.ATTACK_DAMAGE, Identifier.ofVanilla("effect.strength"), 3.0, EntityAttributeModifier.Operation.ADD_VALUE));
    ...
    public static final RegistryEntry<StatusEffect> JUMP_BOOST = StatusEffects.register("jump_boost", new StatusEffect(StatusEffectCategory.BENEFICIAL, 16646020).addAttributeModifier(EntityAttributes.SAFE_FALL_DISTANCE, Identifier.ofVanilla("effect.jump_boost"), 1.0, EntityAttributeModifier.Operation.ADD_VALUE));
    public static final RegistryEntry<StatusEffect> NAUSEA = StatusEffects.register("nausea", new StatusEffect(StatusEffectCategory.HARMFUL, 5578058).fadeTicks(150, 20, 60));
    ...
    public static final RegistryEntry<StatusEffect> INVISIBILITY = StatusEffects.register("invisibility", new StatusEffect(StatusEffectCategory.BENEFICIAL, 0xF6F6F6).addAttributeModifier(EntityAttributes.WAYPOINT_TRANSMIT_RANGE, Identifier.ofVanilla("effect.waypoint_transmit_range_hide"), -1.0, EntityAttributeModifier.Operation.ADD_MULTIPLIED_TOTAL));
    ...
    public static final RegistryEntry<StatusEffect> WEAKNESS = StatusEffects.register("weakness", new StatusEffect(StatusEffectCategory.HARMFUL, 0x484D48).addAttributeModifier(EntityAttributes.ATTACK_DAMAGE, Identifier.ofVanilla("effect.weakness"), -4.0, EntityAttributeModifier.Operation.ADD_VALUE));
    ...
    public static final RegistryEntry<StatusEffect> HEALTH_BOOST = StatusEffects.register("health_boost", new StatusEffect(StatusEffectCategory.BENEFICIAL, 16284963).addAttributeModifier(EntityAttributes.MAX_HEALTH, Identifier.ofVanilla("effect.health_boost"), 4.0, EntityAttributeModifier.Operation.ADD_VALUE));
    public static final RegistryEntry<StatusEffect> ABSORPTION = StatusEffects.register("absorption", new AbsorptionStatusEffect(StatusEffectCategory.BENEFICIAL, 0x2552A5).addAttributeModifier(EntityAttributes.MAX_ABSORPTION, Identifier.ofVanilla("effect.absorption"), 4.0, EntityAttributeModifier.Operation.ADD_VALUE));
    ...
    public static final RegistryEntry<StatusEffect> LUCK = StatusEffects.register("luck", new StatusEffect(StatusEffectCategory.BENEFICIAL, 5882118).addAttributeModifier(EntityAttributes.LUCK, Identifier.ofVanilla("effect.luck"), 1.0, EntityAttributeModifier.Operation.ADD_VALUE));
    public static final RegistryEntry<StatusEffect> UNLUCK = StatusEffects.register("unluck", new StatusEffect(StatusEffectCategory.HARMFUL, 12624973).addAttributeModifier(EntityAttributes.LUCK, Identifier.ofVanilla("effect.unluck"), -1.0, EntityAttributeModifier.Operation.ADD_VALUE));
    ...
    public static final RegistryEntry<StatusEffect> BREATH_OF_THE_NAUTILUS = StatusEffects.register("breath_of_the_nautilus", new StatusEffect(StatusEffectCategory.BENEFICIAL, 65518));
