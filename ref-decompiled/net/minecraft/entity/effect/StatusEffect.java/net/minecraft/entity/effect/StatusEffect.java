...
FabricMobEffect {
    ...
    public void playApplySound(LivingEntity entity, int amplifier) {
        this.applySound.ifPresent(sound -> entity.getEntityWorld().playSound(null, entity.getX(), entity.getY(), entity.getZ(), (SoundEvent)sound, entity.getSoundCategory(), 1.0f, 1.0f));
    }
    ...
    public void forEachAttributeModifier(int amplifier, BiConsumer<RegistryEntry<EntityAttribute>, EntityAttributeModifier> consumer) {
        this.attributeModifiers.forEach((attribute, attributeModifierCreator) -> consumer.accept((RegistryEntry<EntityAttribute>)attribute, attributeModifierCreator.createAttributeModifier(amplifier)));
    }
    ...
    record EffectAttributeModifierCreator(Identifier id, double baseValue, EntityAttributeModifier.Operation operation) {
        ...
        public final String toString() {
            return ObjectMethods.bootstrap("toString", new MethodHandle[]{EffectAttributeModifierCreator.class, "id;amount;operation", "id", "baseValue", "operation"}, this);
        }

        @Override
        public final int hashCode() {
            return (int)ObjectMethods.bootstrap("hashCode", new MethodHandle[]{EffectAttributeModifierCreator.class, "id;amount;operation", "id", "baseValue", "operation"}, this);
        }

        @Override
        public final boolean equals(Object object) {
            return (boolean)ObjectMethods.bootstrap("equals", new MethodHandle[]{EffectAttributeModifierCreator.class, "id;amount;operation", "id", "baseValue", "operation"}, this, object);
        }
    }
}
