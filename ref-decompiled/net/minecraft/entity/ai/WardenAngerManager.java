...
public class WardenAngerManager {
   ...
   private static final Codec SUSPECT_CODEC = RecordCodecBuilder.create((instance) -> {
      return instance.group(Uuids.INT_STREAM_CODEC.fieldOf("uuid").forGetter(Pair::getFirst), Codecs.NON_NEGATIVE_INT.fieldOf("anger").forGetter(Pair::getSecond)).apply(instance, Pair::of);
   });
