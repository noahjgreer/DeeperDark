...
public class SensorType<U extends Sensor<?>> {
    ...
    public static final SensorType<NearestVisibleAdultSensor> NEAREST_ADULT_ANY_TYPE = SensorType.register("nearest_adult_any_type", NearestFollowableFriendlyMobSensor::new);
    ...
    public static final SensorType<TemptationsSensor> FOOD_TEMPTATIONS = SensorType.register("food_temptations", TemptationsSensor::breedingItem);
    ...
    public static final SensorType<TemptationsSensor> NAUTILUS_TEMPTATIONS = SensorType.register("nautilus_temptations", () -> new TemptationsSensor(NautilusBrain.getNautilusFoodPredicate()));
