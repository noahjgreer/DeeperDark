...
extends NearestVisibleLivingEntitySensor {
    ...
    protected boolean matches(ServerWorld world, LivingEntity entity, LivingEntity target) {
        if (!entity.getBrain().hasMemoryModule(MemoryModuleType.HAS_HUNTING_COOLDOWN) && Sensor.testAttackableTargetPredicate(world, entity, target) && FrogEntity.isValidFrogFood(target) && !this.isTargetUnreachable(entity, target)) {
