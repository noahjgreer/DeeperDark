...
public class FrogAttackablesSensor extends NearestVisibleLivingEntitySensor {
   ...
   protected boolean matches(ServerWorld world, LivingEntity entity, LivingEntity target) {
      return !entity.getBrain().hasMemoryModule(MemoryModuleType.HAS_HUNTING_COOLDOWN) && Sensor.testAttackableTargetPredicate(world, entity, target) && FrogEntity.isValidFrogFood(target) && !this.isTargetUnreachable(entity, target) ? target.isInRange(entity, 10.0) : false;
   }
