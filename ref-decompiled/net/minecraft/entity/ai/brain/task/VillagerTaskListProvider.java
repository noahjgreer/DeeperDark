...
public class VillagerTaskListProvider {
   ...
   public static ImmutableList createCoreTasks(RegistryEntry profession, float speed) {
      return ImmutableList.of(Pair.of(0, new StayAboveWaterTask(0.8F)), Pair.of(0, OpenDoorsTask.create()), Pair.of(0, new UpdateLookControlTask(45, 90)), Pair.of(0, new PanicTask()), Pair.of(0, WakeUpTask.create()), Pair.of(0, HideWhenBellRingsTask.create()), Pair.of(0, StartRaidTask.create()), Pair.of(0, ForgetCompletedPointOfInterestTask.create(((VillagerProfession)profession.value()).heldWorkstation(), MemoryModuleType.JOB_SITE)), Pair.of(0, ForgetCompletedPointOfInterestTask.create(((VillagerProfession)profession.value()).acquirableWorkstation(), MemoryModuleType.POTENTIAL_JOB_SITE)), Pair.of(1, new MoveToTargetTask()), Pair.of(2, WorkStationCompetitionTask.create()), Pair.of(3, new FollowCustomerTask(speed)), new Pair[]{Pair.of(5, WalkTowardsNearestVisibleWantedItemTask.create(speed, false, 4)), Pair.of(6, FindPointOfInterestTask.create(((VillagerProfession)profession.value()).acquirableWorkstation(), MemoryModuleType.JOB_SITE, MemoryModuleType.POTENTIAL_JOB_SITE, true, Optional.empty(), (world, pos) -> {
         return true;
      })), Pair.of(7, new WalkTowardsJobSiteTask(speed)), Pair.of(8, TakeJobSiteTask.create(speed)), Pair.of(10, FindPointOfInterestTask.create((poiType) -> {
         return poiType.matchesKey(PointOfInterestTypes.HOME);
      }, MemoryModuleType.HOME, false, Optional.of((byte)14), VillagerTaskListProvider::isUnoccupiedBedAt)), Pair.of(10, FindPointOfInterestTask.create((poiType) -> {
         return poiType.matchesKey(PointOfInterestTypes.MEETING);
      }, MemoryModuleType.MEETING_POINT, true, Optional.of((byte)14))), Pair.of(10, UpdateJobSiteTask.create()), Pair.of(10, LoseJobOnSiteLossTask.create())});
   }
   ...
   public static ImmutableList createWorkTasks(RegistryEntry profession, float speed) {
      ...
      return ImmutableList.of(createBusyFollowTask(), Pair.of(5, new RandomTask(ImmutableList.of(Pair.of(villagerWorkTask, 7), Pair.of(GoAroundTask.create(MemoryModuleType.JOB_SITE, 0.4F, 4), 2), Pair.of(GoToPosTask.create(MemoryModuleType.JOB_SITE, 0.4F, 1, 10), 5), Pair.of(GoToSecondaryPositionTask.create(MemoryModuleType.SECONDARY_JOB_SITE, speed, 1, 6, MemoryModuleType.JOB_SITE), 5), Pair.of(new FarmerVillagerTask(), profession.matchesKey(VillagerProfession.FARMER) ? 2 : 5), Pair.of(new BoneMealTask(), profession.matchesKey(VillagerProfession.FARMER) ? 4 : 7)))), Pair.of(10, new HoldTradeOffersTask(400, 1600)), Pair.of(10, FindInteractionTargetTask.create(EntityType.PLAYER, 4)), Pair.of(2, VillagerWalkTowardsTask.create(MemoryModuleType.JOB_SITE, speed, 9, 100, 1200)), Pair.of(3, new GiveGiftsToHeroTask(100)), Pair.of(99, ScheduleActivityTask.create()));
   }

   public static ImmutableList createPlayTasks(float speed) {
   ...
   public static ImmutableList createRestTasks(RegistryEntry registryEntry, float speed) {
      return ImmutableList.of(Pair.of(2, VillagerWalkTowardsTask.create(MemoryModuleType.HOME, speed, 1, 150, 1200)), Pair.of(3, ForgetCompletedPointOfInterestTask.create((poiType) -> {
         return poiType.matchesKey(PointOfInterestTypes.HOME);
   ...
   public static ImmutableList createMeetTasks(RegistryEntry registryEntry, float speed) {
      return ImmutableList.of(Pair.of(2, Tasks.pickRandomly(ImmutableList.of(Pair.of(GoAroundTask.create(MemoryModuleType.MEETING_POINT, 0.4F, 40), 2), Pair.of(MeetVillagerTask.create(), 2)))), Pair.of(10, new HoldTradeOffersTask(400, 1600)), Pair.of(10, FindInteractionTargetTask.create(EntityType.PLAYER, 4)), Pair.of(2, VillagerWalkTowardsTask.create(MemoryModuleType.MEETING_POINT, speed, 6, 100, 200)), Pair.of(3, new GiveGiftsToHeroTask(100)), Pair.of(3, ForgetCompletedPointOfInterestTask.create((poiType) -> {
         return poiType.matchesKey(PointOfInterestTypes.MEETING);
      }, MemoryModuleType.MEETING_POINT)), Pair.of(3, new CompositeTask(ImmutableMap.of(), ImmutableSet.of(MemoryModuleType.INTERACTION_TARGET), CompositeTask.Order.ORDERED, CompositeTask.RunMode.RUN_ONE, ImmutableList.of(Pair.of(new GatherItemsVillagerTask(), 1)))), createFreeFollowTask(), Pair.of(99, ScheduleActivityTask.create()));
   }

   public static ImmutableList createIdleTasks(RegistryEntry registryEntry, float speed) {
   ...
   public static ImmutableList createPanicTasks(RegistryEntry registryEntry, float speed) {
      float f = speed * 1.5F;
   ...
   public static ImmutableList createPreRaidTasks(RegistryEntry registryEntry, float speed) {
      return ImmutableList.of(Pair.of(0, RingBellTask.create()), Pair.of(0, Tasks.pickRandomly(ImmutableList.of(Pair.of(VillagerWalkTowardsTask.create(MemoryModuleType.MEETING_POINT, speed * 1.5F, 2, 150, 200), 6), Pair.of(GoToPointOfInterestTask.create(speed * 1.5F), 2)))), createBusyFollowTask(), Pair.of(99, EndRaidTask.create()));
   }

   public static ImmutableList createRaidTasks(RegistryEntry registryEntry, float speed) {
      return ImmutableList.of(Pair.of(0, TaskTriggerer.runIf((TaskRunnable)TaskTriggerer.predicate(VillagerTaskListProvider::wonRaid), (TaskRunnable)Tasks.pickRandomly(ImmutableList.of(Pair.of(SeekSkyTask.create(speed), 5), Pair.of(GoToPointOfInterestTask.create(speed * 1.1F), 2))))), Pair.of(0, new CelebrateRaidWinTask(600, 600)), Pair.of(2, TaskTriggerer.runIf((TaskRunnable)TaskTriggerer.predicate(VillagerTaskListProvider::hasActiveRaid), (TaskRunnable)HideInHomeTask.create(24, speed * 1.4F, 1))), createBusyFollowTask(), Pair.of(99, EndRaidTask.create()));
   }

   public static ImmutableList createHideTasks(RegistryEntry registryEntry, float speed) {
      int i = true;
   ...
   private static Pair createFreeFollowTask() {
   ...
   private static Pair createBusyFollowTask() {
