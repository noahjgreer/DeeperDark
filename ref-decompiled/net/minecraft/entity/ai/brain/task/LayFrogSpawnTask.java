            ...
            return (world, entity, time) -> {
               if (!entity.isTouchingWater() && entity.isOnGround()) {
                  ...
                  while(var7.hasNext()) {
                     ...
                     if (world.getBlockState(blockPos2).getCollisionShape(world, blockPos2).getFace(Direction.UP).isEmpty() && world.getFluidState(blockPos2).isOf(Fluids.WATER)) {
                        ...
                        if (world.getBlockState(blockPos3).isAir()) {
                           ...
                           world.playSoundFromEntity((Entity)null, entity, SoundEvents.ENTITY_FROG_LAY_SPAWN, SoundCategory.BLOCKS, 1.0F, 1.0F);
                           isPregnant.forget();
                           return true;
                        }
                     }
