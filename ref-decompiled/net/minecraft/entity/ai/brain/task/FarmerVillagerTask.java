...
public class FarmerVillagerTask extends MultiTickTask {
   ...
   private final List targetPositions = Lists.newArrayList();
         ...
         if (this.currentTarget != null && l > this.nextResponseTime) {
            ...
            if (blockState.isAir() && block2 instanceof FarmlandBlock && villagerEntity.hasSeedToPlant()) {
               ...
               for(int i = 0; i < simpleInventory.size(); ++i) {
                  ...
                  if (bl) {
                     serverWorld.playSound((Entity)null, (double)this.currentTarget.getX(), (double)this.currentTarget.getY(), (double)this.currentTarget.getZ(), SoundEvents.ITEM_CROP_PLANT, SoundCategory.BLOCKS, 1.0F, 1.0F);
