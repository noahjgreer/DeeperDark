...
public class BoneMealTask extends MultiTickTask {
   ...
   private void addLookWalkTargets(VillagerEntity villager) {
      this.pos.ifPresent((pos) -> {
         ...
         villager.getBrain().remember(MemoryModuleType.LOOK_TARGET, (Object)blockPosLookTarget);
         villager.getBrain().remember(MemoryModuleType.WALK_TARGET, (Object)(new WalkTarget(blockPosLookTarget, 0.5F, 1)));
      });
   }
