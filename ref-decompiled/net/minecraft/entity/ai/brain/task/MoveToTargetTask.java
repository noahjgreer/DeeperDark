...
public class MoveToTargetTask extends MultiTickTask {
   ...
   protected boolean shouldKeepRunning(ServerWorld serverWorld, MobEntity mobEntity, long l) {
      if (this.path != null && this.lookTargetPos != null) {
         Optional optional = mobEntity.getBrain().getOptionalRegisteredMemory(MemoryModuleType.WALK_TARGET);
   ...
   protected void run(ServerWorld serverWorld, MobEntity mobEntity, long l) {
      mobEntity.getBrain().remember(MemoryModuleType.PATH, (Object)this.path);
   ...
   protected void keepRunning(ServerWorld serverWorld, MobEntity mobEntity, long l) {
      ...
      if (this.path != path) {
         this.path = path;
         brain.remember(MemoryModuleType.PATH, (Object)path);
      }
   ...
   private boolean hasFinishedPath(MobEntity entity, WalkTarget walkTarget, long time) {
      ...
      this.path = entity.getNavigation().findPathTo((BlockPos)blockPos, 0);
      ...
      if (this.hasReached(entity, walkTarget)) {
         ...
         if (bl) {
            ...
            brain.remember(MemoryModuleType.CANT_REACH_WALK_TARGET_SINCE, (Object)time);
         }
