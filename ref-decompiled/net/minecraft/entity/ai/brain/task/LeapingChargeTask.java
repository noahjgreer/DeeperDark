...
public class LeapingChargeTask extends MultiTickTask {
   ...
   protected void finishRunning(ServerWorld serverWorld, MobEntity mobEntity, long l) {
      if (mobEntity.isOnGround()) {
         mobEntity.setVelocity(mobEntity.getVelocity().multiply(0.10000000149011612, 1.0, 0.10000000149011612));
         serverWorld.playSoundFromEntity((Entity)null, mobEntity, this.sound, SoundCategory.NEUTRAL, 2.0F, 1.0F);
      }
      ...
      mobEntity.getBrain().remember(MemoryModuleType.LONG_JUMP_COOLING_DOWN, (Object)this.cooldownRange.get(serverWorld.random));
   }
