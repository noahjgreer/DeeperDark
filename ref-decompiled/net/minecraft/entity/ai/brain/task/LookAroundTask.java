...
public class LookAroundTask extends MultiTickTask {
   ...
   protected void run(ServerWorld serverWorld, MobEntity mobEntity, long l) {
      ...
      mobEntity.getBrain().remember(MemoryModuleType.LOOK_TARGET, (Object)(new BlockPosLookTarget(mobEntity.getEyePos().add(vec3d))));
      mobEntity.getBrain().remember(MemoryModuleType.GAZE_COOLDOWN_TICKS, (Object)this.cooldown.get(random));
   }
