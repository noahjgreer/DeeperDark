...
extends MultiTickTask<VillagerEntity> {
    ...
    protected boolean shouldRun(ServerWorld serverWorld, VillagerEntity villagerEntity) {
        ...
        return villagerEntity.isAlive() && playerEntity != null && !villagerEntity.isTouchingWater() && !villagerEntity.knockedBack && villagerEntity.squaredDistanceTo(playerEntity) <= 16.0;
    }
