...
public class FollowCustomerTask extends MultiTickTask {
   ...
   private void update(VillagerEntity villager) {
      ...
      brain.remember(MemoryModuleType.WALK_TARGET, (Object)(new WalkTarget(new EntityLookTarget(villager.getCustomer(), false), this.speed, 2)));
      brain.remember(MemoryModuleType.LOOK_TARGET, (Object)(new EntityLookTarget(villager.getCustomer(), true)));
   }
