...
extends MultiTickTask<VillagerEntity> {
    ...
    protected void keepRunning(ServerWorld serverWorld, VillagerEntity villagerEntity, long l) {
        ...
        if (this.isCloseEnough(villagerEntity, playerEntity)) {
            ...
            TargetUtil.walkTowards((LivingEntity)villagerEntity, playerEntity, 0.5f, 5);
        }
    }
    ...
    private void giveGifts(ServerWorld world2, VillagerEntity villager, LivingEntity recipient) {
        villager.forEachGiftedItem(world2, GiveGiftsToHeroTask.getGiftLootTable(villager), (world, stack) -> TargetUtil.give(villager, stack, recipient.getEntityPos()));
    }
    ...
    private static RegistryKey<LootTable> getGiftLootTable(VillagerEntity villager) {
        ...
        if (optional.isEmpty()) {
            return LootTables.HERO_OF_THE_VILLAGE_UNEMPLOYED_GIFT_GAMEPLAY;
        }
        return GIFTS.getOrDefault(optional.get(), LootTables.HERO_OF_THE_VILLAGE_UNEMPLOYED_GIFT_GAMEPLAY);
    }
