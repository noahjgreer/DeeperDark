...
public class SniffTask extends MultiTickTask {
   ...
   protected void finishRunning(ServerWorld serverWorld, WardenEntity wardenEntity, long l) {
      ...
      Optional var10000 = wardenEntity.getBrain().getOptionalRegisteredMemory(MemoryModuleType.NEAREST_ATTACKABLE);
      Objects.requireNonNull(wardenEntity);
      var10000.filter(wardenEntity::isValidTarget).ifPresent((target) -> {
