...
public class GatherItemsVillagerTask extends MultiTickTask {
   ...
   private static Set getGatherableItems(VillagerEntity entity, VillagerEntity target) {
      ImmutableSet immutableSet = ((VillagerProfession)target.getVillagerData().profession().value()).gatherableItems();
      ImmutableSet immutableSet2 = ((VillagerProfession)entity.getVillagerData().profession().value()).gatherableItems();
