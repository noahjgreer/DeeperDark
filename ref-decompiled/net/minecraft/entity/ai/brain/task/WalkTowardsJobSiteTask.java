...
public class WalkTowardsJobSiteTask extends MultiTickTask {
   ...
   protected void keepRunning(ServerWorld serverWorld, VillagerEntity villagerEntity, long l) {
      TargetUtil.walkTowards(villagerEntity, (BlockPos)((GlobalPos)villagerEntity.getBrain().getOptionalRegisteredMemory(MemoryModuleType.POTENTIAL_JOB_SITE).get()).pos(), this.speed, 1);
   }

   protected void finishRunning(ServerWorld serverWorld, VillagerEntity villagerEntity, long l) {
      Optional optional = villagerEntity.getBrain().getOptionalRegisteredMemory(MemoryModuleType.POTENTIAL_JOB_SITE);
      optional.ifPresent((pos) -> {
         ...
         if (serverWorld2 != null) {
            ...
            if (pointOfInterestStorage.test(blockPos, (poiType) -> {
               return true;
            })) {
