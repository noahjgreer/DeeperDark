...
public class MemoryModuleType {
   ...
   public static final MemoryModuleType NEAREST_VISIBLE_TARGETABLE_PLAYERS;
   ...
   public static final MemoryModuleType BREEZE_SHOOT_RECOVER;
   ...
   private static MemoryModuleType register(String id, Codec codec) {
      return (MemoryModuleType)Registry.register(Registries.MEMORY_MODULE_TYPE, (Identifier)Identifier.ofVanilla(id), new MemoryModuleType(Optional.of(codec)));
   }

   private static MemoryModuleType register(String id) {
      return (MemoryModuleType)Registry.register(Registries.MEMORY_MODULE_TYPE, (Identifier)Identifier.ofVanilla(id), new MemoryModuleType(Optional.empty()));
   }
   ...
   static {
      ...
      NEAREST_VISIBLE_TARGETABLE_PLAYERS = register("nearest_visible_targetable_players");
      ...
      BREEZE_SHOOT_RECOVER = register("breeze_shoot_recover", Unit.CODEC);
