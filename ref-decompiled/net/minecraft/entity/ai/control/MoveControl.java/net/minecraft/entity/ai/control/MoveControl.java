...
implements Control {
    ...
    private boolean isPosWalkable(float x, float z) {
        ...
        return entityNavigation == null || (pathNodeMaker = entityNavigation.getNodeMaker()) == null || pathNodeMaker.getDefaultNodeType(this.entity, BlockPos.ofFloored(this.entity.getX() + (double)x, this.entity.getBlockY(), this.entity.getZ() + (double)z)) == PathNodeType.WALKABLE;
    }
