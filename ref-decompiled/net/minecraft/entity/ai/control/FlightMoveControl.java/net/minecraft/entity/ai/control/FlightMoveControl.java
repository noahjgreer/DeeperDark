...
extends MoveControl {
    ...
    public void tick() {
        if (this.state == MoveControl.State.MOVE_TO) {
            ...
            float i = this.entity.isOnGround() ? (float)(this.speed * this.entity.getAttributeValue(EntityAttributes.MOVEMENT_SPEED)) : (float)(this.speed * this.entity.getAttributeValue(EntityAttributes.FLYING_SPEED));
