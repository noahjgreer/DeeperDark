...
extends Goal {
    ...
    public boolean shouldContinue() {
        ...
        Team abstractTeam = this.mob.getScoreboardTeam();
        Team abstractTeam2 = livingEntity.getScoreboardTeam();
    ...
    protected boolean canTrack(@Nullable LivingEntity target, TargetPredicate targetPredicate) {
        ...
        if (!targetPredicate.test(TrackTargetGoal.getServerWorld(this.mob), this.mob, target)) {
            return false;
        }
