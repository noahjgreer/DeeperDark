...
extends Goal {
    ...
    public boolean shouldContinue() {
        return this.tryingTime >= -this.safeWaitingTime && this.tryingTime <= 1200 && this.isTargetPos(this.mob.getEntityWorld(), this.targetPos);
    }
            ...
            for (int l = 0; l < i; ++l) {
                ...
                while (m <= l) {
                    ...
                    while (n <= l) {
                        ...
                        if (this.mob.isInPositionTargetRange(mutable) && this.isTargetPos(this.mob.getEntityWorld(), mutable)) {
