...
extends TrackTargetGoal {
    ...
    public boolean canStart() {
        ...
        if (livingEntity.getType() == EntityType.PLAYER && RevengeGoal.getServerWorld(this.mob).getGameRules().getValue(GameRules.UNIVERSAL_ANGER).booleanValue()) {
            return false;
        }
    ...
    protected void callSameTypeForRevenge() {
        ...
        List<Entity> list = this.mob.getEntityWorld().getEntitiesByClass(this.mob.getClass(), box, EntityPredicates.EXCEPT_SPECTATOR);
