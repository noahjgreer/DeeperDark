...
public class WanderAroundPointOfInterestGoal extends WanderAroundGoal {
   ...
   protected Vec3d getWanderTarget() {
      ...
      return chunkSectionPos2 != chunkSectionPos ? NoPenaltyTargeting.findTo(this.mob, 10, 7, Vec3d.ofBottomCenter(chunkSectionPos2.getCenterPos()), 1.5707963705062866) : null;
   }
}
