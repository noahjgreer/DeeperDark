...
public class Path {
   ...
   public static Path fromBuf(PacketByteBuf buf) {
      ...
      List list = buf.readList(PathNode::fromBuf);
      DebugNodeInfo debugNodeInfo = Path.DebugNodeInfo.fromBuf(buf);
   ...
   public static record DebugNodeInfo(PathNode[] openSet, PathNode[] closedSet, Set targetNodes) {
      final Set targetNodes;

      public DebugNodeInfo(PathNode[] pathNodes, PathNode[] pathNodes2, Set set) {
         this.openSet = pathNodes;
         this.closedSet = pathNodes2;
      ...
      public static DebugNodeInfo fromBuf(PacketByteBuf buf) {
         HashSet hashSet = (HashSet)buf.readCollection(HashSet::new, TargetPathNode::fromBuffer);
