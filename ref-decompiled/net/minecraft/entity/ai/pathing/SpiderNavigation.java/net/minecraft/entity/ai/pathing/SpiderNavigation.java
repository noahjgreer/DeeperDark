    ...
    public void tick() {
        if (this.isIdle()) {
            if (this.targetPos != null) {
                if (this.targetPos.isWithinDistance(this.entity.getEntityPos(), (double)this.entity.getWidth()) || this.entity.getY() > (double)this.targetPos.getY() && BlockPos.ofFloored(this.targetPos.getX(), this.entity.getY(), this.targetPos.getZ()).isWithinDistance(this.entity.getEntityPos(), (double)this.entity.getWidth())) {
                    this.targetPos = null;
                } else {
