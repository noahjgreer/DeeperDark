...
public abstract class VehicleEntity extends Entity {
   protected static final TrackedData DAMAGE_WOBBLE_TICKS;
   protected static final TrackedData DAMAGE_WOBBLE_SIDE;
   protected static final TrackedData DAMAGE_WOBBLE_STRENGTH;
   ...
   static {
      DAMAGE_WOBBLE_TICKS = DataTracker.registerData(VehicleEntity.class, TrackedDataHandlerRegistry.INTEGER);
      DAMAGE_WOBBLE_SIDE = DataTracker.registerData(VehicleEntity.class, TrackedDataHandlerRegistry.INTEGER);
      DAMAGE_WOBBLE_STRENGTH = DataTracker.registerData(VehicleEntity.class, TrackedDataHandlerRegistry.FLOAT);
   }
}
