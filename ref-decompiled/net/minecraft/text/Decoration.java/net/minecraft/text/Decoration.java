...
public record Decoration(String translationKey, List<Parameter> parameters, Style style) {
    ...
    implements StringIdentifiable {
        public static final /* enum */ Parameter SENDER = new Parameter(0, "sender", (content, params) -> params.name());
        public static final /* enum */ Parameter TARGET = new Parameter(1, "target", (content, params) -> params.targetName().orElse(ScreenTexts.EMPTY));
        public static final /* enum */ Parameter CONTENT = new Parameter(2, "content", (content, params) -> content);
