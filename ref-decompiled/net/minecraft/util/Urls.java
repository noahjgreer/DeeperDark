...
public class Urls {
   ...
   public static String getExtendJavaRealmsUrl(@Nullable String subscriptionId, UUID uuid, boolean trial) {
      if (subscriptionId == null) {
         ...
         String var10000 = getExtendJavaRealmsUrl(subscriptionId, uuid);
   ...
   public static String getExtendJavaRealmsUrl(@Nullable String subscriptionId, UUID uuid) {
      return subscriptionId == null ? "https://aka.ms/ExtendJavaRealms" : "https://aka.ms/ExtendJavaRealms?subscriptionId=" + subscriptionId + "&profileId=" + UndashedUuid.toString(uuid);
   }
}
