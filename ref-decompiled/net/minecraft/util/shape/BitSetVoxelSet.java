...
public final class BitSetVoxelSet extends VoxelSet {
   ...
   public boolean surrounded(int x, int y, int z) {
      ...
      return bl && this.contains(x, y, z) && this.contains(x - 1, y, z) && this.contains(x + 1, y, z) && this.contains(x, y - 1, z) && this.contains(x, y + 1, z) && this.contains(x, y, z - 1) && this.contains(x, y, z + 1);
   }
}
