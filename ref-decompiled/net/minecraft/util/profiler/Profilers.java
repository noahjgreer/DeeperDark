...
public final class Profilers {
   private static final ThreadLocal TRACY_PROFILER = ThreadLocal.withInitial(TracyProfiler::new);
   private static final ThreadLocal BUILTIN_PROFILER = new ThreadLocal();
   ...
   public static Profiler get() {
      return ACTIVE_BUILTIN_PROFILER_COUNT.get() == 0 ? getDefault() : (Profiler)Objects.requireNonNullElseGet((Profiler)BUILTIN_PROFILER.get(), Profilers::getDefault);
   }
