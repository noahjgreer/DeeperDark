...
public final class ParseResults {
   ...
   public int indexOf(Symbol... symbols) {
      for(int i = this.stackTop; i > this.stackBottom; i -= 2) {
         ...
         Symbol[] var4 = symbols;
         int var5 = symbols.length;

         for(int var6 = 0; var6 < var5; ++var6) {
            Symbol symbol = var4[var6];
            if (symbol == object) {
               return i + 1;
            }
         }
   ...
   public void put(Symbol symbol, @Nullable Object value) {
   ...
   public Object getOrDefault(Symbol symbol, Object fallback) {
      int i = this.indexOf(symbol);
   ...
   @Nullable
   @SafeVarargs
   public final Object getAny(Symbol... symbols) {
      int i = this.indexOf(symbols);
      return i != -1 ? this.stack[i] : null;
   }

   @SafeVarargs
   public final Object getAnyOrThrow(Symbol... symbols) {
      int i = this.indexOf(symbols);
      if (i == -1) {
   ...
   private boolean isValid() {
      ...
      for(i = this.stackBottom; i != 0; i = this.getPreviousStackBottom(i)) {
         object = this.stack[i];
         if (object != FRAME) {
            return false;
         }
