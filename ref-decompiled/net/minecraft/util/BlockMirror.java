...
public enum BlockMirror implements StringIdentifiable {
   ...
   public static final Codec CODEC = StringIdentifiable.createCodec(BlockMirror::values);
   /** @deprecated */
   @Deprecated
   public static final Codec ENUM_NAME_CODEC = Codecs.enumByName(BlockMirror::valueOf);
   ...
   public BlockRotation getRotation(Direction direction) {
      ...
      return (this != LEFT_RIGHT || axis != Direction.Axis.Z) && (this != FRONT_BACK || axis != Direction.Axis.X) ? BlockRotation.NONE : BlockRotation.CLOCKWISE_180;
   }
