...
public class ChunkPos {
    public static final Codec<ChunkPos> CODEC = Codec.INT_STREAM.comapFlatMap(stream -> Util.decodeFixedLengthArray(stream, 2).map(coords -> new ChunkPos(coords[0], coords[1])), chunkPos -> IntStream.of(chunkPos.x, chunkPos.z)).stable();
    ...
    public boolean isLoadable() {
        return ChunkPos.isLoadable(this.x, this.z);
    }
