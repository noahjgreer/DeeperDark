...
public class AffineTransformations {
   private static final Map DIRECTION_ROTATIONS;
   private static final Map INVERTED_DIRECTION_ROTATIONS;
   ...
   static {
      DIRECTION_ROTATIONS = Maps.newEnumMap(Map.of(Direction.SOUTH, AffineTransformation.identity(), Direction.EAST, new AffineTransformation((Vector3f)null, (new Quaternionf()).rotateY(1.5707964F), (Vector3f)null, (Quaternionf)null), Direction.WEST, new AffineTransformation((Vector3f)null, (new Quaternionf()).rotateY(-1.5707964F), (Vector3f)null, (Quaternionf)null), Direction.NORTH, new AffineTransformation((Vector3f)null, (new Quaternionf()).rotateY(3.1415927F), (Vector3f)null, (Quaternionf)null), Direction.UP, new AffineTransformation((Vector3f)null, (new Quaternionf()).rotateX(-1.5707964F), (Vector3f)null, (Quaternionf)null), Direction.DOWN, new AffineTransformation((Vector3f)null, (new Quaternionf()).rotateX(1.5707964F), (Vector3f)null, (Quaternionf)null)));
      INVERTED_DIRECTION_ROTATIONS = Maps.newEnumMap(Util.transformMapValues(DIRECTION_ROTATIONS, AffineTransformation::invert));
   }
}
