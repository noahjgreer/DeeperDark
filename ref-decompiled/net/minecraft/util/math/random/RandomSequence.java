...
public class RandomSequence {
   public static final Codec CODEC = RecordCodecBuilder.create((instance) -> {
      return instance.group(Xoroshiro128PlusPlusRandom.CODEC.fieldOf("source").forGetter((sequence) -> {
   ...
   public RandomSequence(long seed, Optional id) {
      this(createSource(seed, id));
   }

   private static Xoroshiro128PlusPlusRandom createSource(long seed, Optional id) {
