...
public final class AffineTransformation {
   ...
   public static final Codec CODEC = RecordCodecBuilder.create((instance) -> {
      return instance.group(Codecs.VECTOR_3F.fieldOf("translation").forGetter((affineTransformation) -> {
         return affineTransformation.translation;
   ...
   static {
      ANY_CODEC = Codec.withAlternative(CODEC, Codecs.MATRIX_4F.xmap(AffineTransformation::new, AffineTransformation::getMatrix));
