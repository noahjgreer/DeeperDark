...
public record ReportType(String header, List nuggets) {
   ...
   public String chooseNugget() {
      try {
         return (String)this.nuggets.get((int)(Util.getMeasuringTimeNano() % (long)this.nuggets.size()));
      } catch (Throwable var2) {
         return "Witty comment unavailable :(";
      }
   }

   public void addHeaderAndNugget(StringBuilder reportBuilder, List extraInfo) {
      ...
      reportBuilder.append('\n');
      Iterator var3 = extraInfo.iterator();
