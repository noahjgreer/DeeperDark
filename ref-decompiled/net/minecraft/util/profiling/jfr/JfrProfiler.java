...
public class JfrProfiler implements FlightProfiler {
   ...
   private static final List EVENTS = List.of(ChunkGenerationEvent.class, ChunkRegionReadEvent.class, ChunkRegionWriteEvent.class, PacketReceivedEvent.class, PacketSentEvent.class, NetworkSummaryEvent.class, ServerTickTimeEvent.class, StructureGenerationEvent.class, WorldLoadFinishedEvent.class);
      ...
      if (this.isProfiling()) {
         ...
         try {
            ...
            this.currentRecording = (Recording)Util.make(new Recording(configuration), (recording) -> {
               ...
               recording.setName(String.format(Locale.ROOT, "%s-%s-%s", instanceType.getName(), SharedConstants.getGameVersion().name(), string));
            });
