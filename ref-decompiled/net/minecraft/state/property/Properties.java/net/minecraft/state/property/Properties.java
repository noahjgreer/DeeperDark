...
public class Properties {
    ...
    public static final EnumProperty<Direction> FACING = EnumProperty.of((String)"facing", Direction.class, (Enum[])new Direction[]{Direction.NORTH, Direction.EAST, Direction.SOUTH, Direction.WEST, Direction.UP, Direction.DOWN});
    ...
    public static final EnumProperty<Direction> VERTICAL_DIRECTION = EnumProperty.of((String)"vertical_direction", Direction.class, (Enum[])new Direction[]{Direction.UP, Direction.DOWN});
    ...
    public static final EnumProperty<CopperGolemStatueBlock.Pose> COPPER_GOLEM_POSE = EnumProperty.of("copper_golem_pose", CopperGolemStatueBlock.Pose.class);
}
