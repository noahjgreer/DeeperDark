...
public class Properties {
   ...
   public static final EnumProperty VAULT_STATE;
   public static final EnumProperty CREAKING_HEART_STATE;
   public static final BooleanProperty OMINOUS;
   public static final EnumProperty TEST_BLOCK_MODE;
   ...
   static {
      ...
      FACING = EnumProperty.of("facing", Direction.class, (Enum[])(Direction.NORTH, Direction.EAST, Direction.SOUTH, Direction.WEST, Direction.UP, Direction.DOWN));
      HOPPER_FACING = EnumProperty.of("facing", Direction.class, (facing) -> {
         return facing != Direction.UP;
      });
      HORIZONTAL_FACING = EnumProperty.of("facing", Direction.class, (Predicate)Direction.Type.HORIZONTAL);
      FLOWER_AMOUNT = IntProperty.of("flower_amount", 1, 4);
      SEGMENT_AMOUNT = IntProperty.of("segment_amount", 1, 4);
      ORIENTATION = EnumProperty.of("orientation", Orientation.class);
      BLOCK_FACE = EnumProperty.of("face", BlockFace.class);
      ...
      HYDRATION = IntProperty.of("hydration", 0, 3);
      ...
      INSTRUMENT = EnumProperty.of("instrument", NoteBlockInstrument.class);
      ...
      VERTICAL_DIRECTION = EnumProperty.of("vertical_direction", Direction.class, (Enum[])(Direction.UP, Direction.DOWN));
      ...
      TRIAL_SPAWNER_STATE = EnumProperty.of("trial_spawner_state", TrialSpawnerState.class);
      VAULT_STATE = EnumProperty.of("vault_state", VaultState.class);
      CREAKING_HEART_STATE = EnumProperty.of("creaking_heart_state", CreakingHeartState.class);
      OMINOUS = BooleanProperty.of("ominous");
      TEST_BLOCK_MODE = EnumProperty.of("mode", TestBlockMode.class);
      MAP = BooleanProperty.of("map");
   }
}
