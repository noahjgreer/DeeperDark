...
public class SpectateCommand {
   ...
   private static final DynamicCommandExceptionType NOT_SPECTATOR_EXCEPTION = new DynamicCommandExceptionType((playerName) -> {
      return Text.stringifiedTranslatable("commands.spectate.not_spectator", playerName);
   });

   public static void register(CommandDispatcher dispatcher) {
      dispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)CommandManager.literal("spectate").requires(CommandManager.requirePermissionLevel(2))).executes((context) -> {
