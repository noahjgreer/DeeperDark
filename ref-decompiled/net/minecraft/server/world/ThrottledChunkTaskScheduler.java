...
public class ThrottledChunkTaskScheduler extends ChunkTaskScheduler {
   ...
   public ThrottledChunkTaskScheduler(TaskExecutor executor, Executor dispatchExecutor, int maxConcurrentChunks) {
   ...
   public String toDumpString() {
      ...
      return var10000 + "=[" + (String)this.chunks.longStream().mapToObj((chunkPos) -> {
         return "" + chunkPos + ":" + String.valueOf(new ChunkPos(chunkPos));
