...
public class ChaseServer {
   ...
   private TeleportPos getTeleportPosition() {
      ...
      if (list.isEmpty()) {
         ...
         return string == null ? null : new TeleportPos(string, serverPlayerEntity.getX(), serverPlayerEntity.getY(), serverPlayerEntity.getZ(), serverPlayerEntity.getYaw(), serverPlayerEntity.getPitch());
      }
   }
