...
public class DedicatedServerGui extends JComponent {
   ...
   private final Collection stopTasks = Lists.newArrayList();
   ...
   private JComponent createStatsPanel() {
      ...
      Collection var10000 = this.stopTasks;
      Objects.requireNonNull(playerStatsGui);
      var10000.add(playerStatsGui::stop);
   ...
   public void appendToConsole(JTextArea textArea, JScrollPane scrollPane, String message) {
      if (!SwingUtilities.isEventDispatchThread()) {
         SwingUtilities.invokeLater(() -> {
            this.appendToConsole(textArea, scrollPane, message);
         });
      } else {
