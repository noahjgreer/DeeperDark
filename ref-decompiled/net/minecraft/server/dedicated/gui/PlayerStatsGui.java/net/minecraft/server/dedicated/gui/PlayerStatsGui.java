...
extends JComponent {
    private static final DecimalFormat AVG_TICK_FORMAT = new DecimalFormat("########0.000", DecimalFormatSymbols.getInstance(Locale.ROOT));
    private final int[] memoryUsePercentage = new int[256];
    private int memoryUsePercentagePos;
    private final @Nullable String[] lines = new String[11];
