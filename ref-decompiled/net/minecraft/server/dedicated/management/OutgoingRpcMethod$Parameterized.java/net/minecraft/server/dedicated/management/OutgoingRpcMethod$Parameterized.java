...
public record OutgoingRpcMethod.Parameterized<Params, Result>(RpcMethodInfo<Params, Result> info, OutgoingRpcMethod.Attributes attributes) implements OutgoingRpcMethod<Params, Result>
{
    @Override
