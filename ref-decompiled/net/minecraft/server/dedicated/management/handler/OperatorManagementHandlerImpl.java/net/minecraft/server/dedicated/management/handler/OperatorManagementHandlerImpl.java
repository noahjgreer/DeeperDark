...
implements OperatorManagementHandler {
    ...
    @Override
    public void addToOperators(PlayerConfigEntry player, Optional<PermissionLevel> permissionLevel, Optional<Boolean> canBypassPlayerLimit, ManagementConnectionId remote) {
