...
public class PropertiesRpcDispatcher {
    ...
    public static PermissionLevel setOperatorUserPermissionLevel(ManagementHandlerDispatcher dispatcher, PermissionLevel permissionLevel, ManagementConnectionId remote) {
