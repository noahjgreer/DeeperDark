...
implements CommandOutput {
    ...
    public ServerCommandSource createRconCommandSource() {
        ...
        return new ServerCommandSource(this, Vec3d.of(serverWorld.getSpawnPoint().getPos()), Vec2f.ZERO, serverWorld, LeveledPermissionPredicate.OWNERS, RCON_NAME, RCON_NAME_TEXT, this.server, null);
    }
