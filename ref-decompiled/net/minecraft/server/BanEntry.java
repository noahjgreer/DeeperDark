...
public abstract class BanEntry extends ServerConfigEntry {
   ...
   public BanEntry(@Nullable Object key, @Nullable Date creationDate, @Nullable String source, @Nullable Date expiryDate, @Nullable String reason) {
      super(key);
   ...
   protected BanEntry(@Nullable Object key, JsonObject json) {
      super(key);
