...
public abstract class StructurePoolElement {
    ...
    private volatile  @Nullable StructurePool.Projection projection;
    ...
    public abstract List<StructureTemplate.JigsawBlockInfo> getStructureBlockInfos(StructureTemplateManager var1, BlockPos var2, BlockRotation var3, Random var4);

    public abstract BlockBox getBoundingBox(StructureTemplateManager var1, BlockPos var2, BlockRotation var3);

    public abstract boolean generate(StructureTemplateManager var1, StructureWorldAccess var2, StructureAccessor var3, ChunkGenerator var4, BlockPos var5, BlockPos var6, BlockRotation var7, BlockBox var8, Random var9, StructureLiquidSettings var10, boolean var11);
    ...
    public static Function<StructurePool.Projection, LegacySinglePoolElement> ofLegacySingle(String id) {
        return projection -> new LegacySinglePoolElement((Either<Identifier, StructureTemplate>)Either.left((Object)Identifier.of(id)), EMPTY_PROCESSORS, (StructurePool.Projection)projection, Optional.empty());
    }
    ...
    public static Function<StructurePool.Projection, LegacySinglePoolElement> ofProcessedLegacySingle(String id, RegistryEntry<StructureProcessorList> processorListEntry) {
        return projection -> new LegacySinglePoolElement((Either<Identifier, StructureTemplate>)Either.left((Object)Identifier.of(id)), processorListEntry, (StructurePool.Projection)projection, Optional.empty());
    }

    public static Function<StructurePool.Projection, SinglePoolElement> ofSingle(String id) {
        return projection -> new SinglePoolElement((Either<Identifier, StructureTemplate>)Either.left((Object)Identifier.of(id)), EMPTY_PROCESSORS, (StructurePool.Projection)projection, Optional.empty());
    }
    ...
    public static Function<StructurePool.Projection, SinglePoolElement> ofProcessedSingle(String id, RegistryEntry<StructureProcessorList> processorListEntry) {
        return projection -> new SinglePoolElement((Either<Identifier, StructureTemplate>)Either.left((Object)Identifier.of(id)), processorListEntry, (StructurePool.Projection)projection, Optional.empty());
    }
    ...
    public static Function<StructurePool.Projection, SinglePoolElement> ofSingle(String id, StructureLiquidSettings liquidSettings) {
        return projection -> new SinglePoolElement((Either<Identifier, StructureTemplate>)Either.left((Object)Identifier.of(id)), EMPTY_PROCESSORS, (StructurePool.Projection)projection, Optional.of(liquidSettings));
    }

    public static Function<StructurePool.Projection, SinglePoolElement> ofProcessedSingle(String id, RegistryEntry<StructureProcessorList> processorListEntry, StructureLiquidSettings liquidSettings) {
        return projection -> new SinglePoolElement((Either<Identifier, StructureTemplate>)Either.left((Object)Identifier.of(id)), processorListEntry, (StructurePool.Projection)projection, Optional.of(liquidSettings));
    }
