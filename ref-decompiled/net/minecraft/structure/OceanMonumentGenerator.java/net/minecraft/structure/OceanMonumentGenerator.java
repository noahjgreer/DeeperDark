...
public class OceanMonumentGenerator {
    ...
    extends Piece {
        ...
        public Base(Random random, int x, int z, Direction orientation) {
            ...
            List<PieceSetting> list = this.setupPieces(random);
        ...
        private List<PieceSetting> setupPieces(Random random) {
            int o;
            int n;
            int m;
            int l;
            ...
            this.coreRoomPieceSetting = pieceSettings[Base.getIndex(random.nextInt(4), 0, 2)];
    ...
    extends StructurePiece {
        ...
        protected Piece(StructurePieceType type, int length, Direction orientation, PieceSetting setting, int x, int y, int z) {
            super(type, length, Piece.createBox(orientation, setting, x, y, z));
            this.setOrientation(orientation);
        ...
        private static BlockBox createBox(Direction orientation, PieceSetting setting, int x, int y, int z) {
            ...
            int k = i / 5 % 5;
            int l = i / 25;
            BlockBox blockBox = Piece.createBox(0, 0, 0, orientation, x * 8, y * 4, z * 8);
            switch (orientation) {
                case NORTH: {
