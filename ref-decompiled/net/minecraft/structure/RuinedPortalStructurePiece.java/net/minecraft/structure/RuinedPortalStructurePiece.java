...
extends SimpleStructurePiece {
    ...
    public RuinedPortalStructurePiece(StructureTemplateManager manager, NbtCompound nbt) {
        ...
        this.verticalPlacement = nbt.get("VerticalPlacement", VerticalPlacement.CODEC).orElseThrow();
        this.properties = nbt.get("Properties", Properties.CODEC).orElseThrow();
    }
    ...
    protected void writeNbt(StructureContext context, NbtCompound nbt) {
        ...
        nbt.put("VerticalPlacement", VerticalPlacement.CODEC, this.verticalPlacement);
        nbt.put("Properties", Properties.CODEC, this.properties);
    }
    ...
    private static StructurePlacementData createPlacementData(StructureTemplateManager manager, NbtCompound nbt, Identifier id) {
        ...
        return RuinedPortalStructurePiece.createPlacementData(nbt.get("Mirror", BlockMirror.ENUM_NAME_CODEC).orElseThrow(), nbt.get("Rotation", BlockRotation.ENUM_NAME_CODEC).orElseThrow(), nbt.get("VerticalPlacement", VerticalPlacement.CODEC).orElseThrow(), blockPos, (Properties)Properties.CODEC.parse(new Dynamic((DynamicOps)NbtOps.INSTANCE, (Object)nbt.get("Properties"))).getPartialOrThrow());
    }
