...
public class PoolStructurePiece extends StructurePiece {
   ...
   public PoolStructurePiece(StructureContext context, NbtCompound nbt) {
      ...
      DynamicOps dynamicOps = context.registryManager().getOps(NbtOps.INSTANCE);
      this.poolElement = (StructurePoolElement)nbt.get("pool_element", StructurePoolElement.CODEC, dynamicOps).orElseThrow(() -> {
