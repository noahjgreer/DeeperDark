...
public class OceanRuinGenerator {
   ...
   private static StructureProcessor createArchaeologyStructureProcessor(Block baseBlock, Block suspiciousBlock, RegistryKey lootTable) {
      return new CappedStructureProcessor(new RuleStructureProcessor(List.of(new StructureProcessorRule(new BlockMatchRuleTest(baseBlock), AlwaysTrueRuleTest.INSTANCE, AlwaysTruePosRuleTest.INSTANCE, suspiciousBlock.getDefaultState(), new AppendLootRuleBlockEntityModifier(lootTable)))), ConstantIntProvider.create(5));
   }
   ...
   private static void addCluster(StructureTemplateManager manager, Random random, BlockRotation rotation, BlockPos pos, OceanRuinStructure structure, StructurePiecesHolder pieces) {
      ...
      List list = getRoomPositions(random, blockPos3);
   ...
   static {
      ...
      WARM_RUINS = new Identifier[]{Identifier.ofVanilla("underwater_ruin/warm_1"), Identifier.ofVanilla("underwater_ruin/warm_2"), Identifier.ofVanilla("underwater_ruin/warm_3"), Identifier.ofVanilla("underwater_ruin/warm_4"), Identifier.ofVanilla("underwater_ruin/warm_5"), Identifier.ofVanilla("underwater_ruin/warm_6"), Identifier.ofVanilla("underwater_ruin/warm_7"), Identifier.ofVanilla("underwater_ruin/warm_8")};
      BRICK_RUINS = new Identifier[]{Identifier.ofVanilla("underwater_ruin/brick_1"), Identifier.ofVanilla("underwater_ruin/brick_2"), Identifier.ofVanilla("underwater_ruin/brick_3"), Identifier.ofVanilla("underwater_ruin/brick_4"), Identifier.ofVanilla("underwater_ruin/brick_5"), Identifier.ofVanilla("underwater_ruin/brick_6"), Identifier.ofVanilla("underwater_ruin/brick_7"), Identifier.ofVanilla("underwater_ruin/brick_8")};
      CRACKED_RUINS = new Identifier[]{Identifier.ofVanilla("underwater_ruin/cracked_1"), Identifier.ofVanilla("underwater_ruin/cracked_2"), Identifier.ofVanilla("underwater_ruin/cracked_3"), Identifier.ofVanilla("underwater_ruin/cracked_4"), Identifier.ofVanilla("underwater_ruin/cracked_5"), Identifier.ofVanilla("underwater_ruin/cracked_6"), Identifier.ofVanilla("underwater_ruin/cracked_7"), Identifier.ofVanilla("underwater_ruin/cracked_8")};
      MOSSY_RUINS = new Identifier[]{Identifier.ofVanilla("underwater_ruin/mossy_1"), Identifier.ofVanilla("underwater_ruin/mossy_2"), Identifier.ofVanilla("underwater_ruin/mossy_3"), Identifier.ofVanilla("underwater_ruin/mossy_4"), Identifier.ofVanilla("underwater_ruin/mossy_5"), Identifier.ofVanilla("underwater_ruin/mossy_6"), Identifier.ofVanilla("underwater_ruin/mossy_7"), Identifier.ofVanilla("underwater_ruin/mossy_8")};
      BIG_BRICK_RUINS = new Identifier[]{Identifier.ofVanilla("underwater_ruin/big_brick_1"), Identifier.ofVanilla("underwater_ruin/big_brick_2"), Identifier.ofVanilla("underwater_ruin/big_brick_3"), Identifier.ofVanilla("underwater_ruin/big_brick_8")};
      BIG_MOSSY_RUINS = new Identifier[]{Identifier.ofVanilla("underwater_ruin/big_mossy_1"), Identifier.ofVanilla("underwater_ruin/big_mossy_2"), Identifier.ofVanilla("underwater_ruin/big_mossy_3"), Identifier.ofVanilla("underwater_ruin/big_mossy_8")};
      BIG_CRACKED_RUINS = new Identifier[]{Identifier.ofVanilla("underwater_ruin/big_cracked_1"), Identifier.ofVanilla("underwater_ruin/big_cracked_2"), Identifier.ofVanilla("underwater_ruin/big_cracked_3"), Identifier.ofVanilla("underwater_ruin/big_cracked_8")};
      BIG_WARM_RUINS = new Identifier[]{Identifier.ofVanilla("underwater_ruin/big_warm_4"), Identifier.ofVanilla("underwater_ruin/big_warm_5"), Identifier.ofVanilla("underwater_ruin/big_warm_6"), Identifier.ofVanilla("underwater_ruin/big_warm_7")};
   }
   ...
   public static class Piece extends SimpleStructurePiece {
      ...
      private Piece(StructureTemplateManager holder, NbtCompound nbt, BlockRotation rotation, float integrity, OceanRuinStructure.BiomeTemperature biomeType, boolean large) {
         super(StructurePieceType.OCEAN_TEMPLE, nbt, holder, (identifier) -> {
      ...
      private static StructurePlacementData createPlacementData(BlockRotation rotation, float integrity, OceanRuinStructure.BiomeTemperature temperature) {
         StructureProcessor structureProcessor = temperature == OceanRuinStructure.BiomeTemperature.COLD ? OceanRuinGenerator.SUSPICIOUS_GRAVEL_PROCESSOR : OceanRuinGenerator.SUSPICIOUS_SAND_PROCESSOR;
      ...
      public static Piece fromNbt(StructureTemplateManager structureTemplateManager, NbtCompound nbt) {
         BlockRotation blockRotation = (BlockRotation)nbt.get("Rot", BlockRotation.ENUM_NAME_CODEC).orElseThrow();
         float f = nbt.getFloat("Integrity", 0.0F);
         OceanRuinStructure.BiomeTemperature biomeTemperature = (OceanRuinStructure.BiomeTemperature)nbt.get("BiomeType", OceanRuinStructure.BiomeTemperature.ENUM_NAME_CODEC).orElseThrow();
      ...
      protected void handleMetadata(String metadata, BlockPos pos, ServerWorldAccess world, Random random, BlockBox boundingBox) {
         if ("chest".equals(metadata)) {
            ...
            DrownedEntity drownedEntity = (DrownedEntity)EntityType.DROWNED.create(world.toServerWorld(), SpawnReason.STRUCTURE);
            if (drownedEntity != null) {
               drownedEntity.setPersistent();
               drownedEntity.refreshPositionAndAngles(pos, 0.0F, 0.0F);
               drownedEntity.initialize(world, world.getLocalDifficulty(pos), SpawnReason.STRUCTURE, (EntityData)null);
