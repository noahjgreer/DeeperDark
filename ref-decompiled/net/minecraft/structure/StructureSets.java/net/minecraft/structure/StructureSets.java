...
public interface StructureSets {
    public static void bootstrap(Registerable<StructureSet> structureSetRegisterable) {
        ...
        RegistryEntry.Reference<StructureSet> reference = structureSetRegisterable.register(StructureSetKeys.VILLAGES, new StructureSet(List.of(StructureSet.createEntry(registryEntryLookup.getOrThrow(StructureKeys.VILLAGE_PLAINS)), StructureSet.createEntry(registryEntryLookup.getOrThrow(StructureKeys.VILLAGE_DESERT)), StructureSet.createEntry(registryEntryLookup.getOrThrow(StructureKeys.VILLAGE_SAVANNA)), StructureSet.createEntry(registryEntryLookup.getOrThrow(StructureKeys.VILLAGE_SNOWY)), StructureSet.createEntry(registryEntryLookup.getOrThrow(StructureKeys.VILLAGE_TAIGA))), (StructurePlacement)new RandomSpreadStructurePlacement(34, 8, SpreadType.LINEAR, 10387312)));
        structureSetRegisterable.register(StructureSetKeys.DESERT_PYRAMIDS, new StructureSet(registryEntryLookup.getOrThrow(StructureKeys.DESERT_PYRAMID), (StructurePlacement)new RandomSpreadStructurePlacement(32, 8, SpreadType.LINEAR, 14357617)));
        structureSetRegisterable.register(StructureSetKeys.IGLOOS, new StructureSet(registryEntryLookup.getOrThrow(StructureKeys.IGLOO), (StructurePlacement)new RandomSpreadStructurePlacement(32, 8, SpreadType.LINEAR, 14357618)));
        structureSetRegisterable.register(StructureSetKeys.JUNGLE_TEMPLES, new StructureSet(registryEntryLookup.getOrThrow(StructureKeys.JUNGLE_PYRAMID), (StructurePlacement)new RandomSpreadStructurePlacement(32, 8, SpreadType.LINEAR, 14357619)));
        structureSetRegisterable.register(StructureSetKeys.SWAMP_HUTS, new StructureSet(registryEntryLookup.getOrThrow(StructureKeys.SWAMP_HUT), (StructurePlacement)new RandomSpreadStructurePlacement(32, 8, SpreadType.LINEAR, 14357620)));
        structureSetRegisterable.register(StructureSetKeys.PILLAGER_OUTPOSTS, new StructureSet(registryEntryLookup.getOrThrow(StructureKeys.PILLAGER_OUTPOST), (StructurePlacement)new RandomSpreadStructurePlacement(Vec3i.ZERO, StructurePlacement.FrequencyReductionMethod.LEGACY_TYPE_1, 0.2f, 165745296, Optional.of(new StructurePlacement.ExclusionZone(reference, 10)), 32, 8, SpreadType.LINEAR)));
        structureSetRegisterable.register(StructureSetKeys.ANCIENT_CITIES, new StructureSet(registryEntryLookup.getOrThrow(StructureKeys.ANCIENT_CITY), (StructurePlacement)new RandomSpreadStructurePlacement(24, 8, SpreadType.LINEAR, 20083232)));
        structureSetRegisterable.register(StructureSetKeys.OCEAN_MONUMENTS, new StructureSet(registryEntryLookup.getOrThrow(StructureKeys.MONUMENT), (StructurePlacement)new RandomSpreadStructurePlacement(32, 5, SpreadType.TRIANGULAR, 10387313)));
        structureSetRegisterable.register(StructureSetKeys.WOODLAND_MANSIONS, new StructureSet(registryEntryLookup.getOrThrow(StructureKeys.MANSION), (StructurePlacement)new RandomSpreadStructurePlacement(80, 20, SpreadType.TRIANGULAR, 10387319)));
        structureSetRegisterable.register(StructureSetKeys.BURIED_TREASURES, new StructureSet(registryEntryLookup.getOrThrow(StructureKeys.BURIED_TREASURE), (StructurePlacement)new RandomSpreadStructurePlacement(new Vec3i(9, 0, 9), StructurePlacement.FrequencyReductionMethod.LEGACY_TYPE_2, 0.01f, 0, Optional.empty(), 1, 0, SpreadType.LINEAR)));
        structureSetRegisterable.register(StructureSetKeys.MINESHAFTS, new StructureSet(List.of(StructureSet.createEntry(registryEntryLookup.getOrThrow(StructureKeys.MINESHAFT)), StructureSet.createEntry(registryEntryLookup.getOrThrow(StructureKeys.MINESHAFT_MESA))), (StructurePlacement)new RandomSpreadStructurePlacement(Vec3i.ZERO, StructurePlacement.FrequencyReductionMethod.LEGACY_TYPE_3, 0.004f, 0, Optional.empty(), 1, 0, SpreadType.LINEAR)));
