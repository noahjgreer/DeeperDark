...
public interface StructureSets {
   static void bootstrap(Registerable structureSetRegisterable) {
      RegistryEntryLookup registryEntryLookup = structureSetRegisterable.getRegistryLookup(RegistryKeys.STRUCTURE);
      RegistryEntryLookup registryEntryLookup2 = structureSetRegisterable.getRegistryLookup(RegistryKeys.BIOME);
      RegistryEntry.Reference reference = structureSetRegisterable.register(StructureSetKeys.VILLAGES, new StructureSet(List.of(StructureSet.createEntry(registryEntryLookup.getOrThrow(StructureKeys.VILLAGE_PLAINS)), StructureSet.createEntry(registryEntryLookup.getOrThrow(StructureKeys.VILLAGE_DESERT)), StructureSet.createEntry(registryEntryLookup.getOrThrow(StructureKeys.VILLAGE_SAVANNA)), StructureSet.createEntry(registryEntryLookup.getOrThrow(StructureKeys.VILLAGE_SNOWY)), StructureSet.createEntry(registryEntryLookup.getOrThrow(StructureKeys.VILLAGE_TAIGA))), new RandomSpreadStructurePlacement(34, 8, SpreadType.LINEAR, 10387312)));
      ...
      structureSetRegisterable.register(StructureSetKeys.TRIAL_CHAMBERS, new StructureSet(registryEntryLookup.getOrThrow(StructureKeys.TRIAL_CHAMBERS), new RandomSpreadStructurePlacement(34, 12, SpreadType.LINEAR, 94251327)));
   }
}
