...
public abstract class SimpleStructurePiece extends StructurePiece {
   ...
   public void generate(StructureWorldAccess world, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox chunkBox, ChunkPos chunkPos, BlockPos pivot) {
      ...
      if (this.template.place(world, this.pos, pivot, this.placementData, random, 2)) {
         ...
         while(var9.hasNext()) {
            StructureTemplate.StructureBlockInfo structureBlockInfo = (StructureTemplate.StructureBlockInfo)var9.next();
            if (structureBlockInfo.nbt() != null) {
               StructureBlockMode structureBlockMode = (StructureBlockMode)structureBlockInfo.nbt().get("mode", StructureBlockMode.CODEC).orElseThrow();
         ...
         while(var16.hasNext()) {
            StructureTemplate.StructureBlockInfo structureBlockInfo2 = (StructureTemplate.StructureBlockInfo)var16.next();
