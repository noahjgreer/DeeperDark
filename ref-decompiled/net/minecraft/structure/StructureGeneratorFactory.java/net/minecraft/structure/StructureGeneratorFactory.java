...
public interface StructureGeneratorFactory<C extends FeatureConfig> {
    ...
    public record Context<C extends FeatureConfig>(ChunkGenerator chunkGenerator, BiomeSource biomeSource, NoiseConfig noiseConfig, long seed, ChunkPos chunkPos, C config, HeightLimitView world, Predicate<RegistryEntry<Biome>> validBiome, StructureTemplateManager structureTemplateManager, DynamicRegistryManager registryManager) {
        ...
        public final String toString() {
            return ObjectMethods.bootstrap("toString", new MethodHandle[]{Context.class, "chunkGenerator;biomeSource;randomState;seed;chunkPos;config;heightAccessor;validBiome;structureTemplateManager;registryAccess", "chunkGenerator", "biomeSource", "noiseConfig", "seed", "chunkPos", "config", "world", "validBiome", "structureTemplateManager", "registryManager"}, this);
        }

        @Override
        public final int hashCode() {
            return (int)ObjectMethods.bootstrap("hashCode", new MethodHandle[]{Context.class, "chunkGenerator;biomeSource;randomState;seed;chunkPos;config;heightAccessor;validBiome;structureTemplateManager;registryAccess", "chunkGenerator", "biomeSource", "noiseConfig", "seed", "chunkPos", "config", "world", "validBiome", "structureTemplateManager", "registryManager"}, this);
        }

        @Override
        public final boolean equals(Object object) {
            return (boolean)ObjectMethods.bootstrap("equals", new MethodHandle[]{Context.class, "chunkGenerator;biomeSource;randomState;seed;chunkPos;config;heightAccessor;validBiome;structureTemplateManager;registryAccess", "chunkGenerator", "biomeSource", "noiseConfig", "seed", "chunkPos", "config", "world", "validBiome", "structureTemplateManager", "registryManager"}, this, object);
        }
    }
}
