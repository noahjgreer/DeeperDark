...
public class BastionData {
   public static void bootstrap(Registerable poolRegisterable) {
      RegistryEntryLookup registryEntryLookup = poolRegisterable.getRegistryLookup(RegistryKeys.TEMPLATE_POOL);
      RegistryEntry registryEntry = registryEntryLookup.getOrThrow(StructurePools.EMPTY);
      ...
      StructurePools.register(poolRegisterable, "bastion/blocks/gold", new StructurePool(registryEntry, ImmutableList.of(Pair.of(StructurePoolElement.ofSingle("bastion/blocks/air"), 3), Pair.of(StructurePoolElement.ofSingle("bastion/blocks/gold"), 1)), StructurePool.Projection.RIGID));
      StructurePools.register(poolRegisterable, "bastion/mobs/piglin_melee", new StructurePool(registryEntry, ImmutableList.of(Pair.of(StructurePoolElement.ofSingle("bastion/mobs/melee_piglin_always"), 1), Pair.of(StructurePoolElement.ofSingle("bastion/mobs/melee_piglin"), 5), Pair.of(StructurePoolElement.ofSingle("bastion/mobs/sword_piglin"), 1)), StructurePool.Projection.RIGID));
   }
}
