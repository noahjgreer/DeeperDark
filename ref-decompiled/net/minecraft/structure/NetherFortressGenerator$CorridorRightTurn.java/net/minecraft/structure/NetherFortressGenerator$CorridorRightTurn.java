...
public static class NetherFortressGenerator.CorridorRightTurn
extends NetherFortressGenerator.Piece {
    ...
    public NetherFortressGenerator.CorridorRightTurn(int chainLength, Random random, BlockBox boundingBox, Direction orientation) {
    ...
    public NetherFortressGenerator.CorridorRightTurn(NbtCompound nbt) {
    ...
    public static @Nullable NetherFortressGenerator.CorridorRightTurn create(StructurePiecesHolder holder, Random random, int x, int y, int z, Direction orientation, int chainLength) {
        BlockBox blockBox = BlockBox.rotated(x, y, z, -1, 0, 0, 5, 7, 5, orientation);
        if (!NetherFortressGenerator.CorridorRightTurn.isInBounds(blockBox) || holder.getIntersecting(blockBox) != null) {
            return null;
        }
        return new NetherFortressGenerator.CorridorRightTurn(chainLength, random, blockBox, orientation);
    }
