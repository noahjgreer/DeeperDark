...
public interface StructureProcessorType<P extends StructureProcessor> {
    ...
    public static final Codec<StructureProcessorList> PROCESSORS_CODEC = Codec.withAlternative((Codec)LIST_CODEC.fieldOf("processors").codec(), LIST_CODEC);
    ...
    public static final StructureProcessorType<CappedStructureProcessor> CAPPED = StructureProcessorType.register("capped", CappedStructureProcessor.CODEC);
