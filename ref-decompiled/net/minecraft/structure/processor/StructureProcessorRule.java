...
public class StructureProcessorRule {
   ...
   static {
      ...
      CODEC = RecordCodecBuilder.create((instance) -> {
         ...
         }), PosRuleTest.BASE_CODEC.lenientOptionalFieldOf("position_predicate", AlwaysTruePosRuleTest.INSTANCE).forGetter((rule) -> {
            return rule.positionPredicate;
         }), BlockState.CODEC.fieldOf("output_state").forGetter((rule) -> {
            return rule.outputState;
         }), RuleBlockEntityModifier.TYPE_CODEC.lenientOptionalFieldOf("block_entity_modifier", DEFAULT_BLOCK_ENTITY_MODIFIER).forGetter((rule) -> {
