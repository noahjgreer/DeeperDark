...
public class WoodlandMansionGenerator {
    ...
    static class MansionParameters {
        ...
        public @Nullable Direction findConnectedRoomDirection(FlagMatrix layout, int i, int j, int floor, int roomId) {
    ...
    extends SimpleStructurePiece {
        ...
        public Piece(StructureTemplateManager manager, NbtCompound nbt) {
            super(StructurePieceType.WOODLAND_MANSION, nbt, manager, (Identifier id) -> Piece.createPlacementData(nbt.get("Mi", BlockMirror.ENUM_NAME_CODEC).orElseThrow(), nbt.get("Rot", BlockRotation.ENUM_NAME_CODEC).orElseThrow()));
        }
