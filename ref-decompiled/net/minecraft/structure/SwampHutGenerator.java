      ...
      if (this.adjustToAverageHeight(world, chunkBox, 0)) {
         ...
         if (!this.hasWitch) {
            ...
            if (chunkBox.contains(blockPos)) {
               this.hasWitch = true;
               WitchEntity witchEntity = (WitchEntity)EntityType.WITCH.create(world.toServerWorld(), SpawnReason.STRUCTURE);
               if (witchEntity != null) {
                  ...
                  witchEntity.initialize(world, world.getLocalDifficulty(blockPos), SpawnReason.STRUCTURE, (EntityData)null);
   ...
   private void spawnCat(ServerWorldAccess world, BlockBox box) {
      if (!this.hasCat) {
         ...
         if (box.contains(blockPos)) {
            this.hasCat = true;
            CatEntity catEntity = (CatEntity)EntityType.CAT.create(world.toServerWorld(), SpawnReason.STRUCTURE);
            if (catEntity != null) {
               ...
               catEntity.initialize(world, world.getLocalDifficulty(blockPos), SpawnReason.STRUCTURE, (EntityData)null);
